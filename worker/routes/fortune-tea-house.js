...
const FORTUNE_TEA_SUKUYO_RELATION_GUIDE = {
  ...
  우쇠: {
    tone: "한쪽이 먼저 다가가고 한쪽이 그 관심을 받아들이며 온도 차가 함께 움직이는 인연입니다.",
    strengths: ["가까워지는 속도가 빨라 곁을 내주기까지 오래 걸리지 않습니다.", "먼저 움직이는 쪽의 마음이 또렷해 관계가 어디로 향하는지 읽기 쉽습니다."],
    cautions: ["먼저 다가가는 자리에 선 쪽이 연락과 조율을 도맡다 보면 함께한 뒤에 유독 기운이 빠질 수 있습니다.", "받아들이는 자리에 선 쪽은 편안함에 익숙해지기 쉬우니 고마움을 말과 응답 속도로 되돌려 주는 편이 좋습니다."],
    keywords: ["먼저 다가감", "받아들임", "회복 간격"],
  },
  안괴: {
    ...
    return {
      ...
      calculationBasis: {
        user: {
          ...
          source: cleanTextOr(userSukuyo.source, "korean-calendar-core", 40),
        ...
        partner: {
          ...
          source: cleanTextOr(partnerSukuyo.source, "korean-calendar-core", 40),
