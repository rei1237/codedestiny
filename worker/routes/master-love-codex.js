/**
 * ═══════════════════════════════════════════════════════════════════════════
 *  마스터 운명 연애 비책  (MASTER_LOVE_CODEX)  —  워커 라우트
 * ───────────────────────────────────────────────────────────────────────────
...
const MESSAGES = {
  loginRequired: "마스터 운명 연애 비책을 열려면 로그인이 필요합니다.",
  invalidInput: "생년월일과 태어난 시각(또는 '태어난 시각 모름')을 확인해 주세요.",
  paymentRequired: "마스터 운명 연애 비책은 회당 결제가 필요합니다.",
  ...
  notFound: "요청하신 비책을 찾을 수 없습니다.",
  serverError: "비책을 준비하는 중 문제가 발생했습니다.",
