...
const CHAPTER_BLUEPRINTS = [
  {
    ...
    roman: "I",
    palaceKey: "ming",
    title: "Chapter 1. 명반 총론 — 삶의 중심 구조",
    categories: [
      "명궁과 신궁의 핵심 구조",
      "오행국과 대한 진행 방향",
      "전체 명반의 첫인상",
  ...
  },
  {
    ...
    roman: "II",
    palaceKey: "ming",
    title: "Chapter 2. 명궁 심층 해설 — 타고난 나의 결",
    categories: [
      "명궁 주성이 만드는 자아상",
      "명궁 보조성과 선택 기준",
      "명궁 살성·잡요가 드러내는 부담",
  ...
  },
  {
    ...
    roman: "IV",
    palaceKey: "ming",
    title: "Chapter 4. 12궁 전체 해설",
    categories: [
      "명궁·형제궁·부처궁의 기본 흐름",
      "자녀궁·재백궁·질액궁의 현실 리듬",
      "천이궁·노복궁·관록궁의 사회적 움직임",
      "전택궁·복덕궁·부모궁의 뿌리와 안정감",
      "특히 강한 궁과 부담이 되는 궁",
    ],
  },
  {
    ...
    roman: "V",
    palaceKey: "ming",
    title: "Chapter 5. 사화 구조 해석",
    categories: [
      "화록이 여는 욕망과 기회",
      "화권이 만드는 힘과 책임",
      "화과가 정리하는 평판과 명예",
      "화기가 보여주는 집착과 막힘",
      "사화가 서로 보완하거나 충돌하는 방식",
    ],
  },
  {
    id: "06",
    roman: "VI",
    palaceKey: "ming",
    title: "Chapter 6. 삼방사정과 인생의 핵심 축",
    categories: [
      "명궁 삼방사정의 큰 구조",
      "재백궁으로 이어지는 현실 선택",
      "관록궁으로 드러나는 사회적 역할",
  ...
  },
  {
    ...
    roman: "XIII",
    palaceKey: "timing",
    title: "Chapter 13. 최종 운명 전략과 마스터플랜",
    categories: [
      "이 명반의 최종 결론",
      "반드시 살려야 할 장점",
      "조심해야 할 반복 패턴",
