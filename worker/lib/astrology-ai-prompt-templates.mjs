...
export function classifyQuestionToAstrologyDomain(question) {
  ...
  const map = {
    reconciliation: ["재회", "다시 만나", "관계 회복", "돌아올", "전애인", "헤어진", "읽씹", "차단"],
    breakup: ["이별", "헤어", "정리", "끝내", "끊어", "놓아", "후폭풍"],
    compatibility: ["궁합", "시나스트리", "상대", "이 사람", "그 사람", "우리", "두 사람", "배우자", "파트너", "오래 갈", "장기적"],
    love: ["연애", "썸", "결혼", "고백", "호감", "연락", "마음", "좋아", "데이트", "짝사랑", "인연"],
    career: ["직업", "진로", "이직", "커리어", "창업", "사업", "퇴사", "승진", "직장", "회사", "면접", "합격", "업무"],
    money: ["돈", "재정", "재물", "투자", "수익", "연봉", "월급", "부업", "매출", "계약", "저축", "대출"],
    relationship: ["인간관계", "가족", "친구", "동료", "갈등", "소통", "상사", "팀", "조직", "부모", "자녀"],
    health: ["건강", "멘탈", "스트레스", "수면", "회복", "불안", "무기력", "번아웃", "피로", "감정 기복"],
    life_direction: ["인생", "방향", "미래", "목표", "전환", "선택", "변화", "새출발", "성장"],
  };
