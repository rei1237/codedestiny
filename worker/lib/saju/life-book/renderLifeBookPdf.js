...
export function renderLifeBookPdf(params = {}) {
  ...
  const html = [
    ...
    'body{margin:0;padding:30px;font-family:"Noto Serif KR","Noto Sans KR",serif;background:radial-gradient(circle at 14% -10%,#fffaf4 0%,#f6efe4 42%,#f3eadf 100%);color:#1f172a;line-height:1.92;font-size:15px;word-break:keep-all}',
    ...
    '.lb-content h2{margin-top:16px;padding:9px 12px;border-left:4px solid #9f6940;background:#efe3d2;border-radius:8px;color:#5a3c21;font-size:20px;line-height:1.5}',
    '.lb-content h3{margin-top:14px;color:#69492a;font-size:17px;line-height:1.55}',
    '.lb-content p{font-family:"Noto Sans KR","Noto Serif KR",sans-serif;font-size:15px;line-height:1.92;margin:0 0 10px}',
    ...
    '@media print{body{padding:0;background:#fff}.lb-cover,.lb-card,.lb-chapter{box-shadow:none}.lb-chapter{break-before:page;page-break-before:always}.lb-chapter:first-of-type{break-before:auto;page-break-before:auto}}',
    "</style>",
    "</head>",
    "<body>",
