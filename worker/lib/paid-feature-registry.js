...
export const FEATURE_KEY_PRICE_TABLE = Object.freeze({
  ...
  "saju_lifebook_pdf": { cost: 500, reason: "사주 인생의 책 PDF 생성" },
...
export const PIG_COIN_UNLOCK_PRODUCTS = Object.freeze({
  ...
  "unlock.saju_lifebook_pdf": { featureKey: "saju_lifebook_pdf", cost: 500, reason: "Saju lifebook PDF unlock", forceDeduct: true },
...
export const PAID_FEATURE_KEY_ALIASES = Object.freeze({
  ...
  openSajuLifeBookBuilder: "saju_lifebook_pdf",
  sajuLifebookPdf: "saju_lifebook_pdf",
  saju_lifebook_pdf: "saju_lifebook_pdf",
