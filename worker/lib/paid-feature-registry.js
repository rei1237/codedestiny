...
const RAW_FEATURE_KEY_REASON_COSTS = Object.freeze({
  "neville-meditation": Object.freeze({
    ...
    "openNevilleMeditationPage 60분 코스": 30,
  }),
...
const RAW_FEATURE_KEY_PRICE_TABLE = Object.freeze({
  ...
  "physiognomy-ogwan-mole-deep": { cost: 30, reason: "오관·점 정밀 분석" },
  "tarot-year-fortune": { cost: 50, amountKRW: 5000, reason: "십이지신 천운 타로" },
  "tarot-love-relationship": { cost: 30, reason: "우리는 무슨 사이? 타로 리딩" },
  "tarot-reunion-reading": { cost: 30, reason: "재회운 타로 리딩" },
  "tarot-myeongri-three-card": { cost: 30, reason: "명리학 타로 3장 스프레드" },
  "tarot-mindscan": { cost: 30, reason: "마인드 스캔 타로 리딩" },
  "tarot-celestial-harmony": { cost: 50, reason: "셀레스티얼 하모니 타로 리딩" },
  "tarot-crystal-soul-reading": { cost: 30, reason: "크리스탈 소울 타로 리딩" },
  ...
  "tarot-prompt-maker-standard": { cost: 30, amountKRW: 3000, reason: "타로 오라클 상담 (5~7카드)" },
  "tarot-prompt-maker-deep": { cost: 50, amountKRW: 5000, reason: "타로 오라클 상담 (8~10카드)" },
  "tarot-prompt-maker-master": { cost: 50, amountKRW: 5000, reason: "타로 오라클 상담 (11~14카드)" },
  "maya-prompt-generator": { cost: 30, reason: "마야점 상담 프롬프트 생성" },
  "tarot-ijik": { cost: 30, reason: "이직 타로 리딩" },
  "royal-tea-oracle": { cost: 30, reason: "영국 홍차점 리딩" },
  "ifa-oracle": { cost: 30, reason: "IFÀ 오라클 리딩" },
  "neville-meditation": { cost: 30, reason: "네빌 명상 실습" },
  "cosmic-soul-meditation": { cost: 100, reason: "코스믹 소울 명상" },
  ...
  "fortune-tea-house-tarot-five-consultation": { cost: 50, amountKRW: 5000, reason: "운명 찻집 타로 프리미엄 상담 (5카드)" },
  "fortune-tea-house-saju-consultation": { cost: 50, amountKRW: 5000, reason: "운명 찻집 사주 상담" },
  "fortune-tea-house-saju-compatibility-consultation": { cost: 50, amountKRW: 5000, reason: "운명 찻집 사주 궁합 상담" },
  "fortune-tea-house-sukuyo-compatibility-consultation": { cost: 50, amountKRW: 5000, reason: "운명 찻집 숙요점 궁합 상담" },
  "sukuyo-symbolic-comparison": { cost: 30, reason: "숙요 인연 레이더" },
  "sukuyo-extreme-t-relationship": { cost: 30, reason: "극T 관계 회로 확장" },
  "sukuyo-relationship-encyclopedia": { cost: 30, reason: "숙요 인연 도감" },
  "sukuyo-nature-deep-dive": { cost: 30, reason: "본성 심화 해석" },
  "sukuyo-past-life-reading": { cost: 50, reason: "숙요 전생 인연 리딩" },
  "sukuyo-monthly-fortune": { cost: 30, reason: "월별 숙요 운세 확장" },
  "sukuyo-compatibility-ai": { cost: 300, amountKRW: 30000, reason: "숙요점 궁합 전문가 상담" },
  "sukyo_yearly_fortune_unlock": { cost: 50, reason: "숙요점 1년운 전체 해석 잠금 해제" },
  "compat-astro-synastry": { cost: 30, reason: "점성술 셜럭 시나스트리 궁합" },
  "compat-astro-direct-synastry": { cost: 30, reason: "점성술 직접 입력 시나스트리 궁합" },
  "compat-ziwei-compatibility": { cost: 30, reason: "자미두수 궁합 분석" },
  "compat-saju-compatibility": { cost: 30, reason: "사주 궁합 분석" },
  "compat-sukuyo-compatibility": { cost: 30, reason: "숙요점 궁합 분석" },
  "vedic-compatibility-per-use": { cost: 30, reason: "베다점 궁합 분석" },
  "nakshatra-compat": { cost: 50, amountKRW: 5000, reason: "나크샤트라 동서 통합 궁합" },
  "nakshatra-ai-consultation": { cost: 300, amountKRW: 30000, reason: "나크샤트라 결정판 전문가 심화 상담" },
  "nakshatra-muhurta": { cost: 30, amountKRW: 3000, reason: "나크샤트라 택일(무후르타)" },
  ...
  "human-design-report": { cost: 50, amountKRW: 5000, reason: "휴먼 디자인 프리미엄 리포트" },
  ...
  "destiny-compass-future-sim": { cost: 50, amountKRW: 5000, reason: "미래 시뮬레이션 안내" },
  "destiny-compass-deep-report": { cost: 50, amountKRW: 5000, reason: "운명의 지도 심층 리포트" },
  "pet-saju-ai-consultation": { cost: 30, amountKRW: 3000, reason: "반려동물 사주 AI 심층 리포트" },
  "pet-compatibility-ai": { cost: 30, amountKRW: 3000, reason: "반려동물 궁합 분석" },
  ...
  geomancy: { cost: 30, reason: "지오맨시 오라클 리딩" },
  stonehengeRunes: { cost: 30, reason: "스톤헨지 룬 리딩" },
  "stonehenge-runes-single": { cost: 30, reason: "스톤헨지 룬 1-룬 리딩" },
  "stonehenge-runes-triad": { cost: 30, reason: "스톤헨지 룬 3-룬 리딩" },
  "stonehenge-runes-deep": { cost: 50, reason: "스톤헨지 룬 5-룬 리딩" },
  "stonehenge-runes-yearly": { cost: 50, reason: "스톤헨지 룬 12-룬 리딩" },
  ...
  "animal-destiny-unlock": { cost: 50, reason: "십이운성 동물점 해금" },
  ...
  "palm-reading-general": { cost: 50, reason: "손금 정밀 판독 + 심층 해석" },
  "palm-reading-ai-consult": { cost: 50, reason: "손금 전문가 상담 생성" },
  "life-book-ai-consultation": { cost: 100, amountKRW: 10000, reason: "인생의 책 전문가 상담" },
  ...
  "vedic_ai_prompt_generator": { cost: 50, reason: "베다 점성술 AI 질문 프롬프트 생성" },
  "sukuyo_ai_prompt_generator": { cost: 50, reason: "숙요점 전문가 상담" },
  "vedic_prashna_prompt": { cost: 30, reason: "프라슈나 프롬프트" },
  ...
  "astro_career_talent_deep": { cost: 30, reason: "점성술 커리어·재능 정밀 분석" },
  "astro_talent_attraction_deep": { cost: 30, reason: "점성술 재능과 끌림 심화 분석" },
  "astro_relationship_deep": { cost: 30, reason: "점성술 관계·끌림 심화 분석" },
  "astro_growth_shadow_deep": { cost: 30, reason: "점성술 과제와 변화 심화 리딩" },
  "astro_basic_deep_pack": { cost: 30, reason: "점성술 기본 차트 심층 패키지" },
  "astro_stellar_career_room": { cost: 30, reason: "점성술 봉인된 별의 방 일과 역할" },
  "astro_stellar_talent_room": { cost: 30, reason: "점성술 봉인된 별의 방 재능과 끌림" },
  ...
  "ziwei_twelve_palaces": { cost: 50, reason: "자미두수 12궁 정밀 해설 해금" },
  "ziwei_symbolic_layer": { cost: 50, reason: "자미두수 상징 보조층 해금" },
  "ziwei_life_yearly_flow": { cost: 50, reason: "자미두수 생애 총론과 연간 흐름 해금" },
  "premium-fpti-report": { cost: 100, reason: "FPTI 프리미엄 리포트 생성" },
  tetogen_deep_report: { cost: 50, reason: "테토 에겐 상세 리포트 해금" },
...
const RAW_PIG_COIN_UNLOCK_PRODUCTS = Object.freeze({
  ...
  "unlock.olympus_fc": { featureKey: "olympus-fc", cost: 50, reason: "Olympus profile unlock" },
  ...
  "unlock.saju_guardian": { featureKey: "saju-guardian-unlock", cost: 50, reason: "사주 가디언 소환진 해금" },
  "unlock.tetogen_deep_report": { featureKey: "tetogen_deep_report", cost: 50, reason: "테토 에겐 상세 리포트 해금" },
  ...
  "unlock.ziwei_decade_luck": { featureKey: "ziwei_decade_luck", cost: 50, reason: "자미두수 대한 흐름 해금" },
  "unlock.ziwei_love_deep": { featureKey: "ziwei_love_deep", cost: 50, reason: "자미두수 부부궁 심화 상담 해금" },
  "unlock.ziwei_twelve_palaces": { featureKey: "ziwei_twelve_palaces", cost: 50, reason: "자미두수 12궁 정밀 해설 해금" },
  "unlock.ziwei_symbolic_layer": { featureKey: "ziwei_symbolic_layer", cost: 50, reason: "자미두수 상징 보조층 해금" },
  "unlock.ziwei_life_yearly_flow": { featureKey: "ziwei_life_yearly_flow", cost: 50, reason: "자미두수 생애 총론과 연간 흐름 해금" },
  "unlock.nakshatra_lord_report": { featureKey: "nakshatra-lord-report", cost: 50, reason: "나크샤트라 지배성 심화 리포트 해금" },
  "unlock.nakshatra_dasha_map": { featureKey: "nakshatra-dasha-map", cost: 50, reason: "나크샤트라 다샤 인생지도 해금" },
...
export const PAID_FEATURE_KEY_ALIASES = Object.freeze({
  ...
  //    가리키는 곳을 실제 상품으로 돌린다 — 지우면 액션 이름이 곧 키가 되어 가격을 잃는다.
  openDestinyFlowerStudio: "flower-fc",
  openAstrologyFlowerStudio: "flower-fc",
