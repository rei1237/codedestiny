...
export const FEATURE_KEY_PRICE_TABLE = Object.freeze({
  ...
  "sukuyo-symbolic-comparison": { cost: 30, reason: "숙요점 상징 비교 확장" },
  ...
  "astro_career_talent_deep": { cost: 80, reason: "점성술 커리어·재능 정밀 분석" },
  "astro_talent_attraction_deep": { cost: 80, reason: "점성술 재능과 끌림 심화 분석" },
  "astro_relationship_deep": { cost: 80, reason: "점성술 관계·끌림 심화 분석" },
  "astro_growth_shadow_deep": { cost: 80, reason: "점성술 과제와 변화 심화 리딩" },
  "astro_basic_deep_pack": { cost: 180, reason: "점성술 기본 차트 심층 패키지" },
  "astro_monthly_transit": { cost: 100, reason: "점성술 월간 트랜짓 운세" },
  "astro_yearly_transit": { cost: 180, reason: "점성술 연간 트랜짓 운세" },
