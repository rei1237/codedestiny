export const VEDIC_PREMIUM_ENGINE_VERSION = "pdf-v3-llm-only";
export const VEDIC_PREMIUM_QUALITY_VERSION = "vedic-no-local-v1";
export const VEDIC_PREMIUM_REPORT_TYPE = "vedicPremium";
export const VEDIC_PREMIUM_SERVICE_KEY = "vedic-premium";
...
export function withVedicArchiveFormat(url, format = "pdf") {
...
export function logVedicPdfEvent(event, data = {}) {
  const payload = {
  ...
  try {
    console.info(`[VedicPremiumPDF][${event}]`, payload);
  } catch (_) {}
}
