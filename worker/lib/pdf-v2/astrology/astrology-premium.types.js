import { ASTRO_PREMIUM_FEATURE_KEY } from "../../astro-premium-chapters.js";

export const ASTROLOGY_PREMIUM_ENGINE_VERSION = "pdf-v3-llm-only";
export const ASTROLOGY_PREMIUM_QUALITY_VERSION = "astrology-no-local-v1";
export const ASTROLOGY_PREMIUM_REPORT_TYPE = "westernAstrologyPremium";
export const ASTROLOGY_PREMIUM_SERVICE_KEY = "astro-premium";
export const ASTROLOGY_PREMIUM_FEATURE_KEY = ASTRO_PREMIUM_FEATURE_KEY;
...
export function withAstrologyArchiveFormat(url, format = "pdf") {
...
export function logAstrologyPdfEvent(event, data = {}) {
  const payload = {
  ...
  try {
    console.info(`[AstrologyPremiumPDF][${event}]`, payload);
  } catch (_) {}
}
