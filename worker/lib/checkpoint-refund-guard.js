...
export async function inspectCheckpointBeforeTimeoutRefund(execution) {
  ...
  if (["pet-saju-ai-consultation", "pet-compatibility-ai", "animal-totem-basic", "animal-totem-deep", "dream-psycho-analysis", "geomancy"].includes(execution.featureKey) && execution.metadata?.paidNarrative?.tasks) return "recoverable";
