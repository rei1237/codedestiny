...
export async function inspectCheckpointBeforeTimeoutRefund(execution) {
  ...
  if (["pet-saju-ai-consultation", "pet-compatibility-ai", "animal-totem-basic", "animal-totem-deep", "dream-psycho-analysis", "geomancy", "yoga-guru-per-use", "tarot-prompt-maker", "tarot-prompt-maker-standard", "tarot-prompt-maker-deep", "tarot-prompt-maker-master", "tarot-mindscan", "tarot-love-relationship"].includes(execution.featureKey) && execution.metadata?.paidNarrative?.tasks) return "recoverable";
