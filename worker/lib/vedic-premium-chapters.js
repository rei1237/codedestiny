...
const rows = [
  ["vedic_soul_map", "I", "제 1장. 베다 차트 전체 총론", "라그나와 문 사인, 행성 배치로 인생 구조를 여는 장", "lotus", [["soul_1", "타고난 성향 한눈에 (라그나·문 사인으로 보는 기본 기질을 먼저 짚기)"], ["soul_2", "라그나가 보여주는 삶의 출발점"], ["soul_3", "문 사인이 보여주는 마음의 결"], ["soul_4", "전체 행성 배치가 만드는 인생 분위기"], ["soul_5", "이번 생에서 가장 중요한 배움"]]],
