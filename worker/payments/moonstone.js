 ...
 *
 * 🔴 2026-08-12 에 클러스터가 M10 으로 올라가 트랜잭션이 가능해졌다. 그래도 이 순서를 유지한다 —
 * 차감의 원자성은 애초에 트랜잭션이 아니라 lot CAS 가 주고 있었고(아래 2단계), 크론
 * (settleOrphanSpends)이 예약 잔상을 걷어 복구까지 닫는다. 구 트랜잭션 경로를 되살리지 말 것.
 *
