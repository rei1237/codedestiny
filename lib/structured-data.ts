...
import { FUSION_FORTUNE_PENDING_PROFILE } from "./seo/entity-registry.mjs";
...
export function buildOrganizationJsonLd() {
  return {
    ...
    knowsAbout: [
      {
        "@type": "Thing",
        name: FUSION_FORTUNE_PENDING_PROFILE.primary,
        alternateName: FUSION_FORTUNE_PENDING_PROFILE.secondary,
