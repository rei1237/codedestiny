...
export const SEO_SERVICE_SCOPES = {
  ...
  '/sukuyo': { free: '한 사람의 본명숙과 기본 성향을 확인합니다.', paid: '두 사람의 기본 궁합·정밀 궁합 분석과 질문을 반영한 상담은 별도 유료 기능입니다.', input: '생년월일과 적용 시각·시간대 확인. 관계를 볼 때는 상대 정보도 같은 기준으로 확인', basis: '/sukuyo/guide/' },
  '/sukuyo/compatibility': { free: '관계 유형의 계산 설명과 예시를 읽고, 숙요 도구에서 한 사람의 본명숙을 확인합니다.', paid: '도구의 기본 궁합·정밀 궁합 분석은 별도 유료 기능입니다. 적용 조건과 금액은 결제 화면에서 확인합니다.', input: '두 사람의 생년월일, 달력 구분, 적용 시각·시간대', basis: '/sukuyo/guide/' },
