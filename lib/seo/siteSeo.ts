...
export const publicSeoPages: Record<string, PublicSeoPage> = {
  ...
  about: {
    path: "/about",
    title: "Code Destiny 소개 | 무료 운세 플랫폼",
    description:
  ...
  highValue: {
    path: "/high-value",
    title: "운세 인사이트 가이드 | 사주·타로·궁합·점성술",
    description:
  ...
  insights: {
    path: "/insights",
    title: "운세 인사이트 아카이브 | 사주·타로·자미두수 가이드",
    description:
