...
// 🔴 lib/i18n/ai-locale.js 의 AI_OUTPUT_LOCALES 와 같은 값이어야 한다
//    (scripts/verify-market-policy-registry.mjs 가 두 배열을 대조한다).
//    이건 "AI 가 어떤 언어로 쓰는가"의 목록일 뿐이다 — 시장 개방·법적 관할·결제 통화와 무관하며,
//    시장별 supportedLocales 는 아래에서 따로 정한다(법률 문서 커버리지 축이라 여기서 넓히지 않는다).
export const AI_OUTPUT_MARKET_LOCALES = Object.freeze([
