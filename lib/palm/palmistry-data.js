const PALMISTRY_DATA_TEXT_TRANSLATIONS = {
  ko: {
    "palm.label.001": "선천적 손",
    "palm.label.002": "후천적 손",
    "palm.label.003": "혼합형 손",
    "palm.label.004": "흙의 손",
    "palm.label.005": "불의 손",
    "palm.label.006": "바람의 손",
    "palm.label.007": "물의 손",
    "palm.label.008": "혼합형 손",
    "palm.label.009": "생명선",
    "palm.title.001": "깊고 긴 생명선",
    "palm.title.002": "짧지만 깊은 생명선",
    "palm.title.003": "흐린 생명선",
    "palm.title.004": "중간에 끊김이 있는 생명선",
    "palm.title.005": "가지가 뻗은 생명선",
    "palm.label.010": "두뇌선",
    "palm.title.006": "길고 곧은 두뇌선",
    "palm.title.007": "길고 부드럽게 휘는 두뇌선",
    "palm.title.008": "짧은 두뇌선",
    "palm.title.009": "생명선과 떨어져 시작하는 두뇌선",
    "palm.title.010": "생명선과 붙어 시작하는 두뇌선",
    "palm.label.011": "감정선",
    "palm.title.011": "깊고 곡선적인 감정선",
    "palm.title.012": "직선적인 감정선",
    "palm.title.013": "검지 아래로 향하는 감정선",
    "palm.title.014": "중지 아래로 향하는 감정선",
    "palm.title.015": "잔가지가 많은 감정선",
    "palm.label.012": "운명선",
    "palm.title.016": "중앙을 뚜렷하게 올라가는 운명선",
    "palm.title.017": "희미하거나 약한 운명선",
    "palm.title.018": "생명선에서 시작하는 운명선",
    "palm.title.019": "월구에서 시작하는 운명선",
    "palm.title.020": "끊김이 있는 운명선",
    "palm.label.013": "태양선",
    "palm.title.021": "선명한 태양선",
    "palm.title.022": "희미한 태양선",
    "palm.title.023": "태양선이 약하거나 감지되지 않음",
    "palm.label.014": "재물선",
    "palm.title.024": "M자 형태의 재물선",
    "palm.title.025": "선명한 재물선",
    "palm.title.026": "여러 갈래의 재물선",
    "palm.title.027": "희미한 재물선",
    "palm.label.015": "결혼선",
    "palm.title.028": "선명한 관계선",
    "palm.title.029": "여러 잔선이 있는 관계선",
    "palm.title.030": "위로 향하는 관계선",
    "palm.title.031": "아래로 기우는 관계선",
    "palm.label.016": "수성선",
    "palm.title.032": "선명한 수성선",
    "palm.title.033": "끊김이 있는 수성선",
    "palm.title.034": "희미한 수성선",
    "palm.label.017": "직관선",
    "palm.title.035": "직관선이 보이는 손",
    "palm.title.036": "희미한 직관선",
    "palm.label.018": "금성구",
    "palm.label.019": "월구",
    "palm.label.020": "목성구",
    "palm.label.021": "토성구",
    ...
    "palm.label.027": "중지",
    "palm.label.028": "약지",
    "palm.label.029": "새끼손가락",
    "palm.title.037": "애정 온도가 높은 손",
    "palm.title.038": "현실형 커리어 손",
    "palm.title.039": "직관과 상상력이 강한 손",
    "palm.title.040": "정해진 길보다 표현으로 길을 여는 손",
    "palm.title.041": "관계 신호를 잘 읽는 소통형 손",
    "palm.label.030": "전체",
    "palm.description.001": "손 전체의 인상, 손형, 주요 선, 종합 점수를 한 번에 봅니다.",
    "palm.label.031": "생명선",
    "palm.description.002": "수명이 아니라 에너지 운용, 회복 리듬, 생활 지속성을 봅니다.",
    "palm.label.032": "두뇌선",
    "palm.description.003": "사고방식, 판단력, 집중력, 현실성, 상상력을 봅니다.",
    "palm.label.033": "감정선",
    "palm.description.004": "사랑 방식, 감정 표현, 애착, 관계 기대를 봅니다.",
    "palm.label.034": "운명선",
    "palm.description.005": "직업 방향, 사회적 목표, 자립성, 삶의 방향성을 봅니다.",
    "palm.label.035": "재물/태양선",
    "palm.description.006": "돈을 다루는 습관, 가치 창출, 표현력, 브랜딩 감각을 봅니다.",
    "palm.label.036": "연애/결혼선",
    "palm.description.007": "결혼 횟수가 아니라 깊은 관계에서 원하는 안정감과 약속 방식을 봅니다.",
    "palm.label.037": "손바닥 구丘",
    "palm.description.008": "금성구, 월구, 목성구 등 손바닥의 에너지 영역을 봅니다.",
    "palm.label.038": "선천/후천 비교",
    "palm.description.009": "자주 쓰는 손과 자주 쓰지 않는 손을 비교해 타고난 나와 현재의 나를 봅니다.",
    "palm.label.039": "맞춤 처방",
    "palm.description.010": "오늘의 조언, 7일 루틴, 관계·재물·직업 조언을 제공합니다.",
    "palm.title.042": "본래 회복력은 좋지만 현재는 에너지 소모가 커진 상태",
    "palm.title.043": "후천적 자기관리로 에너지를 키운 손",
    "palm.title.044": "본래 감수성이 강하지만 현재는 현실 판단이 강화됨",
    "palm.title.045": "이성에서 직관으로 확장된 손",
    "palm.title.046": "깊은 감정을 방어적으로 조절하게 된 손",
    "palm.title.047": "관계 경험을 통해 감정 표현이 열린 손",
    "palm.title.048": "현재 삶에서 목표의식과 사회적 방향성이 강화됨",
    "palm.title.049": "본래의 방향을 다시 재정비하는 손",
    "palm.title.050": "감정의 깊이와 직관이 살아 있는 손",
  },
};

function palmistryDataText(key) {
  return PALMISTRY_DATA_TEXT_TRANSLATIONS.ko[key] || "Translation pending";
}

const PALMISTRY_DATA = {
  handRoles: {
    innate: {
      label: palmistryDataText("palm.label.001"),
      meaning: "타고난 기질, 본래 성향, 잠재력, 무의식적 반응을 보여주는 손",
      uiCopy: "타고난 당신의 결",
    },
    acquired: {
      label: palmistryDataText("palm.label.002"),
      meaning: "현재의 성향, 살아오며 만들어진 습관, 사회적 자아, 지금 발현 중인 흐름을 보여주는 손",
      uiCopy: "현재 살아가는 당신의 흐름",
    },
    mixed: {
      label: palmistryDataText("palm.label.003"),
  ...
  handShapes: {
    earth: {
      label: palmistryDataText("palm.label.004"),
    ...
    fire: {
      label: palmistryDataText("palm.label.005"),
    ...
    air: {
      label: palmistryDataText("palm.label.006"),
    ...
    water: {
      label: palmistryDataText("palm.label.007"),
    ...
    mixed: {
      label: palmistryDataText("palm.label.008"),
  ...
  majorLines: {
    lifeLine: {
      label: palmistryDataText("palm.label.009"),
      safeMeaning: "수명이 아니라 에너지 운용, 회복 리듬, 생활 지속성을 보는 선",
      keywords: ["에너지", "회복력", "생활 리듬", "지속력", "자기관리"],
      variants: {
        long_deep: {
          title: palmistryDataText("palm.title.001"),
        ...
        short_deep: {
          title: palmistryDataText("palm.title.002"),
        ...
        faint: {
          title: palmistryDataText("palm.title.003"),
        ...
        broken: {
          title: palmistryDataText("palm.title.004"),
        ...
        branched_out: {
          title: palmistryDataText("palm.title.005"),
    ...
    headLine: {
      label: palmistryDataText("palm.label.010"),
      safeMeaning: "사고방식, 판단력, 집중력, 상상력, 의사결정 습관을 보는 선",
      keywords: ["사고", "판단", "집중", "상상력", "의사결정"],
      variants: {
        long_straight: {
          title: palmistryDataText("palm.title.006"),
        ...
        long_curved: {
          title: palmistryDataText("palm.title.007"),
        ...
        short: {
          title: palmistryDataText("palm.title.008"),
        ...
        separated_start: {
          title: palmistryDataText("palm.title.009"),
        ...
        joined_start: {
          title: palmistryDataText("palm.title.010"),
    ...
    heartLine: {
      label: palmistryDataText("palm.label.011"),
      safeMeaning: "사랑 방식, 감정 표현, 애착, 관계 기대, 상처받는 포인트를 보는 선",
      keywords: ["사랑", "감정", "애착", "표현", "관계 온도"],
      variants: {
        deep_curved: {
          title: palmistryDataText("palm.title.011"),
        ...
        straight: {
          title: palmistryDataText("palm.title.012"),
        ...
        ending_under_index: {
          title: palmistryDataText("palm.title.013"),
        ...
        ending_under_middle: {
          title: palmistryDataText("palm.title.014"),
        ...
        many_branches: {
          title: palmistryDataText("palm.title.015"),
    ...
    fateLine: {
      label: palmistryDataText("palm.label.012"),
      safeMeaning: "직업 방향, 사회적 목표, 자립성, 인생 방향을 보는 선",
      keywords: ["직업", "목표", "사회성", "자립", "방향성"],
      variants: {
        strong_center: {
          title: palmistryDataText("palm.title.016"),
        ...
        weak_or_absent: {
          title: palmistryDataText("palm.title.017"),
        ...
        starts_from_lifeLine: {
          title: palmistryDataText("palm.title.018"),
        ...
        starts_from_moonMount: {
          title: palmistryDataText("palm.title.019"),
        ...
        broken: {
          title: palmistryDataText("palm.title.020"),
  ...
  minorLines: {
    ...
    moneyLine: {
      label: palmistryDataText("palm.label.014"),
      meaning: "확정 재물운이 아니라 돈을 다루는 습관, 가치 창출 방식, 거래 감각을 보는 보조선",
      variants: {
        mCharacter: {
          title: palmistryDataText("palm.title.024"),
          detail:
            "재물/소통 관련 보조선이 M자 구조를 보이면 수입 구조를 다층으로 설계하는 경향이 강할 수 있습니다. 단기 수익보다 포트폴리오형 분산과 관리 루틴이 중요합니다.",
        },
        strong: {
          title: palmistryDataText("palm.title.025"),
          detail:
            "돈의 흐름을 감지하고 가치를 만들어내는 감각이 비교적 좋은 손입니다. 특히 자신의 기술, 말, 정보, 거래 능력을 통해 수입 루트를 만드는 데 강점이 있을 수 있습니다.",
        },
        multiple: {
          title: palmistryDataText("palm.title.026"),
          detail:
            "수입원이 하나로 고정되기보다 여러 방향으로 열릴 가능성을 상징합니다. 다만 분산이 지나치면 관리가 어려울 수 있으므로 기준이 필요합니다.",
        },
        faint: {
          title: palmistryDataText("palm.title.027"),
          detail:
    ...
    intuitionLine: {
      label: palmistryDataText("palm.label.017"),
      meaning: "감각, 예감, 분위기 파악, 무의식적 판단력을 보는 보조선",
      variants: {
        visible: {
          title: palmistryDataText("palm.title.035"),
          detail:
            "분위기, 사람의 감정, 말의 이면을 빠르게 감지하는 편입니다. 논리보다 먼저 느낌으로 상황을 파악하는 경우가 많습니다.",
        },
        faint: {
          title: palmistryDataText("palm.title.036"),
          detail:
  ...
  mounts: {
    venus: {
      label: palmistryDataText("palm.label.018"),
      area: "엄지 아래 도톰한 영역",
    ...
    moon: {
      label: palmistryDataText("palm.label.019"),
      area: "손바닥 바깥쪽 아래 영역",
    ...
    jupiter: {
      label: palmistryDataText("palm.label.020"),
      area: "검지 아래",
    ...
    saturn: {
      label: palmistryDataText("palm.label.021"),
      area: "중지 아래",
    ...
    sun: {
      label: palmistryDataText("palm.label.022"),
      area: "약지 아래",
    ...
    mercury: {
      label: palmistryDataText("palm.label.023"),
      area: "새끼손가락 아래",
    ...
    mars: {
      label: palmistryDataText("palm.label.024"),
  ...
  fingers: {
    thumb: {
      label: palmistryDataText("palm.label.025"),
    ...
    index: {
      label: palmistryDataText("palm.label.026"),
    ...
    middle: {
      label: palmistryDataText("palm.label.027"),
      meaning: "책임감, 현실성, 인내",
      variants: {
        long: "책임감과 신중함이 강합니다.",
    ...
    ring: {
      label: palmistryDataText("palm.label.028"),
    ...
    little: {
      label: palmistryDataText("palm.label.029"),
  ...
  combinationRules: [
    {
      ...
      title: palmistryDataText("palm.title.037"),
      interpretation:
    ...
    },
    {
      ...
      title: palmistryDataText("palm.title.038"),
      interpretation:
    ...
    },
    {
      ...
      title: palmistryDataText("palm.title.039"),
      interpretation:
    ...
    },
    {
      ...
      title: palmistryDataText("palm.title.040"),
      interpretation:
    ...
    },
    {
      ...
      title: palmistryDataText("palm.title.041"),
      interpretation:
...
const PALM_READING_TABS = [
  {
    key: "overview",
    label: palmistryDataText("palm.label.030"),
    icon: "🌕",
    description: palmistryDataText("palm.description.001"),
  },
  {
    key: "lifeLine",
    label: palmistryDataText("palm.label.031"),
    icon: "🌱",
    description: palmistryDataText("palm.description.002"),
  },
  {
    key: "headLine",
    label: palmistryDataText("palm.label.032"),
    icon: "🧠",
    description: palmistryDataText("palm.description.003"),
  },
  {
    key: "heartLine",
    label: palmistryDataText("palm.label.033"),
    icon: "💗",
    description: palmistryDataText("palm.description.004"),
  },
  {
    key: "fateLine",
    label: palmistryDataText("palm.label.034"),
    icon: "🌀",
    description: palmistryDataText("palm.description.005"),
  },
  {
    key: "moneySun",
    label: palmistryDataText("palm.label.035"),
    icon: "💰",
    description: palmistryDataText("palm.description.006"),
  },
  {
    key: "loveMarriage",
    label: palmistryDataText("palm.label.036"),
    icon: "💍",
    description: palmistryDataText("palm.description.007"),
  },
  {
    key: "mounts",
    label: palmistryDataText("palm.label.037"),
    icon: "⛰",
    description: palmistryDataText("palm.description.008"),
  },
  {
    key: "innateAcquired",
    label: palmistryDataText("palm.label.038"),
    icon: "☯️",
    description: palmistryDataText("palm.description.009"),
  },
  {
    key: "prescription",
    label: palmistryDataText("palm.label.039"),
    icon: "🧭",
    description: palmistryDataText("palm.description.010"),
  },
];
...
const HAND_COMPARISON_RULES = {
  lifeLine: {
    innateStrong_acquiredWeak: {
      title: palmistryDataText("palm.title.042"),
      detail:
    ...
    innateWeak_acquiredStrong: {
      title: palmistryDataText("palm.title.043"),
      detail:
  ...
  headLine: {
    innateCurved_acquiredStraight: {
      title: palmistryDataText("palm.title.044"),
      detail:
    ...
    innateStraight_acquiredCurved: {
      title: palmistryDataText("palm.title.045"),
      detail:
  ...
  heartLine: {
    innateDeep_acquiredFaint: {
      title: palmistryDataText("palm.title.046"),
      detail:
    ...
    innateFaint_acquiredDeep: {
      title: palmistryDataText("palm.title.047"),
      detail:
...
const SAMPLE_PALM_READING = {
  ...
  rightHandReading: {
    ...
    overall: {
      title: palmistryDataText("palm.title.050"),
      summary:
