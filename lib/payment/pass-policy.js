...
export const CURRENT_PASS_PLANS = Object.freeze({
  standard: Object.freeze({ tier: "standard", name: "꽃돼지 스탠다드", wonPrice: 14900, maxCoveredCoin: 50, monthlyLimitCoin: 400, profileLimit: 3 }),
  premium: Object.freeze({ tier: "premium", name: "꽃돼지 프리미엄", wonPrice: 39900, maxCoveredCoin: 100, monthlyLimitCoin: 1000, profileLimit: 7 }),
  vvip: Object.freeze({ tier: "vvip", name: "꽃돼지 VVIP", wonPrice: 79900, maxCoveredCoin: 300, monthlyLimitCoin: 2000, profileLimit: 15 }),
  family: Object.freeze({ tier: "family", name: "Code Destiny Family", wonPrice: 149000, maxCoveredCoin: 999999999, monthlyLimitCoin: 5000, profileLimit: 0 }),
});
