...
export const CURRENT_PASS_PLANS = Object.freeze({
  standard: Object.freeze({ tier: "standard", name: "꽃돼지 스탠다드", wonPrice: 89000, maxCoveredCoin: 30, monthlyLimitCoin: 30, profileLimit: 3 }),
  premium: Object.freeze({ tier: "premium", name: "꽃돼지 프리미엄", wonPrice: 269000, maxCoveredCoin: 100, monthlyLimitCoin: 100, profileLimit: 7 }),
  vvip: Object.freeze({ tier: "vvip", name: "꽃돼지 VVIP", wonPrice: 879000, maxCoveredCoin: 300, monthlyLimitCoin: 300, profileLimit: 15 }),
});
