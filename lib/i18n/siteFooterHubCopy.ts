...
export const SITE_FOOTER_HUB_COPY: Record<Locale, SiteFooterHubCopy> = {
  ko: {
    ...
    linkLabels: {
      ...
      "/ifa-oracle.html": "IFA 오라클",
      "/oracle/royal-tea": "로열 티 오라클",
      "/oracle/rune": "스톤헨지 룬 오라클",
      "/oracle/sikojen-povailu": "핀란드 주석점",
      "/high-value": "하이밸류 아카이브",
      "/flower/destiny/": "운명의 꽃 아틀리에",
      "/flower/astrology/": "점성술 운명의 꽃",
      "/flower/jamidusu/": "자미두수 운명의 꽃",
      "/flower/sukuyo/": "숙요 운명의 꽃",
      "/insights": "운명 인사이트 허브",
      "/high-value/complete-guide-to-saju": "사주 완전 가이드",
      "/high-value/how-tarot-actually-works": "타로 리딩 구조 이해",
      "/high-value/understanding-your-destiny": "운명 해석 프레임",
  ...
  ja: {
    ...
    linkLabels: {
      ...
      "/ifa-oracle.html": "IFAオラクル",
      "/oracle/royal-tea": "ロイヤルティー・オラクル",
      "/oracle/rune": "ストーンヘンジ・ルーンオラクル",
      "/oracle/sikojen-povailu": "フィンランドの錫占い",
      "/high-value": "ハイバリュー・アーカイブ",
      "/flower/destiny/": "運命の花アトリエ",
      "/flower/astrology/": "占星術・運命の花",
      "/flower/jamidusu/": "紫微斗数・運命の花",
      "/flower/sukuyo/": "宿曜・運命の花",
      "/insights": "運命インサイト・ハブ",
      "/high-value/complete-guide-to-saju": "四柱推命 完全ガイド",
      "/high-value/how-tarot-actually-works": "タロットリーディングの仕組み",
      "/high-value/understanding-your-destiny": "運命を読み解くフレーム",
  ...
  zh: {
    ...
    linkLabels: {
      ...
      "/insights": "命运洞察中心",
      "/high-value/complete-guide-to-saju": "四柱八字完全指南",
      "/high-value/how-tarot-actually-works": "理解塔罗解读的结构",
      "/high-value/understanding-your-destiny": "命运解读框架",
  ...
  "zh-TW": {
    ...
    linkLabels: {
      ...
      "/insights": "命運洞察中心",
      "/high-value/complete-guide-to-saju": "四柱八字完全指南",
      "/high-value/how-tarot-actually-works": "理解塔羅解讀的結構",
      "/high-value/understanding-your-destiny": "命運解讀框架",
  ...
  en: {
    ...
    linkLabels: {
      ...
      "/high-value/complete-guide-to-saju": "The complete guide to Saju",
      "/high-value/how-tarot-actually-works": "How tarot reading actually works",
      "/high-value/understanding-your-destiny": "A framework for reading destiny",
    ...
    policyLabels: {
      ...
      "/terms#refund-policy": "Refund Policy",
      "/faq": "FAQ",
