...
export const STATIC_POLICY_ROUTES = [
  { key: 'terms', source: 'terms', canonical: '/terms', aliases: ['/terms-of-service'], label: '이용약관' },
  { key: 'privacy', source: 'privacy', canonical: '/privacy', aliases: ['/privacy-policy'], label: '개인정보처리방침' },
  { key: 'refund', source: 'refund-policy', canonical: '/refund-policy', aliases: [], label: '환불·취소' },
  { key: 'contact', source: 'contact', canonical: '/contact', aliases: ['/contact-us'], label: '고객센터' },
