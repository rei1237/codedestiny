...
// PG창을 띄우기 전에 실패해 사용자에게는 "결제창이 안 뜬다"로 보인다. 최소 결제금액이 하한이다.
// 코인가는 KRW_PER_COIN(=100) 고정 환산이므로 1,000원 = 10코인이어야 한다.
export const MUSIC_TRACK_UNLOCK_PRICE_KRW = 1000;
export const MUSIC_TRACK_UNLOCK_COIN_COST = 10;
export const MUSIC_TRACK_FEATURE_PREFIX = "music-track-";

// 다운로드 결제 게이트 단일 스위치.
// true면 전곡 재생은 무료(free_full)로 열어두되 MP3 다운로드는 기존 UNLOCK(1,000원/10코인) 구매를 요구한다.
