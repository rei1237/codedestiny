...
const SUN_RECOVERY_CARD_COPY = {
  "Ten of Cups": {
    upright: {
      keywords: ["정서적 안정", "소속감", "작은 행복"],
      shortMessage: "이미 마음 안쪽에는 다시 편안해지고 싶은 온기가 남아 있습니다.",
      meaning: "컵 텐 정방향은 관계와 일상 속에서 마음을 쉬게 하는 장면이 아직 살아 있음을 보여줍니다. 거창한 확신보다 함께 웃었던 기억, 편안히 머물 수 있는 공간, 나를 받아 주는 사람의 존재가 오늘의 회복 기반이 됩니다. 지금은 모든 감정을 해결하려 하기보다 안전하다고 느끼는 작은 순간을 먼저 회복하는 편이 좋습니다.",
      shadow: "모두를 만족시키려는 마음이 커지면 내 감정은 뒤로 밀릴 수 있습니다.",
      recoveryAdvice: "오늘은 나를 편안하게 해 주는 공간이나 사람을 하나만 떠올리고, 그 온기를 짧게 기록해 보세요.",
    },
  },
  "Seven of Pentacles": {
    reversed: {
      keywords: ["기다림의 피로", "보상 지연", "속도 재조정"],
      shortMessage: "오래 버틴 마음이 이제 기다림의 방식을 바꾸자고 말합니다.",
      meaning: "펜타클 세븐 역방향은 노력했는데도 충분히 돌아오지 않은 느낌, 기다림이 길어져 지친 마음을 비춥니다. 이 카드는 더 참으라는 뜻이 아니라 내가 어디까지 기다릴 수 있는지 기준을 다시 세우라는 신호입니다. 지금 필요한 회복은 포기가 아니라 시간과 에너지를 덜 소모하는 방식으로 속도를 조정하는 일입니다.",
      shadow: "결과가 늦어졌다는 이유로 나의 가치까지 낮게 보지 않도록 조심해야 합니다.",
      recoveryAdvice: "오늘은 계속 붙잡고 있던 기대 하나를 내려놓고, 내가 통제할 수 있는 행동 하나만 정해 보세요.",
    },
  },
  "The Chariot": {
    reversed: {
      keywords: ["억지 추진 중단", "방향 재정렬", "통제 완화"],
      shortMessage: "앞으로 밀어붙이기보다 방향을 다시 고를 시간이 필요합니다.",
      meaning: "전차 역방향은 마음과 몸의 속도가 어긋난 상태를 보여줍니다. 겉으로는 빨리 결론을 내고 싶지만, 안쪽에서는 아직 방향이 정리되지 않았을 수 있습니다. 지금은 강하게 움직일수록 더 지칠 수 있으니 멈춤을 실패로 보지 말고, 내가 정말 원하는 방향을 다시 확인하는 회복의 쉼표로 삼는 편이 좋습니다.",
      shadow: "통제하려는 마음이 커질수록 작은 변수에도 불안이 커질 수 있습니다.",
      recoveryAdvice: "오늘은 중요한 결정을 서두르지 말고, 멈춰야 할 것과 다시 움직일 것을 한 줄씩 나누어 적어 보세요.",
    },
  },
  "King of Wands": {
    reversed: {
      keywords: ["과열된 주도권", "말투의 강함", "부드러운 리더십"],
      shortMessage: "강하게 버틴 마음이 이제 조금 더 부드러운 방식의 힘을 찾고 있습니다.",
      meaning: "완드 킹 역방향은 내가 주도권을 잃지 않으려 애쓰는 동안 말과 태도가 예상보다 강해질 수 있음을 알려줍니다. 이 카드는 힘을 버리라는 뜻이 아니라, 힘의 온도를 낮추면 관계와 마음이 덜 다친다는 사실을 보여줍니다. 오늘의 회복은 크게 이기는 쪽이 아니라 내 기준을 부드럽고 분명하게 전하는 쪽에 있습니다.",
      shadow: "불안할수록 먼저 단정하거나 밀어붙이는 반응이 나올 수 있습니다.",
      recoveryAdvice: "오늘은 주장하기 전에 숨을 한 번 고르고, 내가 원하는 바를 짧고 부드러운 문장으로 말해 보세요.",
    },
  },
};
...
const HEALING_SUIT_COPY = {
  cups: {
    keywords: ["감정 수용", "관계 온도", "마음의 물결"],
    shortMessage: "감정이 흐를 자리를 만들어야 회복의 온도가 돌아옵니다.",
    meaning: "컵 계열 카드는 마음이 충분히 느끼고 표현할 자리를 필요로 한다고 말합니다. 지금은 감정을 지우기보다 어떤 이름을 가진 감정인지 천천히 알아차릴수록 회복이 쉬워집니다.",
    shadow: "상대의 기분을 먼저 살피느라 내 감정을 늦게 알아차릴 수 있습니다.",
    recoveryAdvice: "오늘 느낀 감정을 한 단어로 적고, 그 감정이 원하는 작은 배려를 하나만 골라 보세요.",
  },
  pentacles: {
    keywords: ["현실 안정", "몸의 리듬", "작은 반복"],
    shortMessage: "회복은 마음만이 아니라 몸과 생활의 안정에서도 시작됩니다.",
    meaning: "펜타클 계열 카드는 지금의 회복이 현실적인 루틴과 연결되어 있음을 보여줍니다. 작은 정리, 식사, 수면, 일정 조정처럼 손에 잡히는 행동이 마음의 안전감을 다시 세웁니다.",
    shadow: "성과가 느리면 스스로를 부족하다고 판단하기 쉽습니다.",
    recoveryAdvice: "오늘은 생활을 편하게 만드는 작은 정리 하나를 10분 안에 끝내 보세요.",
  },
  swords: {
    keywords: ["생각 정리", "거리두기", "명료함"],
    shortMessage: "생각의 소음을 줄일수록 마음의 방향이 더 선명해집니다.",
    meaning: "소드 계열 카드는 감정과 사실을 분리해 보라는 신호입니다. 지금 떠오르는 생각이 모두 진실은 아니므로, 마음을 아프게 하는 해석부터 잠시 내려놓는 연습이 필요합니다.",
    shadow: "생각이 빨라질수록 아직 일어나지 않은 장면까지 걱정할 수 있습니다.",
    recoveryAdvice: "오늘은 사실 하나와 추측 하나를 따로 적어 마음의 속도를 낮춰 보세요.",
  },
  wands: {
    keywords: ["에너지 조절", "의지 회복", "따뜻한 추진력"],
    shortMessage: "다시 움직이려는 힘은 남아 있지만, 온도를 조절해야 오래 갑니다.",
    meaning: "완드 계열 카드는 마음 안쪽의 열망과 피로가 함께 올라오는 상태를 보여줍니다. 지금은 의지를 더 밀어붙이기보다 열기를 낮추고 내가 지치지 않는 방식으로 다시 시작하는 편이 좋습니다.",
    shadow: "조급함이 커지면 말과 행동이 마음보다 먼저 나갈 수 있습니다.",
    recoveryAdvice: "오늘은 해야 할 일을 하나만 남기고, 나머지는 내일의 빛으로 넘겨 보세요.",
  },
  major: {
    keywords: ["전환점", "내면 신호", "큰 흐름"],
    shortMessage: "지금의 마음은 작은 사건보다 더 큰 방향 전환을 준비하고 있습니다.",
    meaning: "메이저 카드는 오늘의 감정이 단순한 기분 변화가 아니라 삶의 흐름을 다시 조율하는 신호일 수 있음을 보여줍니다. 서두르지 않아도 괜찮습니다. 큰 변화는 조용한 알아차림에서 시작됩니다.",
    shadow: "의미를 너무 크게 붙이면 지금 가능한 작은 행동을 놓칠 수 있습니다.",
    recoveryAdvice: "오늘은 결론보다 내가 반복해서 느끼는 신호 하나를 조용히 관찰해 보세요.",
  },
};
...
function mapHealingReading(result) {
  ...
  const oneLineMessage = cleanHealingLanguage(cardReadings[0]?.shortMessage || "오늘은 상처를 지우기보다, 그 자리에 다시 빛을 들이는 시간이 필요합니다.");
  const storyFlow = cleanHealingLanguage(`이번 리딩은 ${cardFlow || "네 장의 카드"}의 흐름으로 시작됩니다. 첫 카드는 마음이 어디에서 쉬고 싶어 하는지 보여주고, 두 번째 카드는 인정해야 할 감정의 온도를 알려줍니다. 세 번째 카드는 다시 따뜻해지는 단서를 비추며, 마지막 카드는 오늘 실제로 해 볼 수 있는 작은 행동을 건넵니다. 결론은 서두른 변화가 아니라, 내가 감당할 수 있는 속도로 다시 나를 믿는 일입니다.`);
  ...
  const finalAdvice = cleanHealingLanguage(cardReadings[3]?.recoveryAdvice || cardReadings[0]?.recoveryAdvice || "오늘은 나를 몰아붙이지 않고, 가능한 만큼만 따뜻하게 움직여 보세요.");

  return {
    title: "태양 회복 타로",
    subtitle: "상처를 지우지 않고, 그 자리에 다시 빛을 들이는 리딩",
    oneLineMessage,
    sunLine: oneLineMessage,
    summary: oneLineMessage,
    opening: cleanHealingLanguage("오늘의 카드는 마음을 고치라고 재촉하지 않습니다. 다만 오래 어두웠던 자리에 아주 작은 빛을 들이고, 지금 가능한 회복의 장면을 차분히 고르라고 말합니다."),
    cardReadings,
    cardDeepDive,
    ...
    recoveryRoutines,
    actionPlan,
    affirmation: cleanHealingLanguage("오늘의 나는 나를 몰아붙이지 않고, 다시 따뜻해질 시간을 허락합니다."),
