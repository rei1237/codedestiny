const SPREADS = {
  ...
  self_esteem_levelup_five_card: {
    ...
    questionType: "general",
    positions: [
      { key: "past_debuff", label: "과거 디버프", role: "타인 시선에 묶인 원인", weight: 1.0 },
      { key: "inner_monster", label: "내면 몬스터", role: "거절 공포와 방어심리", weight: 1.1 },
      { key: "current_damage", label: "현재 데미지", role: "지금 누적된 감정 피로", weight: 1.0 },
      { key: "mind_shield", label: "마인드 쉴드", role: "감정 경계를 세우는 방식", weight: 1.1 },
      { key: "levelup_mastery", label: "레벨업 마스터리", role: "지속 가능한 회복 습관", weight: 1.2 },
    ],
  },
