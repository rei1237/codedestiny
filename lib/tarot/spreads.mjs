const SPREADS = {
  ...
  reunion_lighthouse_five_card: {
    ...
    positions: [
      { key: "past_bond", label: "아직 남은 마음의 온도", role: "두 사람 사이에 남아 있는 감정의 온도와 미완의 잔향", weight: 1.1 },
      { key: "their_now", label: "그 사람의 현재 거리감", role: "겉태도와 속마음의 간극, 그리움/방어심/체념의 비율", weight: 1.2 },
      { key: "outside_factor", label: "연락을 막는 파도", role: "연락을 망설이게 만드는 심리적/현실적 제약", weight: 1.1 },
      { key: "their_heart", label: "다시 닿을 수 있는 타이밍", role: "자발적 반응의 문, 속도, 부담이 적은 접촉 방식", weight: 1.2 },
      { key: "reunion_outcome", label: "다시 만나도 무너지지 않을 조건", role: "감정적 재접근과 관계 지속 조건, 반복 상처 방지 기준", weight: 1.3 },
    ],
  },
  yearly_twelve_card: {
  ...
  yearly_three_card: {
    ...
    questionType: "future",
    positions: [
      { key: "base_energy", label: "한 해의 기본 리듬", role: "한 해를 여는 기본 결", weight: 1.0 },
      { key: "challenge_opportunity", label: "넘어야 할 문과 기회", role: "조심할 구간과 열리는 기회", weight: 1.1 },
      { key: "outcome_advice", label: "연말의 결실과 조율", role: "연말 흐름과 마지막 조율 문장", weight: 1.2 },
    ],
  },
  ...
  job_change_seven_card: {
    ...
    questionType: "career",
    positions: [
      { key: "calling", label: "살아나는 일의 결", role: "일에서 다시 살아나는 고유 강점", weight: 1.0 },
      { key: "happy_direction", label: "덜 소모되는 방향", role: "만족도가 높고 에너지 누수가 적은 업무 결", weight: 1.0 },
      { key: "inner_vocation", label: "마음의 소명", role: "깊은 동기와 오래 남는 보람", weight: 1.1 },
      { key: "life_after_move", label: "문턱 너머의 생활", role: "전환 후 생활 리듬과 현실 변화", weight: 1.2 },
      { key: "action_steps", label: "현실로 여는 첫 행동", role: "지원, 포트폴리오, 협상, 정리의 우선순위", weight: 1.0 },
      { key: "let_go", label: "놓아야 할 낡은 기준", role: "버려야 할 비교와 소모 패턴", weight: 0.9 },
      { key: "overall_advice", label: "남길 기준과 옮길 방향", role: "의사결정을 닫는 마지막 기준", weight: 1.2 },
    ],
  },
  mindscan_five_card: {
