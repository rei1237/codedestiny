const SPREADS = {
  ...
  relationship_six_card: {
    ...
    positions: [
      ...
      { key: "position_3", label: "상대가 나를 보는 것", role: "상대가 지금 나를 어떻게 느끼고 있는지 보여줍니다", weight: 1.1 },
      { key: "position_4", label: "연애하고픈 마음", role: "상대가 나와 연애로 발전시키고 싶은 마음이 있는지 보여줍니다", weight: 1.2 },
      { key: "position_5", label: "관계를 막는 것", role: "지금 두 사람 사이를 가로막고 있는 것이 무엇인지 보여줍니다", weight: 1.2 },
