const SPREADS = {
  ...
  reunion_lighthouse_five_card: {
    ...
    positions: [
      { key: "past_bond", label: "아직 남아 있는 마음", role: "내 감정의 온도와 미완의 감정 잔여량", weight: 1.1 },
      { key: "their_now", label: "상대가 보이는 마음의 결", role: "상대의 내면 상태와 겉표현·속마음의 간극", weight: 1.2 },
      { key: "outside_factor", label: "연락이 멈춘 현실 신호", role: "연락 단절의 실제 이유와 감정적·현실적 변수", weight: 1.1 },
      { key: "their_heart", label: "다시 닿을 수 있는 거리", role: "재접근의 타이밍과 속도, 안전한 거리", weight: 1.2 },
      { key: "reunion_outcome", label: "관계 회복의 조건과 기준", role: "재회가 오래 가기 위한 내부 조건과 반복 패턴 차단 기준", weight: 1.3 },
    ],
  },
  yearly_twelve_card: {
