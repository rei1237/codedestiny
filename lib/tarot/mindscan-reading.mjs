...
async function requestMindscanGeminiOnce({ prompt, env, fetchImpl, apiKey, maxOutputTokens }) {
...
async function callMindscanGemini({ question, pairs, insightSeeds = [], env = {}, fetchImpl = globalThis.fetch }) {
  ...
  for (let attempt = 0; attempt < 3; attempt += 1) {
    ...
    try {
      const result = await requestMindscanGeminiOnce({ prompt, env, fetchImpl, apiKey, maxOutputTokens });
