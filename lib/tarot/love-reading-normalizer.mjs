import { toAiLocale } from "../i18n/ai-locale.js";
...
function normalizeLoveReadingLocale(locale) {
  ...
  if (aiLocale === "ko") return "ko";
  if (aiLocale === "ja") return "ja";
  if (aiLocale === "zh-CN") return "zh-CN";
  if (aiLocale === "zh-TW") return "zh-TW";
  // 아직 모든 결정론 원문을 12개 언어로 번역하지 않았다. 다만 지원되는 비한국어 요청을
  // 한국어로 되돌리지는 않는다. 영어 일반 fallback은 모델 결과가 없는 경우에만 쓴다.
  return "en";
}
