...
// 분량 목표. 실측 2026-08-27(gemini-2.5-flash, 현행 프롬프트): 3카드 1,457자 / 7카드 2,350자 /
// 10카드 3,033자 / 14카드 3,590자 — **이미 카드 수에 비례한다.** 그래서 기울기를 더 세우지 않고
// 소형 스프레드의 바닥만 올린다(3카드 2,570 / 14카드 4,660). 같은 측정에서 출력 토큰은 14카드가
// 2,381 로 상한 10,000 의 24% 였고 생성은 12.4초였다 — maxOutputTokens·데드라인은 그대로 둔다.
const DEFAULT_TARGET_CHARS_BASE = 2000;
const DEFAULT_TARGET_CHARS_PER_CARD = 190;
