...
치즈색 햄스터, 모카는 자기 목을 감싸 쥐고 눈물을 글썽였다.
...
사람들이 진짜로 마음을 여는 건, 완벽한 노래 앞에서가 아니었다.
...
치즈색 햄스터의 작은 몸에서, 놀랄 만큼 큰 소리가 나왔다.
...
그런데 지금은, 모카의 노래를 중심으로 하나가 되어 있었다.
...
그때, 노래를 마친 모카가 무대에서 내려와 연이에게 달려왔다.
...
“나 여기서 계속 노래해도, 무성이 또 목소리 훔치러 오면, 또 뺏겨.”
...
방금까지 노래하던 모카가, 스태프들과 웃으며 사진을 찍고 있었다.
