...
연이의 앞발 아래에서 작은 초록빛 새싹 하나가 돋아났다.
...
“네오가 길을 열 수는 있어도, 네 글자를 대신 지켜줄 수는 없어.”
...
그 순간, 연이의 앞발 안에 들어온 [乙]의 빛이 흔들렸다.

마치 작은 새싹이 뿌리째 뽑히려는 것처럼.
...
그녀가 손을 내리자, 섬 가장 안쪽에 있던 검은 거울 하나가 천천히 떠올랐다.
