...
const STORY_DATA_TEXT_TRANSLATIONS = {
  ko: {
    ...
    "story.title.019": "제14화. 인성의 도서관, 다음 줄이 태어나는 곳",
...
import { nc13 } from "./chapters/chapter-13";
import { nc14 } from "./chapters/chapter-14";
import { nc15 } from "./chapters/chapter-15";
import { nc16 } from "./chapters/chapter-16";
import { nc17 } from "./chapters/chapter-17";
import { nc18 } from "./chapters/chapter-18";
import { nc19 } from "./chapters/chapter-19";
import { nc20 } from "./chapters/chapter-20";
import { nc21 } from "./chapters/chapter-21";
import { nc22 } from "./chapters/chapter-22";
import { nc23 } from "./chapters/chapter-23";
import { nc24 } from "./chapters/chapter-24";
import { nc25 } from "./chapters/chapter-25";
import { nc26 } from "./chapters/chapter-26";
import { nc27 } from "./chapters/chapter-27";
import { nc28 } from "./chapters/chapter-28";
...
const baseChapters: IChapter[] = [
  ...
  },
  {
    ...
    title: "제13화. 첫 번째 목소리",
    content: nc13,
    wordCount: nc13.replace(/\s+/g, "").length,
    viewCount: 0,
  ...
  },
  {
    ...
    slug: "chapter-14",
    chapterNumber: 14,
    title: "제14화. 강 건너 황금 냄새",
    content: nc14,
    wordCount: nc14.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제15화. 탄 빵의 냄새",
    content: nc15,
    wordCount: nc15.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제16화. 청토끼 금융그룹",
    content: nc16,
    wordCount: nc16.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    slug: "chapter-17",
    chapterNumber: 17,
    title: "제17화. 회중시계가 열릴 때",
    content: nc17,
    wordCount: nc17.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    slug: "chapter-18",
    chapterNumber: 18,
    title: "제18화. 책들이 숨 쉬는 곳, 그 아래",
    content: nc18,
    wordCount: nc18.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제19화. 기억의 열람실",
    content: nc19,
    wordCount: nc19.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제20화. 원본 계약서",
    content: nc20,
    wordCount: nc20.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제21화. 재성의 발톱",
    content: nc21,
    wordCount: nc21.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    slug: "chapter-22",
    chapterNumber: 22,
    title: "제22화. 모든 기둥이 제자리에",
    content: nc22,
    wordCount: nc22.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제23화. 갓 구운 아침",
    content: nc23,
    wordCount: nc23.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제24화. 돌아가는 문",
    content: nc24,
    wordCount: nc24.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    slug: "chapter-25",
    chapterNumber: 25,
    title: "제25화. 앱이 다시 울린 밤",
    content: nc25,
    wordCount: nc25.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    slug: "chapter-26",
    chapterNumber: 26,
    title: "제26화. 검은 깃털의 주인",
    content: nc26,
    wordCount: nc26.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제27화. 그릇",
    content: nc27,
    wordCount: nc27.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제28화. 붉은 실의 세계",
    content: nc28,
    wordCount: nc28.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제29화. 박병하",
    content: nc29,
    wordCount: nc29.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    title: "제30화. 사랑의 힘",
    content: nc30,
    wordCount: nc30.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
  {
    ...
    slug: "chapter-31",
    chapterNumber: 31,
    title: "최종화. 읽는 이름, 쓰는 운명",
    content: nc31,
    wordCount: nc31.replace(/\s+/g, "").length,
    viewCount: 0,
    publishedAt: "2026-07-22T00:00:00.000Z",
    createdAt: "2026-07-22T00:00:00.000Z",
  },
