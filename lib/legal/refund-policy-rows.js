...
export const REFUND_POLICY_ROWS = [
  ...
  "이용권 선물은 결제 확인 후 링크로 전달되며, 구매 후 1년 안에 로그인한 한 계정에서 수령할 수 있습니다. 이용 기간은 수령 시 시작하며 같은 등급은 남은 기간과 한도에 합산됩니다. 다른 등급 이용권이 활성화되어 있으면 종료 후 수령할 수 있습니다. 미수령 선물은 기존 환불 정책에 따라 확인하고, 수령 후 환불은 운영자 확인이 필요합니다. 링크 재발급 시 이전 링크는 사용할 수 없습니다. 수령 기한 경과만으로 환급 권리가 소멸하지 않으며 연장·환급은 운영자에게 문의할 수 있습니다.",
];
