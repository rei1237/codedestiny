...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function bw(a10) {
        var b2, c2;
        let { pathname: d2, search: e2 } = a10.nextUrl;
        ...
        if ("/index.html" === d2) {
          let b3 = a10.headers.get("user-agent") || "";
          if (bv.test(b3)) {
            let b4 = a10.nextUrl.clone();
            return b4.pathname = "/", b4.search = e2, S.redirect(b4, 301);
          }
        }
        ...
        let f2 = new Headers(a10.headers);
        return f2.set("x-pathname", a10.nextUrl.pathname), S.next({ request: { headers: f2 } });
      }
      let bx = { matcher: ["/:path*"] };
