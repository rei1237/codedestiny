...
test.each(['pet-saju-ai-consultation','pet-compatibility-ai','animal-totem-basic','animal-totem-deep'])('%s saved narrative is not refunded by timeout cleanup',async feature=>{
