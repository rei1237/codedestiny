...
test('실제 scheduled tick은 첫 네 장 저장 후 닫힌 문서를 원래 구매로 15장까지 이어간다', async () => {
  ...
  Object.assign(ctx, {
    ...
    __import: async spec => {
      ...
      return { monitorPaidNarratives: async () => {}, runYeongnyangiRecovery: async () => {}, runPaymentReconcileTask: async () => {}, runPaymentsV2Reconcile: async () => {}, runSnsDailyPostRecovery: async () => {}, runThreadsDailyJobs: async () => {}, runMasterLoveCodexRecovery: async () => {}, runFusionFortuneRecovery: async () => {} };
    },
  });
