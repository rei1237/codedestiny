...
test('실제 신년운세 화면의 재개 이펙트는 포그라운드 전환 4종 모두에서 reloadEpoch를 올리고 정리한다', () => {
  const effect = extractEffect('app/new-year-ai-consultation/NewYearAiClient.tsx', 'setReloadEpoch(value => value + 1)');
