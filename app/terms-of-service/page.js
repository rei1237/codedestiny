  ...
  return (
    ...
    >
      ...
      <section id="refund-policy" style={{ ...sectionStyle, marginBottom: "14px", scrollMarginTop: "116px" }}>
        ...
        <p style={{ lineHeight: 1.75 }}>
          월정석은 각 지급분이 지급된 날로부터 30일간만 유효하며, 그 기간 내에 사용하지 않은 지급분은 자동으로 소멸합니다.
          여러 번 나눠 지급받은 월정석은 각 지급분이 자기 지급일을 기준으로 개별 만료하고, 사용 시에는 먼저 만료되는(오래된) 지급분부터 차감됩니다.
          소멸된 월정석은 복구되지 않으며 현금 환불 대상이 아닙니다.
        </p>
        <p style={{ lineHeight: 1.75 }}>
