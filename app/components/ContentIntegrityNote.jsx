...
export default function ContentIntegrityNote({ datePublished = null, dateModified = null, className = "" }) {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2">
        이 글은 사주·자미두수·점성술·타로 같은 전통 상징 체계의 해석 규칙과 공개된 정보를 바탕으로 정리했으며, 게시 전 편집팀이 표현과 사실 관계, 과장·불안 조장 여부를 검토합니다. 계산 결과를 읽기 쉬운 해설로 옮기는 과정에는 인공지능의 도움을 받되, 방향과 문장은 사람이 다듬습니다. 운세 해석은 미래를 단정하는 예언이 아니라 자기 성찰과 선택 정돈을 돕는 참고 자료입니다.
      </p>
      {showDates ? (
