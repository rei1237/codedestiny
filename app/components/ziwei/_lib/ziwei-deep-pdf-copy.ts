...
const ZIWEI_DEEP_PDF_COPY: Partial<Record<LoadingLocale, ZiweiDeepPdfCopy>> = {
  ko: {
    ...
    title: "내 질문으로 완성하는 심층 상담서",
    introPrefix: "혼자 오래 품었던 질문을 남겨주세요. 당신의 질문에 먼저 답하고, 그 이유를 명반과 함께 ",
    introBold: "15개 챕터·3~4만자",
    introSuffix: "로 풀어드립니다. 한 장씩 읽고, 글자를 검색할 수 있는 PDF로 간직하세요.",
    ...
    pdfDownloadButtonIdle: "PDF 저장하기",
    ...
    pdfDownloadError: "PDF를 저장하지 못했습니다. 글꼴을 불러올 수 있는 연결 상태인지 확인한 뒤 PDF 저장하기를 다시 눌러주세요. 상담 내용은 그대로 열려 있습니다.",
