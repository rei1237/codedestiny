...
const MAIN_ACTION_ROUTE_MAP: Record<string, string> = {
  ...
  "/flower": "/index.html?action=openDestinyFlowerStudio",
...
const HOME_SERVICE_COPY: Record<LoadingLocale, {
  ...
  en: {
    ...
    quickLinks: [
      ...
      { href: "/flower", label: "Destiny Flower" },
  ...
  vi: {
    ...
    quickLinks: [
      ...
      { href: "/flower", label: "Hoa định mệnh" },
  ...
  hi: {
    ...
    quickLinks: [
      ...
      { href: "/flower", label: "नियति का फूल" },
  ...
  es: {
    ...
    quickLinks: [
      ...
      { href: "/flower", label: "Flor del destino" },
  ...
  fr: {
    ...
    quickLinks: [
      ...
      { href: "/flower", label: "Fleur du destin" },
  ...
  de: {
    ...
    quickLinks: [
      ...
      { href: "/flower", label: "Blume des Schicksals" },
  ...
  nl: {
    ...
    quickLinks: [
      ...
      { href: "/flower", label: "Bloem van bestemming" },
  ...
  ms: {
    ...
    quickLinks: [
      ...
      { href: "/flower", label: "Bunga takdir" },
