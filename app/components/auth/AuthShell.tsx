...
const EN: Copy = {
  ...
  phoneHelp: "Used as payment-provider customer information and stored as digits only.",
  ...
  privacySummary: "Name, email, and mobile number / account and payment customer management / until account deletion, except where law requires retention.",
...
const COPY: Partial<Record<LoadingLocale, Copy>> = {
  ko: {
    ...
    phoneHelp: "PG 결제 고객정보에 사용하며 숫자만 안전하게 저장해요.",
    ...
    privacySummary: "수집: 이름·이메일·휴대폰 번호 / 목적: 계정·결제 고객정보 관리 / 보유: 탈퇴 시까지(법령상 보존 제외)",
    terms: "이용약관에 동의합니다.",
