...
const PAYMENT_OVERLAY_FALLBACK_COPY: Record<LoadingLocale, { title: string; sub: string }> = {
  ko: { title: "결제 확인 화면을 여는 중입니다.", sub: "창을 닫지 말고 잠시만 기다려 주세요." },
  en: { title: "Opening the payment check screen.", sub: "Please don't close this window — it will only take a moment." },
  ja: { title: "決済確認画面を開いています。", sub: "ウィンドウを閉じずに少々お待ちください。" },
  "zh-CN": { title: "正在打开支付确认画面。", sub: "请勿关闭窗口，请稍候片刻。" },
  "zh-TW": { title: "正在開啟付款確認畫面。", sub: "請勿關閉視窗，請稍候片刻。" },
  vi: { title: "Đang mở màn hình xác nhận thanh toán.", sub: "Vui lòng không đóng cửa sổ này, chỉ mất một chút thời gian." },
  hi: { title: "भुगतान पुष्टि स्क्रीन खोली जा रही है.", sub: "कृपया विंडो बंद न करें, बस थोड़ी देर लगेगी." },
  es: { title: "Abriendo la pantalla de confirmación de pago.", sub: "No cierres esta ventana, solo tomará un momento." },
  fr: { title: "Ouverture de l'écran de confirmation du paiement.", sub: "Veuillez ne pas fermer cette fenêtre, cela ne prendra qu'un instant." },
  de: { title: "Der Zahlungsbestätigungsbildschirm wird geöffnet.", sub: "Bitte schließe dieses Fenster nicht, es dauert nur einen Moment." },
  nl: { title: "Het betaalbevestigingsscherm wordt geopend.", sub: "Sluit dit venster niet, het duurt maar even." },
  ms: { title: "Membuka skrin pengesahan bayaran.", sub: "Sila jangan tutup tetingkap ini, ia hanya mengambil masa sebentar." },
};

function PaymentOverlayFallback() {
  const copy = PAYMENT_OVERLAY_FALLBACK_COPY[getCurrentLoadingLocale()] || PAYMENT_OVERLAY_FALLBACK_COPY.ko;
  return (
    <div
      role="status"
      aria-live="polite"
    ...
    >
      ...
      >
        ...
        <p className="m-0 text-sm font-black">{copy.title}</p>
...
const PAID_GATE_LOCALIZED_COPY: Record<Exclude<LoadingLocale, "ko">, Partial<Record<PaidFeatureGateStatus, PaidGateCopy>>> = {
  en: {
    ...
    opening: { label: "Preparing", title: "Checking your pass", message: "Checking your pass.\nPlease wait a moment." },
    checkingEntitlement: { label: "Checking", title: "Checking your pass", message: "Checking your pass.\nPlease wait a moment." },
    hasEntitlement: { label: "Available", title: "Pass confirmed", message: "Your pass has been confirmed.\nPreparing your result." },
    noEntitlement: { label: "Payment needed", title: "Payment/pass check", message: "No usable pass was found." },
    loadingProducts: { label: "Checking", title: "Payment/pass check", message: "Checking your pass.\nPlease wait a moment." },
    readyToPay: { label: "Choose payment", title: "Choose a payment method", message: "Select a payment method to open this content." },
    paymentProcessing: { label: "Processing", title: "Processing payment", message: "Confirming your payment and access.\nPlease don't close this window." },
    paymentSuccess: { label: "Complete", title: "Payment complete", message: "Your payment is complete.\nPreparing your result." },
    ...
    paymentPreparing: { label: "Preparing", title: "Preparing your payment", message: "Setting up your order and verification.\nPlease don't close this window." },
    paymentWindowOpen: { label: "In progress", title: "Preparing your payment", message: "Setting up your order and verification.\nPlease don't close this window." },
    savingUnlock: { label: "Saving", title: "Saving your access", message: "Saving your access so we can show your result." },
    unlockSaving: { label: "Saving", title: "Saving your access", message: "Saving your access so we can show your result." },
  ...
  ja: {
    ...
    opening: { label: "準備中", title: "利用券を確認しています", message: "利用券を確認しています。\n少々お待ちください。" },
    checkingEntitlement: { label: "確認中", title: "利用券を確認しています", message: "利用券を確認しています。\n少々お待ちください。" },
    hasEntitlement: { label: "利用可能", title: "利用券の確認が完了しました", message: "利用券の確認が終わりました。\n結果を準備しています。" },
    noEntitlement: { label: "決済が必要", title: "決済・利用券の確認", message: "利用できる利用券が見つかりませんでした。" },
    loadingProducts: { label: "確認中", title: "決済・利用券の確認", message: "利用券を確認しています。\n少々お待ちください。" },
    readyToPay: { label: "選択待ち", title: "決済方法の選択", message: "このコンテンツを開く決済方法を選んでください。" },
    paymentProcessing: { label: "処理中", title: "決済処理中", message: "決済の承認と利用権限を確認しています。\nウィンドウを閉じないでください。" },
    paymentSuccess: { label: "完了", title: "決済完了", message: "決済が完了しました。\n結果を準備しています。" },
    ...
    paymentPreparing: { label: "決済準備", title: "決済を準備しています", message: "注文情報と認証を確認しています。\nウィンドウを閉じないでください。" },
    paymentWindowOpen: { label: "決済進行中", title: "決済を準備しています", message: "注文情報と認証を確認しています。\nウィンドウを閉じないでください。" },
    savingUnlock: { label: "保存中", title: "利用権限を保存しています", message: "結果画面に進めるよう、利用権限を保存しています。" },
    unlockSaving: { label: "保存中", title: "利用権限を保存しています", message: "結果画面に進めるよう、利用権限を保存しています。" },
    cancelled: { label: "キャンセル", title: "決済選択をキャンセルしました", message: "必要なときにもう一度進められます。" },
  },
  "zh-CN": {
    idle: { label: "等待", title: "支付/通行券确认", message: "正在确认通行券。" },
    opening: { label: "准备中", title: "正在确认通行券", message: "正在确认通行券。\n请稍候。" },
    checkingEntitlement: { label: "确认中", title: "正在确认通行券", message: "正在确认通行券。\n请稍候。" },
    hasEntitlement: { label: "可使用", title: "通行券确认完成", message: "通行券确认已完成。\n正在准备结果。" },
    noEntitlement: { label: "需要支付", title: "支付/通行券确认", message: "未找到可用的通行券。" },
    loadingProducts: { label: "确认中", title: "支付/通行券确认", message: "正在确认通行券。\n请稍候。" },
    readyToPay: { label: "等待选择", title: "选择支付方式", message: "请选择可打开此内容的支付方式。" },
    paymentProcessing: { label: "处理中", title: "正在处理支付", message: "正在确认支付和使用权限。\n请勿关闭窗口。" },
    paymentSuccess: { label: "完成", title: "支付完成", message: "支付已完成。\n正在准备结果。" },
    paymentFailed: { label: "失败", title: "支付确认失败", message: "未能完成支付。" },
    error: { label: "错误", title: "确认失败", message: "请检查网络状态后重试。" },
    paymentPreparing: { label: "支付准备", title: "正在准备支付", message: "正在核对订单信息和验证流程。\n请勿关闭窗口。" },
    paymentWindowOpen: { label: "支付进行中", title: "正在准备支付", message: "正在核对订单信息和验证流程。\n请勿关闭窗口。" },
    savingUnlock: { label: "保存中", title: "正在保存使用权限", message: "正在保存使用权限，以便跳转到结果页面。" },
    unlockSaving: { label: "保存中", title: "正在保存使用权限", message: "正在保存使用权限，以便跳转到结果页面。" },
    cancelled: { label: "已取消", title: "已取消支付选择", message: "需要时可以再次继续。" },
  },
  "zh-TW": {
    idle: { label: "等待", title: "付款/通行券確認", message: "正在確認通行券。" },
    opening: { label: "準備中", title: "正在確認通行券", message: "正在確認通行券。\n請稍候。" },
    checkingEntitlement: { label: "確認中", title: "正在確認通行券", message: "正在確認通行券。\n請稍候。" },
    hasEntitlement: { label: "可使用", title: "通行券確認完成", message: "通行券確認已完成。\n正在準備結果。" },
    noEntitlement: { label: "需要付款", title: "付款/通行券確認", message: "找不到可用的通行券。" },
    loadingProducts: { label: "確認中", title: "付款/通行券確認", message: "正在確認通行券。\n請稍候。" },
    readyToPay: { label: "等待選擇", title: "選擇付款方式", message: "請選擇可開啟此內容的付款方式。" },
    paymentProcessing: { label: "處理中", title: "正在處理付款", message: "正在確認付款與使用權限。\n請勿關閉視窗。" },
    paymentSuccess: { label: "完成", title: "付款完成", message: "付款已完成。\n正在準備結果。" },
    paymentFailed: { label: "失敗", title: "付款確認失敗", message: "未能完成付款。" },
    error: { label: "錯誤", title: "確認失敗", message: "請檢查網路狀態後再試一次。" },
    paymentPreparing: { label: "付款準備", title: "正在準備付款", message: "正在核對訂單資訊與驗證流程。\n請勿關閉視窗。" },
    paymentWindowOpen: { label: "付款進行中", title: "正在準備付款", message: "正在核對訂單資訊與驗證流程。\n請勿關閉視窗。" },
    savingUnlock: { label: "儲存中", title: "正在儲存使用權限", message: "正在儲存使用權限，以便前往結果畫面。" },
    unlockSaving: { label: "儲存中", title: "正在儲存使用權限", message: "正在儲存使用權限，以便前往結果畫面。" },
  ...
  vi: {
    ...
    opening: { label: "Đang chuẩn bị", title: "Đang kiểm tra vé sử dụng", message: "Đang kiểm tra vé sử dụng.\nVui lòng chờ trong giây lát." },
    checkingEntitlement: { label: "Đang kiểm tra", title: "Đang kiểm tra vé sử dụng", message: "Đang kiểm tra vé sử dụng.\nVui lòng chờ trong giây lát." },
    hasEntitlement: { label: "Có thể dùng", title: "Đã xác nhận vé sử dụng", message: "Đã xác nhận vé sử dụng.\nĐang chuẩn bị kết quả." },
    noEntitlement: { label: "Cần thanh toán", title: "Kiểm tra thanh toán/vé", message: "Không tìm thấy vé có thể dùng." },
    loadingProducts: { label: "Đang kiểm tra", title: "Kiểm tra thanh toán/vé", message: "Đang kiểm tra vé sử dụng.\nVui lòng chờ trong giây lát." },
    readyToPay: { label: "Chờ chọn", title: "Chọn phương thức thanh toán", message: "Chọn phương thức thanh toán để mở nội dung này." },
    paymentProcessing: { label: "Đang xử lý", title: "Đang xử lý thanh toán", message: "Đang xác nhận thanh toán và quyền sử dụng.\nVui lòng không đóng cửa sổ này." },
    paymentSuccess: { label: "Hoàn tất", title: "Thanh toán hoàn tất", message: "Thanh toán đã hoàn tất.\nĐang chuẩn bị kết quả." },
    ...
    paymentPreparing: { label: "Chuẩn bị thanh toán", title: "Đang chuẩn bị thanh toán", message: "Đang chuẩn bị thông tin đơn hàng và xác thực.\nVui lòng không đóng cửa sổ này." },
    paymentWindowOpen: { label: "Đang thanh toán", title: "Đang chuẩn bị thanh toán", message: "Đang chuẩn bị thông tin đơn hàng và xác thực.\nVui lòng không đóng cửa sổ này." },
    savingUnlock: { label: "Đang lưu", title: "Đang lưu quyền sử dụng", message: "Đang lưu quyền sử dụng để chuyển sang màn hình kết quả." },
    unlockSaving: { label: "Đang lưu", title: "Đang lưu quyền sử dụng", message: "Đang lưu quyền sử dụng để chuyển sang màn hình kết quả." },
  ...
  hi: {
    ...
    opening: { label: "तैयारी", title: "पास जाँचा जा रहा है", message: "आपका पास जाँचा जा रहा है.\nकृपया थोड़ी प्रतीक्षा करें." },
    checkingEntitlement: { label: "जाँच जारी", title: "पास जाँचा जा रहा है", message: "आपका पास जाँचा जा रहा है.\nकृपया थोड़ी प्रतीक्षा करें." },
    hasEntitlement: { label: "उपलब्ध", title: "पास की पुष्टि हो गई", message: "आपका पास सत्यापित हो गया है.\nपरिणाम तैयार किया जा रहा है." },
    noEntitlement: { label: "भुगतान आवश्यक", title: "भुगतान/पास जाँच", message: "उपयोग योग्य पास नहीं मिला." },
    loadingProducts: { label: "जाँच जारी", title: "भुगतान/पास जाँच", message: "आपका पास जाँचा जा रहा है.\nकृपया थोड़ी प्रतीक्षा करें." },
    readyToPay: { label: "चयन प्रतीक्षा", title: "भुगतान विधि चुनें", message: "इस सामग्री को खोलने के लिए भुगतान विधि चुनें." },
    paymentProcessing: { label: "प्रक्रिया जारी", title: "भुगतान संसाधित हो रहा है", message: "भुगतान और पहुँच अधिकार की पुष्टि की जा रही है.\nकृपया यह विंडो बंद न करें." },
    paymentSuccess: { label: "पूर्ण", title: "भुगतान पूर्ण", message: "आपका भुगतान पूर्ण हो गया है.\nपरिणाम तैयार किया जा रहा है." },
    ...
    paymentPreparing: { label: "भुगतान तैयारी", title: "भुगतान तैयार किया जा रहा है", message: "ऑर्डर जानकारी और सत्यापन तैयार किया जा रहा है.\nकृपया यह विंडो बंद न करें." },
    paymentWindowOpen: { label: "भुगतान जारी", title: "भुगतान तैयार किया जा रहा है", message: "ऑर्डर जानकारी और सत्यापन तैयार किया जा रहा है.\nकृपया यह विंडो बंद न करें." },
    savingUnlock: { label: "सहेजा जा रहा", title: "पहुँच अधिकार सहेजे जा रहे हैं", message: "परिणाम स्क्रीन पर जाने के लिए पहुँच अधिकार सहेजे जा रहे हैं." },
    unlockSaving: { label: "सहेजा जा रहा", title: "पहुँच अधिकार सहेजे जा रहे हैं", message: "परिणाम स्क्रीन पर जाने के लिए पहुँच अधिकार सहेजे जा रहे हैं." },
  ...
  es: {
    ...
    opening: { label: "Preparando", title: "Comprobando tu pase", message: "Comprobando tu pase.\nEspera un momento." },
    checkingEntitlement: { label: "Comprobando", title: "Comprobando tu pase", message: "Comprobando tu pase.\nEspera un momento." },
    hasEntitlement: { label: "Disponible", title: "Pase confirmado", message: "Tu pase ha sido confirmado.\nPreparando tu resultado." },
    noEntitlement: { label: "Pago necesario", title: "Comprobación de pago/pase", message: "No se encontró un pase disponible." },
    loadingProducts: { label: "Comprobando", title: "Comprobación de pago/pase", message: "Comprobando tu pase.\nEspera un momento." },
    ...
    paymentProcessing: { label: "Procesando", title: "Procesando el pago", message: "Confirmando tu pago y acceso.\nNo cierres esta ventana." },
    paymentSuccess: { label: "Completado", title: "Pago completado", message: "Tu pago se ha completado.\nPreparando tu resultado." },
    ...
    paymentPreparing: { label: "Preparando pago", title: "Preparando tu pago", message: "Configurando tu pedido y verificación.\nNo cierres esta ventana." },
    paymentWindowOpen: { label: "Pago en curso", title: "Preparando tu pago", message: "Configurando tu pedido y verificación.\nNo cierres esta ventana." },
    savingUnlock: { label: "Guardando", title: "Guardando tu acceso", message: "Guardando tu acceso para mostrar el resultado." },
    unlockSaving: { label: "Guardando", title: "Guardando tu acceso", message: "Guardando tu acceso para mostrar el resultado." },
  ...
  fr: {
    ...
    opening: { label: "Préparation", title: "Vérification de votre pass", message: "Vérification de votre pass.\nVeuillez patienter un instant." },
    checkingEntitlement: { label: "Vérification", title: "Vérification de votre pass", message: "Vérification de votre pass.\nVeuillez patienter un instant." },
    hasEntitlement: { label: "Disponible", title: "Pass confirmé", message: "Votre pass a été confirmé.\nPréparation de votre résultat." },
    noEntitlement: { label: "Paiement requis", title: "Vérification paiement/pass", message: "Aucun pass utilisable n'a été trouvé." },
    loadingProducts: { label: "Vérification", title: "Vérification paiement/pass", message: "Vérification de votre pass.\nVeuillez patienter un instant." },
    ...
    paymentProcessing: { label: "Traitement", title: "Traitement du paiement", message: "Confirmation de votre paiement et de votre accès.\nVeuillez ne pas fermer cette fenêtre." },
    paymentSuccess: { label: "Terminé", title: "Paiement terminé", message: "Votre paiement est terminé.\nPréparation de votre résultat." },
    ...
    paymentPreparing: { label: "Préparation du paiement", title: "Préparation de votre paiement", message: "Configuration de votre commande et de la vérification.\nVeuillez ne pas fermer cette fenêtre." },
    paymentWindowOpen: { label: "Paiement en cours", title: "Préparation de votre paiement", message: "Configuration de votre commande et de la vérification.\nVeuillez ne pas fermer cette fenêtre." },
    savingUnlock: { label: "Enregistrement", title: "Enregistrement de votre accès", message: "Enregistrement de votre accès pour afficher le résultat." },
    unlockSaving: { label: "Enregistrement", title: "Enregistrement de votre accès", message: "Enregistrement de votre accès pour afficher le résultat." },
  ...
  de: {
    ...
    opening: { label: "Wird vorbereitet", title: "Dein Pass wird geprüft", message: "Dein Pass wird geprüft.\nBitte einen Moment warten." },
    checkingEntitlement: { label: "Wird geprüft", title: "Dein Pass wird geprüft", message: "Dein Pass wird geprüft.\nBitte einen Moment warten." },
    hasEntitlement: { label: "Verfügbar", title: "Pass bestätigt", message: "Dein Pass wurde bestätigt.\nDein Ergebnis wird vorbereitet." },
    noEntitlement: { label: "Zahlung nötig", title: "Zahlung/Pass wird geprüft", message: "Es wurde kein nutzbarer Pass gefunden." },
    loadingProducts: { label: "Wird geprüft", title: "Zahlung/Pass wird geprüft", message: "Dein Pass wird geprüft.\nBitte einen Moment warten." },
    ...
    paymentProcessing: { label: "Wird verarbeitet", title: "Zahlung wird verarbeitet", message: "Deine Zahlung und dein Zugriff werden bestätigt.\nBitte schließe dieses Fenster nicht." },
    paymentSuccess: { label: "Abgeschlossen", title: "Zahlung abgeschlossen", message: "Deine Zahlung ist abgeschlossen.\nDein Ergebnis wird vorbereitet." },
    ...
    paymentPreparing: { label: "Zahlung wird vorbereitet", title: "Deine Zahlung wird vorbereitet", message: "Bestellung und Verifizierung werden eingerichtet.\nBitte schließe dieses Fenster nicht." },
    paymentWindowOpen: { label: "Zahlung läuft", title: "Deine Zahlung wird vorbereitet", message: "Bestellung und Verifizierung werden eingerichtet.\nBitte schließe dieses Fenster nicht." },
    savingUnlock: { label: "Wird gespeichert", title: "Zugriff wird gespeichert", message: "Dein Zugriff wird gespeichert, damit dein Ergebnis angezeigt werden kann." },
    unlockSaving: { label: "Wird gespeichert", title: "Zugriff wird gespeichert", message: "Dein Zugriff wird gespeichert, damit dein Ergebnis angezeigt werden kann." },
  ...
  nl: {
    ...
    opening: { label: "Voorbereiden", title: "Je pas wordt gecontroleerd", message: "Je pas wordt gecontroleerd.\nEen moment geduld." },
    checkingEntitlement: { label: "Controleren", title: "Je pas wordt gecontroleerd", message: "Je pas wordt gecontroleerd.\nEen moment geduld." },
    hasEntitlement: { label: "Beschikbaar", title: "Pas bevestigd", message: "Je pas is bevestigd.\nJe resultaat wordt voorbereid." },
    noEntitlement: { label: "Betaling nodig", title: "Betaling/pas controleren", message: "Er is geen bruikbare pas gevonden." },
    loadingProducts: { label: "Controleren", title: "Betaling/pas controleren", message: "Je pas wordt gecontroleerd.\nEen moment geduld." },
    readyToPay: { label: "Betaling kiezen", title: "Kies een betaalmethode", message: "Kies een betaalmethode om deze inhoud te openen." },
    paymentProcessing: { label: "Verwerken", title: "Betaling wordt verwerkt", message: "Je betaling en toegang worden bevestigd.\nSluit dit venster niet." },
    paymentSuccess: { label: "Voltooid", title: "Betaling voltooid", message: "Je betaling is voltooid.\nJe resultaat wordt voorbereid." },
    ...
    paymentPreparing: { label: "Betaling voorbereiden", title: "Je betaling wordt voorbereid", message: "Bestelling en verificatie worden ingesteld.\nSluit dit venster niet." },
    paymentWindowOpen: { label: "Betaling bezig", title: "Je betaling wordt voorbereid", message: "Bestelling en verificatie worden ingesteld.\nSluit dit venster niet." },
    savingUnlock: { label: "Opslaan", title: "Toegang wordt opgeslagen", message: "Je toegang wordt opgeslagen zodat je resultaat kan worden getoond." },
    unlockSaving: { label: "Opslaan", title: "Toegang wordt opgeslagen", message: "Je toegang wordt opgeslagen zodat je resultaat kan worden getoond." },
  ...
  ms: {
    ...
    opening: { label: "Bersedia", title: "Menyemak pas anda", message: "Pas anda sedang disemak.\nSila tunggu sebentar." },
    checkingEntitlement: { label: "Menyemak", title: "Menyemak pas anda", message: "Pas anda sedang disemak.\nSila tunggu sebentar." },
    hasEntitlement: { label: "Boleh digunakan", title: "Pas disahkan", message: "Pas anda telah disahkan.\nSedang menyediakan hasil anda." },
    noEntitlement: { label: "Bayaran diperlukan", title: "Semakan bayaran/pas", message: "Tiada pas yang boleh digunakan ditemui." },
    loadingProducts: { label: "Menyemak", title: "Semakan bayaran/pas", message: "Pas anda sedang disemak.\nSila tunggu sebentar." },
    readyToPay: { label: "Pilih bayaran", title: "Pilih kaedah bayaran", message: "Pilih kaedah bayaran untuk membuka kandungan ini." },
    paymentProcessing: { label: "Memproses", title: "Memproses bayaran", message: "Bayaran dan akses anda sedang disahkan.\nSila jangan tutup tetingkap ini." },
    paymentSuccess: { label: "Selesai", title: "Bayaran selesai", message: "Bayaran anda telah selesai.\nSedang menyediakan hasil anda." },
    ...
    paymentPreparing: { label: "Persediaan bayaran", title: "Menyediakan bayaran anda", message: "Maklumat pesanan dan pengesahan sedang disediakan.\nSila jangan tutup tetingkap ini." },
    paymentWindowOpen: { label: "Bayaran sedang berjalan", title: "Menyediakan bayaran anda", message: "Maklumat pesanan dan pengesahan sedang disediakan.\nSila jangan tutup tetingkap ini." },
    savingUnlock: { label: "Menyimpan", title: "Menyimpan akses anda", message: "Akses anda sedang disimpan supaya hasil dapat dipaparkan." },
    unlockSaving: { label: "Menyimpan", title: "Menyimpan akses anda", message: "Akses anda sedang disimpan supaya hasil dapat dipaparkan." },
