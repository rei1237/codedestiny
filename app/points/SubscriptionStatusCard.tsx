...
const SUBSCRIPTION_STATUS_COPY: Record<LoadingLocale, SubscriptionStatusCopy> = {
  ...
  en: {
    ...
    tiers: {
      ...
      standard: {
        ...
        desc: "General paid services up to KRW 3,000 · PDFs billed separately · Up to 3 profiles",
        profileMax: "3 profiles",
        freeUpTo: "General services up to KRW 3,000",
      },
      premium: {
        label: "Premium Honey 30-day",
        desc: "General paid services up to KRW 5,000 · PDFs billed separately · Up to 7 profiles",
        profileMax: "7 profiles",
        freeUpTo: "General services up to KRW 5,000",
      },
      vvip: {
        label: "VVIP Honey Jar 30-day",
        desc: "General paid services up to KRW 10,000 · PDFs billed separately · Up to 15 profiles",
  ...
  ja: {
    ...
    tiers: {
      ...
      standard: {
        label: "スタンダード蜜 30日",
        desc: "一般有料サービス3,000ウォン以下 · PDFは別途ウォン決済 · 最大3プロフィール",
        profileMax: "3件",
        freeUpTo: "一般3,000ウォン以下まで利用可能",
      },
      premium: {
        label: "プレミアム蜜 30日",
        desc: "一般有料サービス5,000ウォン以下 · PDFは別途ウォン決済 · 最大7プロフィール",
        profileMax: "7件",
        freeUpTo: "一般5,000ウォン以下まで利用可能",
      },
      vvip: {
        label: "VVIP 蜜壺 30日",
        desc: "一般有料サービス10,000ウォン以下 · PDFは別途ウォン決済 · 最大15プロフィール",
        profileMax: "15件",
  ...
  "zh-CN": {
    ...
    tiers: {
      ...
      standard: {
        label: "标准蜜糖 30天",
        desc: "一般付费服务3,000韩元以下 · PDF另行韩元付款 · 最多3个档案",
        profileMax: "3个",
        freeUpTo: "可使用3,000韩元以下的一般服务",
      },
      premium: {
        label: "高级蜜糖 30天",
        desc: "一般付费服务5,000韩元以下 · PDF另行韩元付款 · 最多7个档案",
        profileMax: "7个",
        freeUpTo: "可使用5,000韩元以下的一般服务",
      },
      vvip: {
        label: "VVIP 蜜罐 30天",
        desc: "一般付费服务10,000韩元以下 · PDF另行韩元付款 · 最多15个档案",
        profileMax: "15个",
  ...
  "zh-TW": {
    ...
    tiers: {
      ...
      standard: {
        label: "標準蜜糖 30天",
        desc: "一般付費服務3,000韓元以下 · PDF另行韓元付款 · 最多3個檔案",
        profileMax: "3個",
        freeUpTo: "可使用3,000韓元以下的一般服務",
      },
      premium: {
        label: "高級蜜糖 30天",
        desc: "一般付費服務5,000韓元以下 · PDF另行韓元付款 · 最多7個檔案",
        profileMax: "7個",
        freeUpTo: "可使用5,000韓元以下的一般服務",
      },
      vvip: {
        label: "VVIP 蜜罐 30天",
        desc: "一般付費服務10,000韓元以下 · PDF另行韓元付款 · 最多15個檔案",
        profileMax: "15個",
