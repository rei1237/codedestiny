...
export const ABOUT_PAGE_TEXT_TRANSLATIONS = {
  ...
  ko: {
    ...
    "editorial.title": "만드는 사람과 책임",
    "editorial.team": "이 사이트의 글에 저자로 적히는 \"Code Destiny 편집팀\"은 개인 필명이 아니라, 운영사인 코드 데스티니(Code Destiny)의 콘텐츠 제작·검수 기능을 가리키는 표기입니다. 실재하지 않는 사람에게 경력이나 자격을 붙이지 않으려고 개인 저자 대신 조직 이름으로 귀속합니다.",
    "editorial.owner": "공개되는 글의 최종 검수 책임은 대표 박병하에게 있습니다. 운영 주체·사업자등록번호·통신판매업신고번호·연락처는 모든 페이지 하단에 그대로 표시하고 있으며, 잘못된 내용에 대한 책임도 같은 주체가 집니다.",
    "editorial.author": "운영자 박병하는 10년째 명리학을 공부하고 상담해 온 명리학자입니다. 사이트의 제작 기준과 정정에 책임을 지며, 개별 원고의 검수 완료 여부는 각 글의 제작·검수 안내에서 구분합니다. 운영자 소개가 모든 글의 검수 완료를 뜻하지는 않습니다. 소개에 적는 경력은 본인이 밝힌 사실까지만이며, 확인할 수 있는 공개 출처가 없는 이력은 적지 않습니다.",
    "editorial.process": "공개 문서의 제작 기준은 주제 선정 → 근거 정리 → 초안 → 검토 → 발행과 갱신입니다. 생성형 AI를 사용하는 초안도 검토 대상이며, 이 기준을 안내하는 것만으로 모든 글의 개별 검수가 완료되었다는 뜻은 아닙니다. 실제 검수 기록이 있는 글에만 검수자와 검수일을 표시합니다.",
    "editorial.limits": "현재 사람의 검수는 주로 유료 상담 결과를 대상으로 합니다. 공개 원고·공통 템플릿 전체의 개별 검수 완료를 뜻하지는 않습니다. 규칙으로 조립되는 페이지와 개별 원고는 제작 방식이 다릅니다. 공통 문안·템플릿의 검토와 개별 페이지의 검수 완료는 구분하며, 검색에 공개되어 있다는 사실만으로 사람의 개별 검수를 보장하지 않습니다.",
    "editorial.correction": "설명이 부정확하거나 과장됐다고 느끼셨다면 문의로 알려 주십시오. 보통 영업일 기준 1~3일 내 회신하되, 확인 절차에 따라 더 걸릴 수 있습니다. 오류가 확인되면 해당 문서를 수정하거나 보강합니다.",
    "editorial.policyLink": "콘텐츠 제작 및 AI 활용 고지",
    "editorial.contactLink": "정정 요청·문의",
    "content.title": "콘텐츠는 이렇게 만듭니다",
    "content.body": "운세의 계산값과 이를 읽는 해설은 구분합니다. 명식과 천체 위치 등은 계산 엔진이 산출하고, 기능에 따라 해설에 생성형 AI를 사용할 수 있습니다. 공개 원고는 사실 관계·과장·불안 조장 표현을 점검 대상으로 삼으며, 전문가 검수가 확인된 글에만 검수자와 검수일을 표시합니다. 운세는 과학적으로 입증된 예측이 아니라 전통 상징의 해석이므로, 현실 판단을 대신하지 않는 참고 자료로 제공합니다.",
