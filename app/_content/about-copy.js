...
export const ABOUT_PAGE_TEXT_TRANSLATIONS = {
  ...
  ko: {
    ...
    "editorial.process": "공개 문서는 주제 선정 → 근거 정리 → 초안 → 검수 → 발행과 갱신의 다섯 단계로 만듭니다. 초안 단계에서 생성형 인공지능의 도움을 받되 방향과 최종 문장은 사람이 정하고, 검수 단계에서 과장·불안 조장 표현과 의료·법률·금융 조언으로 오해될 문장을 걸러냅니다. 각 단계에서 무엇을 확인하는지는 아래 고지 문서에 전부 적어 두었습니다.",
    "editorial.limits": "규칙에 따라 자동으로 조립되는 페이지는 문서를 한 건씩 사람이 검토하지 않습니다. 대신 조립에 쓰이는 문안과 템플릿을 사람이 쓰고 검수하며, 운세 표현 안전 기준을 같은 방식으로 적용합니다.",
    "editorial.correction": "설명이 부정확하거나 과장됐다고 느끼셨다면 문의로 알려 주십시오. 영업일 기준 1~3일 안에 회신하고, 확인되면 해당 문서를 수정하거나 보강합니다.",
    "editorial.policyLink": "콘텐츠 제작 및 AI 활용 고지",
    "editorial.contactLink": "정정 요청·문의",
    "content.title": "콘텐츠는 이렇게 만듭니다",
    "content.body": "각 운세의 계산은 명리학·점성술의 고전 규칙과 천문 계산(만세력·에페메리스)을 바탕으로 이루어집니다. 계산 결과를 사람이 읽기 쉬운 해설로 풀어내는 과정에는 생성형 인공지능의 도움을 받되, 방향과 표현이 서비스 기준에 맞는지 사람이 검토합니다. 공개 원고의 사실 관계와 어조를 점검하며, 전문가 검수가 확인된 글에만 검수자와 검수일을 표시합니다. 잘못된 부분이 발견되면 바로잡습니다. 운세는 통계나 과학이 아니라 해석의 언어이므로, 단정적인 표현보다 참고와 성찰을 돕는 문장을 우선합니다.",
