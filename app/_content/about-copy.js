...
export const ABOUT_PAGE_TEXT_TRANSLATIONS = {
  ...
  ko: {
    ...
    "editorial.author": "글을 쓰고 검수하는 사람은 박병하입니다. 10년째 명리학을 공부하고 상담해 온 명리학자로, 이 사이트의 사주·만세력 해설 문안과 유명인 사주 해설을 직접 쓰거나 최종 검수합니다. 소개에 적는 경력은 본인이 밝힌 사실까지만이며, 확인할 수 있는 공개 출처가 없는 이력은 적지 않습니다.",
