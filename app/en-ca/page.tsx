export const metadata = {
  title: "Code Destiny | Free Tarot & Fortune (Canada)",
  description:
    "Code Destiny offers free tarot experiences and fortune insights. This page is tailored for Canada (en-CA) to strengthen regional SEO signals.",
  alternates: {
    canonical: "/en-ca",
  },
  openGraph: {
    title: "Code Destiny | Free Tarot & Fortune (Canada)",
    description: "Free tarot experiences and fortune insights for Canada (en-CA).",
    url: "https://code-destiny.com/en-ca",
    siteName: "Code Destiny",
    type: "website",
  },
};

export default function EnCaLanding() {
  return (
    <main style={{ maxWidth: "960px", margin: "0 auto", padding: "28px 16px 52px", color: "#e2e8f0" }}>
      <h1 style={{ fontSize: "34px", fontWeight: 800, marginBottom: "10px" }}>
        Code Destiny — Free Tarot & Fortune (Canada)
      </h1>
      <p style={{ opacity: 0.9, lineHeight: 1.75, marginBottom: "18px" }}>
        Explore tarot healing experiences and fortune insights. This page is tailored for Canada (en-CA) to help search
