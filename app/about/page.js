...
const ABOUT_PAGE_TEXT_TRANSLATIONS = {
  ...
  ko: {
    ...
    "principles.body": "개인의 선택을 대신하거나 불안을 조장하는 표현을 지양합니다. 건강·법률·투자·금융처럼 전문적인 판단이 필요한 영역은 반드시 해당 분야 전문가와 상담해야 하며, 어떤 운세 결과도 의료·법률·재무 조언을 대체하지 않습니다. 만 14세 미만 이용자는 법정대리인 동의 절차를 거쳐 무료 기능만 이용할 수 있도록 별도 기준으로 보호하고, 결제·환불·개인정보 처리 방침은 문서로 공개합니다.",
