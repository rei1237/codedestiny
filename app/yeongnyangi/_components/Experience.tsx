...
const Result=dynamic(()=>import('./Result'),{ssr:false,loading:()=> <p className={styles.loading}>두루마리를 펼치고 있어요.</p>});
const Library=dynamic(()=>import('./Library'),{ssr:false,loading:()=> <p className={styles.loading}>상담 기록을 불러오고 있어요.</p>});
