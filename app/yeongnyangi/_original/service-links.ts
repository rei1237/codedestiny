...
export const legalLinks=[{label:'이용약관',href:'/terms/'},{label:'개인정보처리방침',href:'/privacy-policy/'},{label:'환불·취소',href:'/refund-policy/'},{label:'고객센터',href:'/contact/'},{label:'서비스 소개',href:'/about/'},{label:'자주 묻는 질문',href:'/faq/'},{label:'면책 안내',href:'/disclaimer/'},{label:'콘텐츠 편집 원칙',href:'/editorial-policy/'},{label:'광고 정책',href:'/advertising-policy/'},{label:TRUST_DOCUMENT_COPY.ko.methodology,href:'/methodology/'}];
