...
const URL_='https://code-destiny.com/';
...
export const metadata:Metadata={title:TITLE,description:DESCRIPTION,alternates:{canonical:URL_},robots:{index:false,follow:true},
 openGraph:{type:'website',locale:'ko_KR',url:URL_,siteName:siteSeo.brandName,title:TITLE,description:DESCRIPTION,images:[{url:OG_IMAGE,width:1200,height:630,alt:siteSeo.brandName}]},
