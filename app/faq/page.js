...
const faqs = [
  ...
  },
  {
    ...
    answer: "30일 이용권과 상품별 원화 단건 결제는 결제일 또는 계약내용을 받은 날부터 7일 이내 청약철회를 요청할 수 있습니다. 콘텐츠 생성, PDF 렌더링, 유료 리딩 열람, 이용권 혜택 사용처럼 제공이 시작된 부분은 환불이 제한될 수 있으며, 표시·광고 또는 계약내용과 다르게 이행된 경우에는 공급일로부터 3개월 이내, 그 사실을 안 날부터 30일 이내 요청할 수 있습니다. 월정석은 구매·충전 상품이 아닌 보너스 혜택이므로 현금 환불 대상 결제 상품이 아닙니다.",
  },
];
