...
export default function FaqPage() {
  ...
  return (
    ...
    >
      ...
      >
        Code Destiny(꿀꿀 만세력) 이용에 관해 자주 받는 질문을 정리했습니다. 더
        자세한 내용은 개인정보처리방침·이용약관을 참고하시거나 문의하기로 연락해
        주세요.
      </p>
      <p
        style={{
      ...
      >
        Below are answers to common questions about Code Destiny. For details,
        see our Privacy Policy and Terms of Service, or reach us via Contact Us.
      </p>
      ...
      <section style={{ ...sectionStyle, marginBottom: "14px" }}>
        ...
        <p
          style={{ lineHeight: 1.82, color: "#dbe5ff", wordBreak: "keep-all" }}
        >
          <Link
            href="/privacy-policy"
