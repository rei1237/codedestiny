    ...
    <main className="relative isolate min-h-[100dvh] overflow-hidden bg-[#070812] px-4 py-8 text-slate-100 md:py-12">
      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        <p className="mt-6 break-keep text-sm leading-7 text-slate-200">
          숙요 27수의 {idx + 1}번째 자리 {suk.nameKo}수({suk.nameHan})는, 인도 27 나크샤트라 {attrs.nameKo}({attrs.nameEn})와 결정성(대표 별) 기준으로 이어집니다.
          두 전통은 같은 황도 27분할에서 갈라져 나왔기에, 한 별을 동양의 방위·사신·칠요와 인도의 지배성·주신·샥티라는 두 언어로 겹쳐 읽을 수 있습니다.
        </p>
