...
export default function TarotDebugRouteClient() {
  const [Content, setContent] = useState<ComponentType | null>(null);

  useEffect(() => {
    let isMounted = true;

    import("@/src/features/fortune-tea-house/components/TarotDebugPage").then((module) => {
      if (isMounted) {
