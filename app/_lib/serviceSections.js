const SERVICE_SECTION_DEFINITIONS = [
  {
    ...
    items: [
      ...
      { href: "/saju/destiny-meeting-place", fallbackTitle: "사주로 보는 인연의 장소", fallbackDesc: "인연 장소·도시·타이밍 독립 분석 · 1회 10,000원" },
    ],
  },
  {
    id: "core",
    ...
    items: [
      { href: "/ziwei/chart", fallbackTitle: "자미두수 명반", fallbackDesc: "기본 서비스 무료 · 궁합 5,000원" },
      { href: "/astrology/cosmic", fallbackTitle: "점성술 코즈믹", fallbackDesc: "기본 서비스 무료 · 궁합 5,000원" },
      { href: "/vedic/jyotish", fallbackTitle: "베다 점성술", fallbackDesc: "기본 서비스 무료 · 궁합 5,000원" },
    ],
  },
  {
    id: "tarot",
    fallbackTitle: "타로 리딩",
    items: [
      { href: "/tarot/mingri", fallbackTitle: "명리학 타로", fallbackDesc: "카드와 십성을 잇는 리딩 · 무료" },
      { href: "/tarot/love", fallbackTitle: "우리는 무슨 사이?", fallbackDesc: "6카드 연애 관계 리딩 · 5,000원" },
      {
      ...
      { href: "/tarot/self-esteem", fallbackTitle: "자존감 레벨업", fallbackDesc: "나를 다시 세우는 5카드 · 무료" },
      { href: "/tarot/reunion", fallbackTitle: "재회운 등대 타로", fallbackDesc: "다시 닿아도 안전한 거리 · 5,000원" },
      { href: "/tarot/year", fallbackTitle: "십이지신 천운(天運)", fallbackDesc: "열두 달의 수호 리듬 · 3,000원" },
  ...
  },
  {
    ...
    fallbackTitle: "신탁 & 해몽",
    items: [
      { href: "/oracle/hwatu", fallbackTitle: "타짜들의 화투점", fallbackDesc: "12달 화투패 운세" },
      { href: "/oracle/hwatu-life", fallbackTitle: "화투 인생 패 테스트", fallbackDesc: "타짜 컨셉 7문항 심리테스트" },
      { href: "/oracle/ifa", fallbackTitle: "IFA 오라클", fallbackDesc: "요루바 256 오두 신탁 · 3,000원" },
      { href: "/oracle/kemet", fallbackTitle: "고대 이집트 신탁", fallbackDesc: "케멧 오라클 리딩" },
      { href: "/oracle/juyuk", fallbackTitle: "주역 거북점", fallbackDesc: "64괘 상징 해석" },
      { href: "/oracle/sukuyo", fallbackTitle: "숙요점", fallbackDesc: "기본 서비스 무료 · 궁합 5,000원" },
