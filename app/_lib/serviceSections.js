const SERVICE_SECTION_DEFINITIONS = [
  {
    ...
    items: [
      ...
      { href: "/master-love-codex", fallbackTitle: "마스터 운명 연애 비책", fallbackDesc: "사주×자미두수 융합 20장 연애 전략서 · 1회 50,000원" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/tarot/year", fallbackTitle: "십이지신 천운(天運)", fallbackDesc: "열두 달의 수호 리듬 · 3,000원", isStaticCanonical: true },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dream/tarot", fallbackTitle: "드림 프롬프트", fallbackDesc: "꿈 문장 AI 프롬프트" },
