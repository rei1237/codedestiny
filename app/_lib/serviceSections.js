  ...
  es: [
    ...
    },
    {
      ...
      items: [
        ...
        ["Dream Prompt", "Prompt de IA desde frases de sueños"],
    ...
    },
    {
      ...
      items: [
        ...
        ["Animal Totem", "Mensaje del animal guardián"],
        ["Destiny Flower", "Atelier integrado"],
        ["Astrology Flower", "Visualización con tema de nebulosa"],
        ["Zi Wei Flower", "Reporte temático del palacio de vida"],
        ["Sukuyo Flower", "Flor basada en fase lunar"],
      ],
    },
  ],
  fr: [
    ...
    },
    {
      ...
      items: [
        ...
        ["Dream Prompt", "Prompt IA depuis les phrases du rêve"],
    ...
    },
    {
      ...
      items: [
        ...
        ["Animal Totem", "Message de l'animal gardien"],
        ["Destiny Flower", "Atelier intégré"],
        ["Astrology Flower", "Visualisation thème nébuleuse"],
        ["Zi Wei Flower", "Rapport thème palais de vie"],
        ["Sukuyo Flower", "Fleur selon phase lunaire"],
      ],
    },
  ],
  de: [
    ...
    },
    {
      ...
      items: [
        ...
        ["Mind Scan Tarot", "Liest den Abstand zwischen Worten und inneren Gefühlen · 5.000 KRW"],
    ...
    },
    {
      ...
      items: [
        ...
        ["Destiny Poker", "Schicksalskartenduell mit den Göttern"],
        ["Dream Prompt", "KI-Prompt aus Traumsätzen"],
    ...
    },
    {
      ...
      items: [
        ...
        ["Animal Totem", "Botschaft des Schutztieres"],
        ["Destiny Flower", "Integriertes Atelier"],
        ["Astrology Flower", "Nebelthemen-Visualisierung"],
        ["Zi Wei Flower", "Bericht zum Lebenspalast-Thema"],
        ["Sukuyo Flower", "Blume auf Mondphasenbasis"],
      ],
    },
  ],
  hi: [
    {
      title: "Saju और Myeongri",
      items: [
        ["Basic Saju Manse Reading", "पाँच तत्व और Ten Gods के आधार पर birth chart analysis · मुफ्त"],
        ["Sibyl System", "Saju आधारित career aptitude और destiny risk coefficient · basic मुफ्त"],
        ["Book of Life", "Premium deep Saju analysis · KRW 50,000"],
        ["Love Secret Strategy", "Saju आधारित love strategy · solo KRW 30,000 / compatibility +KRW 10,000 (total KRW 40,000)"],
        ["LOVE CODE", "Saju love simulation · unlock KRW 10,000"],
        ["Destiny Bias", "Saju आधारित fandom resonance analysis · KRW 5,000 प्रति reading"],
        ["Twelve Growth Animal Oracle", "Saju की Twelve Growth Stars से जागता आपका guardian animal · unlock KRW 10,000"],
        ["Destined Meeting Place by Saju", "Relationship places, cities और timing की independent reading · KRW 10,000 प्रति reading"],
      ],
    },
    {
      title: "Eastern & Western Fate Systems",
      items: [
        ["Zi Wei Dou Shu Chart", "Basic service मुफ्त · compatibility KRW 5,000"],
        ["Cosmic Astrology", "Basic service मुफ्त · compatibility KRW 5,000"],
        ["Vedic Astrology", "Basic service मुफ्त · compatibility KRW 5,000"],
      ],
    },
    {
      title: "Tarot Readings",
      items: [
        ["Myeongri Tarot", "Cards और Ten Gods को जोड़ने वाली reading · मुफ्त"],
        ["What Are We?", "6-card love relationship reading · KRW 5,000"],
        ["Tarot Prompt Library", "Question design + card draw + oracle sentence summary · KRW 5,000 per use · 63 spreads", "Tarot Prompt Library"],
        ["Warm Sun Healing Tarot", "Emotional temperature और recovery routine · मुफ्त"],
        ["Self-Esteem Level Up", "खुद को फिर खड़ा करने वाली 5-card reading · मुफ्त"],
        ["Reunion Lighthouse Tarot", "फिर जुड़ने के लिए सुरक्षित दूरी · KRW 5,000"],
        ["Twelve Zodiac Heaven Luck", "बारह महीनों का guardian rhythm · KRW 3,000"],
        ["Crystal Soul Tarot", "Stone और card texture reading · KRW 5,000"],
        ["Mind Scan Tarot", "बोले गए शब्दों और अंदरूनी भावों के बीच की दूरी · KRW 5,000"],
        ["Celestial Harmony", "11-card planetary cosmic reading · KRW 10,000"],
        ["Career Change Destiny Cards", "7-card career spread · KRW 5,000"],
      ],
    },
    {
      ...
      items: [
        ["Hwatu Oracle of Card Masters", "12-month Hwatu card fortune"],
        ["Hwatu Life Card Test", "Card-master concept वाला 7-question psychology test"],
        ["IFA Oracle", "Yoruba 256 Odu oracle · KRW 3,000"],
        ["Ancient Egyptian Oracle", "Kemet oracle reading"],
        ["I Ching Turtle Oracle", "64 hexagram symbolic reading"],
        ["Sukuyo Astrology", "Basic service मुफ्त · compatibility KRW 5,000"],
        ["Stonehenge Rune Oracle", "Ancient rune symbol reading"],
        ["Geomancy Earth Oracle", "16-line earth sign oracle"],
        ["Tasseography Tea Leaf Oracle", "London royal cup pattern reading"],
        ["Destiny Poker", "देवताओं के साथ destiny card duel"],
        ["Dream Prompt", "Dream sentences से AI prompt"],
        ["Psychoanalytic Dream Reading", "Freudian viewpoint interpretation"],
      ],
    },
    {
      title: "Special Content",
      items: [
        ["I Am Solo Secret House", "Automatic daily stem love simulation"],
        ["AI Animal Face Reading", "Selfie face-shape analysis"],
        ["MBTI Animal Compatibility", "16-type chemistry analysis"],
        ["Animal Totem", "Guardian animal message"],
        ["Destiny Flower", "Integrated atelier"],
        ["Astrology Flower", "Nebula theme visualization"],
        ["Zi Wei Flower", "Life palace themed report"],
        ["Sukuyo Flower", "Moon-phase based flower"],
      ],
    },
  ...
  nl: [
    {
      ...
      items: [
        ...
        ["Sibyl System", "Saju-gebaseerde beroepsaanleg en bestemmingsrisico · Basis gratis"],
        ["Book of Life", "Premium diepe Saju-analyse · KRW 50.000"],
        ["Love Secret Strategy", "Saju-gebaseerde liefdesstrategie · solo KRW 30.000 / compatibiliteit +KRW 10.000 (totaal KRW 40.000)"],
        ["LOVE CODE", "Saju liefdessimulatie · unlock KRW 10.000"],
        ["Destiny Bias", "Saju-gebaseerde fandomresonantieanalyse · KRW 5.000 per lezing"],
        ["Twelve Growth Animal Oracle", "Je beschermdier gewekt door de Twelve Growth Stars in Saju · unlock KRW 10.000"],
    ...
    },
    {
      ...
      items: [
        ["Zi Wei Dou Shu Chart", "Basisservice gratis · compatibiliteit KRW 5.000"],
        ["Cosmic Astrology", "Basisservice gratis · compatibiliteit KRW 5.000"],
        ["Vedic Astrology", "Basisservice gratis · compatibiliteit KRW 5.000"],
      ],
    },
    {
      title: "Tarotlezingen",
      items: [
        ...
        ["Tarot Prompt Library", "Vraagontwerp + kaarttrekking + orakelzin · KRW 5.000 per gebruik · 63 spreads", "Tarot Prompt Library"],
        ["Warm Sun Healing Tarot", "Emotionele temperatuur en herstelroutine · Gratis"],
        ["Self-Esteem Level Up", "5 kaarten die je weer laten staan · Gratis"],
        ["Reunion Lighthouse Tarot", "Veilige afstand om opnieuw te verbinden · KRW 5.000"],
        ["Twelve Zodiac Heaven Luck", "Beschermend ritme van twaalf maanden · KRW 3.000"],
        ["Crystal Soul Tarot", "Steen- en kaarttextuurlezing · KRW 5.000"],
        ["Mind Scan Tarot", "Leest de afstand tussen woorden en innerlijke gevoelens · KRW 5.000"],
        ["Celestial Harmony", "11-kaarten planetaire kosmische lezing · KRW 10.000"],
        ["Career Change Destiny Cards", "7-kaarten carrière spread · KRW 5.000"],
      ],
    },
    {
      title: "Orakels & dromen",
      items: [
        ["Hwatu Oracle of Card Masters", "12-maanden Hwatu kaartfortuin"],
        ["Hwatu Life Card Test", "7-vragen psychologische test met kaartmeesterconcept"],
        ["IFA Oracle", "Yoruba 256 Odu oracle · KRW 3.000"],
        ["Ancient Egyptian Oracle", "Kemet oracle reading"],
        ["I Ching Turtle Oracle", "Symbolische lezing van 64 hexagrammen"],
        ["Sukuyo Astrology", "Basisservice gratis · compatibiliteit KRW 5.000"],
        ["Stonehenge Rune Oracle", "Oude rune-symbolenlezing"],
        ["Geomancy Earth Oracle", "16-regelige aarde-teken oracle"],
        ["Tasseography Tea Leaf Oracle", "London royal cup patroonlezing"],
        ["Destiny Poker", "Bestemmingskaartduel met de goden"],
        ["Dream Prompt", "AI-prompt uit droomzinnen"],
        ["Psychoanalytic Dream Reading", "Interpretatie vanuit Freud"],
      ],
    },
    {
      ...
      items: [
        ...
        ["AI Animal Face Reading", "Selfie gezichtsvormanalyse"],
        ["MBTI Animal Compatibility", "16-type chemieanalyse"],
        ["Animal Totem", "Bericht van het beschermdier"],
        ["Destiny Flower", "Geïntegreerd atelier"],
        ["Astrology Flower", "Nebula-thema visualisatie"],
        ["Zi Wei Flower", "Life-palace themarapport"],
        ["Sukuyo Flower", "Bloem op basis van maanfase"],
      ],
    },
  ],
  ms: [
    {
      ...
      items: [
        ...
        ["Sibyl System", "Aptitud kerjaya dan pekali risiko takdir berasaskan Saju · Asas percuma"],
        ["Book of Life", "Analisis Saju mendalam premium · KRW 50,000"],
        ["Love Secret Strategy", "Strategi cinta berasaskan Saju · solo KRW 30,000 / keserasian +KRW 10,000 (jumlah KRW 40,000)"],
        ...
        ["Twelve Growth Animal Oracle", "Haiwan penjaga anda terjaga melalui Twelve Growth Stars dalam Saju · buka kunci KRW 10,000"],
    ...
    },
    {
      ...
      items: [
        ...
        ["Tarot Prompt Library", "Reka soalan + cabut kad + susun ayat oracle · KRW 5,000 setiap guna · 63 spread", "Tarot Prompt Library"],
        ["Warm Sun Healing Tarot", "Suhu emosi dan rutin pemulihan · Percuma"],
        ["Self-Esteem Level Up", "5 kad untuk menegakkan diri semula · Percuma"],
        ["Reunion Lighthouse Tarot", "Jarak selamat untuk bersambung semula · KRW 5,000"],
        ["Twelve Zodiac Heaven Luck", "Ritma penjaga dua belas bulan · KRW 3,000"],
        ["Crystal Soul Tarot", "Bacaan tekstur batu dan kad · KRW 5,000"],
        ["Mind Scan Tarot", "Membaca jarak antara kata luar dan perasaan dalaman · KRW 5,000"],
        ["Celestial Harmony", "Bacaan kosmik planet 11 kad · KRW 10,000"],
        ["Career Change Destiny Cards", "Spread kerjaya 7 kad · KRW 5,000"],
      ],
    },
    {
      title: "Oracle & mimpi",
      items: [
        ["Hwatu Oracle of Card Masters", "Nasib 12 bulan dengan kad Hwatu"],
        ["Hwatu Life Card Test", "Ujian psikologi 7 soalan bertema card master"],
        ["IFA Oracle", "Oracle Yoruba 256 Odu · KRW 3,000"],
        ["Ancient Egyptian Oracle", "Bacaan oracle Kemet"],
        ["I Ching Turtle Oracle", "Bacaan simbolik 64 hexagram"],
        ["Sukuyo Astrology", "Servis asas percuma · keserasian KRW 5,000"],
        ["Stonehenge Rune Oracle", "Bacaan simbol rune purba"],
        ["Geomancy Earth Oracle", "Oracle 16 baris tanda bumi"],
        ["Tasseography Tea Leaf Oracle", "Bacaan corak cawan diraja London"],
        ["Destiny Poker", "Duel kad takdir bersama para dewa"],
        ["Dream Prompt", "Prompt AI daripada ayat mimpi"],
        ["Psychoanalytic Dream Reading", "Tafsiran dari sudut Freud"],
      ],
    },
    {
      ...
      items: [
        ...
        ["AI Animal Face Reading", "Analisis bentuk wajah selfie"],
        ["MBTI Animal Compatibility", "Analisis kimia 16 jenis"],
        ["Animal Totem", "Mesej haiwan penjaga"],
        ["Destiny Flower", "Atelier bersepadu"],
        ["Astrology Flower", "Visualisasi tema nebula"],
        ["Zi Wei Flower", "Laporan tema life palace"],
        ["Sukuyo Flower", "Bunga berdasarkan fasa bulan"],
      ],
    },
  ],
};
