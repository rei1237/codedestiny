...
export const PAID_SERVICE_RUNTIME_SRC = "/js/destiny-profile.js?v=build-d1697646a65e";
      ...
      const runtimePaymentResult = await runPaidServiceRuntimePayment(input, {
        ...
        passOutcomeNote: toText(initialSnapshot?.source) === "pass_budget_exhausted"
          ? checkoutEntry.text(
            ...
            "이용권 월 한도를 모두 사용했어요. 이용권은 만료일까지 등급과 프로필 상한이 유지되며, 추가 콘텐츠는 단건 결제나 월정석으로 이용할 수 있어요.",
          )
          : "",
      });
