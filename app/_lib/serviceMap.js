...
const DESTINY_BIAS_LOCALIZED = {
  en: {
    ...
    landingPoints: ["My Saju x bias resonance score", "Elemental support and Ten Gods roles", "Free reading card"],
  },
  ja: {
    ...
    landingPoints: ["私の四柱推命 × 推しの共鳴スコア", "五行補完と十神の役割", "無料の分析カード"],
  },
  "zh-CN": {
    ...
    landingPoints: ["我的四柱 × 本命共鸣分数", "五行补足与十神角色", "免费分析卡"],
  },
  "zh-TW": {
    ...
    landingPoints: ["我的四柱 × 本命共鳴分數", "五行補足與十神角色", "免費分析卡"],
  },
  vi: {
    ...
    landingPoints: ["Điểm cộng hưởng Saju x bias", "Bù đắp Ngũ hành và vai trò Thập Thần", "Thẻ đọc miễn phí"],
  },
  hi: {
    ...
    landingPoints: ["मेरी Saju x bias resonance score", "तत्वीय सहारा और दश देव भूमिकाएँ", "मुफ्त reading card"],
  },
  es: {
    ...
    landingPoints: ["Puntuación de resonancia Saju x bias", "Apoyo elemental y roles de Diez Dioses", "Tarjeta de lectura gratuita"],
  },
  fr: {
    ...
    landingPoints: ["Score de résonance Saju x bias", "Soutien des éléments et rôles des Dix Dieux", "Carte de lecture gratuite"],
  },
  de: {
    ...
    landingPoints: ["Saju x Bias Resonanzscore", "Elementare Unterstützung und Rollen der Zehn Götter", "Kostenlose Lesekarte"],
  },
  nl: {
    ...
    landingPoints: ["Saju x bias resonantiescore", "Elementaire steun en rollen van Ten Gods", "Gratis lezingkaart"],
  },
  ms: {
    ...
    landingPoints: ["Skor resonans Saju x bias", "Sokongan unsur dan peranan Ten Gods", "Kad bacaan percuma"],
  },
};
