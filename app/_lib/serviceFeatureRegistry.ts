...
type ServiceFeatureLocale = "ko" | "en" | "ja" | "zh-CN" | "zh-TW";
...
const SERVICE_FEATURE_LOCALES: ServiceFeatureLocale[] = ["ko", "en", "ja", "zh-CN", "zh-TW"];
...
const FEATURE_DEFINITIONS: ServiceFeatureDefinition[] = ([
  ...
  },
  {
    ...
    // premium-ziwei 가격표도 2026-09-12 에 레지스트리에서 삭제됨)
    // 이 라우트의 유료 요소는 페이지 안쪽의 전문가 상담·PDF(ziwei-deep-pdf) 회당 결제뿐이다.
    // 무료 항목은 featureKey 를 갖지 않는다.
    accessType: "free",
  },
  {
    slug: "sukyo",
