...
const FEATURES: ServiceFeature[] = ([
  ...
  },
  {
    slug: "saju-animal",
    title: "사주 십이운성 동물점",
    subtitle: "십이운성을 동물 캐릭터로 해석하는 체험형 사주 콘텐츠",
    description:
      "일간과 지지 조합으로 십이운성 흐름을 계산하고, 이를 동물 캐릭터 중심으로 해석해 성격/연애/진로 포인트를 안내합니다.",
    category: "fun",
    image: "/fuctionassets/%EB%8F%99%EB%AC%BC%EC%A0%90%ED%85%8C%EC%8A%A4%ED%8A%B8.webp",
    heroImageAlt: "사주 십이운성 동물점 대표 이미지",
    detailRoute: "/services/saju-animal",
    launchRoute: "/saju/animal-destiny",
    accessType: "paid",
    featureKey: "animal-destiny-unlock",
    tags: ["십이운성", "사주 동물점", "동물 캐릭터", "성향 분석"],
    highlights: ["캐릭터형 결과", "해금형 콘텐츠"],
    howItWorks: [
      { title: "출생 정보 입력", description: "기본 사주 입력값을 등록합니다." },
      { title: "십이운성 계산", description: "일간/지지 조합으로 단계값을 계산합니다." },
      { title: "동물 결과 확인", description: "동물 캐릭터와 해석 리포트를 확인합니다." },
    ],
    resultExamples: [
      { title: "대표 동물", description: "나의 기본 에너지 캐릭터" },
      { title: "연애/관계 특징", description: "관계 반응과 대화 스타일" },
      { title: "진로 기질", description: "일하는 방식과 강점 요약" },
    ],
    seo: {
      title: "사주 십이운성 동물점 소개 | Code Destiny",
      description: "십이운성 계산을 동물 캐릭터로 풀어낸 사주 동물점 서비스 소개 페이지입니다.",
      keywords: ["십이운성", "사주 동물점", "동물 사주", "성향 테스트"],
    },
  },
  {
