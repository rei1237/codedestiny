...
const FEATURES: ServiceFeature[] = ([
  ...
  },
  {
    ...
    description:
      "자미두수의 12궁 구조와 주요 성요 조합을 기반으로 인생 테마, 관계 패턴, 진로 흐름을 입체적으로 분석합니다.",
    category: "ziwei",
    ...
    howItWorks: [
      ...
      { title: "해석 확인", description: "핵심 궁 해석과 심화 리포트 확장 옵션 확인" },
    ],
    resultExamples: [
      { title: "핵심 궁 요약", description: "명궁·재백궁·관록궁의 핵심 포인트" },
      { title: "관계 흐름", description: "인연 패턴과 커뮤니케이션 스타일" },
      { title: "직업 적성", description: "성요 조합 기반 역할·직무 힌트" },
    ],
    premiumOptions: [],
    seo: {
  ...
  },
  {
    ...
    description:
      "내 본명숙과 상대 본명숙을 바탕으로 관계 타입, 거리, 레이더 지수, 관계 목적별 조언을 엽니다.",
    category: "astrology",
  ...
  },
  {
    ...
    description:
      "인도 전통 조티쉬(Jyotish)의 라그나와 나크샤트라, 다샤 위로 인생의 장기 흐름이 드러납니다.",
    category: "astrology",
  ...
  },
  {
    ...
    description:
      "타로 상징과 스프레드의 흐름 속에서 현재의 감정과 선택의 실마리가 강하게 떠오릅니다.",
    category: "tarot",
  ...
  },
  {
    ...
    description:
      "십이운성 동물점이 아닌, 생년월일의 일주와 오행 기운으로 지금 나를 지키는 가디언 상징을 카드형으로 안내합니다.",
    category: "fun",
    ...
    howItWorks: [
      ...
      { title: "일주 계산", description: "생년월일에서 60갑자 가디언 좌표를 엽니다." },
      { title: "가디언 카드 확인", description: "현재 필요한 수호 메시지와 해석 카드를 확인합니다." },
    ],
    resultExamples: [
      { title: "일주 가디언", description: "내 일주가 부르는 가디언 상징" },
      { title: "오행 기운", description: "가디언 카드에 깃든 원소의 흐름" },
      { title: "현재 메시지", description: "지금 필요한 수호의 한 줄 조언" },
    ],
    seo: {
  ...
  },
  {
    ...
    howItWorks: [
      { title: "출생 정보 입력", description: "생년월일시와 기본 프로필을 입력합니다." },
      { title: "자미두수 명반 계산", description: "로컬 자미두수 엔진으로 명궁, 신궁, 12궁, 사화, 대한 데이터를 먼저 계산합니다." },
    ...
    resultExamples: [
      ...
      { title: "대한·유년 전략", description: "앞으로 열리는 운의 흐름과 선택 기준" },
    ],
    seo: {
