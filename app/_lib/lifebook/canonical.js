...
export const LIFEBOOK_CHAPTERS = [
  ...
  { id: 2, title: "🧬 나의 설계도 — 일간·월지·신강신약·조후", purpose: "일간/월지/신강신약/조후를 연결해 기본 작동 방식 분석" },
  { id: 3, title: "⚔️ 숨겨진 무기 — 용신·희신·기신", purpose: "용신·희신·기신의 계산 근거와 실전 전략" },
  { id: 4, title: "🌀 대운 정밀 분석", purpose: "대운 방향/시작나이/현재·전후 대운 비교와 원국 상호작용" },
  { id: 5, title: "👑 사회적 소명과 직업 방향", purpose: "십성 분포와 월주 중심의 직업·사회성 전략" },
  { id: 6, title: "🤝 관계의 전략", purpose: "비겁·식상·재성·관성·인성 기반의 관계 패턴과 경계 전략" },
  { id: 7, title: "💑 연애·결혼 완전 분석", purpose: "배우자성/일지/합충형파해 기반 연애·결혼 전략" },
  { id: 8, title: "💰 재물·직업 완전 전략", purpose: "재성/식상생재/누수 패턴 중심의 재물 전략" },
  { id: 9, title: "🏥 건강·심신 에너지", purpose: "오행 과부족 기반 생활 리듬과 회복 전략" },
  { id: 10, title: "🔮 신살·12운성·합충형파해", purpose: "감지된 신살/12운성/합충형파해만 해설" },
  { id: 11, title: "📅 2026 병오년 로드맵", purpose: "2026 세운과 원국·대운 결합 분석 및 월별 Go/Hold/Retreat" },
  { id: 12, title: "🌅 생애 마스터플랜", purpose: "원국+용신+대운+세운 통합 10년 전략" },
  { id: 13, title: "💌 거장의 최종 전략 제언", purpose: "핵심 기운/반복 패턴/90일 실행 플랜 최종 제언" },
];
