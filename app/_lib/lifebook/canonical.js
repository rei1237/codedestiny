const LIFEBOOK_CANONICAL_TEXT_TRANSLATIONS = {
  ko: {
    "lifebookCanonical.chapterTitle01": "사주 원국 완전 해설 - 팔자 8글자의 비밀",
    "lifebookCanonical.chapterTitle02": "나의 설계도 - 월지·일간·조후와 기질의 뿌리",
    "lifebookCanonical.chapterTitle03": "숨겨진 무기 - 용신·희신과 나만의 필살기",
    "lifebookCanonical.chapterTitle04": "대운 정밀 분석 - 인생의 큰 파도",
    "lifebookCanonical.chapterTitle05": "격국과 사회적 소명 - 나의 성공 방정식",
    "lifebookCanonical.chapterTitle06": "관계의 전략 - 인연의 법칙과 파트너십",
    "lifebookCanonical.chapterTitle07": "연애·결혼 완전 분석 - 사주가 말하는 나의 사랑",
    "lifebookCanonical.chapterTitle08": "재물·직업 완전 전략 - 부의 그릇을 키우는 천기",
    "lifebookCanonical.chapterTitle09": "건강·심신 에너지 완전 분석 - 오행으로 보는 회복법",
    "lifebookCanonical.chapterTitle10": "가족·뿌리·내면 아이 - 내가 짊어진 오래된 이야기",
    "lifebookCanonical.chapterTitle11": "인생의 위기와 전환점 - 무너질 때 다시 서는 법",
    "lifebookCanonical.chapterTitle12": "나만의 성공 루틴 - 운을 현실로 바꾸는 실행법",
  },
};

function lifebookCanonicalText(key) {
  return LIFEBOOK_CANONICAL_TEXT_TRANSLATIONS.ko[key] || "Translation pending";
}
...
export const LIFEBOOK_CHAPTERS = [
  { id: 1, title: lifebookCanonicalText("lifebookCanonical.chapterTitle01"), purpose: "년주/월주/일주/시주와 지장간, 합충형파해를 원국 중심으로 해설" },
  { id: 2, title: lifebookCanonicalText("lifebookCanonical.chapterTitle02"), purpose: "월지 환경과 조후를 중심으로 한 기본 작동 방식 분석" },
  { id: 3, title: lifebookCanonicalText("lifebookCanonical.chapterTitle03"), purpose: "용신·희신·기신의 계산 근거와 실전 전략" },
  { id: 4, title: lifebookCanonicalText("lifebookCanonical.chapterTitle04"), purpose: "대운 방향/시작나이/현재·전후 대운 비교와 원국 상호작용" },
  { id: 5, title: lifebookCanonicalText("lifebookCanonical.chapterTitle05"), purpose: "십성 분포와 월주 중심의 직업·사회성 전략" },
  { id: 6, title: lifebookCanonicalText("lifebookCanonical.chapterTitle06"), purpose: "비겁·식상·재성·관성·인성 기반의 관계 패턴과 경계 전략" },
  { id: 7, title: lifebookCanonicalText("lifebookCanonical.chapterTitle07"), purpose: "배우자성/일지/합충형파해 기반 연애·결혼 전략" },
  { id: 8, title: lifebookCanonicalText("lifebookCanonical.chapterTitle08"), purpose: "재성/식상생재/누수 패턴 중심의 재물 전략" },
  { id: 9, title: lifebookCanonicalText("lifebookCanonical.chapterTitle09"), purpose: "오행 과부족 기반 생활 리듬과 회복 전략" },
  { id: 10, title: lifebookCanonicalText("lifebookCanonical.chapterTitle10"), purpose: "가족 영향과 독립 과제의 현실 해석" },
  { id: 11, title: lifebookCanonicalText("lifebookCanonical.chapterTitle11"), purpose: "위기 신호 분석과 현실 대응 전략" },
  { id: 12, title: lifebookCanonicalText("lifebookCanonical.chapterTitle12"), purpose: "하루 루틴부터 1년 계획까지 실행 설계" },
];
