...
const PAGE_DESCRIPTION =
  "인도 조티쉬 전통의 나크샤트라와 행성 배치, 다샤 주기로 지금의 질문을 읽는 베다 점성술 상담입니다. 달이 머문 나크샤트라와 현재의 다샤 흐름을 풀어 드립니다.";
...
const vedicAiFaqItems = [
  ...
  },
  {
    ...
    answer:
      "나크샤트라는 달의 길을 27개의 별자리 구간으로 나눈 체계입니다. 태어난 순간 달이 머문 나크샤트라는 마음이 반응하는 방식과 기질을 살펴보는 단서이며, 베다 전통에서는 궁합과 이름 짓기에도 활용됩니다.",
  },
  {
...
const vedicAiJsonLd = [
  buildServiceJsonLd({
    ...
    offer: buildKrwOffer("vedic-ai-consultation", PAGE_PATH),
  }),
    ...
    <>
      ...
      />
        ...
        <p>
          ...
          달이 머문 나크샤트라의 결, 행성들의 배치, 지금 지나는 다샤의 주기를 함께 읽습니다.
