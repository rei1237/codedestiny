...
const MUSIC_COPY = {
  ko: {
    ...
    mute: "음소거",
    unmute: "음소거 해제",
    repeat: (mode: RepeatMode): string => (mode === "one" ? "한 곡 반복" : mode === "all" ? "전체 반복" : "반복 꺼짐"),
    shuffleOn: "셔플 켜짐",
    shuffleOff: "셔플 꺼짐",
    share: "공유",
    copied: "복사됨",
  ...
  en: {
    ...
    mute: "Mute",
    unmute: "Unmute",
    repeat: (mode: RepeatMode): string => (mode === "one" ? "Repeat one" : mode === "all" ? "Repeat all" : "Repeat off"),
  ...
  ja: {
    ...
    mute: "ミュート",
    unmute: "ミュート解除",
    repeat: (mode: RepeatMode): string => (mode === "one" ? "1曲リピート" : mode === "all" ? "全曲リピート" : "リピート オフ"),
    shuffleOn: "シャッフル オン",
    shuffleOff: "シャッフル オフ",
    share: "共有",
    copied: "コピー済み",
  ...
  "zh-CN": {
    ...
    mute: "静音",
    unmute: "取消静音",
    repeat: (mode: RepeatMode): string => (mode === "one" ? "单曲循环" : mode === "all" ? "全部循环" : "循环关闭"),
    shuffleOn: "随机播放：开",
    shuffleOff: "随机播放：关",
    share: "分享",
    copied: "已复制",
  ...
  "zh-TW": {
    ...
    mute: "靜音",
    unmute: "取消靜音",
    repeat: (mode: RepeatMode): string => (mode === "one" ? "單曲循環" : mode === "all" ? "全部循環" : "循環關閉"),
    shuffleOn: "隨機播放：開",
    shuffleOff: "隨機播放：關",
    share: "分享",
    copied: "已複製",
