  ...
  return (
    <div className="policy-embed-body">
      ...
      <section className="policy-embed-section">
        ...
        <p>
          서비스는 원활한 기능 제공과 이용 패턴 분석을 위해 쿠키 및 유사 기술을 사용할 수 있습니다. Google AdSense 등 제3자 파트너가 광고 제공 목적으로 쿠키를 사용할 수 있으며, 이용자는 브라우저 설정 및 Google 광고 설정 페이지를 통해 맞춤 광고를 관리할 수 있습니다.
        </p>
        <p>
      ...
      <section className="policy-embed-section">
        <h3 className="policy-embed-h3">13. 사업자 정보 및 코인 환불 정책</h3>
        ...
        <p><strong>코인 충전형 디지털 운세 서비스 환불 기준</strong></p>
        <p>
        ...
        <p style={{ marginTop: "10px" }}>
          ...
          <br />
          <strong>환불 처리는 결제 수단(카드)으로만 가능합니다.</strong>
        </p>
      </section>
    </div>
  );
