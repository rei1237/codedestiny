...
export const PRIVACY_POLICY_SECTIONS = [
  ...
  },
  {
    ...
    body: (
      <p>
        Code Destiny는 만 14세 미만 아동의 개인정보를 처리할 때 개인정보 보호법 제22조의2에 따라 법정대리인(보호자)의 동의를 받습니다. 가입 시 보호자 이메일로 수집·이용 내역과 동의 링크를 보내고, 보호자가 동의를 완료해야 계정이 활성화됩니다. 동의 확인을 위해 보호자의 이메일 주소와 동의 일시·IP를 최소한으로 수집·보관하며, 만 14세 미만 계정은 유료 결제를 이용할 수 없습니다. 보호자는 언제든 아래 문의처로 동의 철회 및 아동 개인정보 삭제를 요청할 수 있고, 동의 없이 아동의 개인정보가 수집되었다고 판단되면 알려 주십시오. 확인 후 필요한 삭제 조치를 진행합니다.
      </p>
    ),
  },
  {
