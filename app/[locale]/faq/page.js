...
export async function generateMetadata({ params }) { return trustMetadata(await getLocale(params), "faq"); }
export default async function Page({ params }) { return <LocalizedTrustPage locale={await getLocale(params)} pageKey="faq" />; }
