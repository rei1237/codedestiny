...
export async function generateMetadata({ params }) { return trustMetadata(await getLocale(params), "contact"); }
export default async function Page({ params }) { return <LocalizedTrustPage locale={await getLocale(params)} pageKey="contact" />; }
