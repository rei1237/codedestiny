    ...
    <>
      ...
      <ServiceIntroSection label="사용자 리뷰 정책 안내">
        ...
        <ol>
          ...
          <li>승인되어 공개되는 순간, 후기를 남긴 계정으로 월정석 100개가 자동 지급됩니다.</li>
        </ol>
        <p>
          후기 작성 보상은 월정석 100개입니다. 월정석 1개는 1,000원의 100분의 1인 10원 상당이므로
          후기 한 건에 1,000원 상당이 지급되는 셈이고, 상품별로 한 번씩 받을 수 있습니다. 지급은
          운영진 승인 시점에 이루어지며, 반려되거나 숨김 처리된 후기에는 지급되지 않습니다. 월정석은
          구매하거나 충전할 수 없는 보너스 혜택이고 받은 날로부터 30일간 유효하니, 지급받은 뒤에는
          기한 안에 사용해 주세요. 지급 내역은 포인트 페이지의 월정석 사용 내역에서 확인할 수 있습니다.
        </p>
        <p>
