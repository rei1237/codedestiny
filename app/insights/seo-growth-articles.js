...
const CATEGORY_LINKS = {
  ...
  "타로": [
    ...
    { href: "/tarot/reunion", label: "재회운 타로 보기" },
  ...
  "베다점성술": [
    { href: "/vedic", label: "베다점성술 차트 보기" },
    { href: "/astrology", label: "서양 점성술과 비교하기" },
    { href: "/saju", label: "사주와 함께 비교 분석하기" },
  ],
};
...
function article({ slug, title, description, category, keywords, topic, angle, ctaTitle }) {
  const internalLinks = CATEGORY_LINKS[category] || [{ href: "/insights", label: "운세 인사이트 더 보기" }];
  return {
    slug,
    title,
    description,
...
const ZIWEI = [
  ...
  article({ slug: "ziwei-chart-guide", title: "자미두수 명반 보는 법: 명궁부터 12궁까지 초보자 가이드", description: "자미두수 명반에서 명궁과 12궁을 읽는 순서를 제공합니다.", category: "자미두수", keywords: ["자미두수 명반", "자미두수 보는 법", "자미두수 12궁"], topic: "자미두수 명반", angle: "명궁과 궁위 해석", ctaTitle: "자미두수 12궁 분석하기" }),
  ...
  article({ slug: "ziwei-wealth-career", title: "자미두수 재물운과 직업운: 재백궁·관록궁 보는 법", description: "재백궁과 관록궁을 중심으로 재물과 직업 흐름을 읽습니다.", category: "자미두수", keywords: ["자미두수 재물운", "자미두수 직업운", "재백궁", "관록궁"], topic: "재백궁과 관록궁", angle: "커리어와 수입", ctaTitle: "자미두수 프리미엄 PDF 보기" }),
...
const SUKUYO = [
  ...
  article({ slug: "sukuyo-bonmyeongsuk-vs-wolmyeongsuk", title: "본명숙과 월명숙 차이: 숙요점 해석에서 무엇이 더 중요할까", description: "본명숙과 월명숙 차이와 사용 시점을 설명합니다.", category: "숙요점", keywords: ["본명숙", "월명숙", "숙요점"], topic: "본명숙과 월명숙", angle: "해석 우선순위", ctaTitle: "숙요점 궁합 바로 보기" }),
...
const SAJU = [
  ...
  article({ slug: "ten-gods-career-relationship", title: "십성으로 보는 관계와 직업: 비겁·식상·재성·관성·인성", description: "십성 해석을 관계와 직업 의사결정에 적용합니다.", category: "사주", keywords: ["십성", "관계", "직업운", "사주"], topic: "십성", angle: "역할 분류", ctaTitle: "무료 사주풀이 시작하기" }),
  ...
  article({ slug: "daewoon-vs-sewoon", title: "대운과 세운 차이: 10년 흐름과 연간 흐름을 함께 읽는 법", description: "대운과 세운 차이를 실전 일정 계획으로 연결합니다.", category: "사주", keywords: ["대운", "세운", "사주"], topic: "대운과 세운", angle: "시기 해석", ctaTitle: "무료 사주풀이 시작하기" }),
