...
export default function WorldPage() {
  return (
    <main className="cd-main-shell">
      ...
      <EditorNote note={getEditorNote("/world")} className="cd-editor-note" />

      <section aria-labelledby="cd-world-characters">
        <h2 id="cd-world-characters" className="cd-world-h2">인물</h2>
        <div className="cd-card-grid cd-world-characters">
          {CHARACTERS.map((character) => (
            <article key={character.id} id={character.id} className="cd-card cd-world-character">
      ...
      <section aria-labelledby="cd-world-places">
      ...
      <section aria-labelledby="cd-world-usage">
