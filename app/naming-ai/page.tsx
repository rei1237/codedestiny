    ...
    <>
      ...
      />
        ...
        <ul>
          ...
          <li>
            <strong>소리오행</strong> — 한글 자음이 갖는 오행(어금닛소리 목, 혓소리 화, 입술소리 토,
            잇소리 금, 목구멍소리 수)으로 이름을 부를 때 실제로 울리는 기운을 봅니다. 매일 불리는
            소리라 체감이 가장 큽니다.
          </li>
          <li>
            <strong>수리오행</strong> — 한자 획수의 조합이 만드는 원형·이격·정격의 수리를 봅니다.
            성씨 획수가 고정되어 있어 이름 글자의 획수 선택 폭이 여기서 좁혀집니다.
          </li>
          <li>
