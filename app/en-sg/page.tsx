export const metadata = {
  title: "Code Destiny | Free Tarot & Fortune (Singapore)",
  description:
    "Code Destiny offers free tarot experiences and fortune insights. This page is tailored for Singapore (en-SG) to strengthen regional SEO signals.",
  alternates: {
    canonical: "/en-sg",
  },
  openGraph: {
    title: "Code Destiny | Free Tarot & Fortune (Singapore)",
    description: "Free tarot experiences and fortune insights for Singapore (en-SG).",
    url: "https://code-destiny.com/en-sg",
    siteName: "Code Destiny",
    type: "website",
  },
};

export default function EnSgLanding() {
  return (
    <main style={{ maxWidth: "960px", margin: "0 auto", padding: "28px 16px 52px", color: "#e2e8f0" }}>
      <h1 style={{ fontSize: "34px", fontWeight: 800, marginBottom: "10px" }}>
        Code Destiny — Free Tarot & Fortune (Singapore)
      </h1>
      <p style={{ opacity: 0.9, lineHeight: 1.75, marginBottom: "18px" }}>
        Explore tarot healing experiences and fortune insights. This page is tailored for Singapore (en-SG) to help
