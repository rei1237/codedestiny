...
export default function RootLayout({ children }) {
  return (
    <html lang="ko" dir="ltr" className={notoSansKRVariable}>
      <head>
        <Script src="/js/core/pass-verdict.js?v=build-c8d0f674b6e7" strategy="beforeInteractive" />
        ...
        <Script src="/js/core/checkout-entry.js?v=build-c8d0f674b6e7" strategy="beforeInteractive" />
