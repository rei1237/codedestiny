...
export default function RootLayout({ children }) {
  return (
    <html lang="ko" dir="ltr" className={notoSansKRVariable}>
      <head>
        <Script src="/js/core/pass-verdict.js?v=build-bb27a61d19c6" strategy="beforeInteractive" />
        ...
        <Script src="/js/core/checkout-entry.js?v=build-bb27a61d19c6" strategy="beforeInteractive" />
