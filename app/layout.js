...
export default function RootLayout({ children }) {
  return (
    <html lang="ko" dir="ltr" className={notoSansKRVariable}>
      <head>
        <Script src="/js/core/pass-verdict.js?v=build-04d05c157213" strategy="beforeInteractive" />
        ...
        <Script src="/js/core/checkout-entry.js?v=build-04d05c157213" strategy="beforeInteractive" />
