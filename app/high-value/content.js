    ...
    faq: [
      {
        ...
        answer: "연월일시 네 기둥의 구조를 확인한 뒤 오행 분포, 일간, 십성, 대운 순서로 읽으면 흐름을 놓치기 어렵습니다.",
      },
      {
        question: "오행이 부족하면 무조건 나쁜가요?",
        answer: "부족함 자체가 길흉을 확정하지 않습니다. 계절, 조합, 생활 환경과 함께 균형을 보는 것이 중요합니다.",
      },
      {
        question: "만세력 결과는 매번 같아야 하나요?",
        answer: "생년월일시와 달력 기준이 같다면 명식은 같아야 합니다. 다만 해석 문장은 관점과 질문에 따라 달라질 수 있습니다.",
      },
    ],
    sections: [
      {
        h2: "사주팔자를 읽는 기본 순서",
        paragraphs: [
          "사주팔자는 태어난 연, 월, 일, 시를 네 기둥으로 정리하고 그 안의 천간과 지지를 읽는 체계입니다. 처음에는 좋은지 나쁜지보다 어떤 요소가 반복되고 어떤 요소가 약한지 확인하는 것이 좋습니다.",
          "일간은 해석의 중심이 되고, 오행은 기질과 에너지의 분포를 보여줍니다. 십성은 관계, 일, 책임, 표현 방식처럼 현실의 장면과 연결해 볼 수 있는 언어입니다.",
        ],
      },
      {
        h2: "결과를 생활에 연결하는 방법",
        paragraphs: [
          "운세 결과를 읽은 뒤에는 한 문장으로 실행할 수 있는 관찰 포인트를 남기는 것이 좋습니다. 예를 들어 이번 달에는 감정 소모가 큰 약속을 줄이고 회복 시간을 확보한다처럼 행동으로 옮길 수 있어야 합니다.",
          "사주는 결정을 대신하는 도구가 아니라 선택 기준을 정리하는 참고 자료입니다. 기록과 실제 경험을 함께 비교하면 해석의 효용을 더 건강하게 판단할 수 있습니다.",
        ],
      },
    ],
  },
