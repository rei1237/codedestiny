...
export default function YeonStarHugPage() {
  return (
    <main className="min-h-screen bg-rose-50 px-5 py-10 text-slate-700">
      <section className="mx-auto max-w-3xl rounded-3xl border border-white/70 bg-white/80 p-6 shadow-sm">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-rose-400">Yeon Star Hug</p>
        <h1 className="mt-3 text-3xl font-black text-slate-800">연이의 마음 별자리</h1>
