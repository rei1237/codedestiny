...
const APP_SHELL_COPY: Partial<Record<LoadingLocale, AppShellCopy>> = {
  ...
  ja: {
    ...
    passTerminationNote: "月の利用上限が0になっても、パスの満了日・等級・プロフィール上限は維持されます。追加の有料コンテンツは単品決済または月精石で利用できます。",
  },
  "zh-CN": {
    ...
    passTerminationNote: "每月额度为0后，通行证的到期日、等级和个人资料上限仍保持不变。额外付费内容可通过单次付款或月精石使用。",
  },
  "zh-TW": {
    ...
    passTerminationNote: "每月額度為0後，通行證的到期日、等級和個人資料上限仍維持不變。額外付費內容可透過單次付款或月精石使用。",
  },
  vi: {
