...
export interface AppShellCopy {
  ...
  purchaseDisabledTitle: string;
  purchaseDisabledBody: string;
  retryButton: string;
...
const APP_SHELL_COPY_EN: AppShellCopy = {
  ...
  purchaseDisabledTitle: "New Google Play pass purchases have been discontinued.",
  purchaseDisabledBody: "Pass products can only be purchased through one-time web PG payment. Moonstones cannot be used to buy a pass.",
...
const APP_SHELL_COPY: Partial<Record<LoadingLocale, AppShellCopy>> = {
  ko: {
    ...
    purchaseDisabledTitle: "Google Play 이용권 신규 구매는 중단되었습니다.",
    purchaseDisabledBody: "이용권 상품은 웹 PG 단건 결제로만 구매할 수 있습니다. 월정석으로는 이용권을 구매할 수 없습니다.",
    retryButton: "다시 시도",
    recommendedBadge: "추천",
  ...
  ja: {
    ...
    purchaseDisabledTitle: "Google Play利用券の新規購入は中止されました。",
    purchaseDisabledBody: "利用券商品はウェブPGの都度決済でのみ購入できます。月精石では利用券を購入できません。",
    retryButton: "再試行",
  ...
  "zh-CN": {
    ...
    purchaseDisabledTitle: "Google Play使用权新购已停止。",
    purchaseDisabledBody: "使用权商品只能通过网页PG单次支付购买。月精石无法用于购买使用权。",
    retryButton: "重试",
    recommendedBadge: "推荐",
    verifyingButton: "确认中",
  ...
  "zh-TW": {
    ...
    purchaseDisabledTitle: "Google Play使用權新購已停止。",
    purchaseDisabledBody: "使用權商品僅能透過網頁PG單次付款購買。月精石無法用於購買使用權。",
    retryButton: "重試",
    recommendedBadge: "推薦",
    verifyingButton: "確認中",
  ...
  vi: {
    ...
    purchaseDisabledTitle: "Việc mua mới vé sử dụng qua Google Play đã bị ngừng.",
    purchaseDisabledBody: "Sản phẩm vé sử dụng chỉ có thể mua qua thanh toán một lần trên web PG. Không thể dùng đá trăng để mua vé sử dụng.",
    retryButton: "Thử lại",
  ...
  hi: {
    ...
    purchaseDisabledTitle: "Google Play पास की नई खरीद बंद कर दी गई है।",
    purchaseDisabledBody: "पास उत्पाद केवल वेब PG एकमुश्त भुगतान से खरीदे जा सकते हैं। मूनस्टोन से पास नहीं खरीदा जा सकता।",
  ...
  es: {
    ...
    purchaseDisabledTitle: "Las nuevas compras de pase de Google Play se han discontinuado.",
    purchaseDisabledBody: "Los productos de pase solo se pueden comprar mediante pago único en la web PG. No se pueden usar piedras lunares para comprar un pase.",
  ...
  fr: {
    ...
    purchaseDisabledTitle: "Les nouveaux achats de pass Google Play ont été interrompus.",
    purchaseDisabledBody: "Les produits de pass ne peuvent être achetés que via un paiement unique sur le web PG. Les pierres de lune ne peuvent pas être utilisées pour acheter un pass.",
  ...
  de: {
    ...
    purchaseDisabledTitle: "Neue Google Play Pass-Käufe wurden eingestellt.",
    purchaseDisabledBody: "Pass-Produkte können nur über eine einmalige Web-PG-Zahlung gekauft werden. Mondsteine können nicht zum Kauf eines Passes verwendet werden.",
  ...
  nl: {
    ...
    purchaseDisabledTitle: "Nieuwe Google Play-pasaankopen zijn stopgezet.",
    purchaseDisabledBody: "Pasproducten kunnen alleen via eenmalige web-PG-betaling worden gekocht. Maanstenen kunnen niet worden gebruikt om een pas te kopen.",
  ...
  ms: {
    ...
    purchaseDisabledTitle: "Pembelian pas baharu Google Play telah dihentikan.",
    purchaseDisabledBody: "Produk pas hanya boleh dibeli melalui pembayaran sekali web PG. Batu bulan tidak boleh digunakan untuk membeli pas.",
