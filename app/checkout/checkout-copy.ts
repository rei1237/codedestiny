/**
 * 영냥이 Family·단건 결제 화면(`/checkout`)의 화면 문구와 정책 링크.
 *
...
const EN: CheckoutCopy = {
  ...
  methodDirect: "Family Pass or one-time payment",
  rowAmount: "Payment amount",
  policyLine1: "Yeongnyangi consultations accept a Family Pass or a one-time payment.",
  policyLine2: "Other Pass tiers and Moonlight Stone do not apply.",
...
const CHECKOUT_COPY: Partial<Record<LoadingLocale, CheckoutCopy>> = {
  ...
  ko: {
    ...
    rowMethod: "결제 방식",
    methodDirect: "Family 이용권 또는 단건 결제",
    rowAmount: "결제 금액",
    policyLine1: "영냥이 상담은 Family 이용권 또는 단건 결제로 이용해요.",
    policyLine2: "다른 이용권 등급과 월정석은 적용되지 않아요.",
  ...
  ja: {
    ...
    rowMethod: "決済方法",
    methodDirect: "Familyパスまたは単発決済",
    rowAmount: "決済金額",
    policyLine1: "ヨンニャンイの相談はFamilyパスまたは単発決済でご利用いただけます。",
    policyLine2: "他のパス等級と月精石は適用されません。",
  ...
  "zh-CN": {
    ...
    rowMethod: "支付方式",
    methodDirect: "Family 通行券或单次支付",
    rowAmount: "支付金额",
    policyLine1: "灵猫咨询支持 Family 通行券或单次支付。",
    policyLine2: "其他通行券等级和月精石不适用。",
  ...
  "zh-TW": {
    ...
    rowMethod: "付款方式",
    methodDirect: "Family 通行券或單次付款",
    rowAmount: "付款金額",
    policyLine1: "靈貓諮詢支援 Family 通行券或單次付款。",
    policyLine2: "其他通行券等級與月精石不適用。",
