...
const METHODOLOGY_TEXT_TRANSLATIONS = {
  ko: {
    ...
    sections: [
      ...
      {
        title: "계산과 AI의 역할",
        body: "명식·별자리·27수 같은 기초 값은 AI가 아니라 결정론적 계산 엔진이 산출합니다. 같은 생년월일시를 넣으면 언제나 같은 값이 나옵니다. 그 값을 사람이 읽을 수 있는 해설 문장으로 옮기는 단계에서 생성형 AI를 사용하며, 공개 문서는 과장 표현, 불안 조장, 의료·법률·금융 조언으로 오해될 수 있는 문장을 점검 대상으로 삼습니다. 개별 원고의 전문가 검수 여부는 해당 글에 따로 안내합니다. 자세한 제작·검수 기준은 콘텐츠 제작 및 AI 활용 고지에서 확인할 수 있습니다.",
      },
      {
        title: "체계별 계산 근거",
