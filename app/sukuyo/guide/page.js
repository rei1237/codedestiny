...
const flowItems = [
  "생년월일·적용 시각·시간대를 확인한 뒤 달의 항성황경으로 본명숙을 찾고 27숙의 상징을 읽습니다.",
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "현재 Code Destiny는 출생 순간의 달 항성황경을 사용합니다. 생년월일만 입력하면 화면의 기본 시각을 사용한 참고 결과로 읽어야 합니다. 출생시간을 모르면 확정값으로 인용하지 말고, 다른 도구와 비교할 때 시각·시간대와 음력 날짜표 사용 여부를 확인하세요.",
  },
  {
    ...
    <main className="cd-main-shell cd-guide">
      ...
      <section className="cd-card-grid">
        ...
        <article className="cd-card">
          ...
          <p>
            양력·음력·윤달을 구분한 생년월일과 적용 시각·시간대를 확인합니다. 궁합은 두 사람의 정보를 같은 기준으로 비교합니다. 현재 계산기는 라히리 기준 항성 달 황경을 27구간으로 나눕니다. 이름이나 관계 상태는 본명숙의 천문 좌표를 바꾸지 않습니다. 시간 입력이 없는 화면은 기본 시각의 결과이므로 출생시간을 확인한 결과와 구분하세요.
          </p>
        </article>
