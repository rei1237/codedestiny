export const metadata = {
  title: "Code Destiny | Free Tarot & Fortune (Australia)",
  description:
    "Code Destiny offers free tarot experiences and fortune insights. This page is tailored for Australia (en-AU) to strengthen regional SEO signals.",
  alternates: {
    canonical: "/en-au",
  },
  openGraph: {
    title: "Code Destiny | Free Tarot & Fortune (Australia)",
    description: "Free tarot experiences and fortune insights for Australia (en-AU).",
    url: "https://code-destiny.com/en-au",
    siteName: "Code Destiny",
    type: "website",
  },
};

export default function EnAuLanding() {
  return (
    <main style={{ maxWidth: "960px", margin: "0 auto", padding: "28px 16px 52px", color: "#e2e8f0" }}>
      <h1 style={{ fontSize: "34px", fontWeight: 800, marginBottom: "10px" }}>
        Code Destiny — Free Tarot & Fortune (Australia)
      </h1>
      <p style={{ opacity: 0.9, lineHeight: 1.75, marginBottom: "18px" }}>
        Explore tarot healing experiences and fortune insights. This page is tailored for Australia (en-AU) to help
