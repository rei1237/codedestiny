...
export const SCENARIO_DB: Scenario[] = [
  ...
  },
  {
    ...
    type: "답장 템포 차이",
    backgroundEmoji: "📱⏳",
    situationDescription: "늦은 밤, 당신이 보낸 메시지에 한참 뒤 답장이 왔다. 평소와 다른 템포가 어색하게 느껴진다.",
    narrative: "오늘은 서로 바쁜 하루였다. 짧은 오해가 쌓이기 쉬운 타이밍, 말 한 줄의 온도가 분위기를 바꾼다.",
    npcDialogue: (name) => `"미안, 일이 길어졌어. ${name}는 혹시 기다리느라 서운했어?"`,
    choices: [
      {
        id: "c1",
        text: "괜찮아. 네 하루가 어땠는지 먼저 들려줘.",
        element: "수",
        risk: "LOW",
        affinityDelta: 9,
        reaction: (name) => `"고마워… ${name}가 이렇게 말해주면 긴장이 풀려. 오늘 진짜 정신없었어."`,
      },
      {
        id: "c2",
        text: "솔직히 좀 서운했어. 다음엔 한 줄만 먼저 남겨줘.",
        element: "금",
        risk: "MEDIUM",
        affinityDelta: 5,
        reaction: (name) => `"맞아, 그게 맞네. 다음엔 꼭 먼저 남길게. 알려줘서 고마워."`,
      },
      {
        id: "c3",
        text: "원래 이런 식이면 좀 힘들 것 같아.",
        element: "화",
        risk: "HIGH",
        affinityDelta: -3,
        reaction: (name) => `"…그렇게 들릴 수 있구나. 미안한데, 지금은 좀 벅차다."`,
      },
    ],
  },
  {
    ...
    type: "여행 계획 충돌",
    backgroundEmoji: "🧳🗺️",
    situationDescription: "주말 여행을 계획하는데, 당신은 즉흥을 원하고 상대는 일정표를 원한다.",
    narrative: "같은 여행도 스타일이 다르면 작은 디테일에서 갈등이 시작된다. 이번 선택은 두 사람의 운영 방식을 결정한다.",
    npcDialogue: (name) => `"숙소랑 동선은 미리 정하고 싶어. ${name}는 즉흥이 좋아 보이는데… 우리 어떻게 맞출까?"`,
    choices: [
      {
        id: "c1",
        text: "큰 틀만 정하고 세부는 현장에서 같이 정하자.",
        element: "토",
        risk: "LOW",
        affinityDelta: 8,
        reaction: (name) => `"좋아, 그 방식이면 나도 편해. 같이 계획 짜는 것도 재밌겠다."`,
      },
      {
        id: "c2",
        text: "이번엔 네 스타일대로 해보고, 다음엔 내 스타일로 하자.",
        element: "목",
        risk: "LOW",
        affinityDelta: 9,
        reaction: (name) => `"합리적이다. 서로 번갈아 맞추면 불만도 덜하겠다. 딜 성립!"`,
      },
      {
        id: "c3",
        text: "여행인데 그렇게까지 빡빡하면 재미없지 않아?",
        element: "화",
        risk: "HIGH",
        affinityDelta: -2,
        reaction: (name) => `"…내가 통제하려는 사람처럼 보였구나. 좀 신경 쓰이네."`,
      },
    ],
  },
  {
    ...
    type: "친구 경계선",
    backgroundEmoji: "🎉🧩",
    situationDescription: "모임 사진 속에서 상대가 특정 친구와 유난히 가까워 보였다. 마음 한켠이 불편해진다.",
    narrative: "질투와 신뢰는 종이 한 장 차이다. 지금의 질문 방식이 관계의 안전감을 만든다.",
    npcDialogue: (name) => `"아까 모임 사진 보고 마음 쓰였지? ${name} 표정이 좀 달라 보여서…"`,
    choices: [
      {
        id: "c1",
        text: "응, 조금 신경 쓰였어. 나를 안심시킬 수 있게 이야기해줄래?",
        element: "수",
        risk: "LOW",
        affinityDelta: 10,
        reaction: (name) => `"그렇게 말해줘서 고마워. 오해 없게 내가 먼저 설명할게."`,
      },
      {
        id: "c2",
        text: "나도 내 감정 정리해볼게. 우리 내일 차분히 얘기하자.",
        element: "토",
        risk: "LOW",
        affinityDelta: 7,
        reaction: (name) => `"좋아. 피하지 않고 얘기하자는 거지? 그럼 나도 준비해둘게."`,
      },
      {
        id: "c3",
        text: "그냥 네가 그런 스타일인 거겠지. 내가 참아야지 뭐.",
        element: "금",
        risk: "HIGH",
        affinityDelta: -4,
        reaction: (name) => `"그 말은 오히려 더 불안해… 참는다고 해결되는 건 아닌데."`,
      },
    ],
  },
];
