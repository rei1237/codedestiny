        ...
        <div className="relative z-10 grid min-w-0 items-center gap-7 lg:grid-cols-[minmax(0,1fr)_260px]">
          <div className="min-w-0 space-y-4">
            ...
            <m.p
              ...
              className="max-w-2xl whitespace-pre-line text-sm font-semibold leading-relaxed text-[#3b6080] sm:text-base"
            >
              {copy.heroDesc}
            </m.p>
          ...
          >
            <div className="rounded-[1.6rem] border border-[#b8d5ef] bg-white/82 p-5 shadow-[0_14px_34px_rgba(58,111,160,0.2)] backdrop-blur-sm">
              <p className="text-xs font-black tracking-[0.12em] text-[#41698f]">{copy.sideCardLabel}</p>
              <p className="mt-2 whitespace-pre-line text-sm font-semibold leading-relaxed text-[#355e83]">
                {copy.sideCardDesc}
              </p>
