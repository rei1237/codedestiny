...
export default function AnimalDestinyInputForm({ input, onChange, onSubmit, isBusy, canSubmit }: Props) {
  ...
  return (
    <section className="space-y-6 rounded-[2.2rem] border border-[#d6c6a7] bg-[linear-gradient(160deg,#fffdf9_0%,#f3f9ff_100%)] p-5 text-[#2a425d] shadow-[0_18px_48px_rgba(28,53,83,0.16)] sm:p-8">
      ...
      <div className="grid gap-2 text-[11px] font-black sm:grid-cols-3">
        <div className="rounded-xl border border-[#dfc898] bg-[#fff5df] px-3 py-2 text-[#7f5822]">해금: 100코인</div>
        <div className="rounded-xl border border-[#b8d8dd] bg-[#eaf8f7] px-3 py-2 text-[#295867]">분석: 약 20초</div>
        <div className="rounded-xl border border-[#cfd8f2] bg-[#eef2ff] px-3 py-2 text-[#314f7a]">궁합 리딩 포함</div>
      </div>
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <label className="space-y-2 text-sm font-bold text-[#2d4966]">
          ...
          <input
            ...
            placeholder="예: 별빛여우"
            className="w-full rounded-2xl border border-[#c7d7e7] bg-white px-4 py-3 text-base text-[#284662] placeholder:text-[#89a2bb] shadow-[inset_0_1px_0_rgba(255,255,255,0.65)] transition-all focus:border-[#3d7e93] focus:outline-none"
          />
        </label>
        ...
        <label className="space-y-2 text-sm font-bold text-[#2d4966]">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-[#c7d7e7] bg-white px-4 py-3 text-base text-[#284662] shadow-[inset_0_1px_0_rgba(255,255,255,0.65)] transition-all focus:border-[#3d7e93] focus:outline-none"
          />
        </label>
        ...
        <label className="space-y-2 text-sm font-bold text-[#2d4966]">
          ...
          <select
            ...
            className="w-full appearance-none rounded-2xl border border-[#c7d7e7] bg-white px-4 py-3 text-base text-[#284662] shadow-[inset_0_1px_0_rgba(255,255,255,0.65)] transition-all focus:border-[#3d7e93] focus:outline-none"
          >
