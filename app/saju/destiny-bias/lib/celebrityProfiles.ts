...
type RawCelebrityPreset = {
  ...
  time?: string;
  artist?: string;
  aliases?: string[]; // 한글/별칭 검색 지원 (영문 그룹명 등)
};

const idolCategories = new Set<Exclude<DestinyBiasCelebCategory, "전체">>(["걸그룹", "보이그룹"]);

// 영문 그룹명 → 한글 별칭 (한글 검색 지원). 개별 항목의 aliases와 함께 searchText에 합류.
const GROUP_KO_ALIAS: Record<string, string[]> = {
  RESCENE: ["리센느"],
  NMIXX: ["엔믹스"],
  BABYMONSTER: ["베이비몬스터", "베몬"],
  MEOVV: ["미야오", "메오"],
  STAYC: ["스테이씨"],
  QWER: ["큐더블유이알"],
  BTS: ["방탄소년단", "방탄"],
  ...
  케플러: ["kep1er", "kepler"],
  이즈나: ["izna"],
  하츠투하츠: ["hearts2hearts", "h2h", "하트투하트"],
  프로미스나인: ["fromis_9", "fromis", "프나인"],
  엑소: ["exo"],
  샤이니: ["shinee"],
  에이티즈: ["ateez"],
  몬스타엑스: ["monsta x", "몬엑"],
...
const rawCelebrityPresets: RawCelebrityPreset[] = [
  ...
  // ── 확장 로스터 (2026-07, 웹 리서치·생년월일 교차검증) ──
  { category: "걸그룹", fullName: "레드벨벳 아이린", birth: "1991-03-29" },
  { category: "걸그룹", fullName: "레드벨벳 슬기", birth: "1994-02-10" },
  { category: "걸그룹", fullName: "레드벨벳 웬디", birth: "1994-02-21" },
  { category: "걸그룹", fullName: "레드벨벳 조이", birth: "1996-09-03" },
  { category: "걸그룹", fullName: "레드벨벳 예리", birth: "1999-03-05" },
  { category: "걸그룹", fullName: "있지 예지", birth: "2000-05-26" },
  { category: "걸그룹", fullName: "있지 리아", birth: "2000-07-21" },
  { category: "걸그룹", fullName: "있지 류진", birth: "2001-04-17" },
  { category: "걸그룹", fullName: "있지 채령", birth: "2001-06-05" },
  { category: "걸그룹", fullName: "있지 유나", birth: "2003-12-09" },
  { category: "걸그룹", fullName: "마마무 솔라", birth: "1991-02-21" },
  { category: "걸그룹", fullName: "마마무 문별", birth: "1992-12-22" },
  { category: "걸그룹", fullName: "마마무 휘인", birth: "1995-04-17" },
  { category: "걸그룹", fullName: "마마무 화사", birth: "1995-07-23" },
  { category: "걸그룹", fullName: "오마이걸 효정", birth: "1994-07-28" },
  { category: "걸그룹", fullName: "오마이걸 미미", birth: "1995-05-01" },
  { category: "걸그룹", fullName: "오마이걸 유아", birth: "1995-09-17" },
  { category: "걸그룹", fullName: "오마이걸 승희", birth: "1996-01-25" },
  { category: "걸그룹", fullName: "오마이걸 유빈", birth: "1997-09-09" },
  { category: "걸그룹", fullName: "오마이걸 아린", birth: "1999-06-18" },
  { category: "걸그룹", fullName: "케플러 샤오팅", birth: "1999-11-12" },
  { category: "걸그룹", fullName: "케플러 마시로", birth: "1999-12-16" },
  { category: "걸그룹", fullName: "케플러 채현", birth: "2002-04-26" },
  { category: "걸그룹", fullName: "케플러 다연", birth: "2003-03-02" },
  { category: "걸그룹", fullName: "케플러 영은", birth: "2004-12-27" },
  { category: "걸그룹", fullName: "케플러 예서", birth: "2005-08-22" },
  { category: "걸그룹", fullName: "이즈나 마이", birth: "2004-10-28" },
  { category: "걸그룹", fullName: "이즈나 방지민", birth: "2005-05-08" },
  { category: "걸그룹", fullName: "이즈나 코코", birth: "2006-11-14" },
  { category: "걸그룹", fullName: "이즈나 류사랑", birth: "2007-04-18" },
  { category: "걸그룹", fullName: "이즈나 최정은", birth: "2007-08-04" },
  { category: "걸그룹", fullName: "이즈나 정새비", birth: "2008-01-22" },
  { category: "걸그룹", fullName: "하츠투하츠 지우", birth: "2006-09-07" },
  { category: "걸그룹", fullName: "하츠투하츠 유하", birth: "2007-04-12" },
  { category: "걸그룹", fullName: "하츠투하츠 준", birth: "2008-12-03" },
  { category: "걸그룹", fullName: "하츠투하츠 아나", birth: "2008-12-20" },
  { category: "걸그룹", fullName: "프로미스나인 새롬", birth: "1997-01-07" },
  { category: "걸그룹", fullName: "프로미스나인 하영", birth: "1997-09-29" },
  { category: "걸그룹", fullName: "프로미스나인 지원", birth: "1998-03-20" },
  { category: "걸그룹", fullName: "프로미스나인 지선", birth: "1998-11-23" },
  { category: "걸그룹", fullName: "프로미스나인 서연", birth: "2000-01-22" },
  { category: "걸그룹", fullName: "프로미스나인 채영", birth: "2000-05-14" },
  { category: "걸그룹", fullName: "프로미스나인 나경", birth: "2000-06-01" },
  { category: "걸그룹", fullName: "프로미스나인 지헌", birth: "2003-04-17" },
  { category: "보이그룹", fullName: "엑소 시우민", birth: "1990-03-26" },
  { category: "보이그룹", fullName: "엑소 수호", birth: "1991-05-22" },
  { category: "보이그룹", fullName: "엑소 레이", birth: "1991-10-07" },
  { category: "보이그룹", fullName: "엑소 백현", birth: "1992-05-06" },
  { category: "보이그룹", fullName: "엑소 첸", birth: "1992-09-21" },
  { category: "보이그룹", fullName: "엑소 찬열", birth: "1992-11-27" },
  { category: "보이그룹", fullName: "엑소 디오", birth: "1993-01-12" },
  { category: "보이그룹", fullName: "엑소 카이", birth: "1994-01-14" },
  { category: "보이그룹", fullName: "엑소 세훈", birth: "1994-04-12" },
  { category: "보이그룹", fullName: "샤이니 온유", birth: "1989-12-14" },
  { category: "보이그룹", fullName: "샤이니 키", birth: "1991-09-23" },
  { category: "보이그룹", fullName: "샤이니 민호", birth: "1991-12-09" },
  { category: "보이그룹", fullName: "샤이니 태민", birth: "1993-07-18" },
  { category: "보이그룹", fullName: "에이티즈 홍중", birth: "1998-11-07" },
  { category: "보이그룹", fullName: "에이티즈 성화", birth: "1998-04-03" },
  { category: "보이그룹", fullName: "에이티즈 윤호", birth: "1999-03-23" },
  { category: "보이그룹", fullName: "에이티즈 여상", birth: "1999-06-15" },
  { category: "보이그룹", fullName: "에이티즈 산", birth: "1999-07-10" },
  { category: "보이그룹", fullName: "에이티즈 민기", birth: "1999-08-09" },
  { category: "보이그룹", fullName: "에이티즈 우영", birth: "1999-11-26" },
  { category: "보이그룹", fullName: "에이티즈 종호", birth: "2000-10-12" },
  { category: "보이그룹", fullName: "몬스타엑스 셔누", birth: "1992-06-18" },
  { category: "보이그룹", fullName: "몬스타엑스 민혁", birth: "1993-11-03" },
  { category: "보이그룹", fullName: "몬스타엑스 기현", birth: "1993-11-22" },
  { category: "보이그룹", fullName: "몬스타엑스 형원", birth: "1994-01-15" },
  { category: "보이그룹", fullName: "몬스타엑스 주헌", birth: "1994-10-06" },
  { category: "보이그룹", fullName: "몬스타엑스 아이엠", birth: "1996-01-26" },
  { category: "보이그룹", fullName: "더보이즈 상연", birth: "1996-11-04" },
  { category: "보이그룹", fullName: "더보이즈 제이콥", birth: "1997-05-30" },
  { category: "보이그룹", fullName: "더보이즈 영훈", birth: "1997-08-08" },
  { category: "보이그룹", fullName: "더보이즈 현재", birth: "1997-09-13" },
  { category: "보이그룹", fullName: "더보이즈 주연", birth: "1998-01-16" },
  { category: "보이그룹", fullName: "더보이즈 케빈", birth: "1998-02-23" },
  { category: "보이그룹", fullName: "더보이즈 뉴", birth: "1998-04-26" },
  { category: "보이그룹", fullName: "더보이즈 큐", birth: "1998-11-05" },
  { category: "보이그룹", fullName: "더보이즈 주학년", birth: "1999-03-09" },
  { category: "보이그룹", fullName: "더보이즈 선우", birth: "2000-04-12" },
  { category: "보이그룹", fullName: "더보이즈 에릭", birth: "2000-12-22" },
  { category: "보이그룹", fullName: "피원하모니 키호", birth: "2001-09-27" },
  { category: "보이그룹", fullName: "피원하모니 테오", birth: "2001-07-01" },
  { category: "보이그룹", fullName: "피원하모니 지웅", birth: "2001-10-07" },
  { category: "보이그룹", fullName: "피원하모니 인탁", birth: "2003-08-31" },
  { category: "보이그룹", fullName: "피원하모니 소울", birth: "2005-02-01" },
  { category: "보이그룹", fullName: "피원하모니 종섭", birth: "2005-11-19" },
  { category: "보이그룹", fullName: "플레이브 예준", birth: "2001-09-12" },
  { category: "보이그룹", fullName: "플레이브 노아", birth: "2001-02-10" },
  { category: "보이그룹", fullName: "플레이브 밤비", birth: "2002-07-15" },
  { category: "보이그룹", fullName: "플레이브 은호", birth: "2003-05-24" },
];
...
export const destinyBiasCelebrityPresets: DestinyBiasCelebrityPreset[] = rawCelebrityPresets.map((item, index) => {
  ...
  const searchParts = [item.fullName, name, artist, item.category, birthDateInput, ...(item.aliases || []), ...(GROUP_KO_ALIAS[artist] || [])];
