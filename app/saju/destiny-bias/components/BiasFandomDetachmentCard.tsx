...
export default function BiasFandomDetachmentCard({ vm }: Props) {
  ...
  return (
    <section className="space-y-3">
      <p className="text-[11px] font-semibold tracking-[0.16em] text-pink-100/85">무엇 때문에 식는가 WHAT COOLS IT DOWN</p>
      <article className="relative overflow-hidden rounded-[24px] border border-white/14 bg-[linear-gradient(140deg,rgba(8,16,42,0.78),rgba(16,11,50,0.6))] p-4 shadow-[0_12px_36px_rgba(2,6,28,0.4),inset_0_1px_2px_rgba(255,255,255,0.06)] backdrop-blur-xl md:p-5">
        ...
        <div className="relative z-10 space-y-3">
          <div>
            <p className="text-[11px] font-semibold tracking-[0.14em] text-cyan-100/80">탈덕 이유 · {profile.detachmentReason}</p>
          ...
          <div>
            <p className="text-[11px] font-semibold tracking-[0.14em] text-[var(--bias-gold)]/80">탈덕 방식 · {profile.detachmentStyle}</p>
