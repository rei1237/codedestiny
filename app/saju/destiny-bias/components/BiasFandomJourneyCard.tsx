...
export default function BiasFandomJourneyCard({ vm }: Props) {
  ...
  return (
    <section className="space-y-3">
      <p className="text-[11px] font-semibold tracking-[0.16em] text-pink-100/85">{copy.journeySectionLabel} ENTRY &amp; TASTE</p>
      ...
      <article className="relative overflow-hidden rounded-[24px] border border-white/14 bg-[linear-gradient(140deg,rgba(8,16,42,0.78),rgba(16,11,50,0.6))] p-4 shadow-[0_12px_36px_rgba(2,6,28,0.4),inset_0_1px_2px_rgba(255,255,255,0.06)] backdrop-blur-xl md:p-5">
        ...
        <div className="relative z-10 flex items-center gap-2">
          ...
          <h3 className="min-w-0 break-keep text-base font-black text-white md:text-lg">{copy.journeyEntryTypeLabel} · {profile.entryType}</h3>
        </div>
      ...
      <article className="relative overflow-hidden rounded-[24px] border border-white/14 bg-[linear-gradient(140deg,rgba(8,16,42,0.78),rgba(16,11,50,0.6))] p-4 shadow-[0_12px_36px_rgba(2,6,28,0.4),inset_0_1px_2px_rgba(255,255,255,0.06)] backdrop-blur-xl md:p-5">
        ...
        <div className="relative z-10 flex items-center gap-2">
          <span aria-hidden className="grid h-7 w-7 shrink-0 place-items-center rounded-full border border-white/15 bg-white/[0.06] text-sm">💫</span>
          <h3 className="min-w-0 break-keep text-base font-black text-white md:text-lg">{copy.journeyTasteLabel}</h3>
        </div>
        <div className="relative z-10 mt-3 space-y-3">
          <div>
            <p className="text-[11px] font-semibold tracking-[0.14em] text-cyan-100/80">{copy.journeyFirstAttractionLabel}</p>
          ...
          <div>
            <p className="text-[11px] font-semibold tracking-[0.14em] text-[var(--bias-gold)]/80">{copy.journeyLongTermLabel}</p>
