...
export default function PromptHubPage() {
  return (
    <div className="min-h-screen bg-[#fff8ef] px-5 py-10 text-slate-900">
      <section className="mx-auto max-w-3xl rounded-3xl border border-rose-100 bg-white/80 p-6 shadow-sm">
        <span className="inline-flex items-center rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-black text-amber-700">
          무료
        </span>
        <h1 className="mt-3 text-3xl font-black text-slate-950">종합 운세 프롬프트, 지금 바로 만들어보세요</h1>
      ...
      <section className="mx-auto mt-6 max-w-3xl rounded-3xl border border-rose-100 bg-white/80 p-6 shadow-sm">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-rose-500">Fortune Prompt Hub</p>
        <h2 className="mt-3 text-2xl font-black text-slate-950">운세 상담 프롬프트 허브</h2>
      ...
      <section className="mx-auto mt-6 max-w-3xl rounded-3xl border border-rose-100 bg-white/80 p-6 shadow-sm">
        <h2 className="text-xl font-black text-slate-950">이 허브에서 다룰 수 있는 도구</h2>
        <ul className="mt-4 space-y-3 text-sm leading-7 text-slate-700">
          <li>
            <strong className="text-rose-600">사주·당사주</strong> — 생년월일시를 바탕으로 성향, 시기, 관계의 흐름을
            묻는 질문을 다듬습니다.
          </li>
          <li>
            <strong className="text-rose-600">타로</strong> — 오늘의 선택이나 관계의 갈림길처럼 구체적인 장면을 카드로
            풀어낼 질문을 세웁니다.
          </li>
          <li>
            <strong className="text-rose-600">점성술·베다 점성술</strong> — 행성의 배치를 근거로 시기, 궁합, 진로의
            방향을 좁혀 묻는 프롬프트를 만듭니다.
          </li>
          <li>
            <strong className="text-rose-600">자미두수</strong> — 명궁, 재백궁, 관록궁 등 각 궁의 흐름 중 어떤 부분을
            먼저 확인할지 정리합니다.
          </li>
          <li>
            <strong className="text-rose-600">숙요점</strong> — 두 사람의 궁합과 갈등 패턴을 27숙 기준으로 묻는 질문을
            구성합니다.
          </li>
          <li>
            <strong className="text-rose-600">수비학</strong> — 이름과 생년월일의 숫자에서 반복되는 성향을 확인하는
            질문을 만듭니다.
          </li>
          <li>
            <strong className="text-rose-600">구성학·매화역수</strong> — 방위와 수리 감각을 바탕으로 이동, 이사, 선택의
            시점을 묻는 프롬프트를 다듬습니다.
          </li>
          <li>
            <strong className="text-rose-600">꿈 상징·호라리</strong> — 최근 꾼 꿈이나 지금 이 순간의 질문 자체를
            상징으로 풀어낼 문장을 세웁니다.
          </li>
        </ul>
      </section>
      ...
      <section className="mx-auto mt-6 max-w-3xl rounded-3xl border border-rose-100 bg-white/80 p-6 shadow-sm">
        ...
        <div className="mt-4 space-y-4 text-sm leading-7 text-slate-700">
          <div>
            <h3 className="font-bold text-slate-950">생성된 프롬프트를 그대로 다른 서비스에 써도 되나요?</h3>
            <p className="mt-1">
          ...
          <div>
            <h3 className="font-bold text-slate-950">입력한 내용이나 결과가 서버에 저장되나요?</h3>
            <p className="mt-1">
          ...
          <div>
            <h3 className="font-bold text-slate-950">여러 도구를 한 번에 써야 하나요?</h3>
            <p className="mt-1">
          ...
          <div>
            <h3 className="font-bold text-slate-950">프롬프트만 보고 중요한 결정을 내려도 될까요?</h3>
            <p className="mt-1">
