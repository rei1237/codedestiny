    ...
    <FeatureLandingPage
      service={{
        ...
        valueSections: [
          ...
          {
            title: "여섯 자리의 무게가 같지 않습니다",
            body: "④ 상대의 의지와 ⑤ 관계를 막는 핵심이 해석에서 가장 무겁게 잡히고, ③ 상대의 감정과 ⑥ 가까운 흐름이 그다음입니다. 마음의 온도(③)만 높고 움직일 의지(④)가 따라오지 않는 조합이 관계에서 가장 흔한 정체이기 때문에, 두 자리를 짝으로 읽도록 설계돼 있습니다.",
          },
          {
            title: "결과를 읽는 법",
            body: "여섯 장을 좋고 나쁨으로 합산하지 마세요. 앞의 세 자리는 지금 서로를 어떻게 보고 있는지를 설명하고, 뒤의 세 자리는 그래서 무엇이 걸려 있고 어디로 가는지를 가리킵니다. 마음에 들지 않는 결과가 나왔다고 곧바로 다시 뽑으면 대개 같은 자리에 머무는 답이 반복됩니다.",
          },
          {
