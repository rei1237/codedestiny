...
const GUIDE_COPY = {
  ko: {
    ...
    cards: [
      ["타로가 살피는 것", "타로는 현재의 심리, 관계의 온도, 선택지의 장단점, 지금 조심해야 할 태도와 감정의 방향을 살핍니다. 카드는 답을 강요하지 않고, 질문자가 놓치고 있던 흐름을 상징으로 드러냅니다."],
      ["좋은 질문을 세우는 법", "타로 질문은 맞다·아니다보다 지금 내가 무엇을 살펴야 하는지에 가까울수록 깊어집니다. 예를 들어 그 사람이 돌아올까요보다 이 관계에서 내가 확인해야 할 마음은 무엇인가요처럼 묻는 편이 더 건강한 리딩으로 이어집니다."],
      ["필요한 입력값", "질문 주제, 현재 상황, 선택지, 관계의 맥락이 핵심 입력값입니다. 이름이나 생년월일이 필요한 리딩도 있지만, 타로에서는 질문의 맥락이 카드 해석의 방향을 잡는 데 더 중요합니다."],
      ["무료와 유료 범위", "무료 리딩은 한 가지 주제의 핵심 흐름과 짧은 조언을 제공합니다. 유료 리딩은 카드 배열, 위치별 의미, 상호 관계, 상황별 행동 조언을 더 길고 세밀하게 풀어 줍니다. 유료 리딩은 불안을 압박하기 위한 장치가 아닙니다."],
    ],
    flowTitle: "해석 흐름",
    flowItems: [
    ...
    faqItems: [
      ["같은 질문을 여러 번 해도 되나요?", "짧은 시간 안에 같은 질문을 반복하면 불안이 커질 수 있습니다. 상황이 바뀌었거나 새로운 정보가 생겼을 때 다시 보는 편이 리딩을 더 차분하게 받아들이는 데 좋습니다."],
      ["나쁜 카드가 나오면 나쁜 일이 생기나요?", "타로의 어두운 카드는 확정된 불운보다 멈춤, 점검, 관계의 긴장, 감정의 과열을 비추는 경우가 많습니다. 경고가 떠오를수록 현실적인 보호 행동을 함께 살피면 됩니다."],
      ["타로가 결정을 대신해 줄 수 있나요?", "타로는 선택의 분위기와 마음의 방향을 비추는 상담 도구입니다. 법률, 의료, 투자, 결혼, 이혼, 소송, 진로처럼 큰 결정은 타로만으로 정하지 않아야 합니다."],
    ],
