...
const SELF_ESTEEM_COPY: Record<LoadingLocale, SelfEsteemCopy> = {
  ko: {
    badge: "무료 서비스 · FREE QUEST",
    h1: "자존감 레벨업",
    subtitle: "5카드 RPG 퀘스트 타로",
    heroLines: [
      "내 감정의 현재 좌표를 정확히 파악하고,",
      "자존감을 회복하는 실전 미션까지 안내하는 완전 무료 타로 리딩",
    ],
    benefitsTitle: "이 타로가 알려주는 것",
    benefits: [
      "내 자존감의 현재 체력 레벨",
      "자신감을 떨어뜨리는 진짜 패턴",
      "오늘 당장 실천할 미션과 루틴",
    ...
    primaryCta: "무료로 퀘스트 시작",
    secondaryCta: "홈으로 돌아가기",
    infoText: "100% 무료 — 추가 결제 없이 모든 기능 이용 가능",
    imageAlt: "자존감 레벨업 타로 대표 이미지",
    imageBadge: "무료 배지",
    overlayTitle: "5카드 성장 퀘스트",
    overlayLines: [
      "📜 디버프 확인 → 👹 몬스터 진단 → 💔 데미지 측정",
      "🛡️ 실드 획득 → ⭐ 레벨업 완성",
    ],
    stepsTitle: "5단계 퀘스트 방식",
    stepLabel: "단계",
