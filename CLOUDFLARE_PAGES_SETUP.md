...
���� `main` Ŀ�Կ��� Pages�� ���� �� �����Ǹ� �Ʒ� 2������ �ݵ�� ���� ����� �մϴ�.

1. GitHub Actions�� ���� ���
- `.github/workflows/cloudflare-pages-deploy.yml`�� �ڵ� ���� ���
- `.github/workflows/cloudflare-worker-deploy.yml`�� ���� ����(`workflow_dispatch`) ����

2. Cloudflare Pages ��ú��� �ڵ� ���� ����
- Workers & Pages > `codedestiny` > Settings > Builds > Branch control
- `Enable automatic production branch deployments` ����
- Preview branch�� `None`���� ���� (���ϸ�)

�׸��� Pages ��ú��� Build/Deploy command�� Worker ���� ����(`wrangler deploy --config worker/wrangler.toml`)�� ���� ������.
Worker ������ GitHub Actions���� ���� ����ǰ�, ������ ��쿡�� Pages ������ 1ȸ ����ǵ��� �����Ǿ�� �մϴ�.
