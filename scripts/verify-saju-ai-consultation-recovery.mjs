...
// Execute the actual cache with a memory store: implementation shape is not a contract.
execFileSync(process.execPath, ["--test", "__tests__/ui/llm-cache-quality.behavior.test.js"], { stdio: "pipe" });
assert(
