...
assertContains(billingClientSource, 'PAID_SERVICE_RUNTIME_SRC = "/js/destiny-profile.js?v=build-moonbal-fresh-1a2b3"', "React paid runtime cache key includes profile sync fix");
