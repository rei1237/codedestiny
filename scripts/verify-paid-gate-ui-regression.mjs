...
assertContains(billingClientSource, 'PAID_SERVICE_RUNTIME_SRC = "/js/destiny-profile.js?v=build-ecb946e5496b"', "React paid runtime cache key includes profile sync fix");
