...
assertContains(billingClientSource, 'PAID_SERVICE_RUNTIME_SRC = "/js/destiny-profile.js?v=build-ffb6c0ed4593"', "React paid runtime cache key includes profile sync fix");
