...
const CONTENT_LISTINGS = {
  ...
  cd_content_tier_06: { title: "운세 콘텐츠 12,900원", description: "선택하신 운세·상담 기능 1건의 단건 결제입니다. 이용권으로 열리는 기능은 결제 없이 이용됩니다." },
  cd_content_tier_07: { title: "운세 콘텐츠 14,900원", description: "선택하신 심화 분석 기능 1건의 단건 결제입니다. 이용권으로 열리는 기능은 결제 없이 이용됩니다." },
  cd_content_tier_08: { title: "운세 콘텐츠 18,900원", description: "선택하신 심화 분석 기능 1건의 단건 결제입니다. 이용권으로 열리는 기능은 결제 없이 이용됩니다." },
  cd_content_tier_09: { title: "운세 콘텐츠 24,900원", description: "선택하신 궁합·심화 상담 1건의 단건 결제입니다. 이용권으로 열리는 기능은 결제 없이 이용됩니다." },
  cd_content_tier_10: { title: "AI 상담 38,900원", description: "선택하신 AI 운세 상담 1건의 단건 결제입니다. 이용권으로 열리는 기능은 결제 없이 이용됩니다." },
  cd_content_tier_11: { title: "프리미엄 해금 48,900원", description: "선택하신 프리미엄 운세 묶음을 영구 해금하는 단건 결제입니다." },
  cd_content_tier_12: { title: "AI 상담 62,900원", description: "선택하신 심층 AI 운세 상담 1건의 단건 결제입니다. 이용권으로 열리는 기능은 결제 없이 이용됩니다." },
