...
assertIncludes("worker/routes/new-year-ai.js", "finishNewYearDelivery");
assertIncludes("worker/routes/new-year-ai.js", "callDeferredUsageRoute");
...
assertIncludes("worker/routes/new-year-ai.js", "'llmMeta.sections': generated.sections", "completed session should persist per-domain sections");
...
const delivery = spawnSync(process.execPath, ["--test", "__tests__/ui/new-year-paid-delivery.behavior.test.js"], { cwd: root, encoding: "utf8" });
assert(delivery.status === 0, delivery.stdout + delivery.stderr);
