...
assert(route.includes("ASTROLOGY_AI_MAX_RESULT_CHARS = 38000"), "maximum total result character gate missing");
...
assert(html.includes("/feature-details/assets/astrology-ai-320.webp"), "representative image asset missing");
