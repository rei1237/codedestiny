...
const __lazyActionLoaders = {
  ...
  openPastLifeFaceApp: () => __loadScriptOnce('AnalysisEngine.js?v=h79a0367a2977').then(() => __loadScriptOnce('PastLifeFaceUI.js?v=h9c01827e559e')),
  openHwatuModal: () => __loadScriptOnce('HwatuFortune.js?v=h5be3c5cb5489'),
  openMbtiModal: () => __loadScriptOnce('js/astral-soul.js'),
  openKemetModal: () => __loadScriptOnce('/js/oracle-kcg.js?v=build-8642c1f7355b'),
  openDreamModal: () => __loadScriptOnce('/js/dream-ledger.js?v=build-8642c1f7355b'),
  openPsychoDreamModal: () => __loadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-8642c1f7355b'),
  openAnimalTotemModal: () =>
    __loadScriptOnce('/js/services/animal-totem-content-engine.js').then(() =>
      __loadScriptOnce('/js/animal-totem-experience.js?v=build-8642c1f7355b')
    ),
  ...
  openTarotLoveModal: () => __loadScriptOnce('/js/tarot-love-experience.js?v=build-8642c1f7355b'),
  openTarotReunionModal: () => __loadScriptOnce('/js/tarot-reunion-experience.js?v=build-8642c1f7355b'),
  ...
  openTarotSelfEsteemModal: () => __loadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-8642c1f7355b'),
  openTarotYearFortuneModal: () => __loadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-8642c1f7355b'),
  ...
  openSibylModal: () => __loadScriptOnce('/js/sibyl-system.js?v=build-8642c1f7355b').then(() => {
...
function __ensureSajuCoreScripts() {
  return __loadScriptOnce('/js/destiny-profile.js?v=build-8642c1f7355b')
