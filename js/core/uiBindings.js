...
const __lazyActionLoaders = {
  ...
  openKemetModal: () => __loadScriptOnce('/js/oracle-kcg.js?v=build-6deed0abc4cb'),
  openDreamModal: () => __loadScriptOnce('/js/dream-ledger.js?v=build-6deed0abc4cb'),
  openPsychoDreamModal: () => __loadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-6deed0abc4cb'),
  openAnimalTotemModal: () =>
    __loadScriptOnce('/js/services/animal-totem-content-engine.js').then(() =>
      __loadScriptOnce('/js/animal-totem-experience.js?v=build-6deed0abc4cb')
    ),
  ...
  openTarotLoveModal: () => __loadScriptOnce('/js/tarot-love-experience.js?v=build-6deed0abc4cb'),
  openTarotReunionModal: () => __loadScriptOnce('/js/tarot-reunion-experience.js?v=build-6deed0abc4cb'),
  ...
  openTarotSelfEsteemModal: () => __loadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-6deed0abc4cb'),
  openTarotYearFortuneModal: () => __loadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-6deed0abc4cb'),
  ...
  openSibylModal: () => __loadScriptOnce('/js/sibyl-system.js?v=build-6deed0abc4cb').then(() => {
...
function __ensureSajuCoreScripts() {
  return __loadScriptOnce('/js/destiny-profile.js?v=build-6deed0abc4cb')
    .then(() => __loadScriptOnce('/js/services/sajuService.js'))
    .then(() => __loadScriptOnce('/js/core/saju/basicFortunePresentation.js?v=build-6deed0abc4cb'))
