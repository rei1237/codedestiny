...
const __lazyActionLoaders = {
  ...
  openTarotLoveModal: () => __loadScriptOnce('/js/tarot-love-experience.js?v=build-20260605-profile-card-slots'),
  openTarotReunionModal: () => __loadScriptOnce('/js/tarot-reunion-experience.js?v=build-20260605-profile-card-slots'),
  ...
  openTarotSelfEsteemModal: () => __loadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-20260605-profile-card-slots'),
  openTarotYearFortuneModal: () => __loadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-20260605-profile-card-slots'),
  ...
  openZiweiBookModal: () => __loadScriptOnce('/js/ziwei-book.js?v=build-20260605-profile-card-slots'),
  closeZiweiBookModal: () => __loadScriptOnce('/js/ziwei-book.js?v=build-20260605-profile-card-slots'),
  generateZiweiBook: () => __loadScriptOnce('/js/ziwei-book.js?v=build-20260605-profile-card-slots'),
  downloadZiweiBookPdf: () => __loadScriptOnce('/js/ziwei-book.js?v=build-20260605-profile-card-slots'),
    gotoAstrologyPremium: () => __loadScriptOnce('/js/astro-book.js?v=build-20260605-profile-card-slots'),
  gotoZiweiPremium: () => __loadScriptOnce('/js/ziwei-book.js?v=build-20260605-profile-card-slots'),
  openSajuNewYearModal: () => __loadScriptOnce('/js/saju-new-year.js?v=build-20260605-profile-card-slots'),
  closeSajuNewYearModal: () => __loadScriptOnce('/js/saju-new-year.js?v=build-20260605-profile-card-slots'),
  generateSajuNewYear: () => __loadScriptOnce('/js/saju-new-year.js?v=build-20260605-profile-card-slots'),
  downloadSajuNewYearPdf: () => __loadScriptOnce('/js/saju-new-year.js?v=build-20260605-profile-card-slots'),
  openVedicBookModal: () => __loadScriptOnce('/js/vedic-book.js?v=build-20260605-profile-card-slots'),
  closeVedicBookModal: () => __loadScriptOnce('/js/vedic-book.js?v=build-20260605-profile-card-slots'),
  generateVedicBook: () => __loadScriptOnce('/js/vedic-book.js?v=build-20260605-profile-card-slots'),
  downloadVedicBookPdf: () => __loadScriptOnce('/js/vedic-book.js?v=build-20260605-profile-card-slots'),
  gotoVedicPremium: () => __loadScriptOnce('/js/vedic-book.js?v=build-20260605-profile-card-slots'),
  openSukuyoBookModal: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-20260605-profile-card-slots'),
  closeSukuyoBookModal: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-20260605-profile-card-slots'),
  generateSukuyoBook: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-20260605-profile-card-slots'),
  downloadSukuyoBookPdf: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-20260605-profile-card-slots'),
  gotoSukuyoPremium: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-20260605-profile-card-slots'),
  openLoveSecretModal: () => __loadScriptOnce('/js/love-secret-v2.js?v=build-20260605-profile-card-slots'),
  closeLoveSecretModal: () => __loadScriptOnce('/js/love-secret-v2.js?v=build-20260605-profile-card-slots'),
  generateLoveSecret: () => __loadScriptOnce('/js/love-secret-v2.js?v=build-20260605-profile-card-slots'),
  openOlympusOracleModal: () => __loadScriptOnce('/js/olympus-oracle.js'),
  openSibylModal: () => __loadScriptOnce('/js/sibyl-system.js?v=build-20260605-profile-card-slots').then(() => {
...
function __ensureSajuCoreScripts() {
  return __loadScriptOnce('/js/destiny-profile.js?v=build-20260605-profile-card-slots')
