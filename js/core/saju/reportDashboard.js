...
var REPORT_CARDS = [
  ...
  { id:'quantum',    thumb:'quntum.webp', label:'퀀텀 명리 천기',        desc:'합화 우선 분석으로 나만의 천기 지도를 제공합니다.',      note:'지금 밀어붙일 타이밍인지, 숨을 고를 타이밍인지 천기적으로 짚어드립니다.', cta:'⚡ 천기 리포트 보기',          accent:'#38bdf8', glow:'rgba(56,189,248,.55)',  target:'quantumCard',        coinCost:50  },
