...
var REPORT_CARDS = [
  ...
  { id:'fortunePlanner', thumb:'사주 다이어리.webp', label:'갓생 다이어리', desc:'오늘의 일정·할 일·실천 운을 다이어리 한 화면에서 함께 정리해보세요.', note:'누구나 무료로, 횟수 제한 없이 이 기기에 생활 운세 기록을 저장할 수 있습니다.', cta:'다이어리 열기', accent:'#b31955', glow:'rgba(179,25,85,.45)', action:'openFortunePlanner', coinCost:0, badge:'FREE' },
