...
var __cdLazyActionLoaders = {
  ...
  openLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-1779629147578'); },
  closeLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-1779629147578'); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-1779629147578').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-1779629147578'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-1779629147578'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-1779629147578'); },
  openTarotHealingModal: function() { return Promise.resolve(window.location.assign('/tarot/healing')); },
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-1779629147578'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-1779629147578'); },
  openRuneOracle: function() { return Promise.resolve(window.location.assign('/oracle/rune')); },
  gotoZiweiPremium: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-1779629147578'); },
  gotoAstrologyPremium: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-1779629147578'); },
  gotoSukuyoPremium: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-1779629147578'); },
  gotoVedicPremium: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-1779629147578'); },
  gotoNamingPremium: function() { return Promise.resolve(window.location.assign('/myungwun_final.html')); },
  openSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-1779629147578'); },
  openLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-1779629147578'); },
  openLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-1779629147578'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-1779629147578').then(function() {
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    '/js/core/kasi-calendar-service.js?v=build-1779629147578',
    '/js/compat-llm-prompts.js?v=build-1779629147578',
    '/js/saju-engine.js?v=build-1779629147578',
    '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-1779629147578',
    '/js/core/saju/modalProfileState.js?v=build-1779629147578',
    '/js/core/saju/reportDashboard.js?v=build-1779629147578',
    '/js/saju-engine-continuation.js?v=build-1779629147578',
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-1779629147578';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openLuckSyncDiary = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-1779629147578').then(function() {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal() {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-1779629147578')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-1779629147578'); })
          .then(function() {
            try {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-1779629147578'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-1779629147578')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-1779629147578'); })
      .then(function() {
