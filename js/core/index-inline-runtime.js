...
var __cdLazyActionLoaders = {
  openKemetModal: function() { return __cdLoadScriptOnce('/js/oracle-kcg.js?v=build-c17b3415bf47'); },
  openDreamModal: function() { return __cdLoadScriptOnce('/js/dream-ledger.js?v=build-c17b3415bf47'); },
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-c17b3415bf47'); },
  ...
  openJuyukModal: function() { return __cdLoadScriptOnce('/js/iching-engine.js?v=build-c17b3415bf47').then(function() { return __cdLoadScriptOnce('/js/iching-modal.js?v=build-c17b3415bf47'); }); },
  openRuneOracle: function() { window.location.assign('/oracle/rune/'); return Promise.resolve(true); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-c17b3415bf47').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-c17b3415bf47'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-c17b3415bf47'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-c17b3415bf47'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-c17b3415bf47'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-c17b3415bf47'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-c17b3415bf47').then(function() {
  ...
  // 같은 계열의 버그 — 위 주석 참고).
  shareKakao: function() { return __cdLoadScriptOnce('/js/share.js?v=build-c17b3415bf47'); },
  shareInstagram: function() { return __cdLoadScriptOnce('/js/share.js?v=build-c17b3415bf47'); },
  shareSajuResultImage: function() { return __cdLoadScriptOnce('/js/share.js?v=build-c17b3415bf47'); }
};
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/core/korean-calendar.js?v=build-c17b3415bf47',
    '/js/core/kasi-calendar-service.js?v=build-c17b3415bf47',
    '/js/compat-llm-prompts.js?v=build-c17b3415bf47',
    '/js/saju-engine.js?v=build-c17b3415bf47',
      '/js/core/saju/extremeTResult.js?v=build-c17b3415bf47',
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-c17b3415bf47',
    '/js/core/saju/modalProfileState.js?v=build-c17b3415bf47',
    '/js/core/saju/reportDashboard.js?v=build-c17b3415bf47',
    '/js/saju-engine-continuation.js?v=build-c17b3415bf47',
    '/js/entertain-engine.js?v=build-c17b3415bf47',
    /* 체인은 순차 reduce라 앞에 끼우면 이 파일의 실패가 뒤쪽 전체를 죽인다 — 신규 카드 스크립트는 맨 뒤에 둔다. */
    '/js/core/saju/dopamineResult.js?v=build-c17b3415bf47'
  ];
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-c17b3415bf47')
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-c17b3415bf47';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openFortunePlanner = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-c17b3415bf47').then(function() {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal(event) {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-c17b3415bf47')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-c17b3415bf47'); })
          .then(function() {
            try {
...
function _dfReloadSourceData(source, options) {
  ...
  if (!window.CDFlowerArt) {
    loader = loader.then(function() {
      return import('/js/core/bootstrapDestinyFlower.js?v=build-c17b3415bf47').then(function(mod) {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-c17b3415bf47'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-c17b3415bf47')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-c17b3415bf47'); })
      .then(function() {
