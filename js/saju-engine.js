...
function renderTsSinsalBox(p) {
  ...
  var twelveProfile = {
    '장생':{core:'기운이 막 태동하는 시작점으로 회복력과 학습력이 빠르게 붙습니다.',love:'새로운 인연 유입이 쉬우며 첫인상과 호감 형성이 유리합니다.',work:'신규 프로젝트, 재도전, 공부 시작에 강한 타이밍입니다.',money:'큰 승부보다 씨앗 자산(적금/장기플랜) 세팅이 효율적입니다.',tip:'처음 30일 루틴을 만들면 운성 상승을 길게 가져갈 수 있습니다.'},
    '목욕':{core:'감정/매력이 표면으로 올라와 변화와 노출이 많아집니다.',love:'설렘은 크지만 감정 기복도 커지므로 템포 조절이 필요합니다.',work:'브랜딩, SNS, 발표, 영업처럼 노출형 업무에서 성과가 납니다.',money:'소비 유혹이 커지니 예산 상한선 고정이 안전합니다.',tip:'관계와 소비에 기준선을 적어두면 후회를 크게 줄일 수 있습니다.'},
    '관대':{core:'사회적 확장 구간으로 평판과 대외 포지션이 커집니다.',love:'공식적 관계 전환(소개/공개연애) 시너지가 좋습니다.',work:'협업, 네트워킹, 조직 내 승급 기회를 잡기 좋습니다.',money:'사람 기반 수익(고객/파트너)이 늘어나는 흐름입니다.',tip:'나를 설명하는 1분 자기서사를 정리해두면 기회 포착률이 올라갑니다.'},
    '건록':{core:'실행력과 생존력이 강한 실전형 운성으로 결과가 빠릅니다.',love:'주도권을 쥐기 쉬우나 강한 톤은 갈등 요인이 될 수 있습니다.',work:'마감/실행/운영 최적화에 강하고 성과 지표가 뚜렷해집니다.',money:'현금흐름 개선, 단기 매출 증대에 유리한 시기입니다.',tip:'속도는 강점이지만 검토 체크리스트 1장으로 실수를 잠그세요.'},
    '제왕':{core:'에너지가 정점에 달한 리더십 구간으로 결정권이 커집니다.',love:'매력과 존재감은 최고조지만 배려 부족 시 거리감이 생깁니다.',work:'중요 의사결정, 팀 리드, 큰 계약 체결에 유리합니다.',money:'수익 확장 잠재력이 크나 과신한 리스크 진입은 경계해야 합니다.',tip:'내 판단 70% + 타인 피드백 30% 구조가 제왕기의 안정 장치입니다.'},
    '쇠':{core:'상승 후 감속 구간으로 체력/집중 자원 관리가 핵심입니다.',love:'관계를 키우기보다 유지/신뢰 보강에 초점을 맞추세요.',work:'확장보다 효율화, 자동화, 유지보수 전략이 이득입니다.',money:'지출 구조 다이어트와 고정비 점검이 우선입니다.',tip:'일정의 20%를 회복 슬롯으로 고정하면 전체 성과가 오릅니다.'},
    '병':{core:'컨디션 편차가 큰 구간으로 무리한 밀어붙임이 손실로 이어집니다.',love:'예민함이 올라오므로 즉답보다 숙성 대화가 안전합니다.',work:'중요 업무를 오전 집중 시간에 배치하면 품질이 안정됩니다.',money:'보수적 운용이 유리하며 레버리지/빚 기반 투자는 피해야 합니다.',tip:'수면/운동/식사 3축이 흔들리면 운성 체감이 급격히 나빠집니다.'},
    '사':{core:'한 사이클 마감 단계로 내려놓음과 정리가 성과를 만듭니다.',love:'집착을 줄이고 관계 규칙을 재정의하면 갈등이 줄어듭니다.',work:'프로젝트 종료, 인수인계, 불필요 업무 제거에 최적입니다.',money:'미수금/구독/보험 등 누수 항목 정리에 좋은 타이밍입니다.',tip:'끝내야 다음이 열립니다. 종료 목록을 명시적으로 작성하세요.'},
    '묘':{core:'내면 정비 구간으로 외부 확장보다 구조 재설계가 우선입니다.',love:'감정적 반응보다 나의 패턴을 관찰하는 기간으로 쓰세요.',work:'브랜드/포지션/커리어 방향을 다시 설계하면 품질이 올라갑니다.',money:'새 투자보다 기존 자산 리밸런싱이 효율적입니다.',tip:'조용한 준비가 다음 국면의 점프 폭을 결정합니다.'},
    '절':{core:'흐름 단절과 전환의 신호로 과감한 리셋이 필요한 시기입니다.',love:'안 맞는 관계를 정리하면 새로운 인연 여지가 빠르게 생깁니다.',work:'직무/팀/전략 전환, 과거 방식 종료에 적합합니다.',money:'손절 기준을 명확히 두면 큰 손실을 막을 수 있습니다.',tip:'끊어야 살립니다. 미련보다 기준으로 결정하세요.'},
    '태':{core:'다음 사이클을 준비하는 잠복 단계로 기반 공사가 중요합니다.',love:'천천히 신뢰를 쌓는 방식이 오래갑니다.',work:'교육, 리서치, 실력 비축이 가장 높은 복리 효과를 냅니다.',money:'현금 쿠션과 안전자산 비중 확대가 안정적입니다.',tip:'보이지 않는 준비가 가시 성과보다 더 큰 차이를 만듭니다.'},
    '양':{core:'출발 직전 성장 구간으로 도움/지원 에너지가 붙습니다.',love:'관계가 부드럽게 진전되며 케어형 커뮤니케이션이 효과적입니다.',work:'멘토링, 동료 협력, 파일럿 실행으로 판을 키우기 좋습니다.',money:'작은 수익원 다각화가 본게임 전에 안정 장치를 만듭니다.',tip:'혼자보다 팀으로 움직일 때 운성 효율이 가장 높습니다.'}
  };

  var sinsalProfile = {
    '천을귀인':{core:'위기에서 도와주는 귀인운으로 문제 해결의 문이 열립니다.',love:'관계 문제에 중재자/조언자가 나타나며 회복력이 커집니다.',work:'상사/파트너/고객의 예상 밖 지원으로 판이 풀릴 수 있습니다.',money:'막힌 자금/계약이 타인 연결로 재가동될 가능성이 높습니다.',tip:'도움 요청을 명확히 하세요. 귀인은 신호를 줘야 움직입니다.'},
    '곤랑도화':{core:'매력과 주목도가 커져 사람을 끌어당기는 힘이 강해집니다.',love:'썸/호감 신호가 빨라지지만 감정 과열과 삼각구도는 주의하세요.',work:'퍼스널 브랜딩, 콘텐츠, 고객 반응형 업무에서 강점이 큽니다.',money:'관계 기반 수익은 늘지만 충동 소비도 동반되기 쉽습니다.',tip:'선명한 경계와 기준을 먼저 세우면 도화의 장점만 취할 수 있습니다.'},
    '충살':{core:'충돌과 변동이 큰 대신 돌파력도 강한 양날의 신호입니다.',love:'말 한마디가 크게 번질 수 있어 즉각 반응을 줄여야 합니다.',work:'급변 프로젝트, 이슈 대응, 전환 작업에서 성과가 납니다.',money:'변동성 장세와 유사해 분할 대응이 필수입니다.',tip:'정면 돌파 전에 우선순위 3개만 남기면 충살이 추진력으로 바뀝니다.'},
    '원진살':{core:'감정 오해와 미묘한 거리감이 생기기 쉬운 패턴입니다.',love:'서운함 누적을 방치하면 단절로 이어질 수 있습니다.',work:'관계 정치보다 사실/데이터 기반 커뮤니케이션이 필요합니다.',money:'감정 소비(쇼핑/보복 지출)를 특히 경계해야 합니다.',tip:'해석보다 확인 질문을 먼저 던지면 원진 리스크가 크게 줄어듭니다.'},
    '해살':{core:'잔손실/소모가 누적되기 쉬운 운으로 관리력이 중요합니다.',love:'사소한 피로가 관계 만족도를 깎으니 휴식 설계를 병행하세요.',work:'작은 누수(실수/지연/커뮤니케이션 누락) 방지가 핵심입니다.',money:'고정비/구독/보험/수수료 누수를 점검하면 즉시 효과가 납니다.',tip:'주 1회 점검 루틴 하나만 고정해도 해살 피해를 크게 줄입니다.'},
    '파살':{core:'계획이 자주 깨지는 신호로 대체안 설계가 성패를 가릅니다.',love:'기대치 불일치가 잦아 합의 문장을 명확히 남겨야 합니다.',work:'일정 변경/요구사항 변동이 많아 애자일 대응이 유리합니다.',money:'한 번에 올인보다 분할 실행이 파살 구간의 정답입니다.',tip:'플랜A/B/C를 동시에 들고 가면 파살이 오히려 기회가 됩니다.'},
    '귀문관살':{core:'직관과 몰입은 강하지만 예민함/과해석도 함께 커집니다.',love:'감정 추측보다 팩트 확인이 관계 안정의 핵심입니다.',work:'기획/연구/창작 집중도는 높으나 협업 피로는 관리해야 합니다.',money:'불안 심리에 흔들린 매매를 줄이는 규칙이 필요합니다.',tip:'기록 기반 의사결정으로 직관의 장점만 남기세요.'},
    '역마살':{core:'이동/확장/변화 에너지가 강해 판을 넓히는 데 유리합니다.',love:'거리 변화(장거리/출장/이동)가 관계 변수로 작동합니다.',work:'영업/해외/이직/런칭처럼 움직일수록 성과가 좋아집니다.',money:'활동량 증가로 기회 수익이 늘지만 비용도 함께 늘 수 있습니다.',tip:'이동 목적과 KPI를 숫자로 잡으면 역마가 결과로 연결됩니다.'},
    '양인살':{core:'결단/카리스마/자기주장이 강해지는 고압 에너지입니다.',love:'리드력은 매력이나 강압적 톤은 반발을 부를 수 있습니다.',work:'위기결정, 협상, 책임자 역할에서 존재감이 커집니다.',money:'공격적 판단이 빨라지므로 리스크 한도 설정이 필수입니다.',tip:'강함은 유지하되 표현을 20%만 부드럽게 하면 효율이 급상승합니다.'},
    '홍염살':{core:'호감·매혹·화제성이 상승하는 관계 중심 에너지입니다.',love:'연애 운은 강하지만 감정 소모와 스캔들 리스크를 함께 봐야 합니다.',work:'대중 접점 업무, 고객 커뮤니케이션에서 성과가 좋습니다.',money:'외형 관리/경험 소비가 늘기 쉬워 예산 분리가 필요합니다.',tip:'진정성 있는 기준을 먼저 세우면 홍염이 장기 매력으로 남습니다.'}
  };
  ...
  pillars.forEach(function(row) {
    ...
    twelveItems.push({
      ...
      profile: twelveProfile[star] || null
    });
  });
  ...
  function _pushSinsal(name, icon, pos) {
    ...
    sinsalItems.push({
      ...
      icon: icon,
      pos: pos,
      profile: sinsalProfile[name] || null
    });
  }
  ...
  function buildProfileHtml(profile) {
    if (!profile) return '<p>상세 해설을 준비 중입니다.</p>';
    return ''
      + '<div class="ts2-modal-list">'
        + '<div class="ts2-modal-row"><b>핵심 해석</b><span>'+profile.core+'</span></div>'
        + '<div class="ts2-modal-row"><b>연애/관계</b><span>'+profile.love+'</span></div>'
        + '<div class="ts2-modal-row"><b>커리어/일</b><span>'+profile.work+'</span></div>'
        + '<div class="ts2-modal-row"><b>재물/실리</b><span>'+profile.money+'</span></div>'
        + '<div class="ts2-modal-row"><b>실전 팁</b><span>'+profile.tip+'</span></div>'
      + '</div>';
  }
  ...
  function openModal(kind, key, pos) {
    ...
    modalBody.innerHTML = buildProfileHtml(base.profile);
...
function renderSummary(p,johu,natal){
  ...
  function callout(txt){return '<div class="sj-callout">'+txt+'</div>';}
  function insight(txt){return '<div class="sj-insight">💡 '+txt+'</div>';}
  function growth(txt){return '<div class="sj-growth">'+txt+'</div>';}
  function warn(txt){return '<div class="sj-warn">⚠️ '+txt+'</div>';}
  function quote(txt){return '<div class="sj-quote">&ldquo;'+txt+'&rdquo;</div>';}
  function divLine(){return '<div style="height:1px;background:linear-gradient(90deg,transparent,rgba(0,0,0,.1),transparent);margin:16px 0"></div>';}
  ...
  var charBoxDetail={
    甲:'갑목(甲木)은 하늘을 향해 힘껏 뻗어 올라가는 거대한 교목(喬木)입니다. 자연에서 갑목은 가장 먼저 새싹을 틔우고, 가장 높이 자라며, 주변 생명체를 위한 그늘과 산소를 만들어주는 존재입니다. 이것이 바로 당신의 본질입니다. 일단 목표가 정해지면 어떤 장애물이 앞을 가로막더라도 굽히지 않고 전진하는 강력한 추진력과 의지력을 타고났습니다. 큰 프로젝트를 처음부터 끝까지 완수하는 능력이 탁월하며, 경쟁이 있는 환경에서 진가가 더욱 선명하게 드러납니다.<br><br>심리학적으로 볼 때, 갑목 일간은 자아실현(Self-actualization) 욕구가 매우 강한 성향을 보입니다. 매슬로우의 욕구 단계 중 최상층에 해당하는 이 욕구는 단순히 생존이나 인정을 넘어 자신의 가능성을 최대한 발현하려는 내적 동기에서 나옵니다. 이 때문에 남들이 쉽게 포기하는 순간에도 당신은 오히려 더 집중하게 됩니다. 시작이 두렵다는 감각이 상대적으로 적고, 행동 후 반성하는 패턴이 강합니다. 이것은 탁월한 강점이지만, 동시에 항상 앞으로 나아가야 한다는 무의식적 압박이 되어 번아웃의 씨앗이 되기도 합니다.<br><br>당신이 반드시 직면해야 할 내면의 그림자는 고집과 독선입니다. 나무는 강하지만 한 방향으로만 바람을 막으려 하면 결국 부러집니다. 의견 충돌 상황에서 내가 반드시 옳아야 한다는 강박 패턴이 활성화되면, 주변의 진심 어린 조언조차 위협으로 느껴지게 됩니다. 인지심리학 관점에서 이것은 확증 편향(Confirmation Bias)으로 발전할 수 있습니다. 자신의 관점을 지지하는 정보만 받아들이고, 반대 증거는 무시하는 패턴이죠. 독립심이 지나쳐 필요할 때 도움을 요청하지 못하는 경향이 있는데, 이는 내면 깊이 도움을 받으면 약한 사람이다라는 잘못된 핵심 신념(Core Belief)에서 비롯됩니다. 하지만 진정한 강함은 협력할 줄 아는 능력에서 나옵니다. 세상에서 가장 큰 나무도 흙과 물의 지지 없이는 서 있을 수 없습니다.<br><br>동기부여 관점에서, 갑목 에너지를 가진 당신에게 가장 효과적인 성장 공식은 목표-실행-반성-조율의 4단계 사이클입니다. 강한 추진력을 맹목적 돌진이 아닌 올바른 방향으로 빠르게 가기로 조율하는 것이 성숙의 핵심입니다. 주기적으로 스스로에게 물어보세요: 지금 내가 고집하는 것이 목표를 위한 것인가, 아니면 자존심을 지키기 위한 것인가? 크게 자란 나무가 태풍에도 쓰러지지 않으려면 뿌리가 사방으로 깊게 뻗어 있어야 합니다. 당신도 다양한 관점과 사람들을 내 편으로 품을 때, 사주가 약속한 가장 큰 성취의 문이 열립니다. 당신은 리더로 태어났습니다. 이제 혼자 가는 리더가 아닌, 사람들과 함께 성장하는 리더로 진화하는 것이 가장 중요한 과제입니다.',
    乙:'을목(乙木)은 환경에 따라 유연하게 흔들리면서도 결코 끊어지지 않는 덩굴 식물입니다. 태풍에도 부러지지 않고, 어떤 지형에서도 길을 찾아가는 생명력, 그것이 당신의 본질입니다. 뛰어난 공감 능력과 탁월한 적응력으로 어떤 조직에서도 부드럽게 스며들어 핵심 역할을 합니다. 공감적 경청의 힘이 특히 강해서 상대방이 말하기 전에 무엇을 필요로 하는지 먼저 알아채는 경우가 많습니다.<br><br>심리학적으로 볼 때, 을목 일간은 높은 정서 지능(Emotional Intelligence)을 타고났습니다. 다니엘 골먼이 정의한 EI의 5가지 요소, 즉 자기 인식, 자기 조절, 동기 부여, 공감, 사회적 기술 모두에서 평균 이상의 잠재력을 보입니다. 이 때문에 팀 내 갈등 중재자, 분위기 메이커, 조용한 실세 역할을 자연스럽게 맡게 됩니다. 그러나 이 강점의 이면에는 중요한 취약점이 숨어 있습니다. 바로 경계의 불명확함입니다. 지나치게 타인의 감정에 맞추다 보면 자신의 감정과 욕구를 점점 잃어가게 됩니다. 감정 소모의 축적은 어느 순간 갑작스러운 관계 철수나 번아웃으로 터져나옵니다.<br><br>결정의 순간에 타인의 눈치를 과도하게 보면 기회를 놓칩니다. 이것은 단순한 우유부단함이 아니라, 내면 깊이 자리한 거절당할 것 같은 두려움과 관계 조화를 깨뜨리면 안 된다는 신념에서 비롯됩니다. 인지행동치료(CBT) 관점에서 이 자동적 사고는 실제 상황보다 훨씬 과장된 결과를 상상하게 만듭니다. 연습해야 할 것은 자신의 의견을 말해도 관계가 깨지지 않는 경험을 반복해서 쌓는 것입니다.<br><br>당신에게 가장 필요한 성장 처방은 명확한 경계 설정(Boundary Setting)과 자기 주장 훈련입니다. 이것은 상대를 거부하는 것이 아니라, 자신을 존중하는 행위입니다. 자신을 소모하지 않으면서도 타인을 깊이 돌볼 수 있을 때, 을목 에너지의 가장 아름다운 꽃이 핍니다. 덩굴은 지지대를 올바르게 선택할 때 가장 높이 올라갑니다. 당신이 기댈 올바른 지지대, 즉 진심으로 당신의 성장을 응원하는 관계와 환경을 선택하는 안목이 인생의 방향을 결정합니다.',
    丙:'병화(丙火)는 뜨거운 태양입니다. 스스로 빛을 내며 주변 전체를 환하게 밝히는 존재, 그것이 당신의 타고난 역할입니다. 병화 일간은 어디서든 중심이 되고, 에너지가 넘치며, 주변 사람들에게 활력과 용기를 불어넣는 천부적 능력을 지닙니다. 솔직하고 직접적인 표현 방식 덕에 진정성 있는 인기를 얻으며, 감정 표현이 풍부해 사람들이 함께 있고 싶어하는 존재가 됩니다.<br><br>심리학적으로 볼 때, 병화 일간의 핵심 동기는 영향력과 연결입니다. 자신의 존재가 타인에게 긍정적 변화를 가져다줄 때 가장 큰 에너지를 얻습니다. 그러나 이 강렬한 출력 에너지는 동시에 내적 조절의 어려움을 수반합니다. 감정 기복이 크고, 충동적 결정을 내리기 쉬우며, 시작은 화끈하지만 지속력이 부족해지는 패턴이 반복될 수 있습니다. 신경과학적으로 이것은 도파민 반응이 강한 기질과 연결됩니다. 새로운 자극에 즉각 반응하고, 그 강도가 줄어들면 다른 자극을 찾는 사이클이죠.<br><br>쉽게 흥미를 잃고 새로운 자극을 찾아다니는 성향 때문에, 결실을 맺기 직전에 포기하는 패턴이 삶에서 반복될 수 있습니다. 이것이 당신의 가장 큰 약점입니다. 화끈하게 시작한 일을 완주하는 힘, 즉 그릿(Grit)을 의식적으로 훈련해야 합니다. 깊이 들어갔을 때 발견되는 보물은 처음 흥분이 가라앉은 후에야 비로소 나타나기 때문입니다.<br><br>당신에게 가장 필요한 처방은 자기 돌봄의 루틴화입니다. 태양도 밤이 있어야 다음 날 빛날 수 있습니다. 에너지를 무한정 발산하다 소진되는 사이클을 끊으려면, 의도적으로 회복의 시간을 스케줄에 넣어야 합니다. 자신의 에너지 배터리를 충전하는 活動이 무엇인지 명확히 알고, 그것을 소비가 아닌 투자로 인식하는 전환이 필요합니다. 병화의 빛은 잘 관리될 때 가장 멀리까지 닿습니다.',
    丁:'정화(丁火)는 은은하게 타오르는 촛불입니다. 병화의 태양처럼 강렬하지는 않지만, 어둠 속에서 진정한 따뜻함과 방향을 제시하는 빛입니다. 겉으로는 조용하고 차분해 보이지만, 내면에는 놀라울 정도로 뜨거운 열정과 섬세한 감수성이 있습니다. 한 번 신뢰를 쌓은 관계에서는 무한한 충성심과 배려를 보이며, 상대방의 작은 변화도 놓치지 않는 관찰력이 탁월합니다.<br><br>심리학적으로 볼 때, 정화 일간은 고도로 민감한 사람(Highly Sensitive Person, HSP)의 특성을 강하게 보입니다. HSP는 전체 인구의 15-20%를 차지하는 기질로, 세상을 더 깊이, 더 풍부하게 처리하는 신경계 특성입니다. 이 기질은 창의성, 공감, 직관력이라는 강력한 강점을 가져다주지만, 동시에 자극 과부하와 정서적 소진에 더 취약하게 만듭니다. 당신이 때로 사람들이 많은 환경에서 지치거나, 타인의 감정을 자기 것처럼 느끼거나, 아주 작은 비판에도 깊이 상처받는다면, 이것은 결함이 아니라 당신 기질의 특성입니다.<br><br>갈등을 피하기 위해 감정을 억누르다 일정 수준에서 폭발하는 패턴이 있습니다. 이것은 감정 억압(Emotional Suppression)의 전형적인 결과입니다. 억누른 감정은 사라지지 않고 내면에 축적되다가, 예상치 못한 순간에 폭발적으로 터져나옵니다. 이를 방지하기 위해서는 매일 자신의 감정을 소량씩 처리하는 습관이 필요합니다. 일기 쓰기, 신뢰하는 사람과의 대화, 명상 등을 통해 내면의 감정 쓰레기통을 주기적으로 비워주세요.<br><br>당신의 가장 중요한 성장 과제는 자기 연민(Self-Compassion)입니다. 타인에게는 그토록 따뜻하고 배려 깊은 당신이, 정작 자신에게는 가장 가혹한 비평가가 됩니다. 세계적 심리학자 크리스틴 네프의 연구에 따르면, 자기 연민은 자존감보다 더 안정적인 심리적 건강의 토대가 됩니다. 오늘부터 자신에게도 친한 친구에게 하듯 말해보세요. 촛불의 따뜻함이 자신의 내면으로도 향할 때, 당신의 빛은 꺼지지 않고 더 오래, 더 고르게 타오릅니다.',
    戊:'무토(戊土)는 드넓은 대산(大山)과 같습니다. 어떤 것도 받아들이는 무한한 포용력과 어떤 폭풍에도 흔들리지 않는 안정감이 당신의 가장 큰 자산입니다. 사람들은 자연스럽게 당신 곁에서 안도감을 느끼며, 위기의 순간에 무의식적으로 당신을 찾습니다. 약속과 책임을 무엇보다 중시하고, 한번 맡은 일은 끝까지 해내는 사람으로 신뢰받습니다.<br><br>심리학적으로 볼 때, 무토 일간은 안정 애착 유형(Secure Attachment Style)에 가장 가까운 특성을 보입니다. 자신과 세상에 대한 기본적 신뢰가 탄탄하고, 관계에서 불안이나 회피 없이 깊은 유대를 형성할 수 있습니다. 이것은 현대 사회에서 매우 희귀하고 가치 있는 자원입니다. 그러나 이 안정감이 변화 저항으로 이어질 때 큰 기회를 놓치게 됩니다. 뇌 과학적으로, 무토 기질은 기저핵(Basal Ganglia)의 습관 회로가 매우 강하게 작동합니다. 익숙한 것은 안전하고, 새로운 것은 위험하다는 신호를 뇌가 강하게 보내기 때문에 변화 앞에서 자동적으로 제동이 걸립니다.<br><br>기회의 시간이 왔을 때 망설이다 놓치는 경우가 반복된다면, 행동을 시작하는 타이밍을 의도적으로 앞당기는 연습이 필요합니다. 작은 새로운 시도를 매주 하나씩 일상에 넣어보세요. 주문하는 커피를 바꾸는 것부터 시작해도 됩니다. 뇌는 작은 새로움의 경험을 통해 변화에 대한 신경 경로를 서서히 넓혀갑니다.<br><br>무토에게 가장 중요한 성장 처방은 의도적 모험 루틴(Intentional Adventure Routine)입니다. 생존을 위한 안정이 아닌, 성장을 위한 적절한 불편함을 자신에게 허락하세요. 산은 폭풍 속에서도 위치를 바꾸지 않지만, 계절에 따라 다른 모습을 보입니다. 당신도 본질의 안정감은 지키면서, 외면적으로는 새로운 계절을 맞이하는 탁월한 능력을 발휘할 수 있습니다.',
    己:'기토(己土)는 비옥한 밭입니다. 씨앗을 심으면 풍성한 열매가 나고, 무엇이든 받아들여 키워내는 생산적인 대지입니다. 세밀하고 실용적인 눈으로 주변 사람의 필요를 파악하고 뒤에서 든든하게 지원합니다. 자신의 공로를 드러내지 않아도 조직의 실질적인 중심 역할을 하며, 모든 일이 매끄럽게 돌아가는 이면에는 대개 기토 에너지의 조용한 헌신이 있습니다.<br><br>심리학적으로 볼 때, 기토 일간은 돌봄 기반 동기(Care-based Motivation)가 매우 강합니다. 타인의 성장과 행복에 기여할 때 자신의 존재 이유와 성취감을 느끼는 유형입니다. 이것은 매우 숭고한 가치이지만, 동시에 자기 희생 패턴(Self-Sacrifice Pattern)이라는 그림자를 동반합니다. 남을 너무 챙기다 정작 자기 자신을 잃어버리는 것이 가장 큰 위험입니다. 자기 과소평가와 과도한 희생이 패턴화되면, 어느 날 갑자기 모든 것이 무의미하게 느껴지는 번아웃이 옵니다.<br><br>기토 일간이 가장 자주 빠지는 심리적 함정은 착한 사람 증후군(People Pleasing Syndrome)입니다. 모든 사람을 만족시키려는 시도는 결국 아무도 제대로 돕지 못하게 됩니다. 이것은 성격 문제가 아니라, 어린 시절 형성된 내가 충분히 좋아야 사랑받을 수 있다는 조건적 자기 가치감에서 비롯되는 경우가 많습니다. 당신은 무언가를 해줘야 가치 있는 사람이 아닙니다. 존재 자체로 이미 충분합니다.<br><br>가장 중요한 성장 처방은 자기 우선의 연습입니다. 비행기 안전 수칙처럼, 자신의 산소마스크를 먼저 써야 타인을 도울 수 있습니다. 결단력 부족 문제는 중요한 결정에 스스로 데드라인을 설정하는 습관으로 극복할 수 있습니다. 비옥한 밭도 쉬는 계절이 있어야 다음 해에 더 풍성한 수확을 냅니다. 당신이 먼저 충전되고 행복해야, 당신이 사랑하는 모든 사람에게 진정한 선물이 됩니다.',
    庚:'경금(庚金)은 날 선 큰 쇠입니다. 원석을 담금질하고 형태를 잡아 값진 도구를 만드는 강렬한 에너지가 당신의 본질입니다. 직선적이고 결단력이 강하며, 불합리한 상황을 보면 참지 못하고 직접 해결에 나섭니다. 이 솔직함과 정의감이 깊은 신뢰를 쌓는 힘이 됩니다. 복잡한 상황을 빠르게 본질로 파악하고, 위기 순간에 냉정한 판단력을 발휘하는 능력은 타의 추종을 불허합니다.<br><br>심리학적으로 볼 때, 경금 일간은 시스템 1 사고(빠른 직관적 판단)와 시스템 2 사고(느린 분석적 사고) 중 시스템 1의 속도와 결단력이 두드러집니다. 복잡한 상황을 오래 고민하지 않고 핵심을 짚어 바로 행동으로 옮기는 능력은 위기 상황의 리더십에서 매우 강력합니다. 그러나 이 빠른 판단이 인간관계에서는 상대방을 충분히 이해하기 전에 결론을 내려버리는 문제로 이어질 수 있습니다.<br><br>감정을 전달하는 방식에서 부드러움이 부족하면 주변 사람이 상처를 받습니다. 이것은 의도의 문제가 아니라 표현 방식의 차이를 인식하지 못하는 데서 오는 경우가 많습니다. 비폭력 대화(NVC, Nonviolent Communication) 원칙을 연습해보세요. 관찰, 느낌, 필요, 요청의 4단계로 말하는 습관은 당신의 직선적 소통에 부드러운 껍질을 입혀, 메시지를 더 효과적으로 전달하게 합니다. 날카로운 칼도 잘 다듬어진 손잡이가 있어야 상대방이 안전하게 쥘 수 있습니다.<br><br>당신에게 가장 필요한 성장 처방은 심리적 유연성(Psychological Flexibility)입니다. 완고함이 문제 해결을 방해할 때는 전략적으로 유연성을 발휘하세요. 올바른 목표를 위해서라면 방법을 바꾸는 것은 굴복이 아니라 지혜입니다. 의리와 책임감이라는 당신의 핵심 강점은 어떤 환경에서도 빛을 발합니다. 담금질될수록 더 단단해지는 쇠처럼, 갈등과 도전은 당신을 더 강하고 빛나게 만드는 연료입니다.',
    辛:'신금(辛金)은 담금질을 거쳐 정제된 보석입니다. 혹독한 과정을 통해 불필요한 것을 모두 제거하고, 오직 순수하고 빛나는 것만 남긴 에너지가 당신의 본질입니다. 예리하고 정확한 시각과 탁월한 미적 감각으로, 남들이 보지 못하는 디테일을 포착합니다. 완벽주의 성향으로 자신과 타인 모두에게 높은 기준을 적용하며, 이 섬세함이 창의적 결과물의 품질을 한 차원 높입니다.<br><br>심리학적으로 볼 때, 신금 일간은 완벽주의와 높은 기준 지향성이 매우 강합니다. 심리학자 브레네 브라운의 연구에 따르면, 건강한 완벽주의와 해로운 완벽주의는 다릅니다. 건강한 완벽주의는 높은 기준을 추구하면서도 실수를 허용하는 반면, 해로운 완벽주의는 실수를 자기 가치 하락으로 받아들입니다. 신금 일간은 후자로 기울기 쉬어, 완벽하지 않으면 세상에 보여줄 수 없다는 생각에 갇히는 경우가 있습니다. 70%의 완성도에서도 세상에 내보이는 용기가 필요합니다.<br><br>표면적으로는 차갑고 완벽해 보이지만, 내면은 매우 감성적이고 상처받기 쉽습니다. 비판에 과민 반응하는 경향이 있으며, 이로 인해 피드백을 개선의 기회가 아닌 공격으로 받아들이게 됩니다. 이것은 자기 가치를 성과와 결과물에만 연결시키는 조건부 자기 가치감(Contingent Self-Worth)에서 비롯됩니다. 나는 완벽해야 가치 있다는 신념을 나는 성장하는 과정에서 가치 있다로 재프레이밍하는 작업이 핵심입니다.<br><br>당신에게 가장 필요한 성장 처방은 불완전함과의 화해입니다. 자신의 기준을 낮추는 것이 아니라, 타인의 다름을 인정하고 자신의 실수를 학습 데이터로 보는 관점 전환이 필요합니다. 보석은 채굴된 순간부터 빛나는 것이 아니라, 수많은 연마 과정을 거쳐 빛납니다. 그 연마의 흔적, 즉 당신이 겪은 시도와 실수들이 당신을 더 정교하고 빛나는 존재로 만들어가고 있습니다.',
    壬:'임수(壬水)는 거대한 강물입니다. 막히면 돌아가는 유연함과 결코 멈추지 않는 흐름의 끈질김을 동시에 갖추고 있습니다. 시야가 넓고 전략적 사고가 탁월하며, 여러 분야를 동시에 처리하는 멀티태스킹 능력과 큰 그림을 보는 안목이 뛰어납니다. 막힌 상황에서도 다른 길을 찾아내는 문제 해결 능력은 탁월한 강점입니다.<br><br>심리학적으로 볼 때, 임수 일간은 시스템적 사고(Systems Thinking)와 빅 픽처 지향성이 두드러집니다. 개별 사건을 독립적으로 보는 것이 아니라, 복잡한 연결망 속에서 패턴과 구조를 파악하는 능력이 강합니다. 이것은 기획, 전략, 연구, 외교 등의 분야에서 매우 유용합니다. 그러나 이 광활함이 에너지를 과도하게 분산시켜, 넓게 알지만 깊이가 부족하다는 평가를 받을 수 있습니다. 강물도 수로를 좁히면 속도와 힘이 강해집니다.<br><br>감정을 잘 드러내지 않아 주변에서 속을 알기 어렵다는 말을 자주 듣지만, 내면은 매우 깊고 섬세합니다. 이 감정적 거리감은 상처 방어 기제로 발달한 경우가 많습니다. 깊이 연결되면 상처받을 수 있다는 무의식적 두려움이 감정 표현을 차단하게 됩니다. 진정한 연결은 취약성(Vulnerability)을 통해 이루어진다는 브레네 브라운의 연구를 기억하세요.<br><br>당신에게 가장 필요한 성장 처방은 집중력의 채널링입니다. 광활한 강물의 에너지를 하나의 수로에 집중시키는 시간을 만드세요. 매일 1-2가지 핵심 우선순위에 방해받지 않는 집중 시간(Deep Work)을 확보하면, 당신의 탁월한 전략적 사고가 실제 성과로 전환됩니다. 또한 자신의 감정을 신뢰하는 사람들에게 조금씩 개방하는 연습을 하세요. 강물이 바다와 만날 때 가장 완전해지듯, 당신의 깊이 있는 내면이 진정한 연결을 통해 꽃피울 때 비로소 임수의 잠재력이 완전히 발현됩니다.',
    癸:'계수(癸水)는 맑은 이슬입니다. 새벽녘 나뭇잎 위에 맺혀 세상을 정갈하게 적시는 이슬처럼, 당신은 조용하지만 깊은 방식으로 주변에 영향을 미칩니다. 공감 능력이 탁월하고 다른 사람의 감정을 빠르게 포착하여 섬세하게 반응합니다. 일대일 관계에서 깊고 따뜻한 교감을 나누며, 신뢰하는 사람에게는 전폭적인 지지를 제공하는 든든한 존재가 됩니다.<br><br>심리학적으로 볼 때, 계수 일간은 높은 공감 능력(Empathy)과 뛰어난 직관력을 보입니다. 이것은 철학자 마르틴 부버가 말한 나-너(I-Thou) 관계, 즉 온전히 상대방의 존재에 집중하며 진정한 만남을 이루는 능력과 연결됩니다. 이 탁월한 공감 능력이 타인의 고통을 자기 것처럼 느끼는 공감 과부하(Empathy Fatigue)로 이어지면, 지속적인 정서적 소진이 옵니다. 이를 방지하기 위한 공감적 경계(Empathic Boundaries) 훈련이 필요합니다.<br><br>우유부단함과 지나친 내성(Introversion)이 결합되면, 결정을 미루다 기회를 놓치는 패턴이 반복됩니다. 이것은 틀린 결정이 가져올 결과에 대한 과도한 걱정에서 비롯됩니다. 심리학자 배리 슈워츠의 역설적 선택(Paradox of Choice) 이론처럼, 선택지가 많을수록 결정 피로가 커지고 아무것도 선택하지 않는 것이 가장 안전하다는 잘못된 결론에 이르게 됩니다. 하지만 결정하지 않는 것 자체도 하나의 선택임을 기억하세요.<br><br>당신에게 가장 필요한 성장 처방은 직관에 대한 신뢰와 즉각적 실행입니다. 계수의 직관은 많은 경우 정확합니다. 분석하고 고민하는 시간보다, 그 직관이 이끄는 방향으로 작은 첫 걸음을 내딛는 용기가 인생의 흐름을 바꿉니다. 이슬은 아주 작은 물방울이지만, 수백만 개가 모이면 강을 이룹니다. 당신의 꾸준한 작은 실천들이 쌓여 만들어낼 인생의 강이 얼마나 아름다울지, 지금 당장 그 첫 물방울을 떨어뜨려 보세요.'
  };
  ...
  html+=box('🦁 ⑥ 성격·기질 심층 분석 (팩트 보고서)',
    ...
    callout((charBoxDetail[dg]||deep.nature))+
    divLine()+
    subHead('심리 치료사의 진단: 당신의 그림자 & 성장 처방','#b71c1c')+
    insight('당신의 핵심 강점인 <b>'+ganKeyword[dg]+'</b>는 올바로 활용될 때 가장 빛납니다. 하지만 모든 강점은 지나치면 약점이 됩니다. 아래 보완 포인트를 인식하고 의식적으로 다듬어 가세요.')+
    warn('<b>보완 포인트</b>: '+(ganWeakPoint[dg]||'균형을 항상 체크하세요')+'<br><br>이 약점은 타고난 한계가 아닙니다. 인식하고 의식적으로 다듬으면 오히려 강점의 더 깊은 면이 됩니다. 당신의 <b>'+dominant+'</b> 에너지와 함께 위의 보완점을 꾸준히 작업해가면, 사주가 가진 잠재력의 전부를 끌어낼 수 있습니다.')+
    quote('당신은 완벽한 사람이 될 필요가 없습니다. 다만 어제의 나보다 조금 더 성장한 오늘의 나를 만들어가면 됩니다.'),
  ...
  /* ─── 진로 적성별 심층 텍스트 ─── */
  var careerDeepText={
    wood:'목(木) 기운을 타고난 당신은 성장, 확장, 연결의 에너지가 삶의 동력입니다. 사람과 지식과 가능성이 만나는 지점에서 가장 빛나는 재능을 발휘합니다. 교육·강의·코칭 분야는 당신의 성장 욕구와 타인을 키우는 목의 본성이 완벽하게 합치하는 천직입니다. 글쓰기와 출판은 아이디어를 씨앗처럼 세상에 심어 오래 남기는 목 에너지의 표현입니다. 환경·조경·자연 치유 분야는 당신에게 깊은 내적 만족을 줍니다. 의료와 재활 분야에서는 회복과 성장을 돕는 역할이 목의 생명력과 공명합니다. 문화·예술 기획은 창의적 에너지를 사회적 가치로 전환하는 통로입니다.<br><br>진로를 선택할 때 가장 중요한 기준은 이 일이 나와 타인을 동시에 성장시키는가입니다. 목 에너지는 나무가 위로 자라면서 동시에 주변에 그늘을 만들듯, 자신의 발전이 곧 타인에게 도움이 되는 구조에서 가장 강렬한 동기를 얻습니다. 반대로 단순 반복 작업이나 창의성이 전혀 필요 없는 환경에서는 에너지가 빠르게 소진됩니다. 자율성이 보장되고, 지속적으로 새로운 것을 배우고 시도할 수 있는 환경을 우선적으로 찾으세요.<br><br>커리어 성공을 위한 목 에너지 전용 원칙: 처음 5년은 깊이에 투자하세요. 여러 분야를 얕게 경험하는 것보다, 하나의 전문 영역에서 확실한 뿌리를 내리는 것이 장기 성공의 토대가 됩니다. 10년 후에는 그 전문성이 다른 분야와 결합되어 독특한 가치를 만들어냅니다. 또한 네트워크의 질을 높이세요. 목 에너지는 연결에서 강해집니다. 유사한 가치관을 가진 사람들과의 깊은 네트워크가 예상치 못한 순간에 결정적 기회를 가져다줍니다.',
    fire:'화(火) 기운을 타고난 당신은 열정, 감화, 존재감의 에너지가 삶의 동력입니다. 사람들 앞에 서서 빛을 발하고, 에너지를 전달하고, 변화를 이끄는 역할에서 타고난 강점을 발휘합니다. 방송·미디어·PR 분야는 당신의 강한 존재감과 에너지를 담는 가장 자연스러운 그릇입니다. 연예·공연·스포츠는 화 에너지의 열정과 즉흥성이 강점이 되는 분야입니다. IT·스타트업·플랫폼 영역에서는 빠른 속도와 혁신 지향성이 화 에너지와 맞닿습니다. 요식·서비스·호텔 업종은 따뜻함과 환대의 화 에너지가 그대로 서비스 품질이 됩니다. 광고·마케팅·브랜딩은 창의적 아이디어와 감성적 스토리텔링을 결합하는 화 에너지의 무대입니다.<br><br>화 에너지 기반 커리어의 핵심은 지속 가능한 열정 관리입니다. 빠르게 타오르지만 빠르게 꺼지는 불처럼, 에너지 관리 없이는 번아웃의 위험이 큽니다. 흥분이 가라앉아도 계속할 수 있는 이유를 명확히 정의해두는 것이 장기 커리어의 생명줄입니다. 또한 감정 관리 능력이 직업적 성공의 핵심 변수입니다. 화 에너지는 감정 기복이 크기 때문에, 특히 공적 상황에서 감정을 전략적으로 표현하는 능력이 중요합니다.<br><br>화 에너지 전용 커리어 성공 공식: 자신의 이야기를 콘텐츠화하세요. 화 에너지의 진정성 있는 경험은 타인에게 강력한 영감이 됩니다. 소셜미디어, 강연, 글쓰기 등을 통해 자신의 여정을 공유하는 것이 개인 브랜드와 커리어를 동시에 성장시키는 가장 효과적인 전략입니다.',
    earth:'토(土) 기운을 타고난 당신은 안정, 신뢰, 포용의 에너지가 삶의 동력입니다. 사람들이 기댈 수 있는 단단한 기반을 만들고, 복잡한 것을 체계적으로 정리하며, 오랫동안 한결같이 지속하는 능력이 강점입니다. 부동산·건설·인테리어는 실물 자산을 다루는 토 에너지의 가장 직접적인 표현 분야입니다. 금융·보험·투자 영역에서는 안정 지향적 판단력이 탁월한 성과를 냅니다. 행정·공무·국제기관은 체계와 규칙을 중시하는 토 에너지의 신뢰성이 핵심 경쟁력입니다. 교육 지원과 상담 분야는 든든한 뒷받침의 역할로 토 에너지가 꽃피는 영역입니다.<br><br>토 에너지 기반 커리어의 핵심은 변화에 대한 전략적 수용입니다. 안정을 선호하는 토 에너지는 변화가 느린 전통 산업에서 강점을 발휘하지만, 동시에 그 산업이 급변할 때 적응이 느릴 수 있습니다. 5년마다 자신의 커리어 맵을 새로 그려보는 습관을 들이면 변화 속에서도 중심을 잃지 않습니다. 신뢰와 성실함이라는 토 에너지의 핵심 강점은 어떤 환경에서도 당신을 없어서는 안 될 사람으로 만듭니다. 한곳에서 오래 일하면서 쌓이는 깊은 전문성과 관계 자본이 가장 강력한 경쟁 우위입니다.',
    metal:'금(金) 기운을 타고난 당신은 정밀함, 정직, 원칙의 에너지가 삶의 동력입니다. 복잡한 것을 단순화하고, 불필요한 것을 제거하며, 핵심을 정확히 짚는 능력이 강점입니다. 법률·검찰·경찰·군인 분야는 금 에너지의 정의감과 결단력이 직접적으로 발현되는 천직입니다. 의료·치과·외과는 정밀함과 결단력이 결합돼야 하는 금 에너지의 최적 영역입니다. 금융·회계·세무는 정확성과 원칙 지향성이 핵심인 분야입니다. IT보안·정밀기술·항공은 미세한 오차를 허용하지 않는 금 에너지의 집중력이 발휘되는 곳입니다.<br><br>금 에너지 기반 커리어 성공의 핵심은 인간 관계 자본의 구축입니다. 전문성은 이미 뛰어나지만, 그 전문성을 세상에 전달하기 위한 소통력이 커리어의 천장을 결정합니다. 기술이나 지식으로 문제를 해결하는 능력은 탁월하지만, 그 해결책을 상대방이 받아들이도록 설득하는 능력이 동반돼야 합니다. 멘토링, 코칭, 발표 등을 통해 전문성을 나누는 경험을 쌓을수록 리더로서의 영향력이 확장됩니다.',
    water:'수(水) 기운을 타고난 당신은 깊이, 통찰, 흐름의 에너지가 삶의 동력입니다. 표면 너머의 패턴을 읽고, 보이지 않는 연결을 발견하며, 숨겨진 진실에 다가가는 능력이 강점입니다. 연구·분석·데이터 분야는 수 에너지의 깊이 있는 탐구력이 최고의 성과를 내는 영역입니다. 외교·무역·관광은 다양한 문화와 사람을 연결하는 수 에너지의 유연성이 강점이 됩니다. 심리·상담·철학은 인간 내면의 깊이를 탐구하는 수 에너지의 본질적 방향입니다. 글쓰기·시·문학·음악·영화는 수 에너지의 감성과 철학이 예술로 승화되는 분야입니다.<br><br>수 에너지 기반 커리어의 핵심은 통찰을 실행으로 연결하는 구조 만들기입니다. 뛰어난 분석력과 통찰력이 아이디어 단계에 머물지 않고 결과물로 이어지려면, 실행 파트너나 프로젝트 관리 시스템이 필요합니다. 혼자서도 깊이 있게 일할 수 있지만, 실행력이 강한 파트너와의 협업이 성과를 기하급수적으로 높입니다. 수 에너지의 전략적 사고와 실행형 파트너는 최강의 조합입니다.'
  };

  html+=box('💼 ⑦ 진로 적성 & 성공 천기 — 운명이 알려주는 직업 지도',
    subHead('천성 맞춤 분야 ('+EL_KO[dayMaster]+' 에너지 기반)','#1565C0')+
    li(careerByEl[dayMaster]||[])+
    callout((careerDeepText[dayMaster]||deep.career))+
    divLine()+
    subHead('십성 '+dominant+' 기반 핵심 추천','#0d47a1')+
    '<div style="font-size:.84rem;margin-top:4px;line-height:1.78">'+deep.career+'</div>'+
    growth('성공의 핵심 전략: 당신의 가장 큰 강점인 <b>'+tsInfo.meaning+'</b>을(를) 전면에 내세우세요. '+lifeStrategyByTs[dominant])+
    divLine()+
    subHead('진로 선택 3원칙','#0d47a1')+
    insight('① <b>몰입 테스트</b>: 이 일을 할 때 시간 가는 줄 모르는가? 의식 없이 열중하는 것이 천직의 신호입니다.<br>② <b>강점 전환 테스트</b>: 이 분야에서 내 약점이 오히려 강점으로 전환되는가? 섬세함이 단점인 환경과 장점인 환경이 다릅니다.<br>③ <b>시장 교차 테스트</b>: 5년 후 이 분야의 전문가가 되었을 때 세상이 필요로 하는가? 자신의 재능과 세상의 필요가 교차하는 지점이 최적 커리어 방향입니다.'),
  ...
  /* ─── 일간별 연애 심층 텍스트 ─── */
  var loveDeepText={
    wood:'목(木) 에너지를 가진 당신에게 사랑은 함께 성장하는 여정입니다. 정체된 관계, 성장이 멈춘 파트너십은 나뭇가지가 햇빛을 잃듯 서서히 생기를 잃습니다. 당신이 가장 사랑에 빠지는 순간은 상대방이 지적인 자극을 주거나, 새로운 세계를 함께 탐험하거나, 자신도 몰랐던 새로운 모습을 끌어내 줄 때입니다. 관계에서 자율성을 지키는 것이 매우 중요합니다. 지나치게 밀착되거나 의존적인 관계는 목 에너지를 질식시킵니다. 건강한 적정 거리감이 오히려 관계를 더 오래, 더 깊게 지속하게 합니다.<br><br>연애에서 가장 주의해야 할 패턴은 상대방을 바꾸려는 충동입니다. 목 에너지는 성장을 추구하기 때문에 상대방도 동일한 속도로 성장하기를 기대합니다. 하지만 사람마다 성장의 속도와 방향이 다릅니다. 파트너를 내가 원하는 모습으로 변화시키려는 시도는 관계의 가장 큰 갈등 원인이 됩니다. 상대방을 있는 그대로 사랑하면서, 함께 성장하는 방향을 찾는 것이 목 에너지에게 가장 행복한 사랑의 방식입니다.<br><br>결혼 후 행복의 열쇠는 각자의 꿈과 목표를 존중하고 응원하는 파트너십입니다. 상대방의 성장이 곧 나의 행복이라는 인식이 목 에너지 사주의 결혼을 오래 행복하게 유지하는 비결입니다. 정기적으로 서로의 꿈과 목표를 나누는 대화 시간을 만들어 보세요.',
    fire:'화(火) 에너지를 가진 당신에게 사랑은 뜨겁고 극적인 모험입니다. 첫눈에 반하는 사랑, 운명 같은 만남, 설레는 감정의 롤러코스터가 당신이 사랑에서 추구하는 경험입니다. 관계 초반에 엄청난 에너지와 열정을 쏟아붓기 때문에 상대방을 압도하는 경우가 많습니다. 이 뜨거운 시작이 장기적으로 지속되려면, 초반의 열정이 가라앉은 후에도 관계를 유지하는 이유를 의식적으로 만들어가야 합니다.<br><br>화 에너지의 가장 큰 사랑의 위험은 권태입니다. 새로운 관계의 흥분이 사라지면 자연스럽게 다음 자극을 찾게 됩니다. 이것이 반복되면 진정한 사랑을 경험하기 어려워집니다. 사랑은 감정이 아니라 선택이자 실천이라는 인식의 전환이 필요합니다. 감정의 흥분 없이도 상대방을 위해 작은 배려를 실천하는 날들이 쌓일 때, 그것이 진정한 사랑의 뿌리가 됩니다. 정기적으로 새로운 경험을 함께 만들어가는 습관이 권태를 방지하는 가장 효과적인 방법입니다.',
    earth:'토(土) 에너지를 가진 당신에게 사랑은 든든한 안식처를 만드는 과정입니다. 화끈한 로맨스보다 한결같은 신뢰와 안정감이 당신이 관계에서 가장 중시하는 가치입니다. 처음에는 경계가 강하고 마음을 여는 데 시간이 걸리지만, 한 번 마음을 열면 깊고 변치 않는 사랑을 합니다. 상대방 입장에서는 처음에 다가가기 어렵지만, 시간이 지날수록 당신의 진가를 알게 됩니다.<br><br>토 에너지의 사랑에서 주의해야 할 것은 지나친 안정 추구가 변화를 막는 것입니다. 관계도 성장이 필요합니다. 너무 익숙해진 나머지 서로를 당연하게 여기는 순간, 관계의 생기가 줄어들 수 있습니다. 정기적으로 새로운 경험을 함께 하거나, 서로에게 감사를 표현하는 루틴을 만들어 보세요. 토 에너지의 가장 행복한 결혼은 서로가 안식처가 되어주는 관계입니다. 일상의 작은 안정감들이 쌓여 만드는 깊고 따뜻한 사랑이 당신이 추구하는 가장 이상적인 파트너십입니다.',
    metal:'금(金) 에너지를 가진 당신에게 사랑은 원칙과 신뢰를 기반으로 한 파트너십입니다. 상대방에게도 자신과 동일한 수준의 정직함과 책임감을 기대하며, 이 기준이 충족되지 않으면 관계를 지속하기 어렵습니다. 감정 표현이 서툴러 상대방이 오해하는 경우가 많습니다. 마음속으로는 깊이 사랑하지만, 그 감정을 행동과 말로 표현하는 능력을 의식적으로 훈련해야 합니다.<br><br>금 에너지의 사랑에서 가장 자주 발생하는 갈등은 직선적인 소통 방식입니다. 사실과 논리 중심의 소통이 상대방에게 냉정하거나 비판적으로 느껴질 수 있습니다. 비폭력 대화 원칙을 연습하면 그 직선성을 유지하면서도 관계를 보호할 수 있습니다. 당신의 원칙과 정직함이라는 강점은 신뢰 기반의 깊고 오래가는 관계를 만드는 가장 확실한 토대입니다.',
    water:'수(水) 에너지를 가진 당신에게 사랑은 영혼의 교감입니다. 외모나 스펙보다 내면의 깊이와 지적 교감이 당신을 사랑에 빠지게 만드는 핵심 요소입니다. 상대방을 표면적으로 알아가는 것에서 멈추지 않고, 그 사람의 내면 세계를 이해하고 싶어합니다. 이 깊은 연결 욕구가 강렬한 유대감을 만들지만, 동시에 이별의 상처가 매우 깊고 오래가는 원인이 됩니다.<br><br>수 에너지의 사랑에서 주의해야 할 것은 감정에 너무 몰입하여 현실을 놓치는 것입니다. 이상적인 사랑의 그림을 그려놓고 상대방이 그 그림과 다를 때 깊은 실망을 느끼는 패턴이 있습니다. 상대방을 있는 그대로 바라보는 현실적 시각이 필요합니다. 또한 감정을 언어로 표현하는 연습을 해야 합니다. 깊은 내면의 감정이 소통되지 않으면 상대방은 당신의 마음을 알 수 없습니다. 수 에너지의 가장 행복한 관계는 서로의 내면 여행을 함께하는 동반자적 사랑입니다.'
  };

  html+=box('💘 ⑧ 연애·결혼 심층 풀이',
    subHead('사랑의 패턴','#ad1457')+
    '<div style="font-size:.84rem;line-height:1.78;margin-top:4px">'+deep.love+'</div>'+
    callout((loveDeepText[dayMaster]||loveByEl[dayMaster||'earth']))+
    divLine()+
    subHead('인연의 신호 — 어떤 사람과 맞는가','#c2185b')+
    ...
    insight('사랑의 5가지 언어(칭찬의 말, 고품질 시간, 선물, 봉사 행위, 접촉) 중 당신과 상대방의 언어가 다를 수 있습니다. 배우자의 사랑 언어를 파악하고 그 방식으로 사랑을 표현할 때 관계가 깊어집니다.')+
    subHead('결혼 후 행복 유지 원칙','#880e4f')+
    growth('갈등은 관계의 실패 신호가 아니라 더 깊이 알아가는 과정입니다. 갈등을 회피하지 않고 적극적으로 대화하는 패턴, 서로의 성장 공간 존중, 일상의 작은 감사 표현이 장기적으로 행복한 결혼의 세 기둥입니다. 말하지 않아도 알아줄 것이라는 기대는 오해를 낳습니다. 지금 바로 상대방에게 감사하다고 말하세요.'),
  ...
  /* ─── 일간별 건강 심층 텍스트 ─── */
  var healthDeepText={
    wood:'목(木) 에너지의 건강 취약 포인트는 간과 담낭 계통입니다. 목은 간장기(肝臟器)와 연결되며, 스트레스와 분노가 누적될 때 가장 먼저 반응합니다. 눈의 피로, 근막 뻣뻣함, 손발 저림, 두통은 간 에너지 고갈의 대표적 신호입니다. 특히 분노를 억누르는 습관이 있다면 이것이 간 기운의 울체(鬱滯)로 이어져 짜증, 불면, 소화 불량으로 나타납니다. 감정을 건강하게 표현하는 것이 목 에너지 건강 관리의 첫 번째 원칙입니다. 푸른 채소, 신맛 나는 음식(레몬, 식초, 발효식품), 산나물이 목 에너지를 보양합니다. 스트레칭, 요가, 자연 속 걷기가 간 경락을 활성화합니다. 봄철 특히 건강 관리에 신경 쓰고, 과음과 기름진 음식을 자제하세요.',
    fire:'화(火) 에너지의 건강 취약 포인트는 심장과 소장 계통입니다. 화는 심장기(心臟器)와 연결되며, 과도한 자극과 흥분, 수면 부족이 누적될 때 심장에 부담을 줍니다. 가슴 두근거림, 불면, 더위를 타는 증상, 얼굴 붉어짐, 혀의 이상이 화 에너지 과부하의 대표적 신호입니다. 화 에너지는 소진이 빠르므로 충분한 수면이 건강 유지의 핵심입니다. 쓴맛 음식(씀바귀, 여주, 녹차), 붉은 채소(토마토, 붉은 파프리카), 오메가3가 풍부한 생선이 심장을 보호합니다. 명상, 심호흡, 수영이 항진된 화 에너지를 조절합니다. 여름철 방심 금지, 과로와 카페인 과다를 특히 조심하세요.',
    earth:'토(土) 에너지의 건강 취약 포인트는 비장과 위장 계통입니다. 토는 비위기(脾胃器)와 연결되며, 지나친 걱정과 과식이 가장 큰 적입니다. 소화 불량, 식욕 부진, 복부 팽만, 무기력, 과도한 생각으로 잠 못 드는 증상이 토 에너지 고갈의 신호입니다. 규칙적인 식사 시간을 지키고 과식과 폭식을 피하는 것이 토 에너지 건강의 핵심입니다. 단맛의 자연 식품(고구마, 대추, 꿀), 노란 채소(단호박, 옥수수), 발효식품이 비위를 보강합니다. 규칙적인 산책과 태극권, 복식 호흡 명상이 위장 기능을 안정시킵니다. 습기가 많은 환경과 냉음식을 자제하세요.',
    metal:'금(金) 에너지의 건강 취약 포인트는 폐와 대장 계통입니다. 금은 폐기(肺器)와 연결되며, 슬픔과 우울이 누적될 때 폐 에너지가 저하됩니다. 피부 건조, 잦은 기침, 변비 혹은 장 민감성, 슬픔과 우울감이 금 에너지 저하의 대표 신호입니다. 깊은 호흡을 의식적으로 연습하는 것이 폐 에너지를 보강하는 가장 좋은 방법입니다. 매운맛 음식(생강, 파, 마늘)은 적당히 폐를 보강하지만 과하면 역효과가 납니다. 흰 음식(배, 무, 연근, 두부), 호흡 중심 운동이 금 에너지를 보양합니다. 건조한 환경을 조심하고, 규칙적인 피부 보습 관리가 금 에너지 건강 지표입니다.',
    water:'수(水) 에너지의 건강 취약 포인트는 신장과 방광 계통입니다. 수는 신장기(腎臟器)와 연결되며, 만성적 과로와 두려움이 누적될 때 신 에너지가 고갈됩니다. 허리와 무릎 약화, 이명, 탈모, 빈뇨, 만성 피로, 두려움과 불안이 수 에너지 고갈의 대표 신호입니다. 충분한 수면과 수분 섭취가 신 에너지 보강의 핵심입니다. 짠맛 음식(해조류, 된장, 검은콩), 검은 음식(흑임자, 오디, 블루베리), 뼈를 강화하는 칼슘이 신장을 보양합니다. 수영, 아쿠아로빅, 명상이 수 에너지를 보강합니다. 차가운 음식과 환경, 과도한 성생활, 밤샘 작업을 특히 조심하세요.'
  };

  html+=box('🥗 ⑨ 건강·소울 푸드 & 스트레스 신호 분석',
    subHead('타고난 건강 약점 & 경보 신호','#2e7d32')+
    ...
    '</div>'+
    callout((healthDeepText[dayMaster]||health.advice))+
    divLine()+
    subHead('오행에 맞는 운동 추천','#388e3c')+
    li(dayMaster==='wood'?['산책·등산·자연 속 스트레칭 (간 경락 활성화)','요가·필라테스 (근막 이완 & 유연성)','리듬 댄스·수영 (감정 발산 & 전신 순환)']:
       dayMaster==='fire'?['수영·아쿠아로빅 (과열 된 심장 에너지 냉각)','명상·심호흡 운동 (자율신경 안정화)','사이클·가벼운 산책 (지속 가능한 유산소)']:
       dayMaster==='earth'?['규칙적 걷기·태극권 (소화기 활성화)','헬스·코어 운동 (복부 근력 강화)','복식 호흡·명상 (걱정 패턴 완화)']:
       dayMaster==='metal'?['야외 달리기·복싱 (울적함 해소)','수영·줄넘기 (폐 기능 강화)','깊은 호흡 & 근력 운동 (장 기능 활성화)']:
       ['수영·아쿠아로빅 (신장 에너지 보강)','스트레칭·폼롤러 (허리·무릎 보호)','명상·요가 (두려움 & 불안 해소)'])+
    insight('수면은 모든 에너지의 기반입니다. 하루 7-8시간 수면이 부의 90%를 결정하는 체력을 만듭니다. 오늘 밤 취침 시간을 30분 앞당기는 것이 가장 확실한 건강 투자입니다.'),
    '#4caf50','rgba(232,245,233,.7)');
  ...
  html+=box('💰 ⑩ 재물운 & 투자 전략 상세',
    ...
    callout('재물은 운만으로 오지 않습니다. 당신의 <b>'+dominant+'</b> 에너지가 가장 잘 발현될 때 돈도 자연스럽게 따라옵니다. 반대로 에너지가 억눌리거나 잘못된 방향에 쓰일 때 재물이 새어나갑니다. 수입을 늘리는 것만큼 지출의 패턴을 점검하는 것이 중요합니다. 충동 지출, 보증 리스크, 감정적 투자가 <b>'+dominant+'</b> 에너지의 가장 큰 재물 누수 구멍입니다. 매월 1일 전월 수입/지출을 검토하는 월간 머니 리뷰 30분이 1년 뒤 자산을 크게 바꿉니다.')+
    divLine()+
    subHead('오행 기반 재물 개운법','#f57c00')+
    '<div style="font-size:.84rem;line-height:1.78;margin-top:4px">'+
    (elMoneyAdvice[domE]||'재물이 들어오는 방향과 색상을 활용하세요')+'</div>'+
    subHead('투자 원칙','#ef6c00')+
    ...
    insight('재물운의 단기 흐름은 세운(그 해 운)에 따라 달라집니다. 큰 투자 결정은 용신 에너지가 강한 해에 집중하고, 기신 에너지의 해에는 리스크를 최소화하며 내실을 쌓으세요. 매년 1월에 그 해의 재물운을 확인하고 재무 전략을 수립하는 습관이 자산을 꾸준히 성장시킵니다.')+
    warn('주의: <b>'+dominant+'</b> 에너지의 대표적 재물 실패 패턴 — '+tsMoneyPattern[dominant]+' 이 패턴이 반복된다면 자동이체 저축으로 강제 자산 구조를 먼저 만드세요.'),
  ...
  html+=box('🤝 ⑪ 귀인(貴人) & 인간관계 지도',
    ...
    callout((guiinByDom[domE]||'당신의 성장을 돕는 멘토와 공동체'))+
    subHead('인간관계 패턴','#1976D2')+
    '<div style="font-size:.84rem;line-height:1.78;margin-top:4px">'+
    tsRelPattern[dominant]+'</div>'+
    divLine()+
    subHead('당장 정리해야 할 관계 시그널','#d32f2f')+
    warn('아래 3가지 중 하나라도 해당하는 관계는 에너지를 소모하고 운을 막는 구조입니다. 거리를 두거나 관계 구조를 바꾸는 결정이 필요합니다.<br>① 나의 성장을 시기하거나 반복적으로 깎아내리는 사람<br>② 돈·감정·시간을 지속적으로 착취하면서 돌아오는 것이 없는 관계<br>③ 함께 있을 때 자존감이 낮아지거나 피로해지는 환경')+
    subHead('귀인을 끌어당기는 법','#1565C0')+
    growth('귀인은 명함을 들고 찾아오지 않습니다. 당신이 진심을 다하는 영역에서, 꾸준히 가치를 쌓을 때 자연스럽게 나타납니다. 먼저 당신 자신이 타인의 귀인이 되어야 귀인을 끌어당길 수 있습니다. <b>'+dominant+'</b> 에너지를 가진 당신의 귀인 유형인 <b>'+(guiinByDom[domE]||'성장을 돕는 멘토')+'</b>와의 만남을 의도적으로 늘리세요. 커뮤니티, 스터디 모임, 업계 행사에 꾸준히 참여하면서 자신의 가치를 먼저 나누는 태도가 귀인 인연을 만드는 가장 확실한 방법입니다.'),
    '#1565C0','rgba(227,242,253,.7)');
  ...
  html+=box('🚀 ⑬ 인생 전략 로드맵 — 연이의 종합 천기',
    ...
    growth(lifeStrategyByTs[dominant])+
    divLine()+
    subHead('지금 당장 시작할 3가지 핵심 루틴','#7b1fa2')+
    callout('<b>① 주간 리뷰 (매주 일요일 20분)</b>: 이번 주 어떤 결정을 했고 어떤 결과가 왔는가? <b>'+dominant+'</b> 에너지가 잘 발현된 순간과 낭비된 순간을 기록하세요. 패턴이 보이면 다음 주 행동이 달라집니다. 삶은 순간의 선택이 아니라 반복된 패턴의 결과입니다.')+
    callout('<b>② 귀인 접점 늘리기 (월 2회)</b>: 당신의 성장 방향과 같은 사람들이 모이는 공간에 정기적으로 참여하세요. 귀인은 찾는 것이 아니라 올바른 환경 안에서 자연스럽게 만나는 것입니다. 먼저 자신의 가치를 나누는 사람이 귀인을 끌어당깁니다.')+
    callout('<b>③ 용신 에너지 흡수 (매일)</b>: 용신 색상의 소품, 방향 알람, 용신 음식 식단 포함 등 작은 일상의 조율이 에너지 균형을 유지합니다. 큰 변화는 작은 일상의 반복에서 시작됩니다.')+
    quote('지금 당신이 서 있는 곳이 정확히 당신이 있어야 할 곳입니다. 중요한 것은 방향입니다. 올바른 방향으로 한 걸음씩 나아가면, 반드시 원하는 곳에 도달합니다.'),
    '#9C27B0','rgba(243,229,245,.7)');
