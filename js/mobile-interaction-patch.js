(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-ea49d0bd7f16').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-ea49d0bd7f16'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-ea49d0bd7f16'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-ea49d0bd7f16'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-ea49d0bd7f16'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-ea49d0bd7f16'],
    openDreamModal: ['js/dream-ledger.js?v=build-ea49d0bd7f16'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-ea49d0bd7f16'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-ea49d0bd7f16']
  };
