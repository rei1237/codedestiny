(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-a32d26af6edb').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-a32d26af6edb'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-a32d26af6edb'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-a32d26af6edb'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-a32d26af6edb'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-a32d26af6edb'],
    openDreamModal: ['js/dream-ledger.js?v=build-a32d26af6edb'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-a32d26af6edb'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-a32d26af6edb']
  };
