(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-f5bf670864ab').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-f5bf670864ab'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-f5bf670864ab'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-f5bf670864ab'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-f5bf670864ab'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-f5bf670864ab'],
    openDreamModal: ['js/dream-ledger.js?v=build-f5bf670864ab'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-f5bf670864ab'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-f5bf670864ab']
  };
