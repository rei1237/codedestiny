(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-cce19efaa526').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    openPhysiognomyApp: [
      ...
      'PhysiognomyUI.js?v=ha8cb319b39b1'
    ],
    openPastLifeFaceApp: [
      'AnalysisEngine.js?v=ha8cb319b39b1',
      'PastLifeFaceUI.js?v=ha8cb319b39b1'
    ],
    openMbtiModal: ['js/astral-soul.js'],
    openAnimalTotemModal: [
      'js/services/animal-totem-content-engine.js',
      'js/animal-totem-experience.js?v=build-cce19efaa526'
    ],
    openHwatuModal: ['HwatuFortune.js?v=ha8cb319b39b1'],
    // NOTE: uiBindings uses the js/... path; keep the mobile patch path aligned.
    // ensure the latest script is loaded on launch.
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-cce19efaa526'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-cce19efaa526'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-cce19efaa526'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-cce19efaa526'],
    openDreamModal: ['js/dream-ledger.js?v=build-cce19efaa526'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-cce19efaa526'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-cce19efaa526']
  };
