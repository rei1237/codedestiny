(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-de50fa82cb1d').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-de50fa82cb1d'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-de50fa82cb1d'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-de50fa82cb1d'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-de50fa82cb1d'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-de50fa82cb1d'],
    openDreamModal: ['js/dream-ledger.js?v=build-de50fa82cb1d'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-de50fa82cb1d'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-de50fa82cb1d']
  };
