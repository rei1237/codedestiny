(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-ef2e0ec32044').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-ef2e0ec32044'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-ef2e0ec32044'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-ef2e0ec32044'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-ef2e0ec32044'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-ef2e0ec32044'],
    openDreamModal: ['js/dream-ledger.js?v=build-ef2e0ec32044'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-ef2e0ec32044'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-ef2e0ec32044']
  };
