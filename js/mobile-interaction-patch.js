(function () {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-ccced4ad1688'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-ccced4ad1688'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-ccced4ad1688'],
    openDreamModal: ['js/dream-ledger.js?v=build-ccced4ad1688'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-ccced4ad1688'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-ccced4ad1688']
  };
