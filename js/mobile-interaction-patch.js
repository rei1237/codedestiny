(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-6deed0abc4cb').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-6deed0abc4cb'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-6deed0abc4cb'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-6deed0abc4cb'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-6deed0abc4cb'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-6deed0abc4cb'],
    openDreamModal: ['js/dream-ledger.js?v=build-6deed0abc4cb'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-6deed0abc4cb'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-6deed0abc4cb']
  };
