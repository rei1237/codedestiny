(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-a246e8353e68').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-a246e8353e68'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-a246e8353e68'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-a246e8353e68'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-a246e8353e68'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-a246e8353e68'],
    openDreamModal: ['js/dream-ledger.js?v=build-a246e8353e68'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-a246e8353e68'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-a246e8353e68']
  };
