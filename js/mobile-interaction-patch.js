(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-ce12e9ac4138').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openPastLifeFaceApp: [
      'AnalysisEngine.js?v=h96b7981840e2',
      'PastLifeFaceUI.js?v=hb3be4acdb247'
    ],
    openMbtiModal: ['js/astral-soul.js'],
    openAnimalTotemModal: [
      'js/services/animal-totem-content-engine.js',
      'js/animal-totem-experience.js?v=build-ce12e9ac4138'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-ce12e9ac4138'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-ce12e9ac4138'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-ce12e9ac4138'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-ce12e9ac4138'],
    openDreamModal: ['js/dream-ledger.js?v=build-ce12e9ac4138'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-ce12e9ac4138'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-ce12e9ac4138']
  };
  ...
  function bindDirectFeatureCardActions(root) {
    var scope = root && root.querySelectorAll ? root : document;
    var nodes = scope.querySelectorAll('.feature-card-grid [data-action], .moon-collection-nav [data-action]');
