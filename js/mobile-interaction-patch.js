(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-5a4c800d4dea').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-5a4c800d4dea'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-5a4c800d4dea'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-5a4c800d4dea'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-5a4c800d4dea'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-5a4c800d4dea'],
    openDreamModal: ['js/dream-ledger.js?v=build-5a4c800d4dea'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-5a4c800d4dea'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-5a4c800d4dea']
  };
