(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-c31ee8d2c0a0').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-c31ee8d2c0a0'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-c31ee8d2c0a0'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-c31ee8d2c0a0'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-c31ee8d2c0a0'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-c31ee8d2c0a0'],
    openDreamModal: ['js/dream-ledger.js?v=build-c31ee8d2c0a0'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-c31ee8d2c0a0'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-c31ee8d2c0a0']
  };
