(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-f66bf903f672').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-f66bf903f672'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-f66bf903f672'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-f66bf903f672'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-f66bf903f672'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-f66bf903f672'],
    openDreamModal: ['js/dream-ledger.js?v=build-f66bf903f672'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-f66bf903f672'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-f66bf903f672']
  };
