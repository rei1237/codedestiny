(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-e0ae8cbc4b1f').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openPastLifeFaceApp: [
      'AnalysisEngine.js?v=h96b7981840e2',
      'PastLifeFaceUI.js?v=hf22f3ec431ad'
    ],
    openMbtiModal: ['js/astral-soul.js'],
    openAnimalTotemModal: [
      'js/services/animal-totem-content-engine.js',
      'js/animal-totem-experience.js?v=build-e0ae8cbc4b1f'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-e0ae8cbc4b1f'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-e0ae8cbc4b1f'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-e0ae8cbc4b1f'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-e0ae8cbc4b1f'],
    openDreamModal: ['js/dream-ledger.js?v=build-e0ae8cbc4b1f'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-e0ae8cbc4b1f'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-e0ae8cbc4b1f']
  };
