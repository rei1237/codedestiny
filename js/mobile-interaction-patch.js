(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-be6facbf4f3f').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-be6facbf4f3f'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-be6facbf4f3f'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-be6facbf4f3f'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-be6facbf4f3f'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-be6facbf4f3f'],
    openDreamModal: ['js/dream-ledger.js?v=build-be6facbf4f3f'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-be6facbf4f3f'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-be6facbf4f3f']
  };
