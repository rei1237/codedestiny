(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-b8a5319addda').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-b8a5319addda'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-b8a5319addda'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-b8a5319addda'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-b8a5319addda'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-b8a5319addda'],
    openDreamModal: ['js/dream-ledger.js?v=build-b8a5319addda'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-b8a5319addda'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-b8a5319addda']
  };
