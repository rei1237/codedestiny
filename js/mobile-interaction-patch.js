(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-cbe67719dabd').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-cbe67719dabd'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-cbe67719dabd'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-cbe67719dabd'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-cbe67719dabd'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-cbe67719dabd'],
    openDreamModal: ['js/dream-ledger.js?v=build-cbe67719dabd'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-cbe67719dabd'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-cbe67719dabd']
  };
