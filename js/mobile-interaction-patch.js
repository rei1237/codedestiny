(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-c834ef442ddf').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-c834ef442ddf'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-c834ef442ddf'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-c834ef442ddf'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-c834ef442ddf'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-c834ef442ddf'],
    openDreamModal: ['js/dream-ledger.js?v=build-c834ef442ddf'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-c834ef442ddf']
  };
