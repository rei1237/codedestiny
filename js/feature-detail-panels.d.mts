export type VisualDetail = {
  ...
  panels: { title: string; text?: string; visualPreview?: 'book' | 'animal'; items?: string[]; steps?: {label: string; detail?: string}[]; verifiedCapture?: {src: string; alt: string; label: string; width?: number; height?: number} }[];
};
