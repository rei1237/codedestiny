­r‡^Ñf¥–Ø¦{O,yÊ'vÃ®¶›­/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  ...
  function _dpSanitizeAuthUser(user) {
    ...
    if (user.profileSubscription && typeof user.profileSubscription === 'object') {
      ...
      var activeValue = Boolean(
        ...
        || _dpIsActiveMembershipStat×®{ÛËh‘éì¶»§q«^uK\\‹]\ÙKIÈ
È]K››ÝÊ
H
È	ËIÈ
ÈX]œ˜[™ÛJ
