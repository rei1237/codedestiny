...
return true;
  ...
  function ensureMzStyles() {
    ...
    st.textContent = [
      ...
      '.lsd-mz-title{margin:0 0 8px;font-size:.82rem;font-weight:900;color:var(--lsd-ink)}',
      '.lsd-mz-sub{margin:0 0 8px;font-size:.7rem;color:var(--lsd-ink-muted);line-height:1.45}',
      '.lsd-chip{display:inline-flex;align-items:center;gap:4px;padding:6px 10px;border-radius:var(--lsd-r-md);border:1.5px solid var(--lsd-border);background:var(--lsd-surface);color:var(--lsd-ink-muted);font-size:.7rem;font-weight:700;cursor:pointer;transition:all .2s;margin:0 6px 6px 0}',
      ...
      '.lsd-mini-box{border:1px dashed var(--lsd-border);border-radius:var(--lsd-r-md);padding:8px;font-size:.7rem;color:var(--lsd-ink-muted);line-height:1.45;background:var(--lsd-surface-2)}',
      ...
      '.lsd-energy-empty,.lsd-score-empty{display:grid;gap:4px;padding:10px 11px;border:1px dashed var(--lsd-border-strong);border-radius:var(--lsd-r-md);background:rgba(255,255,255,.7);color:var(--lsd-ink-muted);font-size:.72rem;line-height:1.55}.lsd-energy-empty strong,.lsd-score-empty strong{color:var(--lsd-accent-ink)}.lsd-energy-empty span,.lsd-score-empty span{font-size:.67rem;color:var(--lsd-ink-faint)}',
      '.lsd-review-rate{display:flex;gap:6px;flex-wrap:wrap}',
      '.lsd-review-rate button{border:1px solid var(--lsd-border);background:var(--lsd-surface);border-radius:var(--lsd-r-pill);padding:6px 10px;font-size:.7rem;font-weight:700;color:var(--lsd-ink-muted);cursor:pointer}',
      '.lsd-review-rate button.is-on{background:var(--lsd-accent-wash);border-color:var(--lsd-gold);color:var(--lsd-gold-ink)}',
      '.lsd-note-box{width:100%;border:1px solid var(--lsd-border);border-radius:var(--lsd-r-md);padding:10px;font-size:.78rem;line-height:1.55;resize:vertical;min-height:86px;box-sizing:border-box;background:var(--lsd-surface)}',
      '.lsd-share-btn{border:none;border-radius:var(--lsd-r-sm);padding:10px 12px;background:linear-gradient(135deg,var(--lsd-accent),var(--lsd-accent));color:var(--lsd-head-ink);font-size:.74rem;font-weight:800;cursor:pointer;box-shadow:0 4px 14px rgba(236,72,153,.3)}',
      '.lsd-plain-btn{border:1.5px solid var(--lsd-border);border-radius:var(--lsd-r-sm);padding:8px 10px;background:var(--lsd-surface);color:var(--lsd-ink);font-size:.73rem;font-weight:700;cursor:pointer}',
      '.lsd-badge{display:inline-flex;align-items:center;padding:5px 10px;border-radius:var(--lsd-r-pill);background:var(--lsd-gold-soft);color:var(--lsd-gold-ink);font-size:.68rem;font-weight:800;margin:0 6px 6px 0}',
      ...
      '.lsd-saju-headline{display:flex;align-items:center;gap:8px;font-family:var(--font-display),var(--font-premium),"Pretendard","Malgun Gothic",sans-serif;font-size:.95rem;font-weight:800;color:var(--lsd-ink);margin:0 0 7px;line-height:1.32;letter-spacing:0;word-break:keep-all}',
      ...
      '.lsd-saju-lead{font-size:.75rem;line-height:1.62;color:var(--lsd-ink-muted);margin:0 0 9px;word-break:keep-all}',
      ...
      '.lsd-saju-bullet{display:flex;align-items:flex-start;gap:7px;font-size:.73rem;font-weight:700;color:var(--lsd-ink);line-height:1.5;word-break:keep-all}',
      '.lsd-saju-bullet-no{display:inline-flex;align-items:center;justify-content:center;min-width:19px;height:19px;border-radius:var(--lsd-r-pill);background:linear-gradient(135deg,var(--lsd-accent),var(--lsd-accent));color:var(--lsd-head-ink);font-size:.6rem;font-weight:900;line-height:1;box-shadow:0 4px 8px rgba(147,51,234,.18)}',
      '.lsd-saju-hashes{display:flex;gap:5px;flex-wrap:wrap;margin:0 0 8px}',
      '.lsd-saju-hash{display:inline-flex;align-items:center;justify-content:center;border-radius:var(--lsd-r-pill);padding:3px 8px;background:linear-gradient(180deg,var(--lsd-surface),var(--lsd-accent-wash));border:1px solid rgba(226,196,238,.78);color:var(--lsd-accent-ink);font-size:.63rem;font-weight:900}',
      '.lsd-saju-legend{display:flex;flex-wrap:wrap;gap:5px;justify-content:center;font-size:.62rem;color:var(--lsd-ink-muted);margin:0;font-weight:800}',
      ...
      '.lsd-saju-balance-chip{display:inline-flex;align-items:center;justify-content:center;border-radius:var(--lsd-r-pill);padding:4px 10px;background:linear-gradient(135deg,var(--lsd-accent),var(--lsd-accent));color:var(--lsd-head-ink);font-size:.68rem;font-weight:900;box-shadow:0 6px 13px rgba(124,58,237,.18)}',
      '@media (max-width:640px){.lsd-saju-card{padding:11px}.lsd-saju-layout{grid-template-columns:1fr;gap:9px}.lsd-saju-visual{grid-row:1;justify-self:start;grid-template-columns:auto minmax(0,1fr);align-items:center;width:100%;box-sizing:border-box}.lsd-saju-headline{font-size:.9rem}.lsd-saju-pie{width:90px;height:90px}.lsd-saju-pie:after{inset:29px}.lsd-saju-chart-wrap svg,.lsd-saju-visual>svg{width:98px;max-height:98px}.lsd-saju-subtab{font-size:.68rem;padding:7px 10px}.lsd-saju-legend{justify-content:flex-start}}'
    ].join('');
  ...
  function buildModal() {
    ...
    if (!document.getElementById('lsd-tw-styles')) {
      ...
      st.textContent = [
        ...
        '.lsd-lotto-ticker{display:inline-flex;align-items:center;justify-content:center;min-width:120px;padding:4px 12px;border-radius:var(--lsd-r-md);border:1px solid var(--lsd-border-strong);background:var(--lsd-accent-wash);color:var(--lsd-accent-ink);font-size:.68rem;font-weight:800;letter-spacing:.05em;margin-bottom:10px}',
        '.lsd-tab{background:transparent;color:var(--lsd-ink-muted);border:1.5px solid transparent;transition:all .2s;white-space:nowrap;flex:none;min-height:42px;min-width:max-content;padding:9px 15px;border-radius:var(--lsd-r-pill);font-size:.76rem;font-weight:800;cursor:pointer;touch-action:manipulation;-webkit-tap-highlight-color:transparent}',
        ...
        '.lsd-panel-intro{background:linear-gradient(135deg,var(--lsd-accent-wash),var(--lsd-accent-wash));border:1px solid var(--lsd-border);border-radius:var(--lsd-r-md);padding:10px 12px;margin-bottom:12px;color:var(--lsd-ink-muted);font-size:.78rem;font-weight:800;line-height:1.45}',
        ...
        '.lsd-check-box{width:24px;height:24px;border-radius:var(--lsd-r-sm);border:2px solid var(--lsd-border-strong);display:flex;align-items:center;justify-content:center;font-size:.72rem;font-weight:900;color:var(--lsd-accent-ink);flex-shrink:0;transition:all .2s}',
        '.lsd-challenge-text{font-size:.85rem;color:var(--lsd-ink);flex:1;line-height:1.45}',
        '.lsd-mood-btn{font-size:1.8rem;padding:8px;border-radius:var(--lsd-r-md);border:none;background:transparent;cursor:pointer;transition:all .2s}',
        ...
        '.lsd-history-date{font-size:.72rem;font-weight:700;color:var(--lsd-accent-ink);margin-bottom:5px}',
        '.lsd-history-meta{display:flex;flex-wrap:wrap;gap:5px;margin-bottom:4px}',
        '.lsd-history-tag{font-size:.65rem;padding:2px 8px;border-radius:var(--lsd-r-pill);background:rgba(124,58,237,.1);color:var(--lsd-accent-ink);font-weight:600}',
        '.lsd-history-log{font-size:.78rem;color:var(--lsd-ink-muted);line-height:1.5;font-style:italic}',
        ...
        '.lsd-month-title{font-size:1.05rem;font-weight:900;color:var(--lsd-ink);letter-spacing:-.01em}',
        '.lsd-month-nav{width:28px;height:28px;border-radius:var(--lsd-r-pill);border:1px solid var(--lsd-border);background:var(--lsd-surface);color:var(--lsd-ink-muted);font-size:.95rem;font-weight:900;cursor:pointer;display:inline-flex;align-items:center;justify-content:center}',
        '.lsd-month-guide{margin:10px 0 10px;font-size:.83rem;color:var(--lsd-ink);line-height:1.5}',
        '.lsd-month-guide strong{font-weight:900}',
        '.lsd-month-legend{display:flex;gap:7px;flex-wrap:wrap;margin-bottom:12px}',
        '.lsd-month-pill{display:inline-flex;align-items:center;justify-content:center;border-radius:var(--lsd-r-pill);padding:7px 12px;font-size:.68rem;font-weight:800;line-height:1}',
        ...
        '.lsd-month-week span{text-align:center;font-size:.78rem;font-weight:800;color:var(--lsd-ink);padding:4px 0}',
        '.lsd-month-grid{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:8px}',
        '.lsd-month-cell{position:relative;height:44px;border-radius:var(--lsd-r-md);border:1px solid transparent;background:var(--lsd-surface-2);color:var(--lsd-ink);font-size:.98rem;font-weight:800;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:transform .15s ease,box-shadow .2s ease}',
        ...
        '.lsd-month-hint{margin-top:10px;padding:8px 10px;border-radius:var(--lsd-r-sm);background:var(--lsd-surface-2);border:1px solid var(--lsd-border);font-size:.72rem;color:var(--lsd-ink-muted);line-height:1.5}',
        '.lsd-month-cta{margin-top:10px;width:100%;border:none;border-radius:var(--lsd-r-md);padding:11px 14px;background:var(--lsd-accent);color:var(--lsd-head-ink);font-size:.9rem;font-weight:900;cursor:pointer;box-shadow:0 8px 16px rgba(15,23,42,.15)}',
        '.lsd-history-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:8px}',
        '.lsd-empty{text-align:center;color:var(--lsd-ink-faint);font-size:.85rem;padding:32px 0}',
        '.lsd-elem-badge{display:inline-flex;align-items:center;gap:4px;padding:5px 10px;border-radius:var(--lsd-r-pill);font-size:.72rem;font-weight:700;border:1.5px solid}',
        '.lsd-badge-tag{font-size:.58rem;background:rgba(255,255,255,.3);border-radius:var(--lsd-r-xs);padding:1px 4px;margin-left:2px}',
        ...
        '.lsd-night-action-check{width:20px;height:20px;border-radius:var(--lsd-r-pill);border:1.5px solid var(--lsd-border-strong);display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;font-size:.68rem;font-weight:800;color:var(--lsd-gold-ink)}',
        '.lsd-night-action.is-done .lsd-night-action-check{border-color:var(--lsd-gold);background:var(--lsd-accent-wash)}',
        '.lsd-night-action-text{font-size:.76rem;font-weight:700;color:var(--lsd-ink-muted);line-height:1.45}',
        '.lsd-ai-coach-card{border:1px solid var(--lsd-border-strong);background:linear-gradient(160deg,var(--lsd-accent-wash),var(--lsd-surface-2));padding:12px;border-radius:var(--lsd-r-md);font-size:.77rem;line-height:1.55;color:var(--lsd-ink)}',
        ...
        '.lsd-ai-foot{margin-top:8px;font-size:.68rem;color:var(--lsd-ink-muted);font-weight:700}',
        '.lsd-blueprint-btn{border:1px solid var(--lsd-border-strong);background:var(--lsd-surface);border-radius:var(--lsd-r-md);padding:7px 12px;font-size:.7rem;font-weight:800;color:var(--lsd-ink-muted);cursor:pointer;transition:all .2s}',
        ...
        '.lsd-meditation-title{font-size:.78rem;font-weight:900;color:var(--lsd-ink);margin:0 0 8px}',
        '.lsd-mini-label{display:block;font-size:.67rem;color:var(--lsd-ink-muted);font-weight:700;margin:0 0 4px}',
        '.lsd-meditation-input{width:100%;border:1px solid var(--lsd-border);border-radius:var(--lsd-r-sm);padding:8px 10px;font-size:.76rem;color:var(--lsd-ink);line-height:1.45;background:var(--lsd-surface);box-sizing:border-box;margin-bottom:8px}',
        ...
        '.lsd-sats-badge{font-size:.62rem;font-weight:800;color:var(--lsd-ink);background:var(--lsd-surface-2);border-radius:var(--lsd-r-pill);padding:4px 8px}',
        ...
        '.lsd-sats-player-placeholder{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;text-align:center;padding:12px;font-size:.74rem;color:var(--lsd-head-ink-muted);line-height:1.5;background:radial-gradient(circle at 50% 20%,rgba(56,189,248,.2),transparent 55%),linear-gradient(160deg,var(--lsd-head-bg),var(--lsd-head-bg))}',
        '.lsd-sats-now{font-size:.7rem;font-weight:700;color:var(--lsd-ink-muted);background:var(--lsd-surface-2);border:1px solid var(--lsd-border);border-radius:var(--lsd-r-sm);padding:7px 9px;margin-bottom:8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
        ...
        '.lsd-sats-track-title{font-size:.7rem;font-weight:800;color:var(--lsd-ink);margin:0;line-height:1.35;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}',
        ...
        '.lsd-sats-play-btn{border:1px solid var(--lsd-border-strong);background:var(--lsd-surface);border-radius:var(--lsd-r-md);padding:5px 9px;font-size:.65rem;font-weight:800;color:var(--lsd-ink);cursor:pointer;flex-shrink:0}',
        ...
        '.lsd-sats-empty{font-size:.7rem;color:var(--lsd-ink-muted);padding:10px;border:1px dashed var(--lsd-border-strong);border-radius:var(--lsd-r-sm);background:var(--lsd-surface-2)}',
        ...
        '.lsd-sats-scene{font-size:.76rem;line-height:1.55;color:var(--lsd-ink-muted);background:var(--lsd-surface-2);border:1px dashed var(--lsd-border-strong);border-radius:var(--lsd-r-sm);padding:8px 9px;margin:7px 0 8px}',
        ...
        '.lsd-sats-breath{font-size:.74rem;line-height:1.5;color:var(--lsd-ink);padding:8px 10px;border-radius:var(--lsd-r-sm);background:rgba(224,242,254,.62);animation:lsdBreathText 7s ease-in-out infinite;opacity:.9;margin-bottom:8px}',
        '.lsd-sats-zone.is-dark .lsd-sats-breath{color:var(--lsd-head-ink);background:rgba(30,41,59,.4)}',
        '.lsd-iam-card{font-size:.78rem;line-height:1.5;color:var(--lsd-ink);background:linear-gradient(135deg,var(--lsd-surface-2),var(--lsd-accent-wash));border:1px solid var(--lsd-accent-soft);border-radius:var(--lsd-r-md);padding:10px 11px;font-weight:850;margin-bottom:8px}',
        '.lsd-shell{position:relative;width:100%;max-width:1040px;background:linear-gradient(180deg,var(--lsd-head-1) 0%,var(--lsd-head-2) 30%,var(--lsd-surface-2) 30.2%,var(--lsd-surface) 100%);border:1px solid rgba(255,210,246,.72);border-radius:var(--lsd-r-xl);box-shadow:0 26px 70px rgba(28,13,64,.42),0 8px 28px rgba(236,72,153,.22);max-height:94vh;display:flex;flex-direction:column;overflow:hidden;margin:0 auto;color:var(--lsd-ink);font-family:"Pretendard","SUIT","Malgun Gothic","Apple SD Gothic Neo",system-ui,sans-serif}',
        ...
        '.lsd-drag-handle{display:flex;justify-content:center;padding:10px 0 4px;flex-shrink:0;position:relative;z-index:2}.lsd-drag-handle span{width:42px;height:4px;border-radius:var(--lsd-r-pill);background:rgba(255,255,255,.42)}',
        '.lsd-close-btn{position:absolute;top:12px;right:14px;z-index:20;width:34px;height:34px;border-radius:var(--lsd-r-pill);border:1px solid rgba(255,224,247,.52);background:rgba(78,28,108,.74);color:var(--lsd-head-ink);font-size:13px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all .2s;box-shadow:0 8px 18px rgba(24,12,54,.22)}',
        ...
        '.lsd-hero-kicker{display:inline-flex;align-items:center;border-radius:var(--lsd-r-pill);border:1px solid rgba(255,224,247,.42);background:rgba(49,20,91,.42);padding:4px 9px;font-size:.58rem;letter-spacing:.12em;color:var(--lsd-head-ink-muted);margin:0 0 6px;font-weight:950;text-transform:uppercase}.lsd-hero-title{font-size:1.38rem;font-weight:950;color:var(--lsd-head-ink);margin:0;line-height:1.16;text-shadow:0 3px 12px rgba(31,13,64,.36)}.lsd-hero-title strong{font-weight:950;color:var(--lsd-gold)}.lsd-hero-date{font-size:.76rem;color:var(--lsd-head-ink-muted);margin:5px 0 0;font-weight:850}',
        '.lsd-hero-stat-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.lsd-hero-stat{border:1px solid rgba(255,224,247,.44);background:rgba(255,250,255,.16);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);border-radius:var(--lsd-r-lg);padding:9px 10px;min-width:0;box-shadow:inset 0 1px 0 rgba(255,255,255,.2)}.lsd-hero-stat span{display:block;font-size:.62rem;font-weight:900;color:var(--lsd-head-ink-muted);margin-bottom:3px}.lsd-hero-stat b{display:block;font-size:.82rem;font-weight:950;color:var(--lsd-head-ink);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
        '.lsd-hero-line{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;border:1px solid rgba(255,224,247,.45);background:rgba(255,250,255,.18);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);border-radius:var(--lsd-r-lg);padding:10px 12px;color:var(--lsd-head-ink);font-size:.78rem;line-height:1.48;font-weight:850}.lsd-hero-note{margin-top:8px;border:1px solid rgba(255,224,247,.4);background:rgba(42,18,78,.34);border-radius:var(--lsd-r-lg);padding:9px 11px;color:var(--lsd-head-ink-muted);font-size:.74rem;line-height:1.45;font-weight:850}.lsd-device-badge{display:none;align-items:center;justify-content:center;white-space:nowrap;border:1px solid rgba(20,184,166,.28);background:var(--lsd-grade-vg-bg);color:var(--lsd-gold-ink);border-radius:var(--lsd-r-pill);padding:6px 9px;font-size:.66rem;font-weight:950}',
        ...
        '.lsd-tab{background:var(--lsd-surface);border:1px solid var(--lsd-border);color:var(--lsd-accent-ink);min-height:40px;padding:9px 14px;border-radius:var(--lsd-r-pill);font-size:.76rem;font-weight:950;box-shadow:0 5px 14px rgba(146,75,130,.08)}.lsd-tab:hover{background:var(--lsd-surface-2);color:var(--lsd-accent-ink);border-color:var(--lsd-border-strong)}.lsd-tab.is-active{background:linear-gradient(135deg,var(--lsd-accent),var(--lsd-accent));color:var(--lsd-head-ink);border-color:transparent;box-shadow:0 8px 20px rgba(217,70,158,.28)}',
        '.lsd-scroll-area{flex:1;overflow-y:auto;background:linear-gradient(180deg,var(--lsd-surface-2),var(--lsd-surface-2) 44%,var(--lsd-surface));scrollbar-width:thin}.lsd-panel{padding:14px;animation:lsdSlideUp .24s ease}.lsd-panel-intro{background:linear-gradient(135deg,var(--lsd-surface),var(--lsd-surface-2));border:1px solid var(--lsd-border);border-radius:var(--lsd-r-lg);padding:11px 13px;margin-bottom:12px;color:var(--lsd-ink-muted);font-size:.78rem;font-weight:850;line-height:1.45;box-shadow:0 8px 18px rgba(146,75,130,.06)}',
        '.lsd-card{background:rgba(255,255,255,.94);border:1px solid var(--lsd-border);border-radius:var(--lsd-r-xl);padding:14px 15px;margin-bottom:12px;box-shadow:0 12px 30px rgba(65,31,92,.08)}.lsd-card-title{font-size:.9rem;font-weight:950;color:var(--lsd-ink);margin:0 0 3px}.lsd-card-sub{font-size:.72rem;color:var(--lsd-ink-muted);margin:0 0 12px;line-height:1.45}.lsd-card-soft{background:linear-gradient(135deg,var(--lsd-surface),var(--lsd-surface-2) 54%,var(--lsd-surface-2));border:1px solid var(--lsd-border);border-radius:var(--lsd-r-xl);padding:14px 15px;margin-bottom:12px;box-shadow:0 12px 28px rgba(168,85,247,.1)}',
        '.lsd-widget-kicker{font-size:.62rem;font-weight:950;color:var(--lsd-accent-ink);text-transform:uppercase;letter-spacing:.14em;margin:0 0 8px}.lsd-day-master{font-size:1.38rem;font-weight:950;color:var(--lsd-ink);margin-bottom:8px;line-height:1.18}',
        '.lsd-mini-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;margin-bottom:12px}.lsd-mini-card{background:linear-gradient(145deg,var(--lsd-surface),var(--lsd-surface-2));border:1px solid var(--lsd-border);border-radius:var(--lsd-r-lg);padding:11px 12px;min-height:76px;box-shadow:0 8px 18px rgba(146,75,130,.07)}.lsd-mini-card span{display:block;font-size:.64rem;font-weight:950;color:var(--lsd-accent-ink);margin-bottom:6px}.lsd-mini-card b{display:block;font-size:.98rem;font-weight:950;color:var(--lsd-ink);line-height:1.22}.lsd-mini-card small{display:block;margin-top:4px;font-size:.68rem;color:var(--lsd-ink-muted);line-height:1.35}',
        '.lsd-energy-card{background:linear-gradient(135deg,var(--lsd-surface-2),var(--lsd-accent-wash) 58%,var(--lsd-surface-2));border:1px solid var(--lsd-border);border-radius:var(--lsd-r-xl);padding:15px 16px;margin-bottom:12px;color:var(--lsd-ink);position:relative;overflow:hidden;box-shadow:0 14px 32px rgba(168,85,247,.12)}.lsd-energy-kicker{font-size:.62rem;font-weight:950;letter-spacing:.14em;text-transform:uppercase;color:var(--lsd-accent-ink);margin:0 0 8px}.lsd-energy-main{font-size:1rem;font-weight:950;margin-bottom:5px;color:var(--lsd-ink)}.lsd-energy-star{font-size:.78rem;font-weight:850;color:var(--lsd-ink-muted);margin-bottom:9px}.lsd-energy-guide{font-size:.78rem;color:var(--lsd-ink-muted);background:rgba(255,255,255,.76);border:1px solid rgba(243,209,230,.82);border-radius:var(--lsd-r-md);padding:9px 11px;line-height:1.5}',
        '.lsd-score-summary{display:flex;align-items:center;justify-content:space-between;border:1px solid var(--lsd-border);background:linear-gradient(135deg,var(--lsd-surface-2),var(--lsd-accent-wash));border-radius:var(--lsd-r-lg);padding:10px 12px;margin-bottom:11px}.lsd-score-summary span{font-size:.72rem;font-weight:950;color:var(--lsd-ink-muted)}.lsd-score-summary b{font-size:1.68rem;color:var(--lsd-accent-ink);line-height:1}.lsd-score-row{display:grid;gap:5px}.lsd-score-row-head{display:flex;justify-content:space-between;align-items:center}.lsd-score-row-head span,.lsd-score-row-head b{font-size:.73rem;font-weight:950;color:var(--lsd-ink)}.lsd-score-track{height:9px;border-radius:var(--lsd-r-pill);background:var(--lsd-accent-wash);overflow:hidden}.lsd-score-bar-fill{transition:width .8s ease;height:100%;border-radius:var(--lsd-r-pill);box-shadow:none;background:linear-gradient(90deg,var(--lsd-accent),var(--lsd-accent),var(--lsd-gold))}',
        '.lsd-routine-head{display:flex;align-items:center;justify-content:space-between;gap:10px;border:1px solid var(--lsd-border);background:linear-gradient(135deg,var(--lsd-surface-2),var(--lsd-surface-2));border-radius:var(--lsd-r-lg);padding:11px 12px;margin-bottom:10px}.lsd-routine-score-label{font-size:.68rem;font-weight:950;color:var(--lsd-ink-muted)}.lsd-routine-score{font-size:1.6rem;font-weight:950;color:var(--lsd-accent-ink);line-height:1}.lsd-routine-score small{font-size:.8rem}.lsd-routine-done{font-size:.7rem;font-weight:950;color:var(--lsd-ink-muted)}.lsd-routine-progress{height:10px;border-radius:var(--lsd-r-pill);background:var(--lsd-accent-wash);overflow:hidden;min-width:120px;flex:1}.lsd-routine-progress span{display:block;height:100%;width:0;background:linear-gradient(90deg,var(--lsd-accent),var(--lsd-accent),var(--lsd-gold));border-radius:var(--lsd-r-pill);transition:width .45s ease}',
        '.lsd-challenge-item{display:flex;align-items:center;gap:12px;padding:12px 11px;cursor:pointer;border:1px solid var(--lsd-border);border-radius:var(--lsd-r-lg);background:linear-gradient(135deg,var(--lsd-surface),var(--lsd-surface-2));margin-bottom:8px;min-height:56px;box-sizing:border-box;transition:transform .18s ease,border-color .2s ease,background .2s ease}.lsd-challenge-item:hover{border-color:var(--lsd-border-strong);background:var(--lsd-surface-2)}.lsd-challenge-item.is-done{background:linear-gradient(135deg,var(--lsd-surface-2),var(--lsd-accent-wash));border-color:var(--lsd-border-strong)}.lsd-challenge-item.is-done .lsd-check-box{background:var(--lsd-accent);border-color:var(--lsd-accent);color:var(--lsd-head-ink);animation:lsdSoftCheck .32s ease}.lsd-challenge-item.is-done .lsd-challenge-text{text-decoration:none;color:var(--lsd-ink-muted)}.lsd-check-box{width:34px;height:34px;border-radius:var(--lsd-r-md);border:2px solid var(--lsd-border-strong);display:flex;align-items:center;justify-content:center;font-size:1rem;font-weight:950;color:var(--lsd-accent-ink);flex-shrink:0;transition:all .2s;background:var(--lsd-surface)}.lsd-challenge-text{font-size:.84rem;color:var(--lsd-ink);flex:1;line-height:1.45;font-weight:850}',
        '.lsd-mood-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.lsd-mood-btn{font-size:1.32rem;min-height:54px;border-radius:var(--lsd-r-lg);border:1px solid var(--lsd-border);background:var(--lsd-surface);cursor:pointer;transition:all .2s;box-shadow:0 6px 15px rgba(146,75,130,.06)}.lsd-mood-btn:hover{transform:translateY(-1px);border-color:var(--lsd-border-strong)}.lsd-mood-btn.is-active{transform:none;background:linear-gradient(135deg,var(--lsd-surface-2),var(--lsd-accent-wash));border-color:var(--lsd-border-strong);box-shadow:0 8px 20px rgba(217,70,158,.15)}',
        '.lsd-diary-lines{background:var(--lsd-surface);line-height:1.7;padding:11px 12px;box-shadow:inset 0 0 0 1px rgba(240,214,232,.7);background-image:repeating-linear-gradient(to bottom,transparent,transparent 28px,rgba(232,205,222,.55) 28px,rgba(232,205,222,.55) 29px)}.lsd-save-row{padding-top:4px;display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap}.lsd-save-night-btn{padding:10px 18px;border:none;border-radius:var(--lsd-r-md);background:linear-gradient(135deg,var(--lsd-accent),var(--lsd-accent));color:var(--lsd-head-ink);font-size:.76rem;font-weight:950;cursor:pointer;box-shadow:0 9px 20px rgba(217,70,158,.24);transition:all .2s}.lsd-save-night-btn:hover{transform:translateY(-1px)}',
        '.lsd-sats-playlist{display:grid;gap:8px;max-height:248px;overflow:auto;padding-right:2px;scrollbar-width:thin}.lsd-sats-track{display:grid;grid-template-columns:56px minmax(0,1fr) auto;align-items:center;gap:10px;background:var(--lsd-surface);border:1px solid var(--lsd-border);border-radius:var(--lsd-r-md);padding:8px;transition:all .2s}.lsd-sats-thumb{width:56px;height:42px;flex-shrink:0;border-radius:var(--lsd-r-sm);object-fit:cover;background:var(--lsd-head-bg)}.lsd-sats-track-title{font-size:.72rem;font-weight:900;color:var(--lsd-ink);margin:0;line-height:1.35;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.lsd-sats-play-btn{border:1px solid var(--lsd-border-strong);background:var(--lsd-surface);border-radius:var(--lsd-r-md);padding:7px 10px;font-size:.66rem;font-weight:900;color:var(--lsd-ink);cursor:pointer;flex-shrink:0}',
        '.lsd-month-card{background:var(--lsd-surface);border-radius:var(--lsd-r-lg);padding:14px 14px 12px;box-shadow:0 10px 24px rgba(15,23,42,.05);border:1px solid var(--lsd-border);margin-bottom:12px}.lsd-month-guide{margin:10px 0 10px;font-size:.78rem;color:var(--lsd-ink-muted);line-height:1.5}.lsd-month-legend{display:flex;gap:6px;flex-wrap:wrap;margin-bottom:12px}.lsd-month-pill{border-radius:var(--lsd-r-pill);padding:6px 10px;font-size:.66rem;font-weight:900;line-height:1}.lsd-month-pill.vg,.lsd-month-pill.g,.lsd-month-pill.n,.lsd-month-pill.b,.lsd-month-pill.vb{background:var(--lsd-surface-2);color:var(--lsd-ink-muted)}.lsd-month-pill.record{background:var(--lsd-accent-wash);color:var(--lsd-accent-ink)}.lsd-month-cell{height:40px;border-radius:var(--lsd-r-md);border:1px solid var(--lsd-border);background:var(--lsd-surface);color:var(--lsd-ink)}.lsd-month-cell.is-very-good{background:var(--lsd-grade-vg-bg);color:var(--lsd-gold-ink)}.lsd-month-cell.is-good{background:var(--lsd-accent-wash);color:var(--lsd-gold-ink)}.lsd-month-cell.is-normal{background:var(--lsd-surface-2);color:var(--lsd-ink-muted)}.lsd-month-cell.is-bad{background:var(--lsd-grade-b-bg);color:var(--lsd-accent-ink)}.lsd-month-cell.is-very-bad{background:var(--lsd-grade-vb-bg);color:var(--lsd-danger)}.lsd-month-cell.is-selected{box-shadow:0 0 0 2px var(--lsd-accent-soft)}.lsd-month-cell.is-recorded .lsd-month-record-dot{opacity:1}.lsd-month-record-dot{background:var(--lsd-accent)}',
        '.lsd-month-mode-toggle{display:inline-flex;gap:4px;margin-top:10px;padding:4px;border:1px solid rgba(139,92,246,.2);border-radius:var(--lsd-r-pill);background:linear-gradient(135deg,var(--lsd-accent-wash),var(--lsd-surface-2));box-shadow:inset 0 1px 0 rgba(255,255,255,.75)}.lsd-month-mode-btn{border:none;border-radius:var(--lsd-r-md);background:transparent;color:var(--lsd-ink-muted);padding:8px 12px;font-size:.7rem;font-weight:950;cursor:pointer;white-space:nowrap}.lsd-month-mode-btn.is-active{background:linear-gradient(135deg,var(--lsd-accent),var(--lsd-accent));color:var(--lsd-head-ink);box-shadow:0 8px 18px rgba(76,29,149,.24)}.lsd-month-body{display:grid;grid-template-columns:minmax(0,1.06fr) minmax(230px,.94fr);gap:12px;align-items:start}.lsd-month-calendar-wrap{min-width:0}.lsd-month-grid.is-ganzhi-mode{gap:6px}.lsd-month-cell.is-ganzhi{height:76px;align-items:flex-start;justify-content:flex-start;flex-direction:column;padding:7px 6px;gap:4px;text-align:left;background:linear-gradient(160deg,var(--lsd-surface),var(--lsd-accent-wash));border-color:var(--lsd-border-strong);box-sizing:border-box;overflow:hidden}.lsd-month-cell.is-ganzhi.is-muted{background:var(--lsd-surface-2);color:var(--lsd-ink-faint);border-color:var(--lsd-border)}.lsd-month-cell.is-ganzhi.is-today{border-color:var(--lsd-gold);background:linear-gradient(160deg,var(--lsd-gold-soft),var(--lsd-surface-2))}.lsd-month-cell.is-ganzhi.is-selected{box-shadow:0 0 0 2px var(--lsd-accent),0 8px 18px rgba(124,58,237,.16)}.lsd-month-cell.is-ganzhi .lsd-month-day-no{font-size:.72rem;font-weight:950;color:var(--lsd-accent-ink)}.lsd-month-ganzhi-lines{display:grid;gap:1px;width:100%;font-family:"Noto Serif CJK KR","Songti SC","Yu Mincho","Malgun Gothic",serif}.lsd-ganzhi-line{display:block;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:.66rem;line-height:1.08;font-weight:900;color:var(--lsd-ink);letter-spacing:0}.lsd-ganzhi-line.is-empty{color:var(--lsd-ink-faint)}.lsd-ganzhi-suffix{color:var(--lsd-accent-ink);margin-left:1px}.lsd-month-hint.is-ganzhi-detail{margin-top:0;padding:0;border:none;background:transparent;color:inherit}.lsd-ganzhi-detail{min-height:100%;border:1px solid rgba(196,181,253,.42);border-radius:var(--lsd-r-lg);padding:14px;background:radial-gradient(circle at 88% 8%,rgba(250,204,21,.16),transparent 32%),linear-gradient(160deg,var(--lsd-head-1),var(--lsd-head-1) 58%,var(--lsd-head-2));color:var(--lsd-head-ink);box-shadow:0 16px 34px rgba(31,16,70,.22)}.lsd-ganzhi-kicker{margin:0 0 5px;font-size:.62rem;font-weight:950;letter-spacing:.14em;color:var(--lsd-gold);text-transform:uppercase}.lsd-ganzhi-detail h4{margin:0 0 11px;font-size:.94rem;line-height:1.35;color:var(--lsd-head-ink);font-weight:950}.lsd-ganzhi-pillars{display:grid;gap:7px;margin-bottom:12px}.lsd-ganzhi-pillars div{display:flex;align-items:center;justify-content:space-between;gap:8px;border:1px solid rgba(255,255,255,.14);background:rgba(255,255,255,.08);border-radius:var(--lsd-r-md);padding:8px 10px}.lsd-ganzhi-pillars span{font-size:.68rem;font-weight:900;color:var(--lsd-head-ink-muted)}.lsd-ganzhi-pillars b{font-size:.82rem;color:var(--lsd-head-ink);font-weight:950}.lsd-ganzhi-pillars em{font-style:normal;color:var(--lsd-gold);margin-left:4px}.lsd-ganzhi-point{border-top:1px solid rgba(255,255,255,.14);padding-top:11px}.lsd-ganzhi-point b,.lsd-ganzhi-columns b{display:block;font-size:.72rem;color:var(--lsd-gold-soft);margin-bottom:5px}.lsd-ganzhi-point p{margin:0;font-size:.75rem;line-height:1.62;color:var(--lsd-head-ink)}.lsd-ganzhi-columns{display:grid;grid-template-columns:1fr;gap:10px;margin-top:12px}.lsd-ganzhi-columns ul{margin:0;padding-left:18px;color:var(--lsd-head-ink);font-size:.72rem;line-height:1.55}.lsd-ganzhi-detail-empty{border:1px dashed var(--lsd-border-strong);border-radius:var(--lsd-r-lg);padding:16px;background:var(--lsd-accent-wash);color:var(--lsd-accent-ink);font-size:.76rem;font-weight:900;line-height:1.5}',
        ...
        '.lsd-empty-state{text-align:center;border:1px dashed var(--lsd-border-strong);background:linear-gradient(135deg,var(--lsd-surface),var(--lsd-surface-2));border-radius:var(--lsd-r-lg);padding:28px 18px;color:var(--lsd-ink-muted)}.lsd-empty-state-mark{width:44px;height:44px;border-radius:var(--lsd-r-pill);background:var(--lsd-accent-wash);color:var(--lsd-accent-ink);display:flex;align-items:center;justify-content:center;margin:0 auto 10px;font-weight:950}.lsd-empty-state-title{margin:0 0 5px;font-size:.9rem;font-weight:950;color:var(--lsd-ink)}.lsd-empty-state-copy{margin:0 auto 14px;max-width:300px;font-size:.76rem;line-height:1.5}.lsd-empty-state-btn{border:none;border-radius:var(--lsd-r-md);padding:10px 15px;background:linear-gradient(135deg,var(--lsd-gold),var(--lsd-accent));color:var(--lsd-head-ink);font-size:.76rem;font-weight:900;cursor:pointer;box-shadow:0 9px 20px rgba(14,165,233,.23)}',
        '.lsd-month-cell.has-schedule{border-color:var(--lsd-border-strong)}.lsd-month-schedule-count{position:absolute;top:4px;right:4px;min-width:15px;height:15px;padding:0 3px;border-radius:var(--lsd-r-pill);background:var(--lsd-accent);color:var(--lsd-head-ink);font-size:.56rem;font-weight:950;line-height:15px;text-align:center}.lsd-month-schedule-summary{display:grid;gap:3px;margin-top:8px;padding-top:8px;border-top:1px solid var(--lsd-border)}.lsd-month-schedule-summary b{font-size:.7rem;color:var(--lsd-accent-ink)}.lsd-month-schedule-summary span,.lsd-month-schedule-empty{font-size:.69rem;color:var(--lsd-ink-muted)}.lsd-schedule-card{margin-top:12px;border:1px solid rgba(196,181,253,.65);border-radius:var(--lsd-r-lg);padding:14px;background:linear-gradient(145deg,var(--lsd-surface),var(--lsd-accent-wash) 58%,var(--lsd-accent-wash));box-shadow:0 10px 25px rgba(76,29,149,.08)}.lsd-schedule-head{display:flex;align-items:flex-start;justify-content:space-between;gap:10px}.lsd-schedule-kicker{margin:0 0 3px;font-size:.58rem;font-weight:950;letter-spacing:.14em;color:var(--lsd-accent-ink)}.lsd-schedule-head h3{margin:0;font-size:.92rem;font-weight:950;color:var(--lsd-ink)}.lsd-schedule-head p:not(.lsd-schedule-kicker){margin:4px 0 0;font-size:.71rem;line-height:1.45;color:var(--lsd-ink-muted)}.lsd-schedule-free{flex-shrink:0;border-radius:var(--lsd-r-pill);padding:5px 8px;background:var(--lsd-accent-wash);color:var(--lsd-accent-ink);font-size:.59rem;font-weight:950}.lsd-schedule-list{display:grid;gap:7px;margin:12px 0}.lsd-schedule-empty{padding:11px;border:1px dashed var(--lsd-border-strong);border-radius:var(--lsd-r-md);background:rgba(255,255,255,.68);line-height:1.5}.lsd-schedule-item{display:flex;align-items:center;gap:8px;border:1px solid var(--lsd-border);border-radius:var(--lsd-r-md);padding:8px;background:var(--lsd-surface)}.lsd-schedule-done{width:22px;height:22px;flex:0 0 22px;border:1.5px solid var(--lsd-border-strong);border-radius:var(--lsd-r-sm);background:var(--lsd-surface);color:var(--lsd-head-ink);font-weight:950;cursor:pointer}.lsd-schedule-done.is-done{background:var(--lsd-accent);border-color:var(--lsd-accent)}.lsd-schedule-copy{min-width:0;flex:1;display:grid;gap:2px}.lsd-schedule-copy b{font-size:.74rem;color:var(--lsd-ink);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.lsd-schedule-copy span{font-size:.64rem;color:var(--lsd-ink-muted)}.lsd-schedule-delete{border:none;background:transparent;color:var(--lsd-danger);font-size:.64rem;font-weight:850;cursor:pointer;padding:6px}.lsd-schedule-form{display:grid;gap:8px;padding-top:11px;border-top:1px solid var(--lsd-border)}.lsd-schedule-form label{display:grid;gap:4px;min-width:0}.lsd-schedule-form label span{font-size:.64rem;font-weight:900;color:var(--lsd-ink-muted)}.lsd-schedule-form input,.lsd-schedule-form select{width:100%;min-height:38px;box-sizing:border-box;border:1px solid var(--lsd-border-strong);border-radius:var(--lsd-r-sm);background:var(--lsd-surface);color:var(--lsd-ink);padding:8px;font:inherit;font-size:.72rem}.lsd-schedule-form-row{display:grid;grid-template-columns:1fr 1fr;gap:8px}.lsd-schedule-save{min-height:42px;border:none;border-radius:var(--lsd-r-md);background:linear-gradient(135deg,var(--lsd-accent),var(--lsd-accent));color:var(--lsd-head-ink);font-size:.75rem;font-weight:950;cursor:pointer;box-shadow:0 10px 20px rgba(76,29,149,.2)}.lsd-schedule-save:focus-visible,.lsd-schedule-done:focus-visible,.lsd-schedule-delete:focus-visible{outline:3px solid var(--lsd-gold);outline-offset:2px}',
        '.lsd-diary-toast{position:absolute;left:50%;bottom:68px;z-index:35;max-width:min(320px,calc(100% - 32px));transform:translate(-50%,12px);opacity:0;pointer-events:none;border:1px solid rgba(99,102,241,.22);background:rgba(15,23,42,.92);color:var(--lsd-head-ink);border-radius:var(--lsd-r-pill);padding:10px 14px;font-size:.74rem;font-weight:900;line-height:1.35;box-shadow:0 16px 32px rgba(15,23,42,.22);transition:opacity .2s ease,transform .2s ease}.lsd-diary-toast.is-show{opacity:1;transform:translate(-50%,0)}',
        '.lsd-confirm-overlay{position:absolute;inset:0;z-index:34;display:flex;align-items:center;justify-content:center;padding:18px;background:rgba(15,23,42,.42);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px)}.lsd-confirm-card{width:min(340px,100%);border-radius:var(--lsd-r-xl);border:1px solid var(--lsd-border);background:var(--lsd-surface);padding:18px;box-shadow:0 24px 56px rgba(15,23,42,.28)}.lsd-confirm-title{margin:0 0 6px;font-size:.95rem;font-weight:950;color:var(--lsd-ink)}.lsd-confirm-copy{margin:0;font-size:.78rem;line-height:1.55;color:var(--lsd-ink-muted);font-weight:750}.lsd-confirm-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:16px}.lsd-confirm-cancel,.lsd-confirm-delete{border-radius:var(--lsd-r-pill);padding:9px 14px;font-size:.74rem;font-weight:900;cursor:pointer}.lsd-confirm-cancel{border:1px solid var(--lsd-border-strong);background:var(--lsd-surface);color:var(--lsd-ink-muted)}.lsd-confirm-delete{border:1px solid var(--lsd-danger);background:var(--lsd-grade-vb-bg);color:var(--lsd-danger)}',
        '@keyframes lsdSoftCheck{0%{transform:scale(.78)}70%{transform:scale(1.12)}100%{transform:scale(1)}}',
        '@media (min-width:760px){.lsd-hero-grid{grid-template-columns:minmax(0,1.05fr) minmax(280px,.95fr);align-items:start}.lsd-panel{padding:16px 18px 18px}.lsd-mini-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.lsd-hero-title{font-size:1.28rem}.lsd-mood-grid{grid-template-columns:repeat(6,minmax(0,1fr))}.lsd-sats-player{height:230px}}',
    ...
    modal.innerHTML = [
      ...
      '</div>',
      '<div class="lsd-card" style="text-align:center">',
      ...
      '<div class="lsd-panel-intro">하루의 끝에서 오늘의 실천을 부드럽게 접어둡니다.</div>',
      '<div class="lsd-card">',
      '<h3 class="lsd-card-title">밤의 운기 회고</h3>',
      '<p class="lsd-card-sub" style="margin-bottom:0">잘한 것과 보완할 것을 나누어 Tomorrow Blueprint로 이어갑니다.</p>',
      '</div>',
      '<div class="lsd-card">',
      ...
      '<button type="button" class="lsd-mood-btn" data-emoji="🥱">🥱</button>',
      '</div></div>',
      '<div class="lsd-card" style="overflow:hidden">',
