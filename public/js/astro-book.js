...
(function () {
  ...
  function _showScreen(id) {
    var screens = ['abStartScreen','abLoadingScreen','abResultScreen','abErrorScreen'];
  ...
  window.downloadAstroBookPdf = function() {
    ...
    var fname=(profile.name||'사용자')+'_점성술_코즈믹_차트_'+new Date().toLocaleDateString('ko-KR').replace(/[\.\/]/g,'').trim()+'.html';
