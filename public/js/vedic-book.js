(function () {
  ...
  var VEDIC_LOADING_FLOW_PERSONAL = [
    '출생 차트 총론을 구성하는 중입니다...',
    '라그나 축을 정밀 교정하는 중입니다...',
    '달 차트의 정서 흐름을 해석하는 중입니다...',
    '태양 기반 자아 축을 분석하는 중입니다...',
    '9행성 동력을 교차 검증하는 중입니다...',
    '12하우스 카르마 지도를 정리하는 중입니다...',
    '나크샤트라 본능 코드를 해석하는 중입니다...',
    '요가 성립 조건을 점검하는 중입니다...',
    '도샤 리스크를 진단하는 중입니다...',
    '직업·재물·성공운 전략을 설계하는 중입니다...',
    '연애·결혼·파트너십 패턴을 분석하는 중입니다...',
    '건강·심리·생활 리듬을 정리하는 중입니다...',
    '다샤 전환 타이밍을 계산하는 중입니다...',
    'D9/D10 고차원 차트를 보정하는 중입니다...',
    '트랜짓 변화를 현재 맥락에 매핑하는 중입니다...',
    '최종 종합 리포트를 교정하는 중입니다...'
  ];
