...
const __lazyActionLoaders = {
  ...
  openPhysiognomyApp: () => __loadScriptOnce('AnalysisEngine.js?v=ha8cb319b39b1').then(() => __loadScriptOnce('PhysiognomyUI.js?v=ha8cb319b39b1')),
  openPastLifeFaceApp: () => __loadScriptOnce('AnalysisEngine.js?v=ha8cb319b39b1').then(() => __loadScriptOnce('PastLifeFaceUI.js?v=ha8cb319b39b1')),
  openHwatuModal: () => __loadScriptOnce('HwatuFortune.js?v=ha8cb319b39b1'),
  openMbtiModal: () => __loadScriptOnce('js/astral-soul.js'),
  openKemetModal: () => __loadScriptOnce('/js/oracle-kcg.js?v=build-572608ebaf65'),
  openDreamModal: () => __loadScriptOnce('/js/dream-ledger.js?v=build-572608ebaf65'),
  openPsychoDreamModal: () => __loadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-572608ebaf65'),
  openAnimalTotemModal: () =>
    __loadScriptOnce('/js/services/animal-totem-content-engine.js').then(() =>
      __loadScriptOnce('/js/animal-totem-experience.js?v=build-572608ebaf65')
    ),
  ...
  openTarotLoveModal: () => __loadScriptOnce('/js/tarot-love-experience.js?v=build-572608ebaf65'),
  openTarotReunionModal: () => __loadScriptOnce('/js/tarot-reunion-experience.js?v=build-572608ebaf65'),
  ...
  openTarotSelfEsteemModal: () => __loadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-572608ebaf65'),
  openTarotYearFortuneModal: () => __loadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-572608ebaf65'),
  ...
  openSibylModal: () => __loadScriptOnce('/js/sibyl-system.js?v=build-572608ebaf65').then(() => {
...
function __ensureSajuCoreScripts() {
  return __loadScriptOnce('/js/destiny-profile.js?v=build-572608ebaf65')
