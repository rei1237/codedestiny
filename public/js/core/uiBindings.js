...
const __lazyActionLoaders = {
  ...
  openPhysiognomyApp: () => __loadScriptOnce('AnalysisEngine.js?v=hf747a853acdb').then(() => __loadScriptOnce('PhysiognomyUI.js?v=ha514c1f64b43')),
  ...
  openKemetModal: () => __loadScriptOnce('/js/oracle-kcg.js?v=build-bf6fef8e3d67'),
  openDreamModal: () => __loadScriptOnce('/js/dream-ledger.js?v=build-bf6fef8e3d67'),
  openPsychoDreamModal: () => __loadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-bf6fef8e3d67'),
  openAnimalTotemModal: () =>
    __loadScriptOnce('/js/services/animal-totem-content-engine.js').then(() =>
      __loadScriptOnce('/js/animal-totem-experience.js?v=build-bf6fef8e3d67')
    ),
  ...
  openTarotLoveModal: () => __loadScriptOnce('/js/tarot-love-experience.js?v=build-bf6fef8e3d67'),
  openTarotReunionModal: () => __loadScriptOnce('/js/tarot-reunion-experience.js?v=build-bf6fef8e3d67'),
  ...
  openTarotSelfEsteemModal: () => __loadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-bf6fef8e3d67'),
  openTarotYearFortuneModal: () => __loadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-bf6fef8e3d67'),
  ...
  openSibylModal: () => __loadScriptOnce('/js/sibyl-system.js?v=build-bf6fef8e3d67').then(() => {
...
function __ensureSajuCoreScripts() {
  return __loadScriptOnce('/js/destiny-profile.js?v=build-bf6fef8e3d67')
