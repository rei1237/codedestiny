...
const __lazyActionLoaders = {
  ...
  openKemetModal: () => __loadScriptOnce('/js/oracle-kcg.js?v=build-263015f24cdb'),
  openDreamModal: () => __loadScriptOnce('/js/dream-ledger.js?v=build-263015f24cdb'),
  openPsychoDreamModal: () => __loadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-263015f24cdb'),
  openAnimalTotemModal: () =>
    __loadScriptOnce('/js/services/animal-totem-content-engine.js').then(() =>
      __loadScriptOnce('/js/animal-totem-experience.js?v=build-263015f24cdb')
    ),
  ...
  openTarotLoveModal: () => __loadScriptOnce('/js/tarot-love-experience.js?v=build-263015f24cdb'),
  openTarotReunionModal: () => __loadScriptOnce('/js/tarot-reunion-experience.js?v=build-263015f24cdb'),
  ...
  openTarotSelfEsteemModal: () => __loadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-263015f24cdb'),
  openTarotYearFortuneModal: () => __loadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-263015f24cdb'),
  ...
  openSibylModal: () => __loadScriptOnce('/js/sibyl-system.js?v=build-263015f24cdb').then(() => {
...
function __ensureSajuCoreScripts() {
  return __loadScriptOnce('/js/destiny-profile.js?v=build-263015f24cdb')
