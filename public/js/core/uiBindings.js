...
const __lazyActionLoaders = {
  ...
  openTarotLoveModal: () => __loadScriptOnce('/js/tarot-love-experience.js?v=build-a0c0f7626b1e'),
  openTarotReunionModal: () => __loadScriptOnce('/js/tarot-reunion-experience.js?v=build-a0c0f7626b1e'),
  ...
  openTarotSelfEsteemModal: () => __loadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-a0c0f7626b1e'),
  openTarotYearFortuneModal: () => __loadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-a0c0f7626b1e'),
  ...
  openZiweiBookModal: () => __loadScriptOnce('/js/ziwei-book.js?v=build-a0c0f7626b1e'),
  closeZiweiBookModal: () => __loadScriptOnce('/js/ziwei-book.js?v=build-a0c0f7626b1e'),
  generateZiweiBook: () => __loadScriptOnce('/js/ziwei-book.js?v=build-a0c0f7626b1e'),
  downloadZiweiBookPdf: () => __loadScriptOnce('/js/ziwei-book.js?v=build-a0c0f7626b1e'),
    gotoAstrologyPremium: () => __loadScriptOnce('/js/astro-book.js?v=build-a0c0f7626b1e'),
  gotoZiweiPremium: () => __loadScriptOnce('/js/ziwei-book.js?v=build-a0c0f7626b1e'),
  openSajuNewYearModal: () => __loadScriptOnce('/js/saju-new-year.js?v=build-a0c0f7626b1e'),
  closeSajuNewYearModal: () => __loadScriptOnce('/js/saju-new-year.js?v=build-a0c0f7626b1e'),
  generateSajuNewYear: () => __loadScriptOnce('/js/saju-new-year.js?v=build-a0c0f7626b1e'),
  downloadSajuNewYearPdf: () => __loadScriptOnce('/js/saju-new-year.js?v=build-a0c0f7626b1e'),
  openVedicBookModal: () => __loadScriptOnce('/js/vedic-book.js?v=build-a0c0f7626b1e'),
  closeVedicBookModal: () => __loadScriptOnce('/js/vedic-book.js?v=build-a0c0f7626b1e'),
  generateVedicBook: () => __loadScriptOnce('/js/vedic-book.js?v=build-a0c0f7626b1e'),
  downloadVedicBookPdf: () => __loadScriptOnce('/js/vedic-book.js?v=build-a0c0f7626b1e'),
  gotoVedicPremium: () => __loadScriptOnce('/js/vedic-book.js?v=build-a0c0f7626b1e'),
  openSukuyoBookModal: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-a0c0f7626b1e'),
  closeSukuyoBookModal: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-a0c0f7626b1e'),
  generateSukuyoBook: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-a0c0f7626b1e'),
  downloadSukuyoBookPdf: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-a0c0f7626b1e'),
  gotoSukuyoPremium: () => __loadScriptOnce('/js/sukuyo-book.js?v=build-a0c0f7626b1e'),
  openLoveSecretModal: () => __loadScriptOnce('/js/love-secret-v2.js?v=build-a0c0f7626b1e'),
  closeLoveSecretModal: () => __loadScriptOnce('/js/love-secret-v2.js?v=build-a0c0f7626b1e'),
  generateLoveSecret: () => __loadScriptOnce('/js/love-secret-v2.js?v=build-a0c0f7626b1e'),
  openOlympusOracleModal: () => __loadScriptOnce('/js/olympus-oracle.js'),
  openSibylModal: () => __loadScriptOnce('/js/sibyl-system.js?v=build-a0c0f7626b1e').then(() => {
...
function __ensureSajuCoreScripts() {
  return __loadScriptOnce('/js/destiny-profile.js?v=build-a0c0f7626b1e')
