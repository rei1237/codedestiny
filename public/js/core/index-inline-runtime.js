...
function __cdSyncTileLocksFromServer() {
  ...
  var url = __cdResolveApiBaseForLockSync() + '/api/access/unlocks?profileId=' + encodeURIComponent(profileId) + '&serviceKey=saju';
...
// 이 두 source 는 "방금 서버에서 받은 구독 상태를 캐시에 적었다"는 통보라 해금 목록과 무관하다.
// 예전엔 필터가 전혀 없어서 이용권 확인 1회마다 /api/billing/balance 가 따라 나갔다.
// 걸러내는 축은 event 가 아니라 source 다 — 그래야 실제 구독 변경(다른 source)은 종전대로 타일
// 잠금을 갱신하고, 이용권 구매 직후 해금 반영이 늦어지지 않는다.
...
var __cdLazyActionLoaders = {
  openKemetModal: function() { return __cdLoadScriptOnce('/js/oracle-kcg.js?v=build-14d01a41522a'); },
  openDreamModal: function() { return __cdLoadScriptOnce('/js/dream-ledger.js?v=build-14d01a41522a'); },
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-14d01a41522a'); },
  ...
  openJuyukModal: function() { return __cdLoadScriptOnce('/js/iching-engine.js?v=build-14d01a41522a').then(function() { return __cdLoadScriptOnce('/js/iching-modal.js?v=build-14d01a41522a'); }); },
  openRuneOracle: function() { window.location.assign('/oracle/rune/'); return Promise.resolve(true); },
  openLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-14d01a41522a'); },
  closeLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-14d01a41522a'); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-14d01a41522a').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-14d01a41522a'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-14d01a41522a'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-14d01a41522a'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-14d01a41522a'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-14d01a41522a'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-14d01a41522a').then(function() {
  ...
  // 같은 계열의 버그 — 위 주석 참고).
  shareKakao: function() { return __cdLoadScriptOnce('/js/share.js?v=build-14d01a41522a'); },
  shareInstagram: function() { return __cdLoadScriptOnce('/js/share.js?v=build-14d01a41522a'); },
  shareSajuResultImage: function() { return __cdLoadScriptOnce('/js/share.js?v=build-14d01a41522a'); }
};
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/core/kasi-calendar-service.js?v=build-14d01a41522a',
    '/js/compat-llm-prompts.js?v=build-14d01a41522a',
    '/js/saju-engine.js?v=build-14d01a41522a',
      '/js/core/saju/extremeTResult.js?v=build-14d01a41522a',
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-14d01a41522a',
    '/js/core/saju/modalProfileState.js?v=build-14d01a41522a',
    '/js/core/saju/reportDashboard.js?v=build-14d01a41522a',
    '/js/saju-engine-continuation.js?v=build-14d01a41522a',
    '/js/entertain-engine.js?v=build-14d01a41522a',
    /* 체인은 순차 reduce라 앞에 끼우면 이 파일의 실패가 뒤쪽 전체를 죽인다 — 신규 카드 스크립트는 맨 뒤에 둔다. */
    '/js/core/saju/dopamineResult.js?v=build-14d01a41522a'
  ];
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-14d01a41522a')
    .then(function() { return true; })
    .catch(function(err) {
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-14d01a41522a';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openLuckSyncDiary = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-14d01a41522a').then(function() {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal() {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-14d01a41522a')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-14d01a41522a'); })
          .then(function() {
            try {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-14d01a41522a'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-14d01a41522a')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-14d01a41522a'); })
      .then(function() {
