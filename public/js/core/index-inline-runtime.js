...
function __cdResolvePaymentMeta(pathname) {
  if (pathname && pathname.indexOf('/api/payments/subscription/prepare') === 0) return { message: '월정석 결제 정보를 준비하고 있습니다.', mode: 'subscription' };
  if (pathname && pathname.indexOf('/api/payments/subscription/confirm') === 0) return { message: '월정석 결제 승인과 활성화를 확인하고 있습니다.', mode: 'subscription' };
  if (pathname && pathname.indexOf('/api/fortune/pig-coin/profile-subscription/subscribe') === 0) return { message: '월정석 이용권을 활성화하고 있습니다.', mode: 'subscription' };
...
var __cdLazyActionLoaders = {
  ...
  openDreamModal: function() { return __cdLoadScriptOnce('/lib/ai-engine.js').then(function() { return __cdLoadScriptOnce('/js/dream-ledger.js?v=build-20260610-astro-action'); }); },
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-20260610-astro-action'); },
  openOlympusOracleModal: function() { return __cdLoadScriptOnce('/js/olympus-oracle.js'); },
  openLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-20260610-astro-action'); },
  closeLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-20260610-astro-action'); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-20260610-astro-action').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-20260610-astro-action'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-20260610-astro-action'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-20260610-astro-action'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-20260610-astro-action'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-20260610-astro-action'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-20260610-astro-action').then(function() {
      if (typeof window.openSibylModal === 'function') window.openSibylModal();
    });
  },
  openLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260610-astro-action'); },
  closeLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260610-astro-action'); },
  generateLoveSecret: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260610-astro-action'); },
  openLoveSecretLatestReport: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260610-astro-action'); },
  downloadLoveSecretPdf: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260610-astro-action'); },
  shareLoveSecretKakao: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260610-astro-action'); },
  openLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-20260610-astro-action'); },
  closeLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-20260610-astro-action'); },
  generateLifeBook: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-20260610-astro-action'); },
  openAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260610-astro-action'); },
  closeAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260610-astro-action'); },
  generateAstroBook: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260610-astro-action'); },
  downloadAstroBookPdf: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260610-astro-action'); },
  gotoAstrologyPremium: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260610-astro-action'); },
  openZiweiBookModal: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-20260610-astro-action'); },
  closeZiweiBookModal: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-20260610-astro-action'); },
  generateZiweiBook: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-20260610-astro-action'); },
  downloadZiweiBookPdf: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-20260610-astro-action'); },
  gotoZiweiPremium: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-20260610-astro-action'); },
  openSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-20260610-astro-action'); },
  closeSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-20260610-astro-action'); },
  generateSajuNewYear: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-20260610-astro-action'); },
  downloadSajuNewYearPdf: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-20260610-astro-action'); },
  openVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-20260610-astro-action'); },
  closeVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-20260610-astro-action'); },
  generateVedicBook: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-20260610-astro-action'); },
  downloadVedicBookPdf: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-20260610-astro-action'); },
  gotoVedicPremium: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-20260610-astro-action'); },
  openSukuyoBookModal: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-20260610-astro-action'); },
  closeSukuyoBookModal: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-20260610-astro-action'); },
  generateSukuyoBook: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-20260610-astro-action'); },
  downloadSukuyoBookPdf: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-20260610-astro-action'); },
  gotoSukuyoPremium: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-20260610-astro-action'); },
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/core/kasi-calendar-service.js?v=build-20260610-astro-action',
    '/js/compat-llm-prompts.js?v=build-20260610-astro-action',
    '/js/saju-engine.js?v=build-20260610-astro-action',
      '/js/core/saju/extremeTResult.js?v=build-20260610-astro-action',
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-20260610-astro-action',
    '/js/core/saju/modalProfileState.js?v=build-20260610-astro-action',
    '/js/core/saju/reportDashboard.js?v=build-20260610-astro-action',
    '/js/saju-engine-continuation.js?v=build-20260610-astro-action',
    '/js/entertain-engine.js?v=build-20260610-astro-action'
  ];
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-20260610-astro-action')
    .then(function() { return true; })
    .catch(function(err) {
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-20260610-astro-action';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openLuckSyncDiary = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-20260610-astro-action').then(function() {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal() {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-20260610-astro-action')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-20260610-astro-action'); })
          .then(function() {
            try {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-20260610-astro-action'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-20260610-astro-action')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-20260610-astro-action'); })
      .then(function() {
...
function openSajuLifeBookBuilder() {
  ...
  __cdLoadScriptOnce('/js/life-book.js?v=build-20260610-astro-action').then(function () {
...
function changeLanguage(langCode, btn) {
  ...
  if (applyPromise && typeof applyPromise.then === 'function') {
    applyPromise.then(function() {
      ...
      // 다른 언어에서 한국어로 돌아올 때는 번역 잔여 DOM을 확실히 해제하기 위해 1회 새로고침한다.
      if (langCode === 'ko' && prevLangCode && prevLangCode !== 'ko' && !window.__cdKoResetReloading) {
        window.__cdKoResetReloading = true;
        setTimeout(function() {
