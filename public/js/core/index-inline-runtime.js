...
var __cdLazyActionLoaders = {
  openKemetModal: function() { return __cdLoadScriptOnce('/js/oracle-kcg.js?v=build-5eb5ad04653b'); },
  openDreamModal: function() { return __cdLoadScriptOnce('/js/dream-ledger.js?v=build-5eb5ad04653b'); },
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-5eb5ad04653b'); },
  ...
  openJuyukModal: function() { return __cdLoadScriptOnce('/js/iching-engine.js?v=build-5eb5ad04653b').then(function() { return __cdLoadScriptOnce('/js/iching-modal.js?v=build-5eb5ad04653b'); }); },
  openRuneOracle: function() { window.location.assign('/oracle/rune/'); return Promise.resolve(true); },
  openLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-5eb5ad04653b'); },
  closeLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-5eb5ad04653b'); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-5eb5ad04653b').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-5eb5ad04653b'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-5eb5ad04653b'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-5eb5ad04653b'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-5eb5ad04653b'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-5eb5ad04653b'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-5eb5ad04653b').then(function() {
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/core/kasi-calendar-service.js?v=build-5eb5ad04653b',
    '/js/compat-llm-prompts.js?v=build-5eb5ad04653b',
    '/js/saju-engine.js?v=build-5eb5ad04653b',
      '/js/core/saju/extremeTResult.js?v=build-5eb5ad04653b',
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-5eb5ad04653b',
    '/js/core/saju/modalProfileState.js?v=build-5eb5ad04653b',
    '/js/core/saju/reportDashboard.js?v=build-5eb5ad04653b',
    '/js/saju-engine-continuation.js?v=build-5eb5ad04653b',
    '/js/entertain-engine.js?v=build-5eb5ad04653b'
  ];
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-5eb5ad04653b')
    .then(function() { return true; })
    .catch(function(err) {
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-5eb5ad04653b';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openLuckSyncDiary = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-5eb5ad04653b').then(function() {
...
function __cdHydrateCollectionImagesChunked(collection, forceHydrateAll) {
  ...
  function hydrateWrap(wrap) {
    ...
    if (existingImg) {
      ...
      var existingFallback = resizedExisting ? resolvedExistingSrc : (resolvedExistingSrc === existingSrc ? '' : existingSrc);
    ...
    // 리사이즈본이 실패하면 원본 R2 → 그래도 실패하면 심볼 플레이스홀더 순으로 되돌아간다.
    bindCollectionImageFallback(img, resizedSrc ? resolvedSrc : fallbackSrc, placeholder, skeleton);
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal() {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-5eb5ad04653b')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-5eb5ad04653b'); })
          .then(function() {
            try {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-5eb5ad04653b'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-5eb5ad04653b')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-5eb5ad04653b'); })
      .then(function() {
