...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/saju-engine.js?v=build-27fdc9213778',
    ...
    '/js/core/saju/basicFortunePresentation.js?v=build-a3c5ab692388',
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  var presentationReady = window.BasicFortunePresentation
    ? Promise.resolve()
    : __cdLoadScriptOnce('/js/core/saju/basicFortunePresentation.js?v=build-a3c5ab692388');
