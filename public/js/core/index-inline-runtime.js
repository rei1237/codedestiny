...
var __cdLazyActionLoaders = {
  openKemetModal: function() { return __cdLoadScriptOnce('/js/oracle-kcg.js?v=build-20260627-nyai-session-token'); },
  openDreamModal: function() { return __cdLoadScriptOnce('/js/dream-ledger.js?v=build-20260627-nyai-session-token'); },
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-20260627-nyai-session-token'); },
  openOlympusOracleModal: function() { return __cdLoadScriptOnce('/js/olympus-oracle.js'); },
  openLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-20260627-nyai-session-token'); },
  closeLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-20260627-nyai-session-token'); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-20260627-nyai-session-token').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-20260627-nyai-session-token'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-20260627-nyai-session-token'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-20260627-nyai-session-token'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-20260627-nyai-session-token'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-20260627-nyai-session-token'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-20260627-nyai-session-token').then(function() {
      if (typeof window.openSibylModal === 'function') window.openSibylModal();
    });
  },
  openLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260627-nyai-session-token'); },
  closeLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260627-nyai-session-token'); },
  generateLoveSecret: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260627-nyai-session-token'); },
  openLoveSecretLatestReport: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260627-nyai-session-token'); },
  downloadLoveSecretPdf: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260627-nyai-session-token'); },
  shareLoveSecretKakao: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-20260627-nyai-session-token'); },
  openLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-20260627-nyai-session-token'); },
  closeLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-20260627-nyai-session-token'); },
  generateLifeBook: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-20260627-nyai-session-token'); },
  openAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260627-nyai-session-token'); },
  closeAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260627-nyai-session-token'); },
  generateAstroBook: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260627-nyai-session-token'); },
  downloadAstroBookPdf: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260627-nyai-session-token'); },
  gotoAstrologyPremium: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-20260627-nyai-session-token'); },
  ...
  openSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-20260627-nyai-session-token'); },
  closeSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-20260627-nyai-session-token'); },
  generateSajuNewYear: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-20260627-nyai-session-token'); },
  downloadSajuNewYearPdf: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-20260627-nyai-session-token'); },
  openVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-ai-consultation.js?v=20260627-vedic-ai-payment-wasm'); },
  closeVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-ai-consultation.js?v=20260627-vedic-ai-payment-wasm'); },
  generateVedicBook: function() { return __cdLoadScriptOnce('/js/vedic-ai-consultation.js?v=20260627-vedic-ai-payment-wasm'); },
  downloadVedicBookPdf: function() { return __cdLoadScriptOnce('/js/vedic-ai-consultation.js?v=20260627-vedic-ai-payment-wasm'); },
  gotoVedicPremium: function() { return __cdLoadScriptOnce('/js/vedic-ai-consultation.js?v=20260627-vedic-ai-payment-wasm'); },
...
function __cdLoadZiweiBookReady() {
  var src = '/js/ziwei-book.js?v=20260627-ziwei-ai-consultation';
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/core/kasi-calendar-service.js?v=build-20260627-nyai-session-token',
    '/js/compat-llm-prompts.js?v=build-20260627-nyai-session-token',
    '/js/saju-engine.js?v=build-20260627-nyai-session-token',
      '/js/core/saju/extremeTResult.js?v=build-20260627-nyai-session-token',
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-20260627-nyai-session-token',
    '/js/core/saju/modalProfileState.js?v=build-20260627-nyai-session-token',
    '/js/core/saju/reportDashboard.js?v=build-20260627-nyai-session-token',
    '/js/saju-engine-continuation.js?v=build-20260627-nyai-session-token',
    '/js/entertain-engine.js?v=build-20260627-nyai-session-token'
  ];
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-20260627-nyai-session-token')
    .then(function() { return true; })
    .catch(function(err) {
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-20260627-nyai-session-token';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openLuckSyncDiary = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-20260627-nyai-session-token').then(function() {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal() {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-20260627-nyai-session-token')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-20260627-nyai-session-token'); })
          .then(function() {
            try {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-20260627-nyai-session-token'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-20260627-nyai-session-token')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-20260627-nyai-session-token'); })
      .then(function() {
...
function openSajuLifeBookBuilder() {
  ...
  __cdLoadScriptOnce('/js/life-book.js?v=build-20260627-nyai-session-token').then(function () {
