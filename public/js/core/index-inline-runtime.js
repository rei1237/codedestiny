...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/saju-engine.js?v=build-4caab113f2ea',
      ...
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-479a140eec0d',
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-86ecffcb812f')
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  var presentationReady = window.BasicFortunePresentation
    ? Promise.resolve()
    : __cdLoadScriptOnce('/js/core/saju/basicFortunePresentation.js?v=build-28208b3a26fe');
