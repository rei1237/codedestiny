...
var __cdLazyActionLoaders = {
  openKemetModal: function() { return __cdLoadScriptOnce('/js/oracle-kcg.js?v=build-2e47c91a3ba4'); },
  openDreamModal: function() { return __cdLoadScriptOnce('/js/dream-ledger.js?v=build-2e47c91a3ba4'); },
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-2e47c91a3ba4'); },
  ...
  openJuyukModal: function() { return __cdLoadScriptOnce('/js/iching-engine.js?v=build-2e47c91a3ba4').then(function() { return __cdLoadScriptOnce('/js/iching-modal.js?v=build-2e47c91a3ba4'); }); },
  openRuneOracle: function() { window.location.assign('/oracle/rune/'); return Promise.resolve(true); },
  openLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-2e47c91a3ba4'); },
  closeLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-2e47c91a3ba4'); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-2e47c91a3ba4').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-2e47c91a3ba4'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-2e47c91a3ba4'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-2e47c91a3ba4'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-2e47c91a3ba4'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-2e47c91a3ba4'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-2e47c91a3ba4').then(function() {
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/core/kasi-calendar-service.js?v=build-2e47c91a3ba4',
    '/js/compat-llm-prompts.js?v=build-2e47c91a3ba4',
    '/js/saju-engine.js?v=build-2e47c91a3ba4',
      '/js/core/saju/extremeTResult.js?v=build-2e47c91a3ba4',
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-2e47c91a3ba4',
    '/js/core/saju/modalProfileState.js?v=build-2e47c91a3ba4',
    '/js/core/saju/reportDashboard.js?v=build-2e47c91a3ba4',
    '/js/saju-engine-continuation.js?v=build-2e47c91a3ba4',
    '/js/entertain-engine.js?v=build-2e47c91a3ba4',
    /* 체인은 순차 reduce라 앞에 끼우면 이 파일의 실패가 뒤쪽 전체를 죽인다 — 신규 카드 스크립트는 맨 뒤에 둔다. */
    '/js/core/saju/dopamineResult.js?v=build-2e47c91a3ba4'
  ];
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-2e47c91a3ba4')
    .then(function() { return true; })
    .catch(function(err) {
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-2e47c91a3ba4';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openLuckSyncDiary = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-2e47c91a3ba4').then(function() {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal() {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-2e47c91a3ba4')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-2e47c91a3ba4'); })
          .then(function() {
            try {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-2e47c91a3ba4'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-2e47c91a3ba4')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-2e47c91a3ba4'); })
      .then(function() {
