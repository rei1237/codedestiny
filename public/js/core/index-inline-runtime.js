...
var __cdLazyActionLoaders = {
  ...
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-7489ce1a6671'); },
  ...
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-7489ce1a6671').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-7489ce1a6671'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-7489ce1a6671'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-7489ce1a6671'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-7489ce1a6671'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-7489ce1a6671'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-7489ce1a6671').then(function() {
      if (typeof window.openSibylModal === 'function') window.openSibylModal();
    });
  },
  openLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-7489ce1a6671'); },
  closeLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-7489ce1a6671'); },
  generateLoveSecret: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-7489ce1a6671'); },
  openLoveSecretLatestReport: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-7489ce1a6671'); },
  downloadLoveSecretPdf: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-7489ce1a6671'); },
  shareLoveSecretKakao: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-7489ce1a6671'); },
  openLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-7489ce1a6671'); },
  closeLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-7489ce1a6671'); },
  generateLifeBook: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-7489ce1a6671'); },
  openAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-7489ce1a6671'); },
  closeAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-7489ce1a6671'); },
  generateAstroBook: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-7489ce1a6671'); },
  downloadAstroBookPdf: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-7489ce1a6671'); },
  gotoAstrologyPremium: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-7489ce1a6671'); },
  openZiweiBookModal: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-7489ce1a6671'); },
  closeZiweiBookModal: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-7489ce1a6671'); },
  generateZiweiBook: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-7489ce1a6671'); },
  downloadZiweiBookPdf: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-7489ce1a6671'); },
  gotoZiweiPremium: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-7489ce1a6671'); },
  openSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-7489ce1a6671'); },
  closeSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-7489ce1a6671'); },
  generateSajuNewYear: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-7489ce1a6671'); },
  downloadSajuNewYearPdf: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-7489ce1a6671'); },
  openVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-7489ce1a6671'); },
  closeVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-7489ce1a6671'); },
  generateVedicBook: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-7489ce1a6671'); },
  downloadVedicBookPdf: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-7489ce1a6671'); },
  gotoVedicPremium: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-7489ce1a6671'); },
  openSukuyoBookModal: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-7489ce1a6671'); },
  closeSukuyoBookModal: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-7489ce1a6671'); },
  generateSukuyoBook: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-7489ce1a6671'); },
  downloadSukuyoBookPdf: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-7489ce1a6671'); },
  gotoSukuyoPremium: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-7489ce1a6671'); },
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/core/kasi-calendar-service.js?v=build-7489ce1a6671',
    '/js/compat-llm-prompts.js?v=build-7489ce1a6671',
    '/js/saju-engine.js?v=build-7489ce1a6671',
    '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-7489ce1a6671',
    '/js/core/saju/modalProfileState.js?v=build-7489ce1a6671',
    '/js/core/saju/reportDashboard.js?v=build-7489ce1a6671',
    '/js/saju-engine-continuation.js?v=build-7489ce1a6671',
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-7489ce1a6671';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal() {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-7489ce1a6671')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-7489ce1a6671'); })
          .then(function() {
            try {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-7489ce1a6671'));
  }
...
function openZiweiModal(_retried) {
  ...
  var profiles = s ? s.list() : [];
  var profile = s ? s.current() : null;
  window._ziweiModalOpenGuardUntil = Date.now() + 900;
  overlay.style.display = 'flex';
  overlay.style.overflow = 'hidden';
...
function closeZiweiModal(evt) {
  if (Date.now() < (window._ziweiModalOpenGuardUntil || 0)) {
    if (evt && typeof evt.preventDefault === 'function') evt.preventDefault();
    if (evt && typeof evt.stopPropagation === 'function') evt.stopPropagation();
    return;
  }
  window._ziweiModalOpenGuardUntil = 0;
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-7489ce1a6671')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-7489ce1a6671'); })
      .then(function() {
...
function openSajuLifeBookBuilder() {
  ...
  __cdLoadScriptOnce('/js/life-book.js?v=build-7489ce1a6671').then(function () {
