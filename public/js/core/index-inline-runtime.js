...
var __cdLazyActionLoaders = {
  ...
  // 같은 계열의 버그 — 위 주석 참고).
  shareKakao: function() { return __cdLoadScriptOnce('/js/share.js?v=build-371833a6ae33'); },
  shareInstagram: function() { return __cdLoadScriptOnce('/js/share.js?v=build-371833a6ae33'); },
  shareSajuResultImage: function() { return __cdLoadScriptOnce('/js/share.js?v=build-371833a6ae33'); }
};
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/saju-engine.js?v=build-012091c7a0b7',
      ...
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-8e4e408ad780',
    '/js/core/saju/basicFortunePresentation.js?v=build-413e34cd2970',
    '/js/core/saju/modalProfileState.js?v=build-271a3688fe45',
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-78a5cf92dbba';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  var presentationReady = window.BasicFortunePresentation
    ? Promise.resolve()
    : __cdLoadScriptOnce('/js/core/saju/basicFortunePresentation.js?v=build-413e34cd2970');
  ...
  if (
    ...
    tasks.push(presentationReady.then(function () {
      return __cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-271a3688fe45');
    }));
  }
