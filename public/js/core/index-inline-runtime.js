...
function __cdResolvePaymentMeta(pathname) {
  if (pathname && pathname.indexOf('/api/payments/subscription/prepare') === 0) return { message: '월정석 정보를 확인하는 중이에요', mode: 'monthly' };
  if (pathname && pathname.indexOf('/api/payments/subscription/confirm') === 0) return { message: '월정석이 활성화되고 있어요\n곧 이용 가능해져요', mode: 'payment-complete' };
  if (pathname && pathname.indexOf('/api/fortune/pig-coin/profile-subscription/subscribe') === 0) return { message: '월정석이 활성화되고 있어요\n곧 이용 가능해져요', mode: 'payment-complete' };
  if (pathname && (pathname.indexOf('/api/billing/checkout') === 0 || pathname.indexOf('/api/payments/prepare') === 0)) return { message: '잔액을 확인하는 중이에요', mode: 'payment' };
  if (pathname && (pathname.indexOf('/api/billing/confirm') === 0 || pathname.indexOf('/api/payments/confirm') === 0)) return { message: '결제가 완료됐어요\n결과를 불러오는 중이에요', mode: 'payment-complete' };
  if (pathname && pathname.indexOf('/api/billing/coin-gate') === 0) return { message: '이용권을 확인하는 중이에요', mode: 'pass' };
  return { message: '처리 중이에요\n잠시만 기다려 주세요', mode: 'payment' };
}
...
var __cdLazyActionLoaders = {
  openKemetModal: function() { return __cdLoadScriptOnce('/js/oracle-kcg.js?v=build-77cc13501817'); },
  openDreamModal: function() { return __cdLoadScriptOnce('/js/dream-ledger.js?v=build-77cc13501817'); },
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-77cc13501817'); },
  openOlympusOracleModal: function() { return __cdLoadScriptOnce('/js/olympus-oracle.js'); },
  openLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-77cc13501817'); },
  closeLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-77cc13501817'); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-77cc13501817').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-77cc13501817'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-77cc13501817'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-77cc13501817'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-77cc13501817'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-77cc13501817'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-77cc13501817').then(function() {
      if (typeof window.openSibylModal === 'function') window.openSibylModal();
    });
  },
  openLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-77cc13501817'); },
  closeLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-77cc13501817'); },
  generateLoveSecret: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-77cc13501817'); },
  openLoveSecretLatestReport: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-77cc13501817'); },
  downloadLoveSecretPdf: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-77cc13501817'); },
  shareLoveSecretKakao: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-77cc13501817'); },
  openLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-77cc13501817'); },
  closeLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-77cc13501817'); },
  generateLifeBook: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-77cc13501817'); },
  openAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-77cc13501817'); },
  closeAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-77cc13501817'); },
  generateAstroBook: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-77cc13501817'); },
  downloadAstroBookPdf: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-77cc13501817'); },
  gotoAstrologyPremium: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-77cc13501817'); },
  ...
  openSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-77cc13501817'); },
  closeSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-77cc13501817'); },
  generateSajuNewYear: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-77cc13501817'); },
  downloadSajuNewYearPdf: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-77cc13501817'); },
  openVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-77cc13501817'); },
  closeVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-77cc13501817'); },
  generateVedicBook: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-77cc13501817'); },
  downloadVedicBookPdf: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-77cc13501817'); },
  gotoVedicPremium: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-77cc13501817'); },
  openSukuyoBookModal: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-77cc13501817'); },
  closeSukuyoBookModal: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-77cc13501817'); },
  generateSukuyoBook: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-77cc13501817'); },
  downloadSukuyoBookPdf: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-77cc13501817'); },
  gotoSukuyoPremium: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-77cc13501817'); },
...
function __cdLoadZiweiBookReady() {
  var src = '/js/ziwei-book.js?v=build-77cc13501817';
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/core/kasi-calendar-service.js?v=build-77cc13501817',
    '/js/compat-llm-prompts.js?v=build-77cc13501817',
    '/js/saju-engine.js?v=build-77cc13501817',
      '/js/core/saju/extremeTResult.js?v=build-77cc13501817',
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-77cc13501817',
    '/js/core/saju/modalProfileState.js?v=build-77cc13501817',
    '/js/core/saju/reportDashboard.js?v=build-77cc13501817',
    '/js/saju-engine-continuation.js?v=build-77cc13501817',
    '/js/entertain-engine.js?v=build-77cc13501817'
  ];
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-77cc13501817')
    .then(function() { return true; })
    .catch(function(err) {
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-77cc13501817';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openLuckSyncDiary = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-77cc13501817').then(function() {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal() {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-77cc13501817')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-77cc13501817'); })
          .then(function() {
            try {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-77cc13501817'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-77cc13501817')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-77cc13501817'); })
      .then(function() {
...
function openSajuLifeBookBuilder() {
  ...
  __cdLoadScriptOnce('/js/life-book.js?v=build-77cc13501817').then(function () {
