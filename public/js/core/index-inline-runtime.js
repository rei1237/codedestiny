...
var __cdLazyActionLoaders = {
  openKemetModal: function() { return __cdLoadScriptOnce('/js/oracle-kcg.js?v=build-c813e759685f'); },
  openDreamModal: function() { return __cdLoadScriptOnce('/js/dream-ledger.js?v=build-c813e759685f'); },
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-c813e759685f'); },
  ...
  openJuyukModal: function() { return __cdLoadScriptOnce('/js/iching-engine.js?v=build-c813e759685f').then(function() { return __cdLoadScriptOnce('/js/iching-modal.js?v=build-c813e759685f'); }); },
  openRuneOracle: function() { window.location.assign('/oracle/rune/'); return Promise.resolve(true); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-c813e759685f').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-c813e759685f'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-c813e759685f'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-c813e759685f'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-c813e759685f'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-c813e759685f'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-c813e759685f').then(function() {
  ...
  // 같은 계열의 버그 — 위 주석 참고).
  shareKakao: function() { return __cdLoadScriptOnce('/js/share.js?v=build-c813e759685f'); },
  shareInstagram: function() { return __cdLoadScriptOnce('/js/share.js?v=build-c813e759685f'); },
  shareSajuResultImage: function() { return __cdLoadScriptOnce('/js/share.js?v=build-c813e759685f'); }
};
...
function __cdEnsureLunarLibReady() {
  ...
  __cdLunarLibLoadPromise = __cdLoadScriptOnce('/js/services/saju-library-loader.js')
    .then(function() {
      ...
      /* URL 을 __cdEnsureSajuCoreLoaded 의 체인 1번과 **글자 단위로 같게** 유지한다.
         두 경로가 서로 다른 lunar 파일을 부르면 같은 라이브러리를 두 번 받는다. */
      return __cdLoadScriptOnce('https://cdn.jsdelivr.net/npm/lunar-javascript@1.7.7/lunar.min.js')
...
function __cdEnsureSajuCoreLoaded() {
  ...
  /* 🔴 1번은 서드파티다. `@latest` 는 jsdelivr 가 매번 버전을 다시 풀어야 해 캐시가 짧고,
   *    핀이 없는 서드파티 실행 코드라는 점에서도 좋지 않다. 그리고 unminified `lunar.js` 였다 —
   *    같은 라이브러리를 __cdEnsureLunarLibReady 는 이미 `.min.js` 로 부르고 있었다.
  ...
  var chain = [
    ...
    '/js/core/korean-calendar.js?v=build-c813e759685f',
    'https://cdn.jsdelivr.net/npm/lunar-javascript@1.7.7/lunar.min.js',
    '/js/core/kasi-calendar-service.js?v=build-c813e759685f',
    '/js/compat-llm-prompts.js?v=build-c813e759685f',
    '/js/saju-engine.js?v=build-c813e759685f',
      '/js/core/saju/extremeTResult.js?v=build-c813e759685f',
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-c813e759685f',
    '/js/core/saju/modalProfileState.js?v=build-c813e759685f',
    '/js/core/saju/reportDashboard.js?v=build-c813e759685f',
    '/js/saju-engine-continuation.js?v=build-c813e759685f',
    '/js/entertain-engine.js?v=build-c813e759685f',
    /* 체인은 순차 reduce라 앞에 끼우면 이 파일의 실패가 뒤쪽 전체를 죽인다 — 신규 카드 스크립트는 맨 뒤에 둔다. */
    '/js/core/saju/dopamineResult.js?v=build-c813e759685f'
  ];
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-c813e759685f')
    .then(function() { return true; })
    .catch(function(err) {
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-c813e759685f';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openFortunePlanner = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-c813e759685f').then(function() {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal(event) {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-c813e759685f')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-c813e759685f'); })
          .then(function() {
            try {
...
function _dfReloadSourceData(source, options) {
  ...
  if (!window.CDFlowerArt) {
    loader = loader.then(function() {
      return import('/js/core/bootstrapDestinyFlower.js?v=build-c813e759685f').then(function(mod) {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-c813e759685f'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-c813e759685f')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-c813e759685f'); })
      .then(function() {
