...
var __cdLazyActionLoaders = {
  ...
  openDreamModal: function() { return __cdLoadScriptOnce('/lib/ai-engine.js').then(function() { return __cdLoadScriptOnce('/js/dream-ledger.js?v=build-9310b301914d'); }); },
  openPsychoDreamModal: function() { return __cdLoadScriptOnce('/js/psycho-dream-analyzer-freuds-study.js?v=build-9310b301914d'); },
  openOlympusOracleModal: function() { return __cdLoadScriptOnce('/js/olympus-oracle.js'); },
  openLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-9310b301914d'); },
  closeLuckSyncDiary: function() { return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-9310b301914d'); },
  openAnimalTotemModal: function() { return __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-9310b301914d').then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-9310b301914d'); }); },
  openDestinyEggPage: function() { return Promise.resolve(window.location.assign('/tadagochi.html')); },
  openTarotLoveModal: function() { return __cdLoadScriptOnce('/js/tarot-love-experience.js?v=build-9310b301914d'); },
  openTarotReunionModal: function() { return __cdLoadScriptOnce('/js/tarot-reunion-experience.js?v=build-9310b301914d'); },
  ...
  openTarotSelfEsteemModal: function() { return __cdLoadScriptOnce('/js/tarot-self-esteem-experience.js?v=build-9310b301914d'); },
  openTarotYearFortuneModal: function() { return __cdLoadScriptOnce('/js/tarot-year-fortune-experience.js?v=build-9310b301914d'); },
  openSibylModal: function() {
    return __cdLoadScriptOnce('/js/sibyl-system.js?v=build-9310b301914d').then(function() {
      if (typeof window.openSibylModal === 'function') window.openSibylModal();
    });
  },
  openLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-9310b301914d'); },
  closeLoveSecretModal: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-9310b301914d'); },
  generateLoveSecret: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-9310b301914d'); },
  openLoveSecretLatestReport: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-9310b301914d'); },
  downloadLoveSecretPdf: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-9310b301914d'); },
  shareLoveSecretKakao: function() { return __cdLoadScriptOnce('/js/love-secret-v2.js?v=build-9310b301914d'); },
  openLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-9310b301914d'); },
  closeLifeBookModal: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-9310b301914d'); },
  generateLifeBook: function() { return __cdLoadScriptOnce('/js/life-book.js?v=build-9310b301914d'); },
  openAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-9310b301914d'); },
  closeAstroBookModal: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-9310b301914d'); },
  generateAstroBook: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-9310b301914d'); },
  downloadAstroBookPdf: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-9310b301914d'); },
  gotoAstrologyPremium: function() { return __cdLoadScriptOnce('/js/astro-book.js?v=build-9310b301914d'); },
  openZiweiBookModal: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-9310b301914d'); },
  closeZiweiBookModal: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-9310b301914d'); },
  generateZiweiBook: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-9310b301914d'); },
  downloadZiweiBookPdf: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-9310b301914d'); },
  gotoZiweiPremium: function() { return __cdLoadScriptOnce('/js/ziwei-book.js?v=build-9310b301914d'); },
  openSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-9310b301914d'); },
  closeSajuNewYearModal: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-9310b301914d'); },
  generateSajuNewYear: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-9310b301914d'); },
  downloadSajuNewYearPdf: function() { return __cdLoadScriptOnce('/js/saju-new-year.js?v=build-9310b301914d'); },
  openVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-9310b301914d'); },
  closeVedicBookModal: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-9310b301914d'); },
  generateVedicBook: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-9310b301914d'); },
  downloadVedicBookPdf: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-9310b301914d'); },
  gotoVedicPremium: function() { return __cdLoadScriptOnce('/js/vedic-book.js?v=build-9310b301914d'); },
  openSukuyoBookModal: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-9310b301914d'); },
  closeSukuyoBookModal: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-9310b301914d'); },
  generateSukuyoBook: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-9310b301914d'); },
  downloadSukuyoBookPdf: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-9310b301914d'); },
  gotoSukuyoPremium: function() { return __cdLoadScriptOnce('/js/sukuyo-book.js?v=build-9310b301914d'); },
...
function __cdEnsureSajuCoreLoaded() {
  ...
  var chain = [
    ...
    '/js/core/kasi-calendar-service.js?v=build-9310b301914d',
    '/js/compat-llm-prompts.js?v=build-9310b301914d',
    '/js/saju-engine.js?v=build-9310b301914d',
      '/js/core/saju/extremeTResult.js?v=build-9310b301914d',
      '/js/saju-engine-tarot-sukuyo-quantum.js?v=build-9310b301914d',
    '/js/core/saju/modalProfileState.js?v=build-9310b301914d',
    '/js/core/saju/reportDashboard.js?v=build-9310b301914d',
    '/js/saju-engine-continuation.js?v=build-9310b301914d',
    '/js/entertain-engine.js?v=build-9310b301914d'
  ];
...
function __cdEnsureDestinyProfileLoaded() {
  ...
  __cdDestinyProfileLoadPromise = __cdLoadScriptOnce('/js/destiny-profile.js?v=build-9310b301914d')
    .then(function() { return true; })
    .catch(function(err) {
...
function __cdEnsureSwissEphLoaded() {
  ...
  __cdSwissEphLoadPromise = new Promise(function(resolve, reject) {
    var src = '/js/swisseph-loader.js?v=build-9310b301914d';
    var norm = __cdNormalizeScriptSrc(src);
    if (!norm) {
...
window.openLuckSyncDiary = function() {
  return __cdLoadScriptOnce('/js/luck-sync-diary.js?v=build-9310b301914d').then(function() {
...
function __cdBindAnimalTotemTileDirect() {
  ...
  function openTotemModal() {
    ...
    function _doOpenTotem() {
      ...
      raf(function() {
        loadScriptOnce('js/services/animal-totem-content-engine.js?v=build-9310b301914d')
          .then(function() { return loadScriptOnce('js/animal-totem-experience.js?v=build-9310b301914d'); })
          .then(function() {
            try {
...
function __cdEnsureBirthModalDepsLoaded() {
  ...
  if (
    ...
    tasks.push(__cdLoadScriptOnce('/js/core/saju/modalProfileState.js?v=build-9310b301914d'));
  }
...
function openAnimalTotemModal() {
  ...
  if (!hasFullTotemFlow && typeof __cdLoadScriptOnce === 'function') {
    __cdLoadScriptOnce('/js/services/animal-totem-content-engine.js?v=build-9310b301914d')
      .then(function() { return __cdLoadScriptOnce('/js/animal-totem-experience.js?v=build-9310b301914d'); })
      .then(function() {
...
function openSajuLifeBookBuilder() {
  ...
  __cdLoadScriptOnce('/js/life-book.js?v=build-9310b301914d').then(function () {
