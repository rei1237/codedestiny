...
var REPORT_CARDS = [
  ...
  { id:'relationshipTemptation', thumb:'saju-relationship-temptation-768.webp', label:'사주로 보는 그 사람의 바람끼는?', shortTitle:'그 사람의 바람끼는?', desc:'이성 관계의 흔들림과 한 사람에게 머무는 힘을 함께 살펴봅니다.', note:'도화 하나로 단정하지 않고 형충·식상·재관·조후와 안정 요인을 함께 읽어드려요.', cta:'관계 성향 확인하기', accent:'#b31955', glow:'rgba(179,25,85,.38)', target:'relationshipTemptationCard', coinCost:0, badge:'NEW' },
