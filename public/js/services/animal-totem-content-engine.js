  ...
  var ANIMALS = [
    {
      ...
      essence_poetic:
        "🐱 야옹~ 나 고양이는 말이야, 남이 시키는 대로 살지 않아도 괜찮다고 생각해. 조용히 내 페이스로 가도 결국 길은 찾아지거든. 너도 이미 마음속에 답이 있을 거야.",
      direct_message_deep_dive:
        "지금 주변에 휩쓸려서 숨이 찬 느낌이 들지? 나 고양이처럼 잠깐 멈춰서 몸의 감각을 들어봐. 관계를 끊으라는 게 아니라, '나'를 지키는 선을 그어도 된다는 거야. 불필요한 설명은 그만하고, 몸이 보내는 작은 신호를 믿어봐. 네 기준을 세우는 건 이기적인 게 아니라 정직한 거야.",
      today_deep_advice: [
    ...
    },
    {
      ...
      essence_poetic: "🐿️ 우리 다람쥐는 도토리 한 알 한 알이 소중하다고 생각해. 큰 일을 한 번에 하려 하지 말고, 오늘 할 수 있는 작은 걸부터 해보는 거야. 그게 결국 큰 변화를 만든다고!",
      direct_message_deep_dive: "'아직 부족해'라고 느껴지지? 우리 다람쥐는 완벽한 준비를 바라지 않아. 지금 할 수 있는 만큼만 하면 돼. 계획이 막혔다면 출발을 더 작게 쪼개봐. 작은 성취가 에너지를 불러올 거야.",
    ...
    },
    {
      ...
      essence_poetic: "🐦 짹짹! 나 파랑새는 희망이 멀리 있지 않다고 노래해. 기적은 번개처럼 오지 않고, 조용히 네 곁에 내려앉을 때가 많아. 마음의 창문을 조금만 열어봐.",
      direct_message_deep_dive: "더 특별한 신호를 기다리느라 이미 온 기회를 놓치고 있진 않아? 나 파랑새는 작은 것들에 주목하라고 말해. 짧은 연락, 갑자기 떠오른 생각, 자꾸 눈에 띄는 단어—그게 우연이 아닐 수도 있어. 오늘 네가 주목하는 게 내일을 만든다고!",
    ...
    },
    {
      ...
      essence_poetic: "🐶 멍! 나 강아지는 네가 혼자 버티지 않아도 된다고 말하고 싶어. 다정함은 약한 게 아니야. 진짜로 연결되는 건 서로 의지할 수 있을 때라고!",
      direct_message_deep_dive: "혼자 잘 버티는 게 강한 거라고 생각하고 있지? 나 강아지는 기대하고 실망하는 것도 관계 안에서 배우는 거라고 생각해. 도움 요청하는 건 의존이 아니라 연결이야. 감정을 숨기고 배려만 하면 결국 지쳐. 솔직하게 말해도 괜찮아.",
    ...
    },
    {
      ...
      essence_poetic: "🐰 깡총! 나 토끼는 두려워도 뛸 수 있다고 생각해. 예민한 건 약점이 아니라, 위험과 기회를 먼저 알아채는 힘이야. 작은 점프부터 시작해보자!",
      direct_message_deep_dive: "새로운 걸 시작하려다 과거 실패가 떠올라서 망설여지지? 나 토끼는 완벽한 확신을 기다리지 말라고 말해. 작은 점프로 시작해봐. 불안할 때 멈추지 말고 방향만 살짝 바꿔보는 거야. 기회는 먼저 움직인 사람에게 온다고!",
    ...
    },
    {
      ...
      essence_poetic: "🐺 아우~ 우리 늑대는 혼자도 잘 살지만, 함께할 때 더 멀리 간다고 생각해. 본능을 믿되, 소중한 무리도 잊지 않는 거야.",
      direct_message_deep_dive: "다른 사람 말에 휩쓸려서 내 마음 소리가 안 들리지? 나 늑대는 먼저 네 안의 방향감각을 찾으라고 말해. 그다음에 가치가 맞는 사람들과 손잡는 거야. 혼자 다 해보려 하면 결국 지쳐. 독립과 협력의 균형이 진짜 힘이야.",
    ...
    },
    {
      ...
      essence_poetic: "🐻 그르렁~ 나 곰은 겨울에 잠잘 때가 제일 중요하다고 생각해. 멈추는 게 퇴보가 아니라, 다시 힘을 모으는 시간이야.",
      direct_message_deep_dive: "계속 버티라고만 느껴져서 지치지 않아? 나 곰은 지금 피로한 건 의지가 약해서가 아니라, 쉬는 시간이 부족해서라고 말해. 멈출 줄 아는 사람이 더 멀리 가. 몸과 마음이 보내는 신호를 무시하지 말고, 회복하는 것도 책임이야.",
    ...
    },
    {
      ...
      essence_poetic: "🦌 우리 사슴은 부드러움이 약한 게 아니라고 생각해. 예민한 감각으로 숲의 작은 변화까지 읽어내는 거야. 그게 우리의 힘이지.",
      direct_message_deep_dive: "감수성이 높다고 스스로를 낮게 보지 마. 나 사슴은 민감함이 취약한 게 아니라, 관계와 분위기를 먼저 읽는 능력이라고 말해. 다만 모든 걸 다 받아들이면 과부하가 와. 부드럽게 대하되, 경계도 지키는 게 중요해.",
    ...
    },
    {
      ...
      essence_poetic: "🐯 나 호랑이는 소란 피우지 않고 조용히 힘을 모은 다음, 딱 한 번 도약할 때 판을 바꾼다고 생각해. 절제된 강함이 진짜 힘이야.",
      direct_message_deep_dive: "오래 미뤄뒀던 중요한 일이 있지? 나 호랑이는 화내라는 게 아니라, 집중해서 실행하라는 거야. 더 많은 정보보다 지금이 결단할 때일 수 있어. 행동하면서 자신감이 생기는 거야. 한 번에 다 바꾸려 하지 말고, 가장 중요한 한 곳만 강하게 쳐봐.",
    ...
    },
    {
      ...
      essence_poetic: "🦉 부엉~ 나 올빼미는 어둠을 무서워하지 않아. 오히려 그 안에서 본질을 더 잘 본다고 생각해. 조용한 통찰이 가장 밝은 빛이야.",
      direct_message_deep_dive: "지금 혼란스러운 건 정보가 부족해서가 아니라 너무 많아서일 수 있어. 나 올빼미는 '더 많이'보다 '더 깊게' 보라고 말해. 말과 사건 표면 뒤에 뭐가 있는지 관찰해봐. 진짜 묻고 싶은 질문을 다시 정리하면 답이 가까이 있을 거야. 반응하기 전에 관찰하는 거, 잊지 마.",
    ...
    },
    {
      ...
      essence_poetic: "🦅 나 독수리는 높이 날아서 보면 작은 일에 휩쓸리지 않아. 한 걸음 물러나서 큰 그림을 보는 게 중요하다고 생각해.",
      direct_message_deep_dive: "세부적인 일에만 빠져서 방향을 잊고 있진 않아? 나 독수리는 목표와 수단이 뒤바뀌지 않았는지 점검하라고 말해. 당장의 성과도 중요하지만, 장기적으로 어긋나면 결국 지쳐. 높은 시점에서 보면 해야 할 일과 하지 말아야 할 일이 보일 거야.",
    ...
    },
    {
      ...
      essence_poetic: "🦋 나 나비는 날개 펼 때마다 변화가 재탄생이라고 생각해. 오래된 껍질은 실패가 아니라, 그 전 단계였을 뿐이야.",
      direct_message_deep_dive: "익숙한 걸 잃는 게 불안해서 망설여지지? 나 나비는 변화를 한 번에 오는 게 아니라 과정으로 받아들이라고 말해. 과거의 나를 부정할 필요는 없어. 다만 지금 나에게 안 맞는 건 놓아줘도 돼. 남에게 보여주기 위한 게 아니라, 네 마음이 동의하는 게 중요해.",
    ...
    },
    {
      ...
      essence_poetic: "🐦‍⬛ 까악! 나 까마귀는 우연처럼 보이는 것들 사이에서 의미를 찾는 걸 좋아해. 익숙한 걸 새로 해석하는 게 재미있거든.",
      direct_message_deep_dive: "요즘 자꾸 반복되는 걸 무시하지 마. 나 까마귀는 논리 밖에서 오는 연결을 읽으라고 말해. 창조는 완전히 새 걸 만드는 게 아니라, 흩어진 조각을 새로 엮는 거야. 정면으로 돌파가 안 되면 질문 자체를 바꿔봐. 그게 답일 수도 있어.",
    ...
    },
    {
      ...
      essence_poetic: "🐬 우리 돌고래는 삶이 전투만이 아니라고 생각해. 놀고, 호흡하고, 소통하는 게 회복의 길이야.",
      direct_message_deep_dive: "요즘 너무 진지해져서 유연함을 잃었지? 나 돌고래는 문제를 가볍게 여기라는 게 아니라, 긴장을 풀어야 해법이 보인다고 말해. 닫힌 마음은 관계를 딱딱하게 만들어. 웃고, 놀고, 가벼운 대화하는 게 도피가 아니라 회복이야.",
    ...
    },
    {
      ...
      essence_poetic: "🐢 나 거북이는 느린 게 낙오가 아니라고 생각해. 깊이 있는 시간이야. 단단한 등껍질로 나를 지키면서 목적지까지 가는 거지.",
      direct_message_deep_dive: "빠른 성과와 비교 때문에 내 페이스가 의심되는 거지? 나 거북이는 속도보다 방향, 박수보다 꾸준함을 선택하라고 말해. 느리게 가도 더 많이 보고 덜 실수할 수 있어. 네 리듬을 지키는 건 뒤처지는 게 아니라 오래 가는 거야.",
    ...
    },
    {
      ...
      essence_poetic: "🐍 나 뱀은 낡은 껍질을 벗어도 같은 존재로 남지 않아. 벗어나면서 새로 태어나는 거지. 생명력이 갱신되는 거야.",
      direct_message_deep_dive: "오래된 감정 패턴을 반복하면서 에너지가 새어 나가고 있지? 나 뱀은 문제를 해결하려 하기 전에, 그걸 유지하게 하는 게 뭔지 먼저 보라고 말해. 과거 상처는 존중하되, 지금 운전대를 계속 쥐고 있을 필요는 없어. 새로 해석하면 에너지가 다시 흐를 거야.",
    ...
    },
    {
      ...
      essence_poetic: "🦊 야호! 나 여우는 정면으로 부딪히지 않고 흐름을 읽어서 길을 찾아. 유연한 게 타협이 아니라, 지혜로운 방법이야.",
      direct_message_deep_dive: "정면돌파만이 정답이라고 믿어서 지치지 않아? 나 여우는 우회가 패배가 아니라 전략이라고 말해. 상황을 있는 그대로 읽고, 상대 관점을 파악하면 해결이 빨라져. 원칙을 버리는 게 아니라, 원칙을 지키는 더 나은 방식을 찾는 거야.",
