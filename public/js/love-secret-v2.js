(function () {
  ...
  function normalizeBirthParts() {
    ...
    var birthDate = asText(authUser.birthDate);
    var birthTime = asText(authUser.birthTime);
  ...
  function buildSelfPayload() {
    ...
    return {
      name: asText((authUser && authUser.name) || '사용자') || '사용자',
      gender: asText((authUser && authUser.gender) || 'OTHER') || 'OTHER',
      year: birth.year,
      month: birth.month,
      day: birth.day,
      hour: birth.hour,
  ...
  function buildLocalPrintableHtml() {
    ...
    return [
      ...
      '.lb-print-cover{padding:24px;border:1px solid #f2bfd7;border-radius:16px;background:#fff;margin-bottom:24px}',
      '.lb-print-cover h1{margin:0 0 6px;font-size:33px;color:#9d174d}',
      '.lb-print-chapter{margin-bottom:22px;padding:18px;border:1px solid #f6d7e7;border-radius:12px;background:#fff}',
      '.lb-print-chapter h1{margin:0 0 12px;font-size:24px;color:#be185d}',
      '.lb-print-chapter h2{margin:16px 0 8px;font-size:19px;color:#be185d}',
      '.lb-print-chapter h3{margin:12px 0 8px;font-size:16px;color:#db2777}',
