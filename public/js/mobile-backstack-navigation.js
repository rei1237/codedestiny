(function () {
  ...
  var ACTION_TO_OVERLAY_ID = {
    ...
    openLifeBookModal: 'lifeBookModal',
    openLoveSecretModal: 'loveSecretModal',
    ...
    gotoZiweiPremium: 'ziweiBookModal',
    gotoAstrologyPremium: 'astroBookModal',
    gotoSukuyoPremium: 'sukuyoBookModal',
    gotoVedicPremium: 'vedicBookModal'
  };
