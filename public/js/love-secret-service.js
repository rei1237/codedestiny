...
(function (global) {
  ...
  var ILGAN_LOVE = {
    '甲': {
      title: _loveSecretServiceText("loveSecretService.001"),
    ...
    '乙': {
      title: _loveSecretServiceText("loveSecretService.002"),
    ...
    '丙': {
      title: _loveSecretServiceText("loveSecretService.003"),
    ...
    '丁': {
      title: _loveSecretServiceText("loveSecretService.004"),
    ...
    '戊': {
      title: _loveSecretServiceText("loveSecretService.005"),
    ...
    '己': {
      title: _loveSecretServiceText("loveSecretService.006"),
    ...
    '庚': {
      title: _loveSecretServiceText("loveSecretService.007"),
    ...
    '辛': {
      title: _loveSecretServiceText("loveSecretService.008"),
    ...
    '壬': {
      title: _loveSecretServiceText("loveSecretService.009"),
    ...
    '癸': {
      title: _loveSecretServiceText("loveSecretService.010"),
  ...
  var LOVE_RISK = {
    high_tao: {
      title: _loveSecretServiceText("loveSecretService.011"),
    ...
    high_yeokma: {
      title: _loveSecretServiceText("loveSecretService.012"),
    ...
    high_hwa: {
      title: _loveSecretServiceText("loveSecretService.013"),
    ...
    gwimunkwan: {
      title: _loveSecretServiceText("loveSecretService.014"),
    ...
    gasraito: {
      title: _loveSecretServiceText("loveSecretService.015"),
  ...
  function buildLoveBibleHTML(d) {
    ...
    var sec4 = '';
    var tsLoveStrat = {
      '식신': { title: _loveSecretServiceText("loveSecretService.016"), desc: '감성적이고 따뜻한 언어로 마음을 표현하세요. 맛있는 음식, 감각적인 경험을 함께하며 자연스럽게 친밀감을 높이는 것이 핵심입니다.' },
      '상관': { title: _loveSecretServiceText("loveSecretService.017"), desc: '당신의 언어 능력과 유머가 최강 플러팅 무기입니다. 예상치 못한 발언과 독특한 관점으로 상대방을 끊임없이 놀라게 하세요.' },
      '편재': { title: _loveSecretServiceText("loveSecretService.018"), desc: '다양한 경험과 넓은 인맥을 활용하세요. "나랑 있으면 세상이 넓어진다"는 느낌을 주는 것이 핵심 전략입니다.' },
      '정재': { title: _loveSecretServiceText("loveSecretService.019"), desc: '성실하고 신뢰할 수 있는 모습을 일관되게 보여주세요. 약속을 지키고 상대방의 실질적인 필요를 채워주는 것이 연애 성공의 기반입니다.' },
      '편관': { title: _loveSecretServiceText("loveSecretService.020"), desc: '당신의 카리스마와 강단 있는 모습이 상대방을 끌어당깁니다. 단, 너무 강하게 나오면 상대가 위축됩니다 — 3의 힘을 발휘할 때는 1의 부드러움을 곁들이세요.' },
      '정관': { title: _loveSecretServiceText("loveSecretService.021"), desc: '원칙과 책임감이 당신의 연애 자산입니다. 상대방에게 "이 사람이라면 믿을 수 있다"는 확신을 주는 것이 첫 번째 목표입니다.' },
      '편인': { title: _loveSecretServiceText("loveSecretService.022"), desc: '당신만의 독특한 세계관이 상대방을 매혹합니다. 예술적 감각, 창의적인 아이디어, 철학적 대화로 지적 매력을 극대화하세요.' },
      '정인': { title: _loveSecretServiceText("loveSecretService.023"), desc: '깊은 지식과 따뜻한 조언이 상대방에게 귀인처럼 다가갑니다. 배움과 성장을 공유하는 연애가 가장 오래가는 구조입니다.' },
      '비견': { title: _loveSecretServiceText("loveSecretService.024"), desc: '동등한 파트너십을 추구하세요. "우리 둘 다 독립적이지만 함께할 때 더 강해진다"는 메시지가 이상적입니다.' },
      '겁재': { title: _loveSecretServiceText("loveSecretService.025"), desc: '강렬한 에너지와 카리스마로 상대방을 압도하는 첫 인상이 강점입니다. 단, 소유욕과 경쟁심을 내려놓고 상대방에게 여백을 주어야 합니다.' }
    };
    ...
    var output = '<div id="loveBibleReport" class="lb-report">' +
      '<div class="lb-cover">' +
        '<img class="lb-cover-img" src="/fuctionassets/lovebible.webp" alt="${_loveSecretServiceText("loveSecretService.026")}" loading="lazy">' +
