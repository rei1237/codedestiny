...
(function () {
  ...
  /* ─────────────── 챕터 상수 ─────────────── */
  var CHAPTER_TITLES = [
    '🌌 타고난 명(命)과 본질 — 명궁·신궁 분석',
    '🧠 내면의 심리와 무의식 — 복덕궁 분석',
    '🌍 외형적 이미지와 사회적 페르소나 — 천이궁 분석',
    '👑 진로, 적성 및 직업운 — 관록궁 분석',
    '💰 재물운과 자산 관리 스타일 — 재백궁 분석',
    '💞 연애 성향과 배우자운 — 부처궁 분석',
    '🤝 인간관계와 인맥 — 교우궁·형제궁 분석',
    '🏠 부동산 운과 가정 환경 — 전택궁 분석',
    '💪 건강과 활력 — 질액궁 분석',
    '🌊 생애 주기와 10년 대운 — 대한 분석',
    '📅 올해의 신년운세와 월별 흐름 — 유년·유월 분석',
    '🍀 액운 대처법과 맞춤형 행운 아이템 — 개운법 총결산',
    '🌅 종합 총운과 90일 실행 로드맵',
  ];

  var CHAPTER_SUBTITLES = [
    '명궁·신궁·삼방사정을 통합해 타고난 성향과 행동 구조를 해석합니다.',
    '복덕궁 기반으로 스트레스 패턴·회복 루틴·무의식 개운법을 정리합니다.',
    '천이궁으로 첫인상·외부 활동운·이동/확장 전략을 구체화합니다.',
    '관록궁 중심으로 적성·직업군·조직/사업 운영 전략을 제시합니다.',
    '재백궁을 통해 수익 구조·누수 패턴·현실적 자산 관리법을 제공합니다.',
    '부처궁 관점에서 연애 패턴·배우자운·관계 안정화 전략을 분석합니다.',
    '교우궁·형제궁을 결합해 귀인/소인 구분과 인맥 운영 기준을 제시합니다.',
    '전택궁 기반으로 주거·부동산·공간 에너지 관리법을 다룹니다.',
    '질액궁으로 체력 흐름·생활 습관·회복 루틴을 설계합니다.',
    '현재 대한을 중심으로 전후 10년 흐름과 핵심 행동 강령을 제시합니다.',
    '유년·유월 기준으로 연간 흐름과 1월~12월 타이밍을 안내합니다.',
    '맞춤형 개운 아이템·액운 대응·운명 개조 마스터플랜을 종합합니다.',
    '전체 명반 총평과 90일 실천 로드맵으로 실행까지 연결합니다.',
  ];

  var LOADING_MSGS = [
    '명궁·신궁을 통합해 타고난 핵심 기질을 해독하는 중...',
    '복덕궁의 심리 구조와 회복 패턴을 분석하는 중...',
    '천이궁 기반 사회적 페르소나와 외부 활동운을 분석하는 중...',
    '관록궁 기반 커리어·직업 적합도를 정밀 분석하는 중...',
    '재백궁의 수익 구조와 자산 관리 패턴을 읽는 중...',
    '부처궁의 연애 성향과 관계 안정화 포인트를 해석하는 중...',
    '교우궁·형제궁의 인맥 구조와 귀인 흐름을 분석하는 중...',
    '전택궁 기반 주거·부동산·공간 에너지 전략을 정리하는 중...',
    '질액궁 기반 건강 리듬과 회복 루틴을 설계하는 중...',
    '대한 흐름으로 현재 10년 전략을 정밀 분석하는 중...',
    '유년·유월 기준 12개월 타이밍 로드맵을 작성하는 중...',
    '맞춤형 개운 아이템과 액운 대응 전략을 정리하는 중...',
    '종합 총운과 90일 실행 로드맵을 완성하는 중...',
  ];
