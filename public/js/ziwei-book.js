...
(function () {
  ...
  var CHAPTER_SUBTITLES = [
    ...
    '부부궁과 명궁 대궁 축을 활용해 건강한 파트너십 기준과 경계 전략을 제안합니다.',
    ...
    '2026 유년·유월 로드맵으로 분기/월별 행동 기준과 나아가거나 멈춰야할 때를 안내합니다.',
  ...
  var MYSTIC_QUOTES = [
    ...
    '부부궁(夫妻宮)의 별이 당신에게 찾아올 인연을 이미 알고 있습니다.',
  ...
  function _collectZiweiData() {
    ...
    if (zd) {
      lines.push('\n【자미두수 12궁 배치】');
      var palaceNames = ['명궁','형제궁','부부궁','자녀궁','재백궁','질액궁','천이궁','교우궁','관록궁','전택궁','복덕궁','부모궁'];
