(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-094fb105556a').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-094fb105556a'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-094fb105556a'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-094fb105556a'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-094fb105556a'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-094fb105556a'],
    openDreamModal: ['js/dream-ledger.js?v=build-094fb105556a'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-094fb105556a'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-094fb105556a']
  };
