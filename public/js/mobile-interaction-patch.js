(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-a4ba064889af').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    // ???에??최신 ?크립트??확??로드?도??니??
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-a4ba064889af'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-a4ba064889af'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-a4ba064889af'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-a4ba064889af'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-a4ba064889af']
  };
