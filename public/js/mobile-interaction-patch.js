(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-6f563cdfee8a').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-6f563cdfee8a'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-6f563cdfee8a'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-6f563cdfee8a'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-6f563cdfee8a'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-6f563cdfee8a'],
    openDreamModal: ['js/dream-ledger.js?v=build-6f563cdfee8a'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-6f563cdfee8a'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-6f563cdfee8a']
  };
