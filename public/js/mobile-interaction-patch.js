(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-4d1f4e0793f3').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-4d1f4e0793f3'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-4d1f4e0793f3'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-4d1f4e0793f3'],
    openDreamModal: ['js/dream-ledger.js?v=build-4d1f4e0793f3'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-4d1f4e0793f3'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-4d1f4e0793f3']
  };
