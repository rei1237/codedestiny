(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-f477ca7b681f').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-f477ca7b681f'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-f477ca7b681f'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-f477ca7b681f'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-f477ca7b681f'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-f477ca7b681f'],
    openDreamModal: ['js/dream-ledger.js?v=build-f477ca7b681f'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-f477ca7b681f'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-f477ca7b681f']
  };
