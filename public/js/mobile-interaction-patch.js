(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-c46dc63528db').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-c46dc63528db'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-c46dc63528db'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-c46dc63528db'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-c46dc63528db'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-c46dc63528db'],
    openDreamModal: ['js/dream-ledger.js?v=build-c46dc63528db'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-c46dc63528db'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-c46dc63528db']
  };
