(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-8ecbc2c05c6f').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-8ecbc2c05c6f'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-8ecbc2c05c6f'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-8ecbc2c05c6f'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-8ecbc2c05c6f'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-8ecbc2c05c6f'],
    openDreamModal: ['js/dream-ledger.js?v=build-8ecbc2c05c6f'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-8ecbc2c05c6f'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-8ecbc2c05c6f']
  };
