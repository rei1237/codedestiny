(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-f850bfd833bd').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-f850bfd833bd'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-f850bfd833bd'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-f850bfd833bd'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-f850bfd833bd'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-f850bfd833bd'],
    openDreamModal: ['js/dream-ledger.js?v=build-f850bfd833bd'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-f850bfd833bd'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-f850bfd833bd']
  };
