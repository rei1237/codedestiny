(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-9de75fd68d37').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-9de75fd68d37'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-9de75fd68d37'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-9de75fd68d37'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-9de75fd68d37'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-9de75fd68d37'],
    openDreamModal: ['js/dream-ledger.js?v=build-9de75fd68d37'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-9de75fd68d37'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-9de75fd68d37']
  };
