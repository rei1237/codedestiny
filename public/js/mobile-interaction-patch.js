(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-c7ec967e4eef').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-c7ec967e4eef'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-c7ec967e4eef'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-c7ec967e4eef'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-c7ec967e4eef'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-c7ec967e4eef'],
    openDreamModal: ['js/dream-ledger.js?v=build-c7ec967e4eef'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-c7ec967e4eef'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-c7ec967e4eef']
  };
