(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-add38cb0e0e2').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-add38cb0e0e2'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-add38cb0e0e2'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-add38cb0e0e2'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-add38cb0e0e2'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-add38cb0e0e2'],
    openDreamModal: ['js/dream-ledger.js?v=build-add38cb0e0e2'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-add38cb0e0e2'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-add38cb0e0e2']
  };
