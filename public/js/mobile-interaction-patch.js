(function () {
  ...
  function ensureMobileBackstackRuntime() {
    ...
    loadScript('/js/mobile-backstack-navigation.js?v=build-a35fdbeded0b').catch(function(err) {
  ...
  var LAZY_LOAD_ACTIONS = {
    ...
    openAnimalTotemModal: [
      ...
      'js/animal-totem-experience.js?v=build-a35fdbeded0b'
    ],
    ...
    openTarotLoveModal: ['js/tarot-love-experience.js?v=build-a35fdbeded0b'],
    openTarotReunionModal: ['js/tarot-reunion-experience.js?v=build-a35fdbeded0b'],
    openTarotSelfEsteemModal: ['js/tarot-self-esteem-experience.js?v=build-a35fdbeded0b'],

    openTarotYearFortuneModal: ['js/tarot-year-fortune-experience.js?v=build-a35fdbeded0b'],
    openDreamModal: ['js/dream-ledger.js?v=build-a35fdbeded0b'],
    openPsychoDreamModal: ['js/psycho-dream-analyzer-freuds-study.js?v=build-a35fdbeded0b'],
    ...
    gotoNamingPremium: [],
    openSibylModal: ['js/sibyl-system.js?v=build-a35fdbeded0b']
  };
