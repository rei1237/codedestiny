/* -----------------------------------------------------------
   ...
   ----------------------------------------------------------- */
const ASTRAL_SOUL_TEXT_TRANSLATIONS = {
  ko: {
    "astralSoul.001": "상세 보기",
    "astralSoul.002": "지혜로운 부엉이",
    "astralSoul.003": "호기심 많은 고양이",
    "astralSoul.004": "카리스마 사자",
    "astralSoul.005": "영리한 여우",
    "astralSoul.006": "신비로운 사슴",
    "astralSoul.007": "꿈꾸는 토끼",
    "astralSoul.008": "다정한 돌고래",
    "astralSoul.009": "활기찬 수달",
    "astralSoul.010": "성실한 거북이",
    "astralSoul.011": "온화한 코끼리",
    "astralSoul.012": "엄격한 늑대",
    "astralSoul.013": "사교적인 펭귄",
    "astralSoul.014": "날카로운 매",
    "astralSoul.015": "예술적인 나비",
    "astralSoul.016": "용맹한 호랑이",
    "astralSoul.017": "화려한 공작",
    "astralSoul.018": "상세보기",
    "astralSoul.019": "종합 상성률",
    "astralSoul.020": "감정/가치관 공명 (T/F)",
    "astralSoul.021": "행동/생활패턴 (J/P)",
    "astralSoul.022": "대화/관심사 티키타카 (S/N)",
    "astralSoul.023": "완벽한 평행우주 도플갱어",
    "astralSoul.024": "우주가 맺어준 마스터피스",
    "astralSoul.025": "경이로운 지적 탐구의 동반자",
    "astralSoul.026": "화성에서 온 T, 금성에서 온 F",
    "astralSoul.027": "서로를 물들이는 다채로운 프리즘",
  },
};
...
const ASTRAL_DATA = {
    ...
    'INTP': { animal:'🐈', name:'Cat', title:_astralSoulText("astralSoul.003"), code:'INTP', 
    ...
    'ENTJ': { animal:'🦁', name:'Lion', title:_astralSoulText("astralSoul.004"), code:'ENTJ', 
    ...
    'ENTP': { animal:'🦊', name:'Fox', title:_astralSoulText("astralSoul.005"), code:'ENTP', 
        desc:'기발한 발상과 유연한 변칙',
    ...
    'INFJ': { animal:'🦌', name:'Deer', title:_astralSoulText("astralSoul.006"), code:'INFJ', 
        desc:'깊은 직관과 고결한 영혼',
    ...
    'INFP': { animal:'🐇', name:'Rabbit', title:_astralSoulText("astralSoul.007"), code:'INFP', 
    ...
    'ENFJ': { animal:'🐬', name:'Dolphin', title:_astralSoulText("astralSoul.008"), code:'ENFJ', 
    ...
    'ENFP': { animal:'🦦', name:'Otter', title:_astralSoulText("astralSoul.009"), code:'ENFP', 
    ...
    'ISTJ': { animal:'🐢', name:'Turtle', title:_astralSoulText("astralSoul.010"), code:'ISTJ', 
    ...
    'ISFJ': { animal:'🐘', name:'Elephant', title:_astralSoulText("astralSoul.011"), code:'ISFJ', 
    ...
    'ESTJ': { animal:'🐺', name:'Wolf', title:_astralSoulText("astralSoul.012"), code:'ESTJ', 
    ...
    'ESFJ': { animal:'🐧', name:'Penguin', title:_astralSoulText("astralSoul.013"), code:'ESFJ', 
    ...
    'ISTP': { animal:'🦅', name:'Hawk', title:_astralSoulText("astralSoul.014"), code:'ISTP', 
        desc:'냉철한 관찰과 정교한 기술',
    ...
    'ISFP': { animal:'🦋', name:'Butterfly', title:_astralSoulText("astralSoul.015"), code:'ISFP', 
    ...
    'ESTP': { animal:'🐯', name:'Tiger', title:_astralSoulText("astralSoul.016"), code:'ESTP', 
    ...
    'ESFP': { animal:'🦚', name:'Peacock', title:_astralSoulText("astralSoul.017"), code:'ESFP', 
    ...
    Object.keys(ASTRAL_DATA).forEach(code => {
        ...
        card.innerHTML = `
            <div class="totem-icon">${item.animal}</div>
                        ...
                        <button class="totem-info-btn" type="button" title="${_astralSoulText("astralSoul.018")}" aria-label="${item.code} ${_astralSoulText("astralSoul.001")}">
...
function getSynergyText(t1, t2) {
    ...
    statsItems = [
        { label: _astralSoulText("astralSoul.019"), value: `${matchScore}%`, highlight: true },
        { label: _astralSoulText("astralSoul.020"), value: empathyScore, highlight: false },
        { label: _astralSoulText("astralSoul.021"), value: actionScore, highlight: false },
        { label: _astralSoulText("astralSoul.022"), value: convoScore, highlight: false }
    ];
    ...
    if (t1.code === t2.code) {
        title = _astralSoulText("astralSoul.023");
        ...
        title = _astralSoulText("astralSoul.024");
        ...
        title = _astralSoulText("astralSoul.025");
        ...
        title = _astralSoulText("astralSoul.026");
        ...
        title = _astralSoulText("astralSoul.027");
