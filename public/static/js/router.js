...
function ensureRoot() {
  ...
  root.innerHTML = `
    <div class="static-service-runner__head">
      <div class="static-service-runner__title">/static ?úÎπÑ???§Ìñâ ?ÅÏó≠</div>
      <div class="static-service-runner__actions">
        <button type="button" class="static-service-runner__btn" data-service-nav="tarot">?ÄÎ°?/button>
        <button type="button" class="static-service-runner__btn" data-service-nav="hwatu-life">?îÌà¨ ?∏ÏÉù ??/button>
        <button type="button" class="static-service-runner__btn" data-service-nav="stonehenge-rune">?§ÌÜ§?®Ï? Î£?/button>
        <button type="button" class="static-service-runner__btn" data-service-nav="pig-oracle">?ºÏ? Ï£ºÏÑù??/button>
        <button type="button" class="static-service-runner__btn" data-service-close>?´Í∏∞</button>
      </div>
    </div>
...
// ?ÑÏó≠ ?®Ïàò: ÏΩîÏù∏ Í≤åÏù¥????openRuneOracle ?°ÏÖò ?¨Ìò∏Ï∂????¨Ïö©
