...
- 앱 판매가는 웹 대비 **20~30% 인상**해 별도 운영한다(Play 수수료 15% vs 웹 PG 약 3%).
...
| productId | 확정가(KRW) | 웹가 | 인상률 | 대상 |
|---|---|---|---|---|
| `cd_content_tier_01` | 3,900 | 3,000 | +30.0% | 30코인 기능 21개 |
| `cd_content_tier_02` | 6,000 | 5,000 | +20.0% | 50코인 기능 54개 |
| `cd_content_tier_03` | 7,500 | 6,000 | +25.0% | 60코인 |
| `cd_content_tier_04` | 8,900 | 7,000 | +27.1% | 70코인 |
| `cd_content_tier_05` | 10,900 | 9,000 | +21.1% | 90코인 |
| `cd_content_tier_06` | 13,000 | 10,000 | +30.0% | 100코인 기능 36개 |
| `cd_content_tier_07` | 15,000 | 12,000 | +25.0% | 120코인 |
| `cd_content_tier_08` | 19,000 | 15,000 | +26.7% | 150코인 |
| `cd_content_tier_09` | 25,000 | 20,000 | +25.0% | 200코인 |
| `cd_content_tier_10` | 39,000 | 30,000 | +30.0% | 300코인 기능 14개 |
| `cd_content_tier_11` | 49,000 | 39,000 | +25.6% | 390코인 |
| `cd_content_tier_12` | 65,000 | 50,000 | +30.0% | 500코인 |
| `cd_content_tier_13` | 89,000 | 69,000·70,000 | +27.1~29.0% | 690·700코인 |

상품명은 가격을 포함해 명확히 쓴다(예: `운세 콘텐츠 열람 13,000원`). 티어 SKU라 결제 시트에 기능명이 아닌 일반명이 뜨므로, 이름만으로 무엇을 사는지 알 수 있어야 한다.
...
`N원 이하 · 월 최대 N원 상당`이다.
**이용권가는 앱·웹이 같다**(2026-08-24 개정 — 종전의 20~30% 인상은 콘텐츠 티어 SKU 쪽에만 남는다).
커버 한도는 웹 정본(`PASS_LIMITS`, 코인)에서 앱가로 파생된다(`resolveAppPassCoverageKRW`) —
**커버하는 기능 집합은 앱·웹이 동일**하고(코인으로 판정) 표시 금액만 다르다.

| productId | 확정가(KRW) | 웹가 | 인상률 | 커버 한도(앱 표시) | 웹 표시 | 월 이용 한도 |
|---|---|---|---|---|---|---|
| `cd_pass_standard_30d` | 9,900 | 9,900 | — | 6,000원 이하 | 5,000원 이하 | 30,000원 |
| `cd_pass_premium_30d` | 29,900 | 29,900 | — | 13,000원 이하 | 10,000원 이하 | 100,000원 |
| `cd_pass_vvip_30d` | 59,000 | 59,000 | — | 25,000원 이하 | 20,000원 이하 | 200,000원 |
| `cd_pass_family_30d` | 149,000 | 149,000 | — | 전체 | 전체 | 500,000원 |
