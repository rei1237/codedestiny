...
| 4 | 심화 자미두수 PDF 심층 리포트 생성<br>`ziwei-deep-pdf` | [정본](../../worker/routes/ziwei-deep-report.js) · [기존 검사](../../__tests__/ui/ziwei-deep-paid-delivery.behavior.test.js) | 필수 장 저장·완료 후 PDF | [A~F mock 기록](ziwei-deep-paid-delivery-20260917.md) / Node62·Jest125·실제 고객8case·PDF62페이지 / check:fast·commit/push·동일 SHA main CI 진행 중 | ☐ |
...
| 7 | 인생의 책 전문가 상담<br>`life-book-ai-consultation` | [정본](../../worker/routes/life-book-ai.js) · [기존 검사](../../__tests__/ui/life-book-paid-delivery.behavior.test.js) | 장별 저장·deferred apply | 기존 회귀 있음 / 이번 개별 E2E 대기 | ☐ |
| 8 | 인생 총운 전문가 상담<br>`life-fortune-ai-consultation` | [정본](../../worker/routes/life-book-ai.js) · [기존 검사](../../__tests__/ui/life-book-paid-delivery.behavior.test.js) | 총운 SKU·원래 분량·apply | 기존 회귀 있음 / 이번 개별 E2E 대기 | ☐ |
