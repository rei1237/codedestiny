...
개인판·궁합판의 20장, 장별 최소 분량, 계산 엔진, 교차 판정과 생시 미상 한계를 유지한다. 가격·이용권·월정석·단건 결제 정책과 환급 조건은 변경하지 않았다. 생성 검증은 mock 기반이며 실제 결제·청구 LLM 검증 기록은 아니다.
...
- 구현 SHA `77007dc4c1c931ecc148ab73069bf437b78473e9`의 [전체 main CI](https://github.com/rei1237/codedestiny/actions/runs/35103084907)는 모든 lane·CI required success다. 후속 확인에서 서버47개·복귀18개 재검사도 통과했다.
