...
status: active
updated: 2026-09-17
next: 운영에서 사용자가 인연의 서 개인판·궁합판을 실제 결제(카드·카카오페이)로 1회씩 완주해 20장 생성·자동 복귀·내 서재 다시 읽기를 확인한다. 실패하면 운영 DB 읽기 전용으로 해당 세션의 deliveryMeta.failures 코드만 확인하고, 필요 시 아래 롤백 절차를 따른다.
---
