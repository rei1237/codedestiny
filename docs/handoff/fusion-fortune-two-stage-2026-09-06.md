...
status: active
updated: 2026-09-06
next: 구조화 출력·목표 분량 서술자 모두 **머지 완료**(PR #1641, #1660). 🔴 서술자가 실제로 분량을 올리는지는 **미검증** — 확인하려면 실호출 1회 승인이 필요하다(절대 규칙 1). 별건으로 메인 대표 상담 카드의 글자수 표기 제거가 **PR #1671 CI 전부 통과, 사용자 머지 대기**.
---
