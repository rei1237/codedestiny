...
> 사전 스윕(화면에 보이는 한국어 제거)은 별도 계보다 — [locale-sweep-2026-08-24.md](locale-sweep-2026-08-24.md) 를 볼 것.
...
라우트가중 101,072(2026-08-25, 359 라우트). [locale-sweep-2026-08-24.md](locale-sweep-2026-08-24.md) 참조.
