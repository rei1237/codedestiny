...
> 앞선 인수인계 `ziwei-upgrade-2026-08-27.md` 는 항목이 전부 이관되어 **삭제했다(2026-09-06)**. 그 문서의 §2-(A) PR-C 와
> §2-(B)-1(유료/무료 표기)은 종결됐고(`app/_lib/serviceFeatureRegistry.ts:3936-3940` 이 사유와 함께 `accessType:"free"`),
> §2-(B)-2(앱 엔진에 화성·영성·천괴·천월 없음)는 **이 문서 §2**, §2-(B)-3(밝기 가드 45건 중 19건 실패·미배선)은
> [ziwei-deep-adjacent-defects-2026-09-06.md](ziwei-deep-adjacent-defects-2026-09-06.md) §3 이 이어받았다.
> 🔴 이 줄은 원래 "§2-(B) 는 전부 끝났다"였다 — 2026-09-06 재실측에서 §2-(B)-3 이 **그대로 열려 있어** 정정했다.
