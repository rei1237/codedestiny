...
status: active
updated: 2026-09-24
next: "2차 재실사 수정은 main·스테이징까지 나갔고(`cb7da13e0`, verify:staging PASS) **운영에는 없다** — 보류 릴리스가 이 커밋들보다 먼저 `c255916e2` 로 승격됐다(13번). 다음 승격은 사용자가 요청할 때만, 결제 커밋 7건을 이름으로 밝혀 새 1회 승인. 사람 몫: 4 포트원 문의·6 이니시스 MID 분류·7 Atlas Network Access·8 포트원 콘솔 채널·9 운영 읽기 조회 ⓐ~ⓓ·11·12 제품 결정. 3번 엄격 모드는 승격 뒤 확정 20건에서 재집계. 코드 작업은 후속(보고만)뿐이고, 그중 🔴 자미두수 V2 만료 취소(결제됐는데 402)가 가장 급하다 — 운영 읽기 집계부터."
---
