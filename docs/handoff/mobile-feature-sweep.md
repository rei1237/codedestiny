...
status: active
updated: 2026-09-02
next: "fortune-chat 수정 세션 — 컴포저 safe-area -47px·입력 14.4px·TT<44 13건 (아래 레시피 절차)"
---
...
발견 표기 = OF/TT/IN/SA최소여유/열폭@360/이탈. 열폭 참고선: 360px 에서 254px 문제·274px 수용(#1435 실측).
...
| 운세 챗 | /fortune-chat/ | 1 | 09-02 | 0/13/1건 14.4px/**-47px**/—/유 | | 스캔됨 |
| 낙샤트라 | /nakshatra/ | 1 | 09-02 | 0/1/6건 15px/—/274px/수동 | | 스캔됨 |

수정 우선순위: 운세챗(SA 위반+입력 줌 위험) → 낙샤트라(입력 6건 15px) → 작전실(열폭 266px·이탈 없음) → 러브코덱스·찻집(탭 타깃 소수).
