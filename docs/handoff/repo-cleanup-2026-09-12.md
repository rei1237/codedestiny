...
- [ ] 5) 권고: ruleset 20666260 에 `CI required` 를 필수 상태 검사로 재등록(strict off). 2026-09-12 이후 필수 검사가 없다. 사용자 승인 필요.
...
- 다른 열린 PR 이 `CLAUDE.md`·`docs/CONTEXT_AUDIT.md`·`package.json`·`.github/workflows/**` 를 고친다. 그 PR 머지 뒤에 2)·3)·5)를 한다.
