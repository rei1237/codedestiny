...
status: done
updated: 2026-08-17
next: "후속 문서 docs/handoff/adsense-remaining-levers-2026-08-17.md 를 읽는다 — 이 문서는 배경·함정 기록이다"
---
...
>
> 🔴 **이어서 작업하려면 [adsense-remaining-levers-2026-08-17.md](adsense-remaining-levers-2026-08-17.md) 를 먼저 읽을 것.**
> 이 문서 이후 PR 3건(#761·#764·#766)이 더 들어갔고, **§4-2 의 "robots.txt Disallow" 안은 폐기**됐으며
> §4-4 의 nakshatra codex 진단(토큰 72% 중복)은 실측과 달랐다(8-gram Jaccard 10.8%).
> 후속 문서에 현재 기준선 · 남은 레버 3개 · 각 판정의 근거가 정리돼 있다.
