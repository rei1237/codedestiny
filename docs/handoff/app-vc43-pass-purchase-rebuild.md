...
- 2026-09-04: Google Play 신품질기준(메모리·R8·Zero-Tap) 대응 PR #1560 머지(main `4d2414fcd`) — `MainActivity.onTrimMemory`, `CodeDestinyCredentialsPlugin` 뼈대 + `androidx.credentials 1.6.0`, `measure:app-memory`, 보고서 `PLAY_QUALITY_AUDIT_2026-09-04`(완료 감사 보고서, git 히스토리 참조) · [docs/app-audit/ZERO_TAP_SIGNIN_DESIGN.md](../app-audit/ZERO_TAP_SIGNIN_DESIGN.md).
