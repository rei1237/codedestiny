...
| 배치 3 | **PR-A2** — 사주 파생 4 · 명상/요가 2 · 작명 1 · 상담 3 재작성 + 최애운명 무료 오분류 수정 + 손금 `featureId` 정정 | PR 생성 |
...
### 배치 3 = PR-A2 — 사주 파생 4 · 명상/요가 2 · 작명 1 · 상담 3 (2026-09-02)

10종을 구현 대조 후 재작성했다. **서빙 키·근거 `파일:줄` 표는 PR 본문이 정본.** 다음 배치가 알아야 할 것만 남긴다.
