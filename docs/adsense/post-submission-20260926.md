# AdSense 제출 후 콘텐츠 정정 — 2026-09-26
...
허브 6개와 우선 글 20편은 운영에 반영되어 있다. 해당 릴리스의 Pages와 Worker SHA는 모두 `aae9918d38611da2d6e7a0b7b8c5d3a687c846b7`이었다. 이번 문서의 후속 정정 5편은 별도 변경이며, main 반영과 운영 승격을 구분한다.
