...
- `node --test __tests__/ui/publisher-integrity.test.mjs`: 8 PASS.
...
5. Complete GSC external link/page evidence and locale/editorial quality review before any broad deindex/deletion.
