...
- `node verify-plf-mockup.cjs` PASS: 360/390/430/1440px, overflow 없음, 초기 이미지 src 1개, 3개 장면+공유 대표 이미지, 44px 이상 버튼, 펼침 및 demo 안내 작동, CLS0. reduced-motion 활성·DPR1·file:// 기준. 운영 LCP 및 실제 네트워크는 미측정.
...
- `node verify-plf-mockup.cjs` 실제 모듈 하네스 PASS: 360/390/430/1440px, 가로 넘침 없음, 핵심 3화·상세 9장면, 핵심 본문 1,317자, 초기 이미지 요청 1개, CLS 0, 44px 버튼, IO 없음/404/reduced-motion/초점 복원.
