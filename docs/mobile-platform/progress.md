...
- 상세 소개: 등록 목적지 69개를 65개 고유 실행 경로로 정규화. 실제 소스를 확인한 63개 공개, `face-reading`은 `/animal/physio` 계약과 `/features/face-reading/` 상세로 연결. 소개 페이지는 `noindex, follow`로 두고 실제 서비스 랜딩의 검색 소유권 유지.
...
- 63개 소개주소: 직접 진입, 새로고침, canonical/OG, CTA, 320/360/375/390/412/430/768/1280px.
- 목록: 63개 고유 링크, 검색, 결과 없음, 전체 복구.
