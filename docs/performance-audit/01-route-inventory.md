...
- 서비스 카드/내비게이션 근거: `index.html`, `app/_lib/serviceSections.js`, `app/_lib/serviceMap.js`, `app/components/MainLandingPage.tsx`, `app/components/FeatureLandingPage.tsx`, `app/components/AppChrome.tsx`.
