...
|---|---|---|---|
| `cd_content_tier_01` | `3900` | 운세 콘텐츠 열람권 3,900원 | 선택한 운세·타로·사주 콘텐츠 1건을 엽니다. 결제 시점에 고른 콘텐츠에 적용됩니다. |
| `cd_content_tier_02` | `6000` | 운세 콘텐츠 열람권 6,000원 | 선택한 운세·타로·관상 콘텐츠 1건을 엽니다. 결제 시점에 고른 콘텐츠에 적용됩니다. |
| `cd_content_tier_03` | `7500` | 운세 콘텐츠 열람권 7,500원 | 선택한 심화 운세 콘텐츠 1건을 엽니다. 결제 시점에 고른 콘텐츠에 적용됩니다. |
| `cd_content_tier_04` | `8900` | 운세 콘텐츠 열람권 8,900원 | 선택한 심화 운세 콘텐츠 1건을 엽니다. 결제 시점에 고른 콘텐츠에 적용됩니다. |
| `cd_content_tier_05` | `10900` | 운세 콘텐츠 열람권 10,900원 | 선택한 심화 분석 콘텐츠 1건을 엽니다. 결제 시점에 고른 콘텐츠에 적용됩니다. |
| `cd_content_tier_06` | `12900` | 운세 콘텐츠 열람권 12,900원 | 선택한 운세·상담 콘텐츠 1건을 엽니다. 결제 시점에 고른 콘텐츠에 적용됩니다. |
| `cd_content_tier_07` | `14900` | 운세 콘텐츠 열람권 14,900원 | 선택한 심화 분석 콘텐츠 1건을 엽니다. 결제 시점에 고른 콘텐츠에 적용됩니다. |
| `cd_content_tier_08` | `18900` | 운세 콘텐츠 열람권 18,900원 | 선택한 심화 분석 콘텐츠 1건을 엽니다. 결제 시점에 고른 콘텐츠에 적용됩니다. |
| `cd_content_tier_09` | `24900` | 운세 콘텐츠 열람권 24,900원 | 선택한 궁합·심화 상담 콘텐츠 1건을 엽니다. 결제 시점에 고른 콘텐츠에 적용됩니다. |
| `cd_content_tier_10` | `38900` | AI 상담 열람권 38,900원 | 선택한 AI 운세 상담 1건을 엽니다. 결제 시점에 고른 상담에 적용됩니다. |
| `cd_content_tier_11` | `48900` | 프리미엄 해금권 48,900원 | 선택한 프리미엄 운세 묶음을 영구 해금합니다. 결제 시점에 고른 항목에 적용됩니다. |
| `cd_content_tier_12` | `62900` | AI 상담 열람권 62,900원 | 선택한 심층 AI 운세 상담 1건을 엽니다. 결제 시점에 고른 상담에 적용됩니다. |
| `cd_content_tier_13` | `89000` | 프리미엄 전체 해금권 89,000원 | 선택한 프리미엄 전체 묶음을 영구 해금합니다. 결제 시점에 고른 항목에 적용됩니다. |
...
| 상품 ID | 가격(KRW) | 이름 | 설명 |
|---|---|---|---|
| `cd_pass_standard_30d` | `12000` | 스탠다드 이용권 (30일) | 30일간 3,000원 이하 유료 기능을 추가 결제 없이 이용합니다. 프로필 3개. 자동 갱신되지 않습니다. |
| `cd_pass_premium_30d` | `37900` | 프리미엄 이용권 (30일) | 30일간 5,000원 이하 유료 기능을 추가 결제 없이 이용합니다. 프로필 7개. 자동 갱신되지 않습니다. |
| `cd_pass_vvip_30d` | `73900` | VVIP 이용권 (30일) | 30일간 10,000원 이하 유료 기능을 추가 결제 없이 이용합니다. 프로필 15개. 자동 갱신되지 않습니다. |
| `cd_pass_family_30d` | `369000` | 패밀리 이용권 (30일) | 30일간 모든 유료 기능을 추가 결제 없이 이용합니다. 프로필 무제한. 자동 갱신되지 않습니다. |

> 웹가 대비: 9,900→12,000 (+21.2%) / 29,900→37,900 (+26.8%) / 59,000→73,900 (+25.3%) / 300,000→369,000 (+23.0%)
