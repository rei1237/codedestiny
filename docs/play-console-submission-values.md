...
실제 정책과 모순이고, 한도를 다 쓴 사용자가 "제한이 없다더니"를 겪는다. 한도는 이용권 사이클마다 리셋되며,
넘겨도 서비스가 막히지 않고 남은 기간은 단건 결제로 넘어간다.
...
| 상품 ID | 가격(KRW) | 이름 | 설명 |
|---|---|---|---|
| `cd_pass_standard_30d` | `9900` | 스탠다드 꿀 (30일) | 30일간 5,000원 이하 유료 기능을 월 최대 30,000원 상당까지 이용합니다. 프로필 3개. 자동 갱신되지 않습니다. |
| `cd_pass_premium_30d` | `29900` | 프리미엄 꿀 (30일) | 30일간 10,000원 이하 유료 기능을 월 최대 100,000원 상당까지 이용합니다. 프로필 7개. 자동 갱신되지 않습니다. |
| `cd_pass_vvip_30d` | `59000` | VVIP 꿀단지 (30일) | 30일간 20,000원 이하 유료 기능을 월 최대 200,000원 상당까지 이용합니다. 프로필 15개. 자동 갱신되지 않습니다. |
| `cd_pass_family_30d` | `149000` | Code Destiny Family (30일) | 30일간 이용권 대상 유료 기능 전체를 월 최대 500,000원 상당까지 이용합니다. 프로필 무제한. 자동 갱신되지 않습니다. |
