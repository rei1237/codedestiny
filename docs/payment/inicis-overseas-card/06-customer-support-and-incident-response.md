...
현재 상태: 고객 문의 채널은 이메일 하나이고, 영어 연락 페이지는 응답기한·언어 지원을 약속하지 않는다. 결제 사고 감지는 1단계 C7 운영자 알림이 있고, 채널 운영 설정·담당자·온콜은 2026-09-18 오너 확인으로 모두 정해졌다(담당자는 오너 본인, 평일 업무시간, 당일 내 조치 기대). 2단계에서 결제 문의 진입점(로케일별 연락 페이지의 `#payment-help` 절 + 결제창 하단 링크)이 생겼다 — **채널이 늘어난 것이 아니라 같은 이메일로 가는 길이 생긴 것이고, 응답기한·언어 지원 보장은 여전히 없다**. 개인정보 유출 대응 내부 절차는 없음으로 확인됐다(범위 밖 결함). 없는 CS 기능을 있다고 적지 않는다. 완료 보고가 아니다.

- 측정일: 2026-09-17. §1 은 2026-09-18 재측정(2단계 결제 문의 진입점). §4 는 2026-09-18 오너 확인으로 해소.
...
| 항목 | 상태 |
|---|---|
| 결제 사고 1차 담당자 | READY — 2026-09-18 오너 확인: 오너 본인이 알림 메일을 직접 확인하고 `/admin/orders` 에서 조치한다 |
| 온콜·대응 시간 | READY — 2026-09-18 오너 확인: 평일 업무시간만 확인(상시 온콜 아님). 알림 인지 후 조치까지 내부 기대치는 당일 내(엄격한 SLA 아님) |
| 개인정보 유출 대응 절차 | 확인됨(2026-09-18, 오너 답변): 내부 절차 없음 — 범위 밖 결함. 법적 신고 의무 등은 [07](07-personal-data-inventory.md) LEGAL REVIEW 범위(별도) |
| C7 알림 수신자·채널(D4) | READY — 2026-09-18 오너 확인: 수신 이메일 `admin@code-destiny.com`(`wrangler secret list` 실측상 `ADMIN_FEEDBACK_EMAIL` 등록됨과 정합). Discord·Slack 은 오너가 쓰지 않기로 결정, 미등록은 의도된 상태 |

### 해소 기록 (2026-09-18)

위 3문항에 오너가 직접 답했다. 상세는 위 §4 표, [09 신청 사실](09-inicis-application-facts.md) 문항 9, [07 개인정보](07-personal-data-inventory.md) §4 참고.

1. ~~결제 사고 1차 담당자~~ — 오너 본인. [09](09-inicis-application-facts.md) 문항 9에 반영.
2. ~~온콜·대응 시간~~ — 평일 업무시간만, 당일 내 조치 기대(신청서·고객 화면에는 옮기지 않는 방침 유지).
3. ~~개인정보 유출 대응 절차~~ — 내부 절차 없음(범위 밖 결함), [07](07-personal-data-inventory.md) §4에 반영. 법적 신고 의무는 별도 LEGAL REVIEW.
...
| 알림 채널 운영 설정·담당자·온콜 | READY — 알림 채널(이메일 `admin@code-destiny.com`, Discord·Slack 은 오너가 안 씀), 담당자(오너 본인)·온콜(평일 업무시간, 당일 내 조치 기대) 모두 2026-09-18 오너 확인 |
| 개인정보 유출 대응 내부 절차 | NOT READY(범위 밖 결함 — 없음, 2026-09-18 오너 확인) |
| 웹훅 반복 실패·환불 실패·크론 실패 알림 채널 | NOT READY(범위 밖 결함) |
| 오류 수집(Sentry 등) | NOT READY(없음) |

**최종 판정: READY** — 알림 채널·결제 사고 1차 담당자(오너 본인)·온콜(평일 업무시간, 당일 내 조치 기대)은 2026-09-18 오너 확인으로 모두 해소됐다. 개인정보 유출 대응 내부 절차는 "없음"으로 확인됐고(범위 밖 결함), 법적 신고 의무 등 법 해석은 [07](07-personal-data-inventory.md) LEGAL REVIEW REQUIRED 범위로 별도 남는다. 신청서에는 "이메일 문의, 응답기한 보장 없음(한국어 페이지 기준 영업일 1~3일 안내)"처럼 있는 것만 적는다.
