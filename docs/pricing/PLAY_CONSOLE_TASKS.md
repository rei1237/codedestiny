...
**없다.** 남은 7개 콘텐츠 SKU와 이용권 4개의 **앱가는 한 건도 바뀌지 않았다.**

웹가만 내려간 상품들이 이미 존재하던 하위 티어로 이동했을 뿐이다. 덕분에 Play 가격 변경에 따르는 사용자 고지·유예 기간 요구사항이 이번 정비에는 **적용되지 않는다**.

| productId | 앱가 | 웹가 | 상태 |
|---|---:|---:|---|
| `cd_content_tier_01` | ₩3,900 | ₩3,000 | 유지 |
| `cd_content_tier_02` | ₩6,000 | ₩5,000 | 유지 |
| `cd_content_tier_06` | ₩13,000 | ₩10,000 | 유지 |
| `cd_content_tier_09` | ₩25,000 | ₩20,000 | 유지 |
| `cd_content_tier_10` | ₩39,000 | ₩30,000 | 유지 |
| `cd_content_tier_11` | ₩49,000 | ₩39,000 | 유지 (번들 예외) |
| `cd_content_tier_13` | ₩89,000 | ₩70,000 | 유지 (번들 예외, 대응 코인가에서 690 제거 → 700만) |
| `cd_pass_{standard,premium,vvip,family}_30d` | 13,000 / 36,000 / 75,900 / 185,000 | 9,900 / 29,900 / 59,000 / 149,000 | 유지 |
...
| 앱가 | **₩8,900** (웹 ₩7,000 대비 +27.1% — 20~30% 밴드 안) |
| 대응 코인가 | 70코인 |
