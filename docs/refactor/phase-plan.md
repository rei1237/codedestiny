...
| 4 | 권한 판정 단일화: writer 4개 → 서버 SoT 하나에 묻기 | ~~3~~, 4, 5, ~~6~~, 15 | 착수 전 재측정 (2026-09-13) — **3·6 은 이미 닫혀 있어 제외**했다. 실작업은 4·5·15 뿐이다([근거](structural-issues-top20.md#345615-재측정-2026-09-13-phase-4-착수-전)) |
