...
export const yeoniSpriteSheets = {
  sprite1: {
    src: fortuneTeaHouseAssets.yeoni.sprite1,
    columns: 4,
    rows: 2,
    frameCount: 8,
    aspectRatio: "4 / 5",
  ...
  sprite2: {
    src: fortuneTeaHouseAssets.yeoni.sprite2,
    columns: 4,
    rows: 2,
    frameCount: 8,
    aspectRatio: "4 / 5",
  ...
  sprite3: {
    src: fortuneTeaHouseAssets.yeoni.sprite3,
    columns: 4,
    rows: 2,
    frameCount: 8,
    aspectRatio: "4 / 5",
  ...
  sprite4: {
    src: fortuneTeaHouseAssets.yeoni.sprite4,
    columns: 4,
    rows: 2,
    frameCount: 8,
    aspectRatio: "4 / 5",
  ...
  sprite5: {
    src: fortuneTeaHouseAssets.yeoni.sprite5,
    columns: 4,
    rows: 2,
    frameCount: 8,
    aspectRatio: "4 / 5",
  ...
  sprite6: {
    src: fortuneTeaHouseAssets.yeoni.sprite6,
    columns: 4,
    rows: 2,
    frameCount: 8,
    aspectRatio: "4 / 5",
  ...
  sprite7: {
    src: fortuneTeaHouseAssets.yeoni.sprite7,
    columns: 4,
    rows: 2,
    frameCount: 8,
    aspectRatio: "4 / 5",
