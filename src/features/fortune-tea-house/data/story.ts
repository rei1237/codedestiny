...
export const teaHouseLandingCopy = {
  ...
  prologue: [
    ...
    "그리고 가끔은 코끝을 살짝 움직이며 말합니다. 꿀... 오늘은 말하지 않은 마음이 더 진하게 향을 내고 있네요. 그 순간 이 찻집이 평범한 운세의 방이 아니라, 오직 당신의 밤을 위해 열린 작은 달빛 상담실이라는 것이 조용히 드러납니다.",
  ],
  cta: "찻집에 들어가기",
} as const;
...
export const teaHouseStorySteps: TeaHouseStoryStep[] = [
  ...
  },
  {
    ...
    visual: "yeoni",
    mood: "playful",
    text: "방금 본 꽃돼지?가 신경 쓰이나요?\n괜찮아요. 처음 오신 분들은 보통 세 번 정도 다시 쳐다보시거든요.",
  },
  {
    id: "yeoni-5",
    stage: "yeoniIntro",
