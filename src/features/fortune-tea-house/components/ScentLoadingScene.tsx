...
export default function ScentLoadingScene({ selectedCup, consultationMode = "tarot", progress }: ScentLoadingSceneProps) {
  ...
  return (
    <section className={styles.emotionScene} data-accent={selectedCup?.accent || "pink"} aria-label="연이가 상담문을 준비하는 중">
      <div className={styles.emotionVisual}>
        ...
        >
          ...
          <span className={styles.scentLoadingTeaChatSprite} role="img" aria-label="찻잔을 건네는 연이" />
        </div>
      </div>
