...
const MASTER_LOVE_CODEX_COPY_EN: MasterLoveCodexCopy = {
  ...
  libraryDesc: "Completed books stay here, ready to read again.",
...
const MASTER_LOVE_CODEX_COPY: Partial<Record<LoadingLocale, MasterLoveCodexCopy>> = {
  ko: {
    ...
    libraryDesc: "모든 장이 완성된 책만 보관됩니다. 언제든 다시 펼쳐 읽을 수 있습니다.",
  ...
  ja: {
    ...
    libraryDesc: "全章が完成した書だけが保管されます。いつでも読み返せます。",
    libraryNavLink: "マイ書斎",
  ...
  "zh-CN": {
    ...
    libraryEyebrow: "我的书房",
    libraryTitle: "我的情缘之书",
    libraryDesc: "所有章节完成后，书才会保存在这里，随时可以再次阅读。",
    libraryNavLink: "我的书房",
  ...
  "zh-TW": {
    ...
    libraryEyebrow: "我的書房",
    libraryTitle: "我的情緣之書",
    libraryDesc: "所有章節完成後，書才會保存在這裡，隨時可以再次閱讀。",
    libraryNavLink: "我的書房",
    libraryStatusCompleted: "已完成",
